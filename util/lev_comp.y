...
%token	<i> MESSAGE_ID MESSAGE_ATTR MESSAGE_COLOR MESSAGE_SOUND_TYPE MESSAGE_SOUND_ID MAZE_ID LEVEL_ID LEV_INIT_ID TILESET_ID GEOMETRY_ID NOMAP_ID BOUNDARY_TYPE_ID SPECIAL_TILESET_ID TILESET_PARAM_ID DECOTYP_ID
...
message		: MESSAGE_ID ':' string_expr
		...
		| MESSAGE_ID ':' string_expr ',' MESSAGE_COLOR
		  {
		      add_opvars(splev, "iiiiiio", VA_PASS7(0, 0, 0, 0, (int)$5, ATR_NONE, SPO_MESSAGE));
		  }
		| MESSAGE_ID ':' string_expr ',' MESSAGE_ATTR ',' MESSAGE_COLOR ',' MESSAGE_SOUND_TYPE ',' MESSAGE_SOUND_ID ',' INTEGER ',' INTEGER
		  {
		      add_opvars(splev, "iiiiiio", VA_PASS7((int)$15, (int)$13, (int)$11, (int)$9, (int)$7, (int)$5, SPO_MESSAGE));
		  }		
		;
