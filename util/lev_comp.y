...
%token	<i> CORRIDOR_ID GOLD_ID ENGRAVING_ID FOUNTAIN_ID THRONE_ID MODRON_PORTAL_ID LEVEL_TELEPORTER_ID LEVEL_TELEPORT_DIRECTION_TYPE POOL_ID SINK_ID NONE
%token	<i> RAND_CORRIDOR_ID DOOR_STATE LIGHT_STATE CURSE_TYPE ENGRAVING_TYPE KEYTYPE_ID LEVER_ID
...
modron_portal_detail : MODRON_PORTAL_ID ':' coord_or_var ',' TARGET_ID ':' coord_or_var ',' MODRON_PORTAL_TYPE ',' ACTIVE_OR_INACTIVE
		...
		| MODRON_PORTAL_ID ':' coord_or_var ',' LEVEL_TELEPORTER_ID ',' LEVEL_TELEPORT_DIRECTION_TYPE ',' MODRON_PORTAL_TYPE ',' ACTIVE_OR_INACTIVE
		  {
		      add_opvars(splev, "iiio", VA_PASS4((int) $<i>7, (int) $<i>9, (int) $<i>11, SPO_MODRON_LEVEL_TELEPORTER));
		  }
		;
