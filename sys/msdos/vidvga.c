...
static void vga_cliparound(int, int, boolean);
...
static void vga_DisplayCell_O(struct overview_planar_cell_struct *, int, int);
...
static void read_planar_tile_O(unsigned, struct overview_planar_cell_struct *);
...
static void
vga_cliparound(int x, int y, boolean force)
{
