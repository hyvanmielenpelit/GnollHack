...
INSTDUNGEONFILES1= \
	...
	$(SLIB)bigrm-3.lev	$(SLIB)bigrm-4.lev	$(SLIB)bigrm-5.lev $(SLIB)bovine1.lev $(SLIB)quantum1.lev $(SLIB)quantum2.lev \
...
INSTDUNGEONFILES= $(NETHACK)GnollHack.cnf $(INSTDUNGEONFILES1)
...
QUANTUM1= $(SLIB)quantum1.lev $(SLIB)quantum2.lev

$(SLIB)quantum1.lev:	$(DAT)quantum.des $(SBIN)lev_comp
$(SLIB)quantum2.lev:	$(DAT)quantum.des $(SBIN)lev_comp
...
MODRON1= $(SLIB)modron1.lev $(SLIB)modron2.lev $(SLIB)modron3.lev $(SLIB)modron4.lev
$(MODRON1): $(SLIB)modron5.lev

$(SLIB)modron5.lev:	$(DAT)modron.des $(SBIN)lev_comp
...
# Create the directories here because GnollHack.cnf puts them there by default
$(NETHACK)GnollHack.cnf:  $(AMI)GnollHack.cnf
	copy $(AMI)GnollHack.cnf $@
