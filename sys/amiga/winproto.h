...
void amii_getlin_ex(int attr, int color, const char *prompt, char *bufp);
...
void amiga_init_print_glyph(int initid);
...
void amii_init_print_glyph(int initid);
...
char amii_yn_function_ex(int attr, int color, const char *prompt, const char *resp, char def);
//char amii_yn_function_ex(int attr, int color, const char *query, const char *resp, char def);
