...
void amiga_issue_gui_command(int cmd_id, int cmd_param, int cmd_param2, const char* cmd_str);
...
void amii_issue_gui_command(int cmd_id, int cmd_param, int cmd_param2, const char* cmd_str);
...
char amii_yn_function_ex(int style, int attr, int color, int glyph, const char* title, const char *prompt, const char *resp, int def, const char* resp_desc, const char* introline, unsigned long ynflags);
