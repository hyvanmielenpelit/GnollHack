...
void
mac_delay_output_milliseconds(int interval)
{
    long destTicks = (TickCount() * interval) / 50 + 1;
...
struct window_procs mac_procs = {
    ...
    donull,
#endif
    tty_print_glyph, tty_issue_gui_command, tty_raw_print, tty_raw_print_bold, mac_nhgetch,
