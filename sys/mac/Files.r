...
read 'File' (1012,"asmodeus.lev") "asmodeus.lev";
...
read 'File' (1027,"juiblex.lev") "juiblex.lev";
...
read 'File' (1065,"yeenoghu.lev") "yeenoghu.lev";
...
read 'File' (1012,"asmodeus.lev") ":lib:asmodeus.lev";
...
read 'File' (1027,"juiblex.lev") ":lib:juiblex.lev";
