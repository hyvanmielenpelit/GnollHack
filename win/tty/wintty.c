...
char ch;
{
    ...
    wchar_t utf8char = cp437toUnicode[uch];

    setlocale(LC_ALL, "en_US.utf8");
    char mbstr[BUFSZ];
    wcstombs(mbstr, utf8char, BUFSZ);
    puts(mbstr);
...
static const enum statusfields
    ...
    { BL_TITLE, BL_STR, BL_DX, BL_CO, BL_IN, BL_WI, BL_CH, BL_GOLD,  //BL_ALIGN,
      BL_FLUSH, BL_FLUSH, blPAD, blPAD, blPAD, blPAD, blPAD, blPAD },
    { BL_LEVELDESC, BL_HP, BL_HPMAX, BL_ENE, BL_ENEMAX,  //BL_GOLD, 
      BL_AC, BL_MC_LVL, BL_MC_PCT, BL_MOVE, BL_XP, BL_EXP, BL_HD, BL_TIME, BL_2WEP, BL_SKILL, BL_HUNGER,
    ...
    { BL_LEVELDESC, BL_HP, BL_HPMAX, BL_ENE, BL_ENEMAX,  //BL_GOLD, BL_ALIGN, 
      BL_AC,  BL_MC_LVL, BL_MC_PCT, BL_MOVE, BL_XP, BL_EXP, BL_HD, BL_TIME, BL_SCORE, BL_FLUSH,
