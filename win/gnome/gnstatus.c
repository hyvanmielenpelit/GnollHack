...
/* GnollHack 4.0	gnstatus.c	$NHDT-Date: 1432512806 2015/05/25 00:13:26 $  $NHDT-Branch: master $:$NHDT-Revision: 1.15 $ */
...
ghack_init_status_window()
{
    ...
    gtk_signal_connect(GTK_OBJECT(statTable), "gnome_delay_output_intervals",
        GTK_SIGNAL_FUNC(ghack_delay), NULL);
