...
{S_branch_upstair,  "up stairs", "staircase up"},
{S_branch_dnstair,  "down stairs", "staircase down"},
{S_extra_upstair, "up stairs", "staircase up"},
{S_extra_dnstair, "down stairs", "staircase down"},
{S_altar,    "altar", "altar"},
{S_lawful_altar,    "lawful altar", "lawful altar"},
{S_neutral_altar,    "neutral altar", "neutral altar"},
...
{S_octahedral_portal,     "octahedral magic portal", "octahedral magic portal"},
{S_tetrahedral_portal,     "tetrahedral magic portal", "tetrahedral magic portal"},
{S_cubical_portal,        "cubical magic portal", "cubical magic portal"},
{S_dodecahedral_portal,   "dodecahedral magic portal", "dodecahedral magic portal"},
