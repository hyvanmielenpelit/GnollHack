...
#define F_WOUNDED_LEGS 33

#define F_HUNGER   34
#define F_ENCUMBER 35
#define F_LEV      36
#define F_FLY      37
#define F_RIDE     38
...
uint64_t *colormasks;
{
    ...
    if (fld != BL_FLUSH && fld != BL_RESET) {
        ...
        if (fld == BL_CONDITION) {
            ...
            MaybeDisplayCond(BL_MASK_WOUNDED_LEGS, colormasks, "Legs");
        } else {
...
uint64_t *colormasks UNUSED;
{
    ...
    static const struct {
        ...
        { BL_MASK_WOUNDED_LEGS, F_WOUNDED_LEGS },
