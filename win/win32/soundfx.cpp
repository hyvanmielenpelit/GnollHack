...
const struct ghsound_eventmapping ghsound2event[MAX_GHSOUNDS] = {
    ...
    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging/Digging Ambient", 0.5f },
    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging/Digging Start", 0.5f },
    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging/Digging Finish", 0.5f },

    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging/Digging Interrupted", 0.5f },
    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging/Digging Resume", 0.5f },
    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging Ground/Digging Ground Ambient", 0.5f},
    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging Ground/Digging Ground Start", 0.5f},
    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging Ground/Digging Ground Finish", 0.5f},
    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging Ground/Digging Ground Interrupted", 0.5f},
    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging Ground/Digging Ground Resume", 0.5f},
    { SOUND_BANK_MASTER, "event:/SFX/Altar/Desecrate Altar", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Spell/General/Summon Demon", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Altar/Sacrifice Pet", 0.5f },

    { SOUND_BANK_MASTER, "event:/SFX/Altar/Sacrifice Coaligned Unicorn", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Altar/Add Alignment", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Environment/Thunderclap", 1.0f },
    { SOUND_BANK_MASTER, "event:/SFX/Environment/Charged Air", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Altar/Accepts Sacrifice", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Altar/Rejects Sacrifice", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Altar/Power Increase", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Altar/Power Decrease", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Altar/God Mollified", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Altar/Inadequacy", 0.5f },

    { SOUND_BANK_MASTER, "event:/SFX/Altar/Absolved", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Altar/Hopeful Feeling", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Altar/Reconciliation", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Altar/Gift", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Altar/Four-Leaf Clover", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Spell/General/Aura Glow", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Altar/Offering Burst of Flame", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Altar/Offering Vanish", 0.5f },
    { SOUND_BANK_MASTER, "event:/Monster/Dog/Dog Yelp", 0.5f },
    { SOUND_BANK_MASTER, "event:/Monster/Dog/Dog Warn Cursed", 0.5f },

    { SOUND_BANK_MASTER, "event:/Monster/Cat/Cat Yelp", 0.5f },
    { SOUND_BANK_MASTER, "event:/Monster/Cat/Cat Warn Cursed", 0.5f },
    { SOUND_BANK_MASTER, "event:/Monster/Generic/Generic Yelp", 0.5f },
    { SOUND_BANK_MASTER, "event:/Monster/Generic/Generic Warn Cursed", 0.5f },
    { SOUND_BANK_MASTER, "event:/Monster/Generic/Generic Pray", 1.0f },
    { SOUND_BANK_MASTER, "event:/SFX/Pray/Fail", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Pray/Pleased", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Pray/Fix All Troubles", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Pray/Fix One Trouble", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Pray/Repair", 0.5f },

    { SOUND_BANK_MASTER, "event:/SFX/Pray/Healing", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Pray/Uncurse", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Pray/Gift", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Pray/Crowning", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Pray/Spellbook", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Pray/Bless Water", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Pray/Curse Water", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Pray/Shimmering Light", 0.5f },
    ...
    { SOUND_BANK_MASTER, "event:/SFX/Spell/Enchant Item/Success", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Spell/Enchant Item/Blessed Success", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Spell/Enchant Item/Uncurse and Other", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Spell/Enchant Item/Negative", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Spell/Enchant Item/Violent Glow", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Spell/Enchant Item/Vibrate Warning", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Spell/Enchant Item/Vibrate and Destroy", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Spell/Enchant Item/Special Success", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Spell/Enchant Item/Special Negative", 0.5f },

    { SOUND_BANK_MASTER, "event:/SFX/Spell/Enchant Item/General Fail", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Spell/General/Hands Itch", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Spell/Protect Item/Success", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Spell/Protect Item/Fail", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Spell/Repair Item/Success", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Spell/Repair Item/Fail", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Spell/Bless Item/Success", 0.4f },
    { SOUND_BANK_MASTER, "event:/SFX/Spell/Bless Item/Uncurse", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Spell/Curse Item/Success", 0.5f },
    { SOUND_BANK_MASTER, "event:/SFX/Spell/Curse Item/Unbless", 0.5f },
};
