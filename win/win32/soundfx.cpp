...
const struct ghsound_eventmapping ghsound2event[MAX_GHSOUNDS] = {
    ...
    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging/Digging Ambient", 0.3f },
    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging/Digging Start", 0.3f },
    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging/Digging Finish", 0.3f },

    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging/Digging Interrupted", 0.3f },
    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging/Digging Resume", 0.3f },
    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging Ground/Digging Ground Ambient", 0.3f},
    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging Ground/Digging Ground Start", 0.3f},
    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging Ground/Digging Ground Finish", 0.3f},
    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging Ground/Digging Ground Interrupted", 0.3f},
    { SOUND_BANK_MASTER, "event:/Ambience/Occupation/Digging Ground/Digging Ground Resume", 0.3f},
