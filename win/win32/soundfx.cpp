...
const struct ghsound_eventmapping ghsound2event[MAX_GHSOUNDS] = {
    ...
    { SOUND_BANK_MASTER, "event:/SFX/Level/Shop/Someone Cursing Shoplifters", 1.0f },
    { SOUND_BANK_MASTER, "event:/SFX/Level/Shop/Chime of Cash Register", 1.0f },
    { SOUND_BANK_MASTER, "event:/SFX/Level/Shop/Neiman and Marcus Arguing", 1.0f },
    { SOUND_BANK_MASTER, "event:/SFX/Level/Deserted Shop/Faint Chime", 1.0f },
    { SOUND_BANK_MASTER, "event:/SFX/Level/Temple/Someone Praising God", 1.0f },
    { SOUND_BANK_MASTER, "event:/SFX/Level/Temple/Someone Beseeching", 1.0f },
    { SOUND_BANK_MASTER, "event:/SFX/Level/Temple/Animal Carcass Being Offered", 1.0f },
    { SOUND_BANK_MASTER, "event:/SFX/Level/Temple/Plea For Donations", 1.0f },

    { SOUND_BANK_MASTER, "event:/SFX/Level/Smithy/Iron Being Forged", 1.0f },
    { SOUND_BANK_MASTER, "event:/SFX/Level/Smithy/Loud Clanging", 1.0f },
    { SOUND_BANK_MASTER, "event:/SFX/Level/Smithy/Water Being Vaporized", 1.0f },
    { SOUND_BANK_MASTER, "event:/SFX/Level/NPC/Someone Mumbling", 1.0f },
    { SOUND_BANK_MASTER, "event:/SFX/Level/NPC/Distant Chitchat", 1.0f },
    { SOUND_BANK_MASTER, "event:/SFX/Level/NPC/Footsteps at Distance", 1.0f },
    { SOUND_BANK_MASTER, "event:/SFX/Level/Oracle/Strange Wind", 1.0f },
    { SOUND_BANK_MASTER, "event:/SFX/Level/Oracle/Convulsive Ravings", 1.0f },
    { SOUND_BANK_MASTER, "event:/SFX/Level/Oracle/Snoring Snakes", 1.0f },
