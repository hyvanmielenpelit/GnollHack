...
typedef void(__callconv* AddExtendedMenuCallback)(int, int, long long, CHAR_P, CHAR_P, int, const char*, UCHAR_P, int, int,
    unsigned long long, unsigned long long, CHAR_P, CHAR_P, unsigned long, UCHAR_P, struct obj, struct objclassdata);
...
typedef void(__callconv* OpenSpecialViewCallback)(int, const char*);
