...
typedef void(__callconv* AddExtendedMenuCallback)(int, int, long long, CHAR_P, CHAR_P, int, const char*, UCHAR_P, int, int,
    unsigned long long, unsigned long long, CHAR_P, unsigned long, UCHAR_P, struct obj, struct objclassdata);
...
typedef int(__callconv* YnFunctionCallback)(int, int, int, const char*, const char*, const char*, const char*, const char*);
...
typedef int(__callconv* PlayImmediateSoundCallback)(int, const char*, int, double, double, const char**, float*, int, int, int, unsigned int);
