...
namespace GnollHackCommon
{
    ...
    public enum init_print_glyph_stages
    {
        ...
        INIT_GLYPH_BEFORE_COLLECT,
        INIT_GLYPH_COLLECT_GARBAGE,
        INIT_GLYPH_AFTER_COLLECT,
        INIT_GLYPH_FORCE_ASCII,
        INIT_GLYPH_UNFORCE_ASCII,
    ...
    public class GHConstants
    {
        ...
        public const int AllMessageRows = 50;
