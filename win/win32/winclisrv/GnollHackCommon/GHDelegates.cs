...
namespace GnollHackCommon
{
    ...
    public delegate string GetMsgHistoryCallback(IntPtr attrs, IntPtr colors, byte value1);

    [UnmanagedFunctionPointer(CallingConvention.StdCall)]
    public delegate void PutMsgHistoryCallback([MarshalAs(UnmanagedType.LPStr)] string value1, IntPtr attrs, IntPtr colors, byte value2);
