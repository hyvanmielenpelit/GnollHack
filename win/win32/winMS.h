...
void mswin_status_enablefield(int fieldidx, const char *nm, const char *fmt,
                              boolean enable);
void mswin_status_update(int idx, genericptr_t ptr, int chg, int percent, int color, uint64_t *colormasks);
...
void mswin_display_floating_text(int x, int y, const char* text, int style, int attr, int color, uint64_t tflags);
void mswin_display_screen_text(const char* text, const char* supertext, const char* subtext, int style, int attr, int color, uint64_t tflags);
