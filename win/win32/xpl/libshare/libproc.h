...
char lib_yn_function_ex(int style, int attr, int color, int glyph, const char* title, const char* question, const char* choices, int def, const char* resp_desc, const char* introline, uint64_t ynflags);
...
void lib_display_floating_text(int x, int y, const char* text, int style, int attr, int color, uint64_t tflags);
void lib_display_screen_text(const char* text, const char* supertext, const char* subtext, int style, int attr, int color, uint64_t tflags);
