...
typedef void(__callconv* VoidIntIntBooleanCallback)(int, int, boolean);
typedef void(__callconv* VoidIntIntIntCallback)(int, int, int);
typedef void(__callconv* VoidIntBooleanCallback)(int, uchar);
...
typedef void(__callconv* VoidConstCharBooleanCallback)(const char*, boolean);
...
typedef char*(__callconv* CharPtrBooleanCallback)(boolean);
typedef void(__callconv* VoidIntConstCharPtrConstCharPtrBooleanCallback)(int, const char*, const char*, uchar);
