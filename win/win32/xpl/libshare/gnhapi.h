...
#define GHRUNFLAGS_VI_KEYS                  0x00080000UL
#define GHRUNFLAGS_WORN_SHOWS_EQUIPMENT     0x00100000UL
#define GHRUNFLAGS_METRIC_SYSTEM            0x00200000UL
#define GHRUNFLAGS_DAMAGE_FORMULA           0x00400000UL
