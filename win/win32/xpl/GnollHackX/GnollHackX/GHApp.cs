        ...
        public static void InitializeMoreCommandButtons(Assembly assembly, bool useSimple)
        {
            lock (_moreBtnLock)
            {
                ...
                if (useSimple)
                {
                    ...
                    _moreBtnMatrix[2, 3, 1] = new GHCommandButtonItem("2-Weapon", AppResourceName + ".Assets.UI.twoweap.png", GHUtils.Ctrl((int)'x'));
                ...
                else
                {
                    ...
                    _moreBtnMatrix[2, 3, 4] = new GHCommandButtonItem("Wipe", AppResourceName + ".Assets.UI.wipe.png", GHUtils.Meta((int)'e'));
