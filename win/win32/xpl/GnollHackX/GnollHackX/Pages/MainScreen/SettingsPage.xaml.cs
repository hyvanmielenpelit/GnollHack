...
#endif
{
    ...
    public partial class SettingsPage : CustomModalPage, ISpecialKeyPressHandlingPage, IMessagePopupPage
    {
        ...
        private static readonly Dictionary<string, (string Tooltip, string Description)> _settingDescriptions = new Dictionary<string, (string Tooltip, string Description)>
        {
            { "GPU Acceleration", ("Toggle GPU vs CPU rendering. May crash on some systems.", "Enables and disables the GPU acceleration of the game. If disabled, the game uses CPU for rendering graphics. Note that GPU acceleration can cause crashes on some systems.") },
            { "Graphics", ("Switch between 2D tiles and ASCII text.", "Shows the game in 2D tile graphics or in ASCII text.") },
            { "Map FPS", ("Max refresh rate of the game map (typically 60 FPS).", "Determines the max refresh rate of the game. This can be used to save battery or to make the game smoother. The default refresh rate varies by device (typically 60 FPS).") },
            { "Screen Resolution", ("Rendering resolution of the game map.", "Determines the rendering resolution of the game map.") },
            { "Screen Scale", ("Scale UI components larger or smaller.", "Custom scale to make UI components larger or smaller than normal.") },
            { "Windowed Mode", ("Run game in windowed or fullscreen mode.", "Determines if the game runs in windowed or fullscreen mode.") },
            { "Edge to Edge", ("Extend game screen over notches and cutouts.", "Determines whether the game screen extends over notches and similar areas.") },
            { "Cursor Style", ("(ASCII only) How the player character is indicated.", "*(ASCII graphics only)* Determines the way how the player character is indicated in the game.") },
            { "Hide Navigation", ("Hide OS navigation buttons at the bottom of the screen.", "Determines whether to hide the operating system navigation buttons in the bottom of the screen.") },
            { "Hide Status Bar", ("Hide OS status bar at the top of the screen.", "Determines if the top status bar of the operating system is hidden.") },
            { "Show Battery", ("Display a battery icon in the status bar.", "Displays a battery icon in the status bar indicating the current battery level.") },
            { "Show FPS", ("Display refresh rate (FPS) in the status bar.", "Displays a frames-per-second icon in the status bar indicating the current refresh rate of the game.") },
            { "Show Zoom", ("Display current zoom level in the status bar.", "Displays a zoom icon in the status bar indicating the current zoom level of the map.") },
            { "Silent Mode", ("Mute all game sounds and music.", "Game sounds and music are not played if turned on.") },
            { "Dark Mode", ("Toggle light or dark backgrounds for menus and text.", "**Off (Light mode):** Menu and text window backgrounds are light and texts are black.\n**On (Dark mode):** Menu and text window backgrounds are dark and texts are white.") },
            { "Tournament Mode", ("Enables specific settings required for tournaments.", "Toggles several other settings to values required by tournaments like [[Junethack]].") },
            { "Metric System", ("Display weights in metric (kg, g) instead of imperial.", "Enables the metric system, displaying weights in kilograms (`kg`), grams (`g`), or tons. If disabled (default), the game uses the imperial system, displaying weights in pounds (`lbs` / `lb`), ounces (`oz`), or hundredweights (`cwt`). Mirrors the `metric_system` option.") },
            { "Show Dice as Ranges", ("Show item damage as ranges (2-12) instead of dice (2d6).", "Converts traditional D&D-style dice notation (like `2d6`) into a simple range (like `2-12`) in item descriptions. If disabled, traditional XdY notation is used. Mirrors the `show_dice_as_ranges` option.") },
            { "Show Damage Formula", ("Show underlying dice formula for item damage.", "Shows the underlying dice formula (e.g., `1d6+2`) used to calculate an item's damage when examining it. Mirrors the `show_damage_formula` option.") },
            { "Menu Fade Effects", ("Toggle fade animations for menus (Android only).", "Determines whether the texts in the menu and text pages fade in and out when opening and closing the page. Only available on Android.") },
            { "Improved Menu Images", ("Use higher quality bilinear interpolation for menu images.", "**Off:** Nearest neighbour (faster but worse quality).\n**On:** Bilinear interpolation (slower but better quality).") },
            { "Highlighted Menu Keys", ("Color hotkeys based on light/dark mode.", "**Off:** Hotkeys are grayed.\n**On:** Hotkeys are colored black/white based on light/dark mode.") },
            { "Show Equipment Icons", ("Display equipment slot icons in inventory.", "Displays equipment slot icons in the inventory menu.") },
            { "Equipment Flip Animation", ("Enable 3D flip when switching inventory/equipment screens.", "Enables a 3D flip animation when moving between inventory and equipment screens.") },
            { "Worn Shows Equipment", ("Show graphical equipment screen when using the worn command.", "Determines whether the worn item command (`]`) shows a full graphical equipment screen with all body slots or a plain text list of currently worn items. Mirrors the `worn_shows_equipment` option.") },
            { "Starting and Gifted Pets", ("Start with a pet and receive gifted pets.", "Determines whether the player starts with a pet and receives gifted pets in special situations. Turn off the setting (or enable the option) if you are attempting a petless conduct. Mirrors the `pets_not_gifted` option (with inverted value).") },
            { "Allow Ghost Levels", ("Enable encountering ghosts of dead characters (bones files).", "Determines if the game uses so-called bones files of dead characters.") },
            { "Simple Command Layout", ("Show fewer command rows with extra commands in menus.", "**Off:** Shows two rows of commands in the bottom of the screen, and extra commands in more commands.\n**On:** Shows one row of commands and only the most important extra commands in more commands.") },
            { "Alternative Zoom Button", ("Show alternative zoom toggle on the map.", "Displays the alternative zoom toggle button in the top-right corner of the map.") },
            { "Travel Mode Button", ("Show travel mode toggle on the map.", "Displays the travel mode toggle button in the top-right corner of the map.") },
            { "Auto-Dig Button", ("Show auto-dig toggle on the map.", "Displays the auto-dig toggle button in the top-right corner of the map.") },
            { "Ignore Stopping Button", ("Show ignore stopping toggle on the map.", "Displays the ignore stopping toggle button in the top-right corner of the map.") },
            { "Desktop Buttons", ("Show Stats and Equipment alongside command buttons.", "Determines whether Stats and Equipment buttons are shown on the left and right side of command buttons.") },
            { "Skill Context Button", ("Show skill context button on the left.", "Determines whether to show the skill context button on the left side of the screen.") },
            { "Polearm Context Button", ("Show polearm context button on the left.", "Determines whether to show the polearm context button on the left side of the screen.") },
            { "Single Commands Page", ("Use one large commands page instead of categories.", "Uses a single large commands page instead of several categorized pages.") },
            { "Classic Status Bar", ("Use text-based NetHack style status bar instead of graphical.", "**Off:** Shows the modern graphical game status bar.\n**On:** Shows the game status bar in text in the NetHack style.") },
            { "Desktop Status Bar", ("Display ability scores and extra info on the status bar.", "Displays ability scores and other extra information on the status bar.") },
            { "Show Score", ("Display game score on the status bar.", "Displays the game score on the status bar.") },
            { "Show XP", ("Display experience points on the status bar.", "Displays experience points on the status bar.") },
            { "Right-Aligned on 2nd Row", ("Move score, XP, and gold to the 2nd status bar row.", "Moves the display location of score, experience points and gold to the 2nd status bar row.") },
            { "Show Status Screen", ("Toggle button for the status screen.", "Toggle for showing the status screen. The same as tapping the middle area of the status bar.") },
            { "Grid", ("Show grid lines on the map for easier tile visibility.", "Determines if the game shows grid lines in the game for easier tile position discernment.") },
            { "Grid Opacity", ("Adjust the transparency of map grid lines.", "Adjusts the opacity of the grid lines if they are shown.") },
            { "Hit Point Bars", ("Show HP bars under player, pets, and monsters.", "Determines if the game shows hit point bars under the player character, pets, and monsters.") },
            { "Player Mark", ("Display a green targeting icon above the player.", "Determines if a green targeting icon is displayed above the player character.") },
            { "Targeting", ("Display a red targeting icon above hostile monsters.", "Determines if a red targeting icon is displayed above hostile monsters.") },
            { "Show Pets", ("Show pet icons at the top of the game screen.", "Determines if the game shows pet icons in the top of the game screen (under the game status bar).") },
            { "Pet Rows", ("Number of allowed pet icon rows at the top of the screen.", "Determines how many rows of pet icons are allowed in the top of the screen.") },
            { "Orbs", ("Show health and mana orbs in the top left corner.", "Determines if health and mana orbs are shown in the top left corner of the screen.") },
            { "Show Max Hit Points", ("Show maximum HP under current HP in the health orb.", "Determines if maximum hit points are shown under the current hit points in the health orb.") },
            { "Show Max Mana", ("Show maximum mana under current mana in the mana orb.", "Determines if maximum mana is shown under the current mana in the mana orb.") },
            { "Messages", ("Number of messages shown in the bottom left corner.", "Determines the number of messages shown in the bottom left corner of the screen.") },
            { "Show All", ("Toggle button for showing all messages.", "Toggle for showing all messages. The same as tapping the message area in the game screen.") },
            { "Walk Arrows", ("Show walk arrows when Travel Mode is disabled.", "Determines if there are walk arrows when Travel Mode is disabled.") },
            { "Default Auto-Center", ("Enable the Auto-Center button by default.", "Determines if the Auto-Center button in the game screen is enabled by default.") },
            { "Show Keyboard Shortcuts", ("Display keyboard shortcuts in menus.", "Determines if keyboard shortcuts are shown in menus.") },
            { "Lighter Unlit Areas", ("Make unlit map areas appear lighter.", "**Off:** Unlit areas are darker.\n**On:** Unlit areas are lighter.") },
            ...
            { "Traditional Get Position", ("Select locations using a cursor instead of tapping.", "When asked to select a location, the location is selected by moving around a tile-based game cursor using arrow icons or keyboard, rather than clicking a location on the map.") },
            { "Auto-Dig", ("Automatically dig solid rock if wielding a digging tool.", "Automatically attempts to dig through solid rock or walls when moving into, clicking, or tapping them if wielding a suitable digging tool (like a pick-axe or mattock). Mirrors the `autodig` option.") },
            { "Ignore Stopping", ("Prevent pathfinding from stopping on items or doors.", "Prevents automated pathfinding travel from stopping when your character passes over items, closed doors, or engravings. Mirrors the `ignore_stopping` option.") },
            { "Right Mouse Button", ("Configure the command for right mouse click.", "Configures the game command bound to a right mouse button click. The default \"by role\" setting triggers role-specific default actions. Mirrors the `right_click_command` option.") },
            { "Middle Mouse Button", ("Configure the command for middle mouse click.", "Configures the game command bound to a middle mouse button click. The default \"by role\" setting triggers role-specific default actions. Mirrors the `middle_click_command` option.") },
            { "Quick Engrave Text", ("Default text used for the quick engrave command.", "The default text written when using the quick engrave command. Mirrors the `engrave_quicktext` option.") },
            { "Quick Engrave Style", ("Tool choice method for the quick engrave command.", "Selects which engraving method or tool is automatically chosen when executing the quick engrave command: ask every time, always use finger, or use last item. Mirrors the `engrave_quickstyle` option.") },
            { "Master", ("Adjust the volume of all sounds and music.", "Changes the volume of all sounds and music.") },
            { "Music", ("Adjust the volume of music.", "Changes the volume of music.") },
            { "Ambient", ("Adjust the volume of ambient sounds.", "Changes the volume of ambient sounds.") },
            { "Dialogue", ("Adjust the volume of voice overs.", "Changes the volume of voice overs.") },
            { "Effects", ("Adjust the volume of sound effects.", "Changes the volume of sound effects.") },
            { "Interface", ("Adjust the volume of interface sounds.", "Changes the volume of interface sounds, such as button clicks.") },
            { "Post Game Progress", ("Post journey event updates to a Discord channel.", "Posts updates of new events of your journey to a selected channel on a Discord Server.") },
            { "Webhook Link", ("Discord webhook link for posting game progress.", "Specifies the webhook link to the channel on a Discord server where your game progress is posted.") },
            { "Post Diagnostic Data", ("Send anonymous crash logs and diagnostics to developers.", "Enables posting of anonymous game diagnostics and crash logs to the developer server.") },
            { "Account", ("Set the GnollHack Server web address.", "Enables you to access and specify the GnollHack Server web address.") },
            { "User Name", ("Your GnollHack server username.", "Your user name on the GnollHack server.") },
            { "Password", ("Your GnollHack server password.", "Your password on the GnollHack server.") },
            { "Use Release Account", ("Use the live server instead of the test server.", "**Off:** The game connects to the test GnollHack Server.\n**On:** The game connects to the live GnollHack Server with your release account.") },
            { "Post Top Scores", ("Upload your final score to the GnollHack Server.", "Posts your score to the GnollHack Server when your game has ended.") },
            { "Share Bones Files", ("Upload bones files and encounter other players' ghosts.", "Posts bones files to the server, and allows you to encounter other players' dead characters' ghosts (if Allow Ghost Levels is on).") },
            { "Use Blacklist", ("Use blacklist or whitelist for blocking bones files.", "Determines whether to use blacklist or whitelist in blocking unwanted users' bones files.") },
            { "Whitelist", ("List of allowed users for bones files.", "List of allowed user names on the GnollHack server for bones files. Shown when **Use Blacklist** is off. Leave empty to allow all users.") },
            { "Blacklist", ("List of blocked users for bones files.", "List of blocked user names on the GnollHack server for bones files. Shown when **Use Blacklist** is on. Leave empty to block no users.") },
            { "Save File Tracking", ("Track save files via the GnollHack Server.", "Determines whether the save files are tracked by the GnollHack Server.") },
            { "Record Game", ("Record a replay of your game.", "Determines whether the game records a replay of your game.") },
            { "Show Recording", ("Show a red dot indicating game recording is active.", "Determines whether a red dot appears on the status bar to indicate that game recording is on.") },
            { "Auto-Upload to Cloud", ("Automatically upload replays to Azure cloud storage.", "Determines whether the saved replay is automatically uploaded to an Azure cloud storage.") },
            { "Cloud Storage", ("Custom Azure connection string for uploading replays.", "Specifies a custom Azure cloud storage connection string to upload replays to.") },
            { "Developer Mode", ("Enable Wizard Mode and options file editing.", "Activates Developer Mode, which enables [[Wizard Mode]] and editing the options file.") },
            { "Debug Logging", ("Write debug info to the app log.", "Debug information is written in the app log.") },
            { "Low-Level Logging", ("Extensive logging of low-level events (can clog log).", "Extensive logging of various low-level events. Can clog the app log quickly.") },
            { "Screen Logging", ("Print log messages directly on the game screen.", "Toggles printing of log messages directly on the game screen.") },
            { "Frame Time Profiler", ("Gather frame time data to investigate stuttering.", "Gathers the data on frame times to e.g. investigate stuttering.") },
            { "Debug Post Channel", ("Alternative channel for debug progress posting.", "Use an alternative post channel instead of the one specified under Post Game Progress.") },
            { "Show Memory", ("Show managed memory usage on the game screen.", "Shows the current managed memory usage on the game screen.") },
            { "Low Disk Space Warning", ("Warn if free disk space is under 5 GB to protect saves.", "Displays a warning if free disk space is low (less than 5 GB) to prevent save game corruption.") },
            { "Alternative Layer Drawing", ("(Legacy) Draw the map tile by tile instead of layer by layer.", "*(Legacy)* **Off:** The map is drawn one layer at a time across all tiles.\n**On:** Each tile is drawn through all of its layers before moving on to the next tile. Hidden in release builds unless it is already turned on.") },
            { "Load Sound Banks", ("Load sound banks. Disable to save memory (mutes game).", "Determines if the sound banks are loaded. Can be disabled to save memory, but the game will have no sounds.") },
            { "Streaming Banks to Memory", ("Load streamed sounds to memory (uses more memory).", "**Off:** Streamed from their default location (or to disk).\n**On:** Read to memory and streamed from there (uses more memory).") },
            { "Streaming Banks to Disk", ("Copy streamed sounds to storage (uses more storage).", "**Off:** Streamed from their default location (or to memory).\n**On:** Copied to the storage and streamed from there (uses more storage space).") },
            { "Longer Message History", ("Show 16,384 previous messages with search. Heavy on CPU.", "Shows 16,384 last messages instead of 250, and adds a search bar. Switches off automatically for performance reasons upon adding new messages or restarting.") },
            { "Hide Message History", ("Hide latest messages completely (good for screenshots).", "The game will not show latest messages at all. Useful for taking cleaner screenshots.") },
            { "Use Single Dumplog", ("Directly open dumplog based on HTML setting.", "**Off:** The game asks whether to open plain text or HTML dumplog.\n**On:** Opens the dumplog based on the **Use HTML Dumplog** setting.") },
            { "Use HTML Dumplog", ("Choose plain text or HTML for single dumplogs.", "If **Use Single Dumplog** is **On**, determines if the dumplog is plain text (**Off**) or HTML (**On**).") },
            { "GZip Replay Compression", ("Compress game replays using GZip instead of Zip.", "**Off:** Zip format is used.\n**On:** GZip format is used.") },
            { "Platform Render Loop", ("Use platform-specific render loop linked to refresh rate.", "**Off:** UI framework specific animation system is used.\n**On:** Platform-specific render loop linking to display refresh rate is used.") },
            { "Runtime GL Effects", ("(Experimental) Enable runtime GL shaders on the map.", "*(Experimental)* Enables runtime GL shaders for advanced visual effects on the map.") },
            { "GL Only on Map", ("Use GL rendering on map only, CPU for other pages.", "**Off:** Skia GL rendering is used on map, menus, and more commands page.\n**On:** Skia GL rendering is used only on map. Other pages use CPU-based rendering.") },
            ...
            { "Map GPU Cache", ("Cache size for Skia GPU map rendering.", "Determines the cache size for Skia GPU rendering for the map. Large numbers can lead to out of memory.") },
            { "Menu GPU Cache", ("Cache size for Skia GPU menu rendering.", "Determines the cache size for Skia GPU rendering for the menu and more commands pages.") },
            { "Allow Spoilers", ("Let Gnoll Overseer reveal game mechanics and secrets.", "When enabled, Gnoll Overseer can freely discuss game mechanics, item identities, monster stats, and optimal strategies. When disabled (default), Gnoll Overseer avoids revealing information the player hasn't discovered yet.") },
            { "Verbose Responses", ("Gnoll Overseer gives longer, detailed explanations.", "When enabled, Gnoll Overseer provides detailed explanations and longer responses. When disabled (default), responses are concise and action-oriented.") },
            { "Send Game Context", ("Auto-send game state when opening Gnoll Overseer.", "When enabled (default), opening Gnoll Overseer from the game menu automatically sends the current game snapshot and message history. When disabled, no such data is sent.") },
            { "Use Local Address", ("Run Gnoll Overseer server at a local IP address.", "Enables the Gnoll Overseer to run at a local IP address.") },
            { "Local Address", ("Local IP address for the Gnoll Overseer server.", "Local IP address where Gnoll Overseer server can be found.") },
            { "Client Data Access", ("Let Gnoll Overseer request full message history.", "When enabled (default), the Gnoll Overseer can request additional data from your game client, such as full message history. This data is sent to your AI provider for processing.") },
            { "Game Actions", ("Let Gnoll Overseer suggest and perform in-game actions.", "When enabled, the Gnoll Overseer can suggest and perform in-game actions on your behalf. All actions require your confirmation. (Unavailable in this version.)") },
            { "Data Consent", ("Manage AI data processing consent.", "Shows whether you have accepted the AI data processing disclosure. Press Reset to revoke your consent; the disclosure will appear again the next time you open Overseer.") },
        };
...
//#endif
            ...
            //if (roundedScreenRefreshRate >= 90)
            //    list.Add("90 fps");
            //if (roundedScreenRefreshRate >= 120)
            //    list.Add("120 fps");
                ...
                foreach (var child in children)
                {
                    if (child is Label label)
                    {
                        ...
                        if (!string.IsNullOrEmpty(text) && _settingDescriptions.ContainsKey(text))
                        {
                            ...
                            {
                                var (tooltip, description) = _settingDescriptions[text];
                                ...
                                if (!label.GestureRecognizers.Any(g => g is TapGestureRecognizer))
                                {
                                    ...
                                    {
                                        ShowSettingInfoPopup(text, description, baseFontFamily);
                                    };
        ...
        private async Task SetSettingValues()
        {
            ...
            if (TileBatchingGrid.IsVisible && TileBatchingSwitch.IsEnabled)
            {
                GHApp.UseTileBatching = TileBatchingSwitch.IsToggled;
                Preferences.Set("UseTileBatching", TileBatchingSwitch.IsToggled);
            }
...
#endif
        {
            if(RecordSwitch.IsEnabled)
            {
                ...
                if (!string.IsNullOrEmpty(text) && _settingDescriptions.ContainsKey(text))
                {
                    ShowSettingInfoPopup(text, _settingDescriptions[text].Description, RecordLabel.FontFamily);
                }
            }
            else
            {
...
#endif
        {
            if (GZipSwitch.IsEnabled || _gamePage == null)
            {
                ...
                if (!string.IsNullOrEmpty(text) && _settingDescriptions.ContainsKey(text))
                {
                    ShowSettingInfoPopup(text, _settingDescriptions[text].Description, GZipLabel.FontFamily);
                }
            }
            else
            {
