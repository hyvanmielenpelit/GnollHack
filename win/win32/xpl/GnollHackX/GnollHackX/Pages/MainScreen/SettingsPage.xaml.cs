...
#endif
{
    ...
    public partial class SettingsPage : CustomModalPage, ISpecialKeyPressHandlingPage, IMessagePopupPage
    {
        ...
        private static readonly Dictionary<string, (string Tooltip, string Description)> _settingDescriptions = new Dictionary<string, (string Tooltip, string Description)>
        {
            ...
            { "Whitelist/Blacklist", ("List of allowed or blocked users for bones files.", "List of allowed or blocked user names on the GnollHack server for bones files.") },
...
//#endif
        ...
        private void SetInitialValues()
        {
...
#endif
            bool longermsghistory = false, hidemsghistory = false, xlog_release_account = false, forcepostbones = false, fixrects = false, fixvertical = true, runtimeeffects = GHConstants.DefaultRuntimeEffects, spritebatching = GHConstants.DefaultUseSpriteBatching, save_file_tracking = false, disablewindowskey = false, defaultvikeys = false;
            ...
            SpriteBatchingSwitch.IsToggled = spritebatching;
