...
#endif
{
    ...
    public partial class SettingsPage : CustomModalPage, ISpecialKeyPressHandlingPage
    {
        ...
        private static readonly Dictionary<string, string> _settingDescriptions = new Dictionary<string, string>
        {
            ...
            { "Edge to Edge", "Determines whether the game screen extends over notches and similar areas." },
            ...
            { "Colored X-Ray Vision", "**Off:** Areas seen in X-ray vision and normal vision are colored in the same way.\n**On:** Areas seen exclusively with X-ray vision have a tinting color." },
