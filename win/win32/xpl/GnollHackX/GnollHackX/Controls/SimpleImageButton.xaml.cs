...
#endif
{
    ...
    public partial class SimpleImageButton : ContentView
    {
        ...
        public void SetSideSize(double canvasViewWidth, double canvasViewHeight, bool usingDesktopButtons, bool usingSimpleCmdLayout, float inverseCanvasScale)
        {
            ...
            double imgsidewidth = UIUtils.CalculateButtonSideWidth(canvasViewWidth, canvasViewHeight, usingDesktopButtons, usingSimpleCmdLayout, inverseCanvasScale, LandscapeButtonsInRow, PortraitButtonsInRow, true);
