...
#endif
{
    ...
    public partial class SimpleImageButton : ContentView
    {
        ...
        public void SetSideSize(double canvasViewWidth, double canvasViewHeight, bool usingDesktopButtons, bool usingSimpleCmdLayout)
        {
            ...
            double imgsidewidth = UIUtils.CalculateButtonSideWidth(canvasViewWidth, canvasViewHeight, usingDesktopButtons, usingSimpleCmdLayout, LandscapeButtonsInRow, PortraitButtonsInRow, true);
