...
namespace GnollHackM
{
    ...
    class ClientUtils
    {
        ...
        private static Color XRed = new Color((float)0xFF / 255.0f, 32.0f / 255.0f, 32.0f / 255.0f);
        private static Color XGreen = new Color(0, (float)0xFF / 255, 0);
        private static Color XBlue = new Color(112.0f / 255.0f, 112.0f / 255.0f, (float)0xFF / 255.0f);
        private static Color XBrown = new Color(210.0f / 255.0f, 128.0f / 255.0f, 32.0f / 255.0f);
        private static Color XBrightBlue = new Color(180.0f / 255.0f, 200.0f / 255.0f, (float)0xFF / 255.0f);
        private static Color XBrightCyan = new Color(165.0f / 255.0f, 255.0f / 255.0f, (float)0xFF / 255.0f);
        private static Color XTitleGoldColor = new Color((float)0xD4 / 255, (float)0xA0 / 255, (float)0x17 / 255);
        public static Color NHColor2XColor(int nhclr, int attr, bool revertblackandwhite, bool istitle)
        {
            Color res = istitle ? XTitleGoldColor : revertblackandwhite ? Colors.Black : Colors.White;
            bool usealtcolors = (attr & (int)MenuItemAttributes.AltColors) != 0;
            switch ((nhcolor)nhclr)
            {
                case nhcolor.CLR_BLACK:
                    res = revertblackandwhite ? Colors.White : Colors.DarkGray;
                    break;
                case nhcolor.CLR_RED:
                    res = revertblackandwhite ? Colors.Red : XRed;
                    break;
                case nhcolor.CLR_GREEN:
                    res = revertblackandwhite ? Colors.Green : XGreen;
                    break;
                case nhcolor.CLR_BROWN:
                    if (usealtcolors)
                        res = XTitleGoldColor;
                    else
                        res = revertblackandwhite ? Colors.Brown : XBrown;
                    break;
                case nhcolor.CLR_BLUE:
                    res = revertblackandwhite ? Colors.Blue : XBlue;
                    break;
                case nhcolor.CLR_MAGENTA:
                    res = Colors.Magenta;
                    break;
                ...
                case nhcolor.CLR_ORANGE:
                    ...
                    break;
                case nhcolor.CLR_BRIGHT_GREEN:
                    res = Colors.LightGreen;
                    break;
                case nhcolor.CLR_YELLOW:
                    res = Colors.Yellow;
                    break;
                case nhcolor.CLR_BRIGHT_BLUE:
                    res = revertblackandwhite ? Colors.LightBlue : XBrightBlue;
                    break;
                case nhcolor.CLR_BRIGHT_MAGENTA:
                    res = Colors.LightPink;
                    break;
                case nhcolor.CLR_BRIGHT_CYAN:
                    res = revertblackandwhite ? Colors.LightCyan : XBrightCyan;
                    break;
                case nhcolor.CLR_WHITE:
                    res = revertblackandwhite ? Colors.Black : Colors.White;
                    break;
                case nhcolor.CLR_MAX:
                    break;
                default:
        ...
        public static Color NHColor2GrayedXColor(int color, int attr, bool revertblackandwhite, bool istitle)
        {
            ...
            Color bgcolor = revertblackandwhite ? Colors.White : Colors.Black;
            Color grayedcolor;
