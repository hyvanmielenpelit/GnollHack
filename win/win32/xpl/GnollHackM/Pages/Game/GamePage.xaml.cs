    ...
    public partial class GamePage : ContentPage
    {
        ...
        public async void StartGame()
        {
            ...
            if (!App.StartGameDataSet)
            {
                ...
                tasks.Add(Task.Run(() =>
                {
                    using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.gnollhack_64x96_transparent_32bits.png"))
                    {
                ...
                tasks.Add(Task.Run(() =>
                {
                    using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.gnollhack_64x96_transparent_32bits-2.png"))
                    {
                ...
                tasks.Add(Task.Run(() =>
                {
                    using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.gnollhack-logo-test-2.png"))
                    {
                ...
                tasks.Add(Task.Run(() =>
                {
                    using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.skill.png"))
                    {
                ...
                case 'm':
                    switch (data.style)
                    {
                        case (int)context_menu_styles.CONTEXT_MENU_STYLE_GETPOS: /* Next interesting / monster */
                            icon_string = "GnollHackM.Assets.UI.next.png";
                            break;
                        default:
                            icon_string = "GnollHackM.Assets.UI.next.png";
                            break;
                ...
                case 'M':
                    switch (data.style)
                    {
                        case (int)context_menu_styles.CONTEXT_MENU_STYLE_GETPOS: /* Previous interesting / monster */
                            icon_string = "GnollHackM.Assets.UI.previous.png";
                            break;
                        default:
                            icon_string = "GnollHackM.Assets.UI.previous.png";
                            break;
                    ...
                    break;
                case 'e':
                    icon_string = "GnollHackM.Assets.UI.eat.png";
                    break;
                case 'l':
                    icon_string = "GnollHackM.Assets.UI.loot.png";
                    break;
                case 'p':
                    icon_string = "GnollHackM.Assets.UI.pay.png";
                    break;
                case ',':
                    icon_string = "GnollHackM.Assets.UI.pickup.png";
                    break;
                case '<':
                    switch (data.style)
                    {
                        case (int)context_menu_styles.CONTEXT_MENU_STYLE_GETDIR: /* Upwards */
                            icon_string = "GnollHackM.Assets.UI.target-upwards.png";
                            break;
                        case (int)context_menu_styles.CONTEXT_MENU_STYLE_GETPOS:
                            icon_string = "GnollHackM.Assets.UI.stairs-up.png";
                            break;
                        default:
                        case (int)context_menu_styles.CONTEXT_MENU_STYLE_GENERAL:
                            if (data.target_text != null && data.target_text == "Pit")
                                icon_string = "GnollHackM.Assets.UI.arrow_up.png";
                            else
                                icon_string = "GnollHackM.Assets.UI.stairs-up.png";
                            break;
                    }
                ...
                case '>':
                    switch (data.style)
                    {
                        case (int)context_menu_styles.CONTEXT_MENU_STYLE_GETDIR: /* Downwards */
                            icon_string = "GnollHackM.Assets.UI.target-downwards.png";
                            break;
                        case (int)context_menu_styles.CONTEXT_MENU_STYLE_GETPOS:
                            icon_string = "GnollHackM.Assets.UI.stairs-down.png";
                            break;
                        default:
                        case (int)context_menu_styles.CONTEXT_MENU_STYLE_GENERAL:
                            if(data.target_text != null && data.target_text == "Pit")
                                icon_string = "GnollHackM.Assets.UI.arrow_down.png";
                            else
                                icon_string = "GnollHackM.Assets.UI.stairs-down.png";
                            break;
                    }
                    break;
                case ':':
                    icon_string = "GnollHackM.Assets.UI.lookhere.png";
                    break;
                case 'q':
                    icon_string = "GnollHackM.Assets.UI.quaff.png";
                    break;
                case 'r':
                    icon_string = "GnollHackM.Assets.UI.read.png";
                    break;
                case '.':
                    switch(data.style)
                    {
                        case (int)context_menu_styles.CONTEXT_MENU_STYLE_GETPOS: /* Pick position in getpos */
                            icon_string = "GnollHackM.Assets.UI.select.png";
                            break;
                        case (int)context_menu_styles.CONTEXT_MENU_STYLE_GETDIR: /* Self in getdir */
                            icon_string = "GnollHackM.Assets.UI.target-self.png";
                            break;
                        default:
                        case (int)context_menu_styles.CONTEXT_MENU_STYLE_GENERAL:
                            icon_string = "GnollHackM.Assets.UI.wait.png";
                            break;
                    }
                    break;
                case (char)27:
                    switch (data.style)
                    {
                        case (int)context_menu_styles.CONTEXT_MENU_STYLE_CLOSE_DISPLAY:
                            icon_string = "GnollHackM.Assets.UI.exit-to-map.png";
                            break;
                        default:
                            icon_string = "GnollHackM.Assets.UI.no.png";
                            break;
                    }
                    break;
                case 'C':
                    if(data.cmd_text == "Steed")
                        icon_string = "GnollHackM.Assets.UI.chatsteed.png";
                    else
                        icon_string = "GnollHackM.Assets.UI.chat.png";
                    break;
                default:
                    if (cmddefchar == LastPickedCmd)
                        icon_string = "GnollHackM.Assets.UI.lastitem.png";
                    else if (cmddefchar == OfferCmd)
                        icon_string = "GnollHackM.Assets.UI.offer.png";
                    else if (cmddefchar == PrayCmd)
                        icon_string = "GnollHackM.Assets.UI.pray.png";
                    else if (cmddefchar == DipCmd)
                        icon_string = "GnollHackM.Assets.UI.dip.png";
                    else if (cmddefchar == DigCmd)
                        icon_string = "GnollHackM.Assets.UI.dig.png";
                    else if (cmddefchar == SitCmd)
                        icon_string = "GnollHackM.Assets.UI.sit.png";
                    else if (cmddefchar == RideCmd)
                        icon_string = "GnollHackM.Assets.UI.ride.png";
                    else
                        icon_string = "GnollHackM.Assets.UI.missing_icon.png";
                    break;
            }
        ...
        public void DisplayPopupText(DisplayScreenTextData data)
        {
                ...
                data.style == (int)popup_text_types.POPUP_TEXT_NO_MONSTERS_IN_LIST)
            {
                ...
                PopupGrid.BackgroundColor = Colors.Transparent;
        ...
        {
            int idx = 0;
            idx = ContextLayout.Children.IndexOf((View)sender);
            if (idx < 0)
                idx = ContextLayout.Children.IndexOf((View)((View)sender).Parent);
        ...
        private void ShowYnResponses(int style, int attr, int color, int glyph, string title, string question, string responses, string descriptions, string introline, ulong ynflags)
        {
            ...
            if (title == null)
            {
                ...
                YnTitleLabel.Text = "";
                YnTitleLabel.TextColor = Colors.White;
            }
            else
            {
                YnTitleLabel.Text = title;
                YnTitleLabel.IsVisible = true;
                YnQuestionLabel.TextColor = Colors.White;
        ...
        {
            string res = "resource://GnollHackM.Assets.UI.missing_icon.png";
            switch (ch)
            {
                case 'm':
                    res = "resource://GnollHackM.Assets.UI.name.png";
                    break;
                case 's':
                case 'i':
                    res = "resource://GnollHackM.Assets.UI.inventory.png";
                    break;
                case 'd':
                    if (desc != null && desc.Length >= 4 && desc.Substring(0, 4) == "Drop")
                        res = "resource://GnollHackM.Assets.UI.dropmany.png";
                    else if (desc == "Disarm")
                        res = "resource://GnollHackM.Assets.UI.yes.png";
                    break;
                case 'y':
                    res = "resource://GnollHackM.Assets.UI.yes.png";
                    break;
                case 'n':
                    res = "resource://GnollHackM.Assets.UI.no.png";
                    break;
                case 'q':
                    res = "resource://GnollHackM.Assets.UI.cancel.png";
                    break;
                case 'a':
                    res = "resource://GnollHackM.Assets.UI.yestoall.png";
                    break;
                case 'r':
                    res = "resource://GnollHackM.Assets.UI.rightring.png";
                    break;
                case 'l':
                    if (desc == "Load")
                        res = "resource://GnollHackM.Assets.UI.load.png";
                    else
                        res = "resource://GnollHackM.Assets.UI.leftring.png";
                    break;
                default:
                    break;
            }
        ...
        {
            GetLineFrame.BorderColor = Colors.Black;
        ...
        private void GetLineOkButton_Clicked(object sender, EventArgs e)
        {
            ...
            {
                GetLineFrame.BorderColor = Colors.Red;
        ...
        private void ToggleAutoCenterModeButton_Clicked(object sender, EventArgs e)
        {
            ...
            if (MapNoClipMode)
            {
                ToggleAutoCenterModeButton.ImgSourcePath = "resource://GnollHackM.Assets.UI.stone-autocenter-off.png";
                SimpleToggleAutoCenterModeButton.ImgSourcePath = "resource://GnollHackM.Assets.UI.stone-autocenter-off.png";
            }
            else
            {
                ToggleAutoCenterModeButton.ImgSourcePath = "resource://GnollHackM.Assets.UI.stone-autocenter-on.png";
                SimpleToggleAutoCenterModeButton.ImgSourcePath = "resource://GnollHackM.Assets.UI.stone-autocenter-on.png";
        ...
        private void ToggleTravelModeButton_Clicked(object sender, EventArgs e)
        {
            ...
            if (MapTravelMode)
            {
                ToggleTravelModeButton.ImgSourcePath = "resource://GnollHackM.Assets.UI.stone-travel-on.png";
            }
            else
            {
                ToggleTravelModeButton.ImgSourcePath = "resource://GnollHackM.Assets.UI.stone-travel-off.png";
            }
        }
        private void LookModeButton_Clicked(object sender, EventArgs e)
        {
            ...
            if (MapLookMode)
            {
                LookModeButton.ImgSourcePath = "resource://GnollHackM.Assets.UI.stone-look-on.png";
                SimpleLookModeButton.ImgSourcePath = "resource://GnollHackM.Assets.UI.stone-look-on.png";
            }
            else
            {
                LookModeButton.ImgSourcePath = "resource://GnollHackM.Assets.UI.stone-look-off.png";
                SimpleLookModeButton.ImgSourcePath = "resource://GnollHackM.Assets.UI.stone-look-off.png";
            }
        }
        ...
        private void ToggleZoomMiniButton_Clicked(object sender, EventArgs e)
        {
            ...
            if (ZoomMiniMode)
            {
                ToggleZoomMiniButton.ImgSourcePath = "resource://GnollHackM.Assets.UI.stone-minimap-on.png";
                SimpleToggleZoomMiniButton.ImgSourcePath = "resource://GnollHackM.Assets.UI.stone-minimap-on.png";
            }
            else
            {
                ToggleZoomMiniButton.ImgSourcePath = "resource://GnollHackM.Assets.UI.stone-minimap-off.png";
                SimpleToggleZoomMiniButton.ImgSourcePath = "resource://GnollHackM.Assets.UI.stone-minimap-off.png";
        ...
        private void ToggleZoomAlternateButton_Clicked(object sender, EventArgs e)
        {
            ...
            {
                ToggleZoomAlternateButton.ImgSourcePath = "resource://GnollHackM.Assets.UI.stone-altmap-on.png";
                lock(_mapOffsetLock)
                {
                    if(MapFontSize > 0)
                    {
            ...
            {
                ToggleZoomAlternateButton.ImgSourcePath = "resource://GnollHackM.Assets.UI.stone-altmap-off.png";
                lock (_mapOffsetLock)
                {
        ...
        private void MenuCountOkButton_Clicked(object sender, EventArgs e)
        {
            if (_countMenuItem != null)
            {
                if (MenuCountEntry.IsVisible)
                {
                    ...
                    {
                        MenuCountEntry.TextColor = Colors.Red;
        ...
        private void MenuEntry_PropertyChanged(object sender, System.ComponentModel.PropertyChangedEventArgs e)
        {
            if (_countMenuItem != null)
            {
                MenuCountEntry.TextColor = Colors.White;
            }
        }
        ...
        private void MenuEntry_Completed(object sender, EventArgs e)
        {
            if (_countMenuItem != null)
            {
                ...
                if (res)
                {
                    MenuCountEntry.TextColor = Colors.Green;
                }
                else
                {
                    MenuCountEntry.TextColor = Colors.Red;
