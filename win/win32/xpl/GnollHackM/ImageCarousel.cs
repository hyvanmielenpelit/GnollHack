...
namespace GnollHackM
{
    ...
    public class ImageCarousel : SKCanvasView
    {
        ...
        {
            new CarouselBitmap("GnollHackM.Assets.main-menu-ranger.jpg", TextAlignment.Center, TextAlignment.Center),
            new CarouselBitmap("GnollHackM.Assets.main-menu-dwarf.jpg", TextAlignment.Center, TextAlignment.Center),
            new CarouselBitmap("GnollHackM.Assets.main-menu-gnoll.jpg", TextAlignment.Center, TextAlignment.Center),
        };
