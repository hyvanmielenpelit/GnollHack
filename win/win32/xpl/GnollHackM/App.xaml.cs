...
namespace GnollHackM
{
    public partial class App : Application
    {
        public App()
        {
            ...
            ButtonNormalImageSource = ImageSource.FromResource("GnollHackM.Assets.button_normal.png", assembly);
            ButtonSelectedImageSource = ImageSource.FromResource("GnollHackM.Assets.button_selected.png", assembly);
            ButtonDisabledImageSource = ImageSource.FromResource("GnollHackM.Assets.button_disabled.png", assembly);
        ...
        {
            Assembly assembly = typeof(App).GetTypeInfo().Assembly;
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.diablo_h.ttf"))
            {
                if (stream != null)
                {
                    try
            ...
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.uwch.ttf"))
            {
                if (stream != null)
                {
                    try
            ...
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.Immortal-Regular.ttf"))
            {
                if (stream != null)
                {
                    try
            ...
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.archristy.ttf"))
            {
                if (stream != null)
                {
                    try
        ...
        {
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.endr.ttf"))
            {
                if (stream != null)
                {
                    try
            ...
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.shxi.ttf"))
            {
                if (stream != null)
                {
                    try
            ...
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.DejaVuSansMono.ttf"))
            {
                if (stream != null)
                {
                    try
            ...
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.DejaVuSansMono-Bold.ttf"))
            {
                if (stream != null)
                {
                    try
            ...
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.Lato-Regular.ttf"))
            {
                if (stream != null)
                {
                    try
            ...
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.Lato-Bold.ttf"))
            {
                if (stream != null)
                {
                    try
        ...
        //        using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets." + filename))
        //        {
        //            if (stream != null)
        //            {
        //                try
        ...
        public static void InitGameBitmaps(Assembly assembly)
        {
            try
            {
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.menubackground.png"))
                {
                    MenuBackgroundBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.background-oldpaper.png"))
                {
                    OldPaperBackgroundBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.background-loading-screen.png"))
                {
                    LoadingScreenBackgroundBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.button_normal.png"))
                {
                    ButtonNormalBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.button_selected.png"))
                {
                    ButtonSelectedBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.button_disabled.png"))
                {
                    ButtonDisabledBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.frame-topleft.png"))
                {
                    SimpleFrameTopLeftCornerBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.frame-topleft-small.png"))
                {
                    SimpleFrameSmallTopLeftCornerBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.frame-horizontal.png"))
                {
                    SimpleFrameTopHorizontalBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.frame-vertical.png"))
                {
                    SimpleFrameLeftVerticalBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.scroll.png"))
                {
                    ScrollBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.you.png"))
                {
        ...
        public static void InitSymbolBitmaps(Assembly assembly)
        {
            try
            {
                ...
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.symbol-success.png"))
                {
                    _successBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.symbol-mana.png"))
                {
                    _manaBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.symbol-cooldown.png"))
                {
                    _cooldownBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.symbol-casts.png"))
                {
                    _castsBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.symbol-adds.png"))
                {
                    _addsBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.symbol-food.png"))
                {
                    _foodBitmap = SKBitmap.Decode(stream);
                }

                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.symbol-spell-abjuration.png"))
                {
                    _spellAbjurationBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.symbol-spell-arcane.png"))
                {
                    _spellArcaneBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.symbol-spell-celestial.png"))
                {
                    _spellCelestialBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.symbol-spell-clerical.png"))
                {
                    _spellClericalBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.symbol-spell-conjuration.png"))
                {
                    _spellConjurationBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.symbol-spell-divination.png"))
                {
                    _spellDivinationBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.symbol-spell-enchantment.png"))
                {
                    _spellEnchantmentBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.symbol-spell-healing.png"))
                {
                    _spellHealingBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.symbol-spell-movement.png"))
                {
                    _spellMovementBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.symbol-spell-nature.png"))
                {
                    _spellNatureBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.symbol-spell-necromancy.png"))
                {
                    _spellNecromancyBitmap = SKBitmap.Decode(stream);
                }
                using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.symbol-spell-transmutation.png"))
                {
        ...
        public static void InitializeMoreCommandButtons(Assembly assembly, bool useSimple)
        {
            ...
            if (useSimple)
            {
                _moreBtnMatrix[0, 0, 0] = new GHCommandButtonItem("Wish", "GnollHackM.Assets.UI.wish.png", GHUtils.Ctrl((int)'w'));
                _moreBtnMatrix[0, 1, 0] = new GHCommandButtonItem("Reveal", "GnollHackM.Assets.UI.reveal.png", GHUtils.Ctrl((int)'f'));
                _moreBtnMatrix[0, 2, 0] = new GHCommandButtonItem("Genesis", "GnollHackM.Assets.UI.genesis.png", GHUtils.Meta((int)'m'));
                _moreBtnMatrix[0, 3, 0] = new GHCommandButtonItem("Levelport", "GnollHackM.Assets.UI.levelport.png", GHUtils.Ctrl((int)'v'));

                _moreBtnMatrix[0, 0, 1] = new GHCommandButtonItem("Identify", "GnollHackM.Assets.UI.identify.png", GHUtils.Ctrl((int)'i'));
                _moreBtnMatrix[0, 1, 1] = new GHCommandButtonItem("Teleport", "GnollHackM.Assets.UI.teleport.png", GHUtils.Ctrl((int)'t'));
                _moreBtnMatrix[0, 2, 1] = new GHCommandButtonItem("Level Change", "GnollHackM.Assets.UI.levelchange.png", GHUtils.Meta(0));
                _moreBtnMatrix[0, 3, 1] = new GHCommandButtonItem("Polymorph Self", "GnollHackM.Assets.UI.polymorph.png", GHUtils.Meta(1));

                _moreBtnMatrix[0, 2, 5] = new GHCommandButtonItem("Extended", "GnollHackM.Assets.UI.extended.png", (int)'#');
                _moreBtnMatrix[0, 3, 5] = new GHCommandButtonItem("Back to Game", "GnollHackM.Assets.UI.more.png", -1);

                _moreBtnMatrix[1, 0, 0] = new GHCommandButtonItem("You", "GnollHackM.Assets.UI.you.png", (int)'}');
                _moreBtnMatrix[1, 1, 0] = new GHCommandButtonItem("Skills", "GnollHackM.Assets.UI.skill.png", (int)'S');
                _moreBtnMatrix[1, 2, 0] = new GHCommandButtonItem("Overview", "GnollHackM.Assets.UI.overview.png", GHUtils.Ctrl((int)'o'));
                _moreBtnMatrix[1, 3, 0] = new GHCommandButtonItem("Goals", "GnollHackM.Assets.UI.conduct.png", GHUtils.Meta(3));

                _moreBtnMatrix[1, 0, 1] = new GHCommandButtonItem("Wait", "GnollHackM.Assets.UI.wait.png", (int)'.');
                _moreBtnMatrix[1, 1, 1] = new GHCommandButtonItem("Wield", "GnollHackM.Assets.UI.wield.png", (int)'w');
                _moreBtnMatrix[1, 2, 1] = new GHCommandButtonItem("Drop Items", "GnollHackM.Assets.UI.dropmany.png", (int)'%');
                _moreBtnMatrix[1, 3, 1] = new GHCommandButtonItem("Drop Types", "GnollHackM.Assets.UI.droptypes.png", (int)'D');

                _moreBtnMatrix[1, 0, 2] = new GHCommandButtonItem("Throw", "GnollHackM.Assets.UI.throw.png", (int)'t');
                _moreBtnMatrix[1, 1, 2] = new GHCommandButtonItem("Fire", "GnollHackM.Assets.UI.fire.png", (int)'f');
                _moreBtnMatrix[1, 2, 2] = new GHCommandButtonItem("Chat", "GnollHackM.Assets.UI.chat.png", (int)'C');
                _moreBtnMatrix[1, 3, 2] = new GHCommandButtonItem("Zap", "GnollHackM.Assets.UI.zap.png", (int)'z');

                _moreBtnMatrix[1, 0, 3] = new GHCommandButtonItem("Eat", "GnollHackM.Assets.UI.eat.png", (int)'e');
                _moreBtnMatrix[1, 1, 3] = new GHCommandButtonItem("Drink", "GnollHackM.Assets.UI.quaff.png", (int)'q');
                _moreBtnMatrix[1, 2, 3] = new GHCommandButtonItem("Read", "GnollHackM.Assets.UI.read.png", (int)'r');
                _moreBtnMatrix[1, 3, 3] = new GHCommandButtonItem("Apply", "GnollHackM.Assets.UI.apply.png", (int)'a');

                _moreBtnMatrix[1, 0, 4] = new GHCommandButtonItem("View Spell", "GnollHackM.Assets.UI.viewspell.png", GHUtils.Meta((int)'z'));
                _moreBtnMatrix[1, 1, 4] = new GHCommandButtonItem("Mix", "GnollHackM.Assets.UI.mix.png", (int)'X');
                _moreBtnMatrix[1, 2, 4] = new GHCommandButtonItem("Yell", "GnollHackM.Assets.UI.yell.png", GHUtils.Ctrl((int)'y'));
                _moreBtnMatrix[1, 3, 4] = new GHCommandButtonItem("Pray", "GnollHackM.Assets.UI.pray.png", GHUtils.Meta((int)'p'));

                _moreBtnMatrix[1, 0, 5] = new GHCommandButtonItem("Count", "GnollHackM.Assets.UI.count.png", -5);
                _moreBtnMatrix[1, 1, 5] = new GHCommandButtonItem("Search 20", "GnollHackM.Assets.UI.search20.png", -2);
                _moreBtnMatrix[1, 2, 5] = new GHCommandButtonItem("Rest", "GnollHackM.Assets.UI.rest.png", -3);
                _moreBtnMatrix[1, 3, 5] = new GHCommandButtonItem("Back to Game", "GnollHackM.Assets.UI.more.png", -1);

                _moreBtnMatrix[2, 0, 0] = new GHCommandButtonItem("Attributes", "GnollHackM.Assets.UI.attributes.png", GHUtils.Meta(2));
                _moreBtnMatrix[2, 1, 0] = new GHCommandButtonItem("Discoveries", "GnollHackM.Assets.UI.discoveries.png", (int)'\\');
                _moreBtnMatrix[2, 2, 0] = new GHCommandButtonItem("Killed", "GnollHackM.Assets.UI.killed.png", GHUtils.Meta((int)'k'));
                _moreBtnMatrix[2, 3, 0] = new GHCommandButtonItem("Genocided", "GnollHackM.Assets.UI.genocided.png", GHUtils.Meta((int)'g'));

                _moreBtnMatrix[2, 0, 1] = new GHCommandButtonItem("Travel", "GnollHackM.Assets.UI.travel.png", (int)'_');
                _moreBtnMatrix[2, 1, 1] = new GHCommandButtonItem("2-Weapon", "GnollHackM.Assets.UI.twoweap.png", GHUtils.Ctrl((int)'x'));
                _moreBtnMatrix[2, 2, 1] = new GHCommandButtonItem("Examine", "GnollHackM.Assets.UI.examine.png", GHUtils.Meta((int)'x'));
                _moreBtnMatrix[2, 3, 1] = new GHCommandButtonItem("Engrave", "GnollHackM.Assets.UI.engrave.png", (int)'E');

                _moreBtnMatrix[2, 0, 2] = new GHCommandButtonItem("Ride", "GnollHackM.Assets.UI.ride.png", GHUtils.Meta((int)'R'));
                _moreBtnMatrix[2, 1, 2] = new GHCommandButtonItem("Untrap", "GnollHackM.Assets.UI.untrap.png", GHUtils.Meta((int)'u'));
                _moreBtnMatrix[2, 2, 2] = new GHCommandButtonItem("Handedness", "GnollHackM.Assets.UI.handedness.png", GHUtils.Meta((int)'h'));
                _moreBtnMatrix[2, 3, 2] = new GHCommandButtonItem("Unwield", "GnollHackM.Assets.UI.unwield.png", GHUtils.Meta(5));

                _moreBtnMatrix[2, 0, 3] = new GHCommandButtonItem("Light", "GnollHackM.Assets.UI.light.png", GHUtils.Ctrl((int)'l'));
                _moreBtnMatrix[2, 1, 3] = new GHCommandButtonItem("Loot", "GnollHackM.Assets.UI.loot.png", (int)'l');
                _moreBtnMatrix[2, 2, 3] = new GHCommandButtonItem("Open", "GnollHackM.Assets.UI.open.png", (int)'o');
                _moreBtnMatrix[2, 3, 3] = new GHCommandButtonItem("Close", "GnollHackM.Assets.UI.close.png", (int)'c');

                _moreBtnMatrix[2, 0, 4] = new GHCommandButtonItem("Teleport", "GnollHackM.Assets.UI.teleport.png", GHUtils.Ctrl((int)'t'));
                _moreBtnMatrix[2, 1, 4] = new GHCommandButtonItem("Monster", "GnollHackM.Assets.UI.monster.png", GHUtils.Meta(4));
                _moreBtnMatrix[2, 2, 4] = new GHCommandButtonItem("Jump", "GnollHackM.Assets.UI.jump.png", (int)'j');
                _moreBtnMatrix[2, 3, 4] = new GHCommandButtonItem("Dig", "GnollHackM.Assets.UI.dig.png", GHUtils.Ctrl((int)'g'));

                _moreBtnMatrix[2, 0, 5] = new GHCommandButtonItem("Name", "GnollHackM.Assets.UI.name.png", (int)'N');
                _moreBtnMatrix[2, 1, 5] = new GHCommandButtonItem("Look Here", "GnollHackM.Assets.UI.lookhere.png", (int)':');
                _moreBtnMatrix[2, 2, 5] = new GHCommandButtonItem("Extended", "GnollHackM.Assets.UI.extended.png", (int)'#');
                _moreBtnMatrix[2, 3, 5] = new GHCommandButtonItem("Back to Game", "GnollHackM.Assets.UI.more.png", -1);
            }
            else
            {
                _moreBtnMatrix[0, 0, 0] = new GHCommandButtonItem("Wish", "GnollHackM.Assets.UI.wish.png", GHUtils.Ctrl((int)'w'));
                ...
                _moreBtnMatrix[1, 0, 1] = new GHCommandButtonItem("View Spell", "GnollHackM.Assets.UI.viewspell.png", GHUtils.Meta((int)'z'));
                _moreBtnMatrix[1, 1, 1] = new GHCommandButtonItem("Mix", "GnollHackM.Assets.UI.mix.png", (int)'X');
                _moreBtnMatrix[1, 2, 1] = new GHCommandButtonItem("Travel", "GnollHackM.Assets.UI.travel.png", (int)'_');
                _moreBtnMatrix[1, 3, 1] = new GHCommandButtonItem("2-Weapon", "GnollHackM.Assets.UI.twoweap.png", GHUtils.Ctrl((int)'x'));

                _moreBtnMatrix[1, 0, 2] = new GHCommandButtonItem("Examine", "GnollHackM.Assets.UI.examine.png", GHUtils.Meta((int)'x'));
                _moreBtnMatrix[1, 1, 2] = new GHCommandButtonItem("Engrave", "GnollHackM.Assets.UI.engrave.png", (int)'E');
                _moreBtnMatrix[1, 2, 2] = new GHCommandButtonItem("Ride", "GnollHackM.Assets.UI.ride.png", GHUtils.Meta((int)'R'));
                _moreBtnMatrix[1, 3, 2] = new GHCommandButtonItem("Wield", "GnollHackM.Assets.UI.wield.png", (int)'w');

                _moreBtnMatrix[1, 0, 3] = new GHCommandButtonItem("Eat", "GnollHackM.Assets.UI.eat.png", (int)'e');
                _moreBtnMatrix[1, 1, 3] = new GHCommandButtonItem("Drink", "GnollHackM.Assets.UI.quaff.png", (int)'q');
                _moreBtnMatrix[1, 2, 3] = new GHCommandButtonItem("Read", "GnollHackM.Assets.UI.read.png", (int)'r');
                _moreBtnMatrix[1, 3, 3] = new GHCommandButtonItem("Drop Types", "GnollHackM.Assets.UI.droptypes.png", (int)'D');

                _moreBtnMatrix[1, 0, 4] = new GHCommandButtonItem("Untrap", "GnollHackM.Assets.UI.untrap.png", GHUtils.Meta((int)'u'));
                _moreBtnMatrix[1, 1, 4] = new GHCommandButtonItem("Handedness", "GnollHackM.Assets.UI.handedness.png", GHUtils.Meta((int)'h'));
                _moreBtnMatrix[1, 2, 4] = new GHCommandButtonItem("Yell", "GnollHackM.Assets.UI.yell.png", GHUtils.Ctrl((int)'y'));
                _moreBtnMatrix[1, 3, 4] = new GHCommandButtonItem("Pray", "GnollHackM.Assets.UI.pray.png", GHUtils.Meta((int)'p'));
                ...
                _moreBtnMatrix[2, 0, 1] = new GHCommandButtonItem("Wear", "GnollHackM.Assets.UI.wear.png", (int)'W');
                _moreBtnMatrix[2, 1, 1] = new GHCommandButtonItem("Put On", "GnollHackM.Assets.UI.puton.png", (int)'P');
                _moreBtnMatrix[2, 2, 1] = new GHCommandButtonItem("Quiver", "GnollHackM.Assets.UI.quiver.png", (int)'Q');
                _moreBtnMatrix[2, 3, 1] = new GHCommandButtonItem("Chronicle", "GnollHackM.Assets.UI.chronicle.png", GHUtils.Meta(13));

                _moreBtnMatrix[2, 0, 2] = new GHCommandButtonItem("Take Off", "GnollHackM.Assets.UI.takeoff.png", (int)'T');
                _moreBtnMatrix[2, 1, 2] = new GHCommandButtonItem("Remove", "GnollHackM.Assets.UI.remove.png", (int)'R');
                _moreBtnMatrix[2, 2, 2] = new GHCommandButtonItem("Take Off Many", "GnollHackM.Assets.UI.takeoffmany.png", GHUtils.Meta((int)'t'));
                _moreBtnMatrix[2, 3, 2] = new GHCommandButtonItem("Unwield", "GnollHackM.Assets.UI.unwield.png", GHUtils.Meta(5));

                _moreBtnMatrix[2, 0, 3] = new GHCommandButtonItem("Dig", "GnollHackM.Assets.UI.dig.png", GHUtils.Ctrl((int)'g'));
                _moreBtnMatrix[2, 1, 3] = new GHCommandButtonItem("Light", "GnollHackM.Assets.UI.light.png", GHUtils.Ctrl((int)'l'));
                _moreBtnMatrix[2, 2, 3] = new GHCommandButtonItem("Jump", "GnollHackM.Assets.UI.jump.png", (int)'j');
                _moreBtnMatrix[2, 3, 3] = new GHCommandButtonItem("Fight", "GnollHackM.Assets.UI.fight.png", (int)'F');

                _moreBtnMatrix[2, 0, 4] = new GHCommandButtonItem("Tip", "GnollHackM.Assets.UI.tip.png", GHUtils.Meta((int)'T'));
                _moreBtnMatrix[2, 1, 4] = new GHCommandButtonItem("Invoke", "GnollHackM.Assets.UI.invoke.png", GHUtils.Meta((int)'i'));
                _moreBtnMatrix[2, 2, 4] = new GHCommandButtonItem("Rub", "GnollHackM.Assets.UI.rub.png", GHUtils.Meta((int)'r'));
                _moreBtnMatrix[2, 3, 4] = new GHCommandButtonItem("Wipe", "GnollHackM.Assets.UI.wipe.png", GHUtils.Meta((int)'w'));

                _moreBtnMatrix[2, 0, 5] = new GHCommandButtonItem("Name", "GnollHackM.Assets.UI.name.png", (int)'N');
                _moreBtnMatrix[2, 1, 5] = new GHCommandButtonItem("What Is", "GnollHackM.Assets.UI.whatis.png", (int)'/');
                _moreBtnMatrix[2, 2, 5] = new GHCommandButtonItem("Look Far", "GnollHackM.Assets.UI.lookfar.png", (int)';');
                _moreBtnMatrix[2, 3, 5] = new GHCommandButtonItem("Back to Game", "GnollHackM.Assets.UI.more.png", -1);

                _moreBtnMatrix[3, 0, 0] = new GHCommandButtonItem("Look Here", "GnollHackM.Assets.UI.lookhere.png", (int)':');
                _moreBtnMatrix[3, 1, 0] = new GHCommandButtonItem("Pick Up", "GnollHackM.Assets.UI.pickup.png", (int)',');
                _moreBtnMatrix[3, 2, 0] = new GHCommandButtonItem("Sit", "GnollHackM.Assets.UI.sit.png", GHUtils.Ctrl((int)'s'));
                _moreBtnMatrix[3, 3, 0] = new GHCommandButtonItem("Pay", "GnollHackM.Assets.UI.pay.png", (int)'p');

                _moreBtnMatrix[3, 0, 1] = new GHCommandButtonItem("Loot", "GnollHackM.Assets.UI.loot.png", (int)'l');
                _moreBtnMatrix[3, 1, 1] = new GHCommandButtonItem("Dip", "GnollHackM.Assets.UI.dip.png", GHUtils.Meta((int)'d'));
                _moreBtnMatrix[3, 2, 1] = new GHCommandButtonItem("Offer", "GnollHackM.Assets.UI.offer.png", GHUtils.Meta((int)'o'));
                _moreBtnMatrix[3, 3, 1] = new GHCommandButtonItem("Autopickup", "GnollHackM.Assets.UI.autopickup.png", (int)'@');

                _moreBtnMatrix[3, 0, 2] = new GHCommandButtonItem("Go Down", "GnollHackM.Assets.UI.stairs-down.png", (int)'>');
                _moreBtnMatrix[3, 1, 2] = new GHCommandButtonItem("Go Up", "GnollHackM.Assets.UI.stairs-up.png", (int)'<');
                _moreBtnMatrix[3, 2, 2] = new GHCommandButtonItem("Open", "GnollHackM.Assets.UI.open.png", (int)'o');
                _moreBtnMatrix[3, 3, 2] = new GHCommandButtonItem("Close", "GnollHackM.Assets.UI.close.png", (int)'c');

                _moreBtnMatrix[3, 0, 3] = new GHCommandButtonItem("Break", "GnollHackM.Assets.UI.break.png", GHUtils.Ctrl((int)'b'));
                _moreBtnMatrix[3, 1, 3] = new GHCommandButtonItem("Force Lock", "GnollHackM.Assets.UI.forcelock.png", GHUtils.Meta((int)'f'));
                _moreBtnMatrix[3, 2, 3] = new GHCommandButtonItem("Teleport", "GnollHackM.Assets.UI.teleport.png", GHUtils.Ctrl((int)'t'));
                _moreBtnMatrix[3, 3, 3] = new GHCommandButtonItem("Monster", "GnollHackM.Assets.UI.monster.png", GHUtils.Meta(4));

                _moreBtnMatrix[3, 0, 4] = new GHCommandButtonItem("Spells", "GnollHackM.Assets.UI.spells.png", (int)'+');

                _moreBtnMatrix[3, 0, 5] = new GHCommandButtonItem("Help", "GnollHackM.Assets.UI.help.png", (int)'?');
                _moreBtnMatrix[3, 1, 5] = new GHCommandButtonItem("Commands", "GnollHackM.Assets.UI.commands.png", GHUtils.Meta((int)'c'));
                _moreBtnMatrix[3, 2, 5] = new GHCommandButtonItem("Extended", "GnollHackM.Assets.UI.extended.png", (int)'#');
                _moreBtnMatrix[3, 3, 5] = new GHCommandButtonItem("Back to Game", "GnollHackM.Assets.UI.more.png", -1);
            }
        ...
        {
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.arrow_left.png"))
            {
                _arrowBitmap[0] = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.arrow_up.png"))
            {
                _arrowBitmap[1] = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.arrow_right.png"))
            {
                _arrowBitmap[2] = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.arrow_down.png"))
            {
                _arrowBitmap[3] = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.arrow_upleft.png"))
            {
                _arrowBitmap[4] = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.no.png"))
            {
                _arrowBitmap[5] = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.arrow_upright.png"))
            {
                _arrowBitmap[6] = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.arrow_downright.png"))
            {
                _arrowBitmap[7] = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.arrow_downleft.png"))
            {
        ...
        {
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.orb_border.png"))
            {
                _orbBorderBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.orb_fill.png"))
            {
            ...
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.orb_glass.png"))
            {
                _orbGlassBitmap = SKBitmap.Decode(stream);
            }

            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-wizard-mode.png"))
            {
                _statusWizardBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-casual-mode.png"))
            {
                _statusCasualBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-casual-classic-mode.png"))
            {
                _statusCasualClassicBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-modern-mode.png"))
            {
                _statusModernBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-difficulty.png"))
            {
                _statusDifficultyBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-difficulty-very-easy.png"))
            {
                _statusDifficultyVeryEasyBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-difficulty-easy.png"))
            {
                _statusDifficultyEasyBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-difficulty-average.png"))
            {
                _statusDifficultyAverageBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-difficulty-hard.png"))
            {
                _statusDifficultyHardBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-difficulty-expert.png"))
            {
                _statusDifficultyExpertBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-difficulty-master.png"))
            {
                _statusDifficultyMasterBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-difficulty-grand-master.png"))
            {
                _statusDifficultyGrandMasterBitmap = SKBitmap.Decode(stream);
            }

            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-xp-level.png"))
            {
                _statusXPLevelBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-hd.png"))
            {
                _statusHDBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-ac.png"))
            {
                _statusACBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-mc.png"))
            {
                _statusMCBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-move.png"))
            {
                _statusMoveBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-weapon-style.png"))
            {
                _statusWeaponStyleBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-empty-handed.png"))
            {
                _statusEmptyHandedBitmap = SKBitmap.Decode(stream);
            }

            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-gold.png"))
            {
                _statusGoldBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-turns.png"))
            {
                _statusTurnsBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.status-dungeon-level.png"))
            {
                _statusDungeonLevelBitmap = SKBitmap.Decode(stream);
            }

            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.search.png"))
            {
                _searchBitmap = SKBitmap.Decode(stream);
            }
            using (Stream stream = assembly.GetManifestResourceStream("GnollHackM.Assets.UI.wait.png"))
            {
        ...
        private static Stream GetStreamFromFile(string filename)
        {
            ...
            var stream = assembly.GetManifestResourceStream("GnollHackM." + filename);
        ...
        public static void InitializeCachedBitmaps()
        {
            lock (_cachedBitmapsLock)
            {
                try
                {
                    ...
                    {
                    "GnollHackM.Assets.UI.missing_icon.png",
                    "GnollHackM.Assets.UI.yes.png",
                    "GnollHackM.Assets.UI.yestoall.png",
                    "GnollHackM.Assets.UI.no.png",
                    "GnollHackM.Assets.UI.cancel.png",
                    "GnollHackM.Assets.UI.inventory.png",
                    "GnollHackM.Assets.UI.leftring.png",
                    "GnollHackM.Assets.UI.rightring.png",
                    "GnollHackM.Assets.UI.load.png",
                    "GnollHackM.Assets.UI.name.png",
                    "GnollHackM.Assets.UI.dropmany.png",
                    "GnollHackM.Assets.UI.stone-look-off.png",
                    "GnollHackM.Assets.UI.stone-look-on.png",
                    "GnollHackM.Assets.UI.stone-autocenter-off.png",
                    "GnollHackM.Assets.UI.stone-autocenter-on.png",
                    "GnollHackM.Assets.UI.stone-minimap-off.png",
                    "GnollHackM.Assets.UI.stone-minimap-on.png",
                    "GnollHackM.Assets.UI.stone-travel-off.png",
                    "GnollHackM.Assets.UI.stone-travel-on.png",
                    "GnollHackM.Assets.UI.stone-altmap-off.png",
                    "GnollHackM.Assets.UI.stone-altmap-on.png",
                    "GnollHackM.Assets.UI.tombstone.png",
                    "GnollHackM.Assets.UI.stairs-down.png",
                    "GnollHackM.Assets.UI.stairs-up.png",
                    "GnollHackM.Assets.UI.chat.png",
                    "GnollHackM.Assets.UI.pickup.png",
                    "GnollHackM.Assets.UI.eat.png",
                    "GnollHackM.Assets.UI.pray.png",
                    "GnollHackM.Assets.UI.offer.png",
                    "GnollHackM.Assets.UI.loot.png",
                    "GnollHackM.Assets.UI.lastitem.png",
                    "GnollHackM.Assets.FMOD-Logo-192-White.png",
                    "GnollHackM.Assets.gnollhack-logo-test-2.png",
                    };
