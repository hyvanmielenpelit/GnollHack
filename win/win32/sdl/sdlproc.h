...
char sdl_yn_function(const char *question, const char *choices, CHAR_P def);
...
void sdl_add_context_menu(int cmd_def_char, int cmd_cur_char, int dir, int glyph, const char* text, int attr, int color);
