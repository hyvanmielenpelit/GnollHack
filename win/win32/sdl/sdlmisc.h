...
extern GLuint image_load_from_resource(HINSTANCE hInstance, int resource_id, int* x_ptr, int* y_ptr, int* n_ptr);
extern GLuint image_load(const char* filename, int* x_ptr, int* y_ptr, int* n_ptr);
