...
boolean clumsy;
{
    ...
    dmg += weapon_skill_dmg_bonus(uarmf, P_MARTIAL_ARTS, FALSE, FALSE);
...
dokick() {
    ...
    {
        if (yn_function_ex(YN_STYLE_GENERAL, ATR_NONE, CLR_MSG_ATTENTION, (const char*)0, "Kick your steed?", ynchars, 'y', yndescs) == 'y')
        {
