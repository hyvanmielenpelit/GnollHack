...
static char FDECL(hup_yn_function_ex, (int, int, int, const char *, const char *, const char *, CHAR_P, const char*));
...
/*ARGSUSED*/
static char
hup_yn_function_ex(style, attr, color, title, prompt, resp, deflt, resp_desc)
...
unsigned long *colormasks UNUSED;
{
    ...
    static enum statusfields gsu_fieldorder[][21] = {
        /* line one */
        { BL_TITLE, BL_STR, BL_DX, BL_CO, BL_IN, BL_WI, BL_CH, BL_GOLD, //BL_ALIGN,
          ...
          BL_FLUSH, BL_FLUSH, BL_FLUSH, BL_FLUSH, BL_FLUSH  },
