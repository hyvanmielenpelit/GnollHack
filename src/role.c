...
const struct Role roles[] = {
    ...
    { { "Barbarian", 0 },
      ...
      "the Duali Oasis",
      ROLE_BARBARIAN,
      "Melee warrior with poison resistance",
    ...
    { { "Knight", 0 },
      ...
      "the Isle of Glass",
      ROLE_KNIGHT,
      "Armored melee warrior adept at riding",
    ...
    { { "Monk", 0 },
      ...
      ROLE_MONK,
      "Martial artist casting clerical spells",
      { 
    ...
    { { "Priest", "Priestess" },
      ...
      ROLE_PRIEST,
      "Clerical spell caster seeing beatitude",
    ...
    { { "Rogue", 0 },
      ...
      ROLE_ROGUE,
      "Thief who backstabs and uses poison",
    ...
    { { "Samurai", 0 },
      ...
      "the Shogun's Castle",
      ROLE_SAMURAI,
      "Warrior adept at melee and ranged combat",
    ...
    { { "Tourist", 0 },
      ...
      "the Thieves' Guild Hall",
      ROLE_TOURIST, 
      "Versatile traveller with many skills",
    ...
    { { "Valkyrie", 0 },
      ...
      "the cave of Surtur",
      ROLE_VALKYRIE,
      "Female melee warrior with cold resistance",
