...
const struct Role roles[] = {
    ...
    { { "Ranger", 0 },
      ...
      ROLE_RANGER,
      { "Extra score from ranged weapons of artifact, at least elite, or mythic quality", "", "", "", ""},
      PM_RANGER,
    ...
    { { "Samurai", 0 },
      ...
      "the Shogun's Castle",
      ROLE_SAMURAI,
      { "Extra score from Japanese items of artifact, at least elite, or mythic quality", "Starts with a faithful dog", "", "", ""},
      PM_SAMURAI,
      PM_LITTLE_DOG,
      PM_LORD_SATO,
      PM_ROSHI,
