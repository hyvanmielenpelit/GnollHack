...
#include "hack.h"
    ...
    || defined(MSWIN_GRAPHICS) || defined(NUKLEAR_GRAPHICS) || defined(DLL_GRAPHICS) || defined(LIB_GRAPHICS)  || defined(ANDROID_GRAPHICS) || defined(DUMPLOG) || defined(DUMPHTML) || defined(CURSES_GRAPHICS)
