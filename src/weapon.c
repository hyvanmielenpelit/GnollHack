...
static const NEARDATA short hwep[] = 
{
    ...
    TSURUGI, RUNESWORD, SWORD_OF_DEFENSE, SWORD_OF_WOUNDING, SWORD_OF_LIFE_STEALING,
	SWORD_OF_DRAGON_SLAYING, SWORD_OF_GIANT_SLAYING, SWORD_OF_TROLL_SLAYING, SWORD_OF_ORC_SLAYING, MACE_OF_DISRUPTION,
	SWORD_OF_HOLY_VENGEANCE, SWORD_OF_UNHOLY_DESECRATION, CORPSE, /* cockatrice corpse */
