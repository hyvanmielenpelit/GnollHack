...
SPELL("magic missile",   "vellum",
      P_ATTACK_SPELL,      40,  2, 4,  5, A_INT, 1, RAY, RAY_MAGIC_MISSILE, 0, HI_LEATHER, O1_NONE),
...
SPELL("light",           "cloth",
      P_DIVINATION_SPELL,  35,  1, 1,  2, A_INT, 1, NODIR, 0, 0, HI_CLOTH, O1_NONE),
...
SPELL("cure blindness",  "yellow",
      P_HEALING_SPELL,     25,  2, 1,  2, A_INT, 1, IMMEDIATE, 0, 0, CLR_YELLOW, O1_NONE),
...
SPELL("detect food",     "cyan",
      P_DIVINATION_SPELL,  30,  3, 2, 2, A_INT, 1, NODIR, 0, 0, CLR_CYAN, O1_NONE),
...
SPELL("cure sickness",   "indigo",
      P_HEALING_SPELL,     32,  3, 3, 5, A_INT, 1, NODIR, 0, 0, CLR_BLUE, O1_NONE),
...
SPELL("detect treasure", "gray",
      P_DIVINATION_SPELL,  20,  5, 2, 3, A_INT, 1, NODIR, 0, 0, CLR_GRAY, O1_NONE),
...
SPELL("jumping",         "thin",
      P_ESCAPE_SPELL,      18,  3, 1,  2, A_INT,  1, IMMEDIATE, 0, 0, HI_PAPER, O1_NONE),
...
SPELL("armageddon",      "pitch black",
      P_ATTACK_SPELL,       2, 10, 9,200, A_INT, 1, NODIR, 0, 0, CLR_BLACK, O1_NONE),
