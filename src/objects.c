...
SPELL("magic missile",   "vellum", None,
      P_ARCANE_SPELL,      10,  2, 0, 0,  7, A_INT, 1, RAY, RAY_MAGIC_MISSILE, 3, 4, 0, 0, 0, 0, HI_LEATHER, O1_NONE),
#undef PAPER /* revert to normal material */
SPELL("fire bolt",        "light red", None,
      P_ARCANE_SPELL,      10,  4, 0, 3, 20, A_INT, 1, RAY, RAY_FIRE, 3, 6, 0, 0, 0, 0, CLR_RED, O1_FIRE_RESISTANT),
...
SPELL("animate air",	  "wave-patterned", None,
	P_CONJURATION_SPELL,		   10,  3,20, 7,100, A_INT, 1, NODIR, 0, 0, 0, 0, 1, 20, 30, HI_PAPER, O1_NONE),
SPELL("animate earth",	  "wave-patterned", None,
	P_CONJURATION_SPELL,		   10,  3,20, 6, 75, A_INT, 1, NODIR, 0, 0, 0, 0, 1, 20, 30, HI_PAPER, O1_NONE),
SPELL("animate fire",	  "wave-patterned", None,
	P_CONJURATION_SPELL,		   10,  3,20, 5, 50, A_INT, 1, NODIR, 0, 0, 0, 0, 1, 20, 30, HI_PAPER, O1_NONE),
SPELL("animate water",	  "wave-patterned", None,
	P_CONJURATION_SPELL,		   10,  3,20, 4, 30, A_INT, 1, NODIR, 0, 0, 0, 0, 1, 20, 30, HI_PAPER, O1_NONE),
SPELL("summon ogre",	  "old", None,
	P_CONJURATION_SPELL,		   15,  3, 2, 3, 20, A_AVG_INT_CHA, 1, NODIR, 0, 0, 0, 0, 1, 20, 30, HI_PAPER, O1_NONE),
...
SPELL("detect food",     "cyan", None,
      P_DIVINATION_SPELL,  20,  3, 0, -1, 4, A_MAX_INT_WIS, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_CYAN, O1_NONE),
SPELL("cause fear",      "light blue", None,
      P_ENCHANTMENT_SPELL, 10,  3, 1, 1, 10, A_AVG_INT_WIS_CHA, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_BRIGHT_BLUE, O1_NONE),
...
SPELL("charm monster",   "magenta", None,
      P_ENCHANTMENT_SPELL, 20,  3, 2, 6, 75, A_AVG_INT_WIS_CHA, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_MAGENTA, O1_NONE),
