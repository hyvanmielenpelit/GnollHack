...
SPELL("extra healing",   "plaid",
      P_HEALING_SPELL,     17,  5, 4, 3, 20, A_WIS, 1, IMMEDIATE, 0, 8, 4, 0, 8, 4, 0, CLR_GREEN, O1_NONE),
...
SPELL("cancellation",    "shining",
      P_TRANSMUTATION_SPELL,      15,  8, 6, 5, 50, A_INT, 1, IMMEDIATE, 0, 0, 0, 0, 1, 20, 30, CLR_WHITE, O1_NONE),
...
WAND("cancellation", "platinum", 45, 200, 1, IMMEDIATE, 0, 0, 0, 0, 1, 20, 30, PLATINUM, CLR_WHITE, O1_LIGHTNING_RESISTANT | O1_POLYMORPH_RESISTANT | O1_DISINTEGRATION_RESISTANT),
