...
SPELL("black blade of disaster", "ebony",
	  P_MATTER_SPELL,		5,  10, 12, 9,200, A_INT, 1, NODIR, 0, 0, 0, 0, 3, 4, 8, CLR_BLACK, O1_DISINTEGRATION_RESISTANT),
...
SPELL("extra healing",   "plaid",
      P_HEALING_SPELL,     22,  5, 4, 3, 20, A_WIS, 1, IMMEDIATE, 0, 8, 4, 0, 8, 4, 0, CLR_GREEN, O1_NONE),
...
SPELL("remove curse",    "wrinkled",
      P_CLERIC_SPELL,      20,  5, 5, 4, 20, A_WIS, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
...
SPELL("protection",      "dull",
      P_CLERIC_SPELL,      16, 3,200, 2, 15, A_WIS, 1, NODIR, 0, 0, 0, 0, 2, 10, 40, HI_PAPER, O1_NONE),
SPELL("jumping",         "thin",
...
SPELL("time stop",		  "ancient",
	  P_ENCHANTMENT_SPELL,  2, 10, 12, 9,200, A_INT, 1, NODIR, 0, 0, 0, 0, 1, 4, 3, HI_PAPER, O1_NONE),
SPELL("mage armor",		  "ornamental",
	  P_CLERIC_SPELL,	   15,  1,360, 1, 10, A_INT, 1, NODIR, 0, 0, 0, 0, 4, 20, 200, CLR_BLACK, O1_NONE),
