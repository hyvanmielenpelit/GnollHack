...
SPELL("sleep",           "mottled",
      P_ENCHANTMENT_SPELL, 25,  1, 4, 3,  5, A_CHA, 1, RAY, RAY_SLEEP, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
...
SPELL("force bolt",      "red",
      P_ARCANE_SPELL,      20,  2, 2, 1,10, A_INT, 1, IMMEDIATE, 0, 3, 6, 1, 3, 6, 1, CLR_RED, O1_NONE),
