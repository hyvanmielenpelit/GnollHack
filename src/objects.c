...
RING("mana regeneration", "crystal",
     ENERGY_REGENERATION, 0, 0, 200, 1, 0,  6, MINERAL, HI_MINERAL, O1_NONE),
...
SPELL("magic missile",   "vellum",
      P_ARCANE_SPELL,      20,  2, 1, 0,  7, A_INT, 1, RAY, RAY_MAGIC_MISSILE, 3, 4, 0, 0, 0, 0, HI_LEATHER, O1_NONE),
#undef PAPER /* revert to normal material */
SPELL("fire bolt",        "light red",
      P_ARCANE_SPELL,      20,  4, 4, 3, 20, A_INT, 1, RAY, RAY_FIRE, 3, 6, 0, 0, 0, 0, CLR_RED, O1_FIRE_RESISTANT),
SPELL("fireball",        "ragged",
      P_ARCANE_SPELL,      20,  6, 6, 5, 50, A_INT, 1, TARGETED, RAY_FIRE, 5, 6, 0, 0, 0, 0, HI_PAPER, O1_FIRE_RESISTANT | O1_SPELL_EXPLOSION_EFFECT),
SPELL("fire storm",       "crimson",
      P_ARCANE_SPELL,      10,  8, 8, 7,100, A_INT, 1, TARGETED, RAY_FIRE, 12, 6, 0, 0, 0, 0, CLR_RED, O1_FIRE_RESISTANT | O1_SPELL_EXPLOSION_EFFECT),
SPELL("cone of cold",    "dog eared",
      P_ARCANE_SPELL,      10,  6, 6, 5, 50, A_INT, 1, RAY, RAY_COLD, 15, 6, 0, 0, 0, 0, HI_PAPER, O1_COLD_RESISTANT),
SPELL("ice storm",		  "mithril-plated",
      P_ARCANE_SPELL,      10,  7, 7, 6, 75, A_INT, 1, TARGETED, RAY_COLD, 4, 10, 8, 0, 0, 0, HI_SILVER, O1_COLD_RESISTANT | O1_SPELL_EXPLOSION_EFFECT),
SPELL("sleep",           "mottled",
...
SPELL("lightning bolt",  "shimmering",
      P_ARCANE_SPELL,      10,  3, 	3, 2, 15, A_INT, 1, RAY, RAY_LIGHTNING, 6, 6, 0, 0, 0, 0, HI_PAPER, O1_LIGHTNING_RESISTANT),
SPELL("thunderstorm",	 "strange",
      P_ARCANE_SPELL,      10,  10, 10, 8,150, A_INT, 1, TARGETED, RAY_LIGHTNING, 10, 12, 0, 0, 0, 0, HI_PAPER, O1_LIGHTNING_RESISTANT | O1_SPELL_EXPLOSION_EFFECT),
SPELL("light",           "cloth",
...
SPELL("healing",         "white",
      P_HEALING_SPELL,     15,  2, 2, 1,10, A_WIS, 1, IMMEDIATE, 0, 4, 4, 0, 0, 0, 0, CLR_WHITE, O1_NONE),
SPELL("knock",           "pink",
      P_TRANSMUTATION_SPELL,      25,  1, 0, -1, 1, A_INT, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_BRIGHT_MAGENTA, O1_NONE),
SPELL("force bolt",      "red",
      P_ARCANE_SPELL,      15,  2, 2, 1,10, A_INT, 1, IMMEDIATE, 0, 3, 6, 1, 0, 0, 0, CLR_RED, O1_NONE),
