...
SPELL("magic missile",   "vellum",
      P_ATTACK_SPELL,      30,  2, 3,  5, A_INT, 1, RAY, RAY_MAGIC_MISSILE, 4, 4, 0, 4, 4, 0, HI_LEATHER, O1_NONE),
#undef PAPER /* revert to normal material */
SPELL("fireball",        "ragged",
      P_ATTACK_SPELL,      20,  4, 5, 20, A_INT, 1, RAY, RAY_FIRE, 12, 6, 0, 12, 6, 0, HI_PAPER, O1_NONE),
SPELL("cone of cold",    "dog eared",
      P_ATTACK_SPELL,      10,  7, 6, 30, A_INT, 1, RAY, RAY_COLD, 15, 6, 0, 15, 6, 0, HI_PAPER, O1_NONE),
SPELL("sleep",           "mottled",
      P_ENCHANTMENT_SPELL, 40,  1, 3,  5, A_CHA, 1, RAY, RAY_SLEEP, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
SPELL("disintegrate",	 "stained",
      P_ATTACK_SPELL,       5, 10,10,100, A_INT, 1, RAY, RAY_DISINTEGRATION, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
SPELL("light",           "cloth",
      P_DIVINATION_SPELL,  35,  1, 0,  2, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_CLOTH, O1_NONE),
SPELL("black blade of disaster", "ebony",
	  P_MATTER_SPELL,		5,  1, 9, 50, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_BLACK, O1_NONE),
...
SPELL("detect monsters", "leathery",
      P_DIVINATION_SPELL,  28,  1, 2, 5, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_LEATHER, O1_NONE),
SPELL("healing",         "white",
      P_HEALING_SPELL,     30,  2, 1, 5, A_WIS, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_WHITE, O1_NONE),
SPELL("knock",           "pink",
      P_MATTER_SPELL,      35,  1, -1, 1, A_INT, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_BRIGHT_MAGENTA, O1_NONE),
SPELL("force bolt",      "red",
      P_ATTACK_SPELL,      35,  2, 2, 5, A_INT, 1, IMMEDIATE, 0, 3, 8, 0, 3, 8, 0, CLR_RED, O1_NONE),
...
SPELL("haste self",      "purple",
      P_ESCAPE_SPELL,      33,  4, 3, 15, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_MAGENTA, O1_NONE),
...
SPELL("extra healing",   "plaid",
      P_HEALING_SPELL,     27,  5, 3, 15, A_WIS, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_GREEN, O1_NONE),
...
SPELL("armageddon",      "pitch black",
      P_ATTACK_SPELL,       2, 10,10,200, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_BLACK, O1_NONE),
