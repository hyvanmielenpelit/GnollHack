...
/* spellbooks ... */
     ...
     */
#define SPELL(name,desc,sub,prob,delay,level,manacost,attr,mgc,dir,dirsubtype,color,flags)  \
    OBJECT(OBJ(name, desc),                                             \
           BITS(0, 0, 0, 0, mgc, 0, 0, 0, 0, 0, dir, sub, PAPER),       \
           0, 0, 0, SPBOOK_CLASS, prob, delay, 50, level * 100,               \
           0, 0, 0, 0, 0, 0, 0, level, manacost, attr, 20, color,dirsubtype, 0, flags)
...
SPELL("dig",             "parchment",
      P_MATTER_SPELL,      20,  6, 7, 10, A_INT, 1, RAY, RAY_DIGGING, HI_LEATHER, O1_NONE),
SPELL("magic missile",   "vellum",
      P_ATTACK_SPELL,      40,  2, 3,  5, A_INT, 1, RAY, RAY_MAGIC_MISSILE, HI_LEATHER, O1_NONE),
#undef PAPER /* revert to normal material */
SPELL("fireball",        "ragged",
      P_ATTACK_SPELL,      20,  4, 5, 20, A_INT, 1, RAY, RAY_FIRE, HI_PAPER, O1_NONE),
SPELL("cone of cold",    "dog eared",
      P_ATTACK_SPELL,      10,  7, 6, 30, A_INT, 1, RAY, RAY_COLD, HI_PAPER, O1_NONE),
SPELL("sleep",           "mottled",
      P_ENCHANTMENT_SPELL, 40,  1, 3,  5, A_CHA, 1, RAY, RAY_SLEEP, HI_PAPER, O1_NONE),
SPELL("disintegrate",	 "stained",
      P_ATTACK_SPELL,       5, 10,10,100, A_INT, 1, RAY, RAY_DISINTEGRATION, HI_PAPER, O1_NONE),
SPELL("light",           "cloth",
      P_DIVINATION_SPELL,  35,  1, 0,  2, A_INT, 1, NODIR, 0, HI_CLOTH, O1_NONE),
SPELL("black blade of disaster", "ebony",
	  P_MATTER_SPELL,		5,  1, 9, 50, A_INT, 1, NODIR, 0, CLR_BLACK, O1_NONE),
SPELL("summon ogre",	  "old",
	P_CLERIC_SPELL,		   15,  1, 3, 15, A_CHA, 1, NODIR, 0, HI_PAPER, O1_NONE),
SPELL("summon demon", "worn",
	P_CLERIC_SPELL,			5,  5, 7, 30, A_CHA, 1, NODIR, 0, HI_PAPER, O1_NONE),
SPELL("detect monsters", "leathery",
      P_DIVINATION_SPELL,  38,  1, 2, 5, A_INT, 1, NODIR, 0, HI_LEATHER, O1_NONE),
SPELL("healing",         "white",
      P_HEALING_SPELL,     40,  2, 1, 5, A_WIS, 1, IMMEDIATE, 0, CLR_WHITE, O1_NONE),
SPELL("knock",           "pink",
      P_MATTER_SPELL,      35,  1, -1, 1, A_INT, 1, IMMEDIATE, 0, CLR_BRIGHT_MAGENTA, O1_NONE),
SPELL("force bolt",      "red",
      P_ATTACK_SPELL,      35,  2, 2, 5, A_INT, 1, IMMEDIATE, 0, CLR_RED, O1_NONE),
SPELL("confuse monster", "orange",
      P_ENCHANTMENT_SPELL, 30,  2, 2,  3, A_CHA, 1, IMMEDIATE, 0, CLR_ORANGE, O1_NONE),
SPELL("cure blindness",  "yellow",
      P_HEALING_SPELL,     25,  2, 0,  2, A_WIS, 1, IMMEDIATE, 0, CLR_YELLOW, O1_NONE),
SPELL("drain life",      "velvet",
      P_ATTACK_SPELL,      10,  2, 5, 30, A_INT, 1, IMMEDIATE, 0, CLR_MAGENTA, O1_NONE),
SPELL("slow monster",    "light green",
      P_ENCHANTMENT_SPELL, 30,  2, 1, 3, A_INT, 1, IMMEDIATE, 0, CLR_BRIGHT_GREEN, O1_NONE),
SPELL("wizard lock",     "dark green",
      P_MATTER_SPELL,      30,  3, -1, 1, A_INT, 1, IMMEDIATE, 0, CLR_GREEN, O1_NONE),
SPELL("create monster",  "turquoise",
      P_CLERIC_SPELL,      35,  3, 3, 15, A_CHA, 1, NODIR, 0, CLR_BRIGHT_CYAN, O1_NONE),
SPELL("detect food",     "cyan",
      P_DIVINATION_SPELL,  30,  3, 0, 2, A_INT, 1, NODIR, 0, CLR_CYAN, O1_NONE),
SPELL("cause fear",      "light blue",
      P_ENCHANTMENT_SPELL, 25,  3, 2, 3, A_CHA, 1, NODIR, 0, CLR_BRIGHT_BLUE, O1_NONE),
SPELL("clairvoyance",    "dark blue",
      P_DIVINATION_SPELL,  15,  3, 2, 10, A_INT, 1, NODIR, 0, CLR_BLUE, O1_NONE),
SPELL("cure sickness",   "indigo",
      P_HEALING_SPELL,     32,  3, 2, 5, A_WIS, 1, NODIR, 0, CLR_BLUE, O1_NONE),
SPELL("charm monster",   "magenta",
      P_ENCHANTMENT_SPELL, 20,  3, 6, 25, A_CHA, 1, IMMEDIATE, 0, CLR_MAGENTA, O1_NONE),
SPELL("haste self",      "purple",
      P_ESCAPE_SPELL,      33,  4, 3, 15, A_INT, 1, NODIR, 0, CLR_MAGENTA, O1_NONE),
SPELL("detect unseen",   "violet",
      P_DIVINATION_SPELL,  20,  4, 1, 5, A_INT, 1, NODIR, 0, CLR_MAGENTA, O1_NONE),
SPELL("levitation",      "tan",
      P_ESCAPE_SPELL,      20,  4, 2, 10, A_INT, 1, NODIR, 0, CLR_BROWN, O1_NONE),
SPELL("extra healing",   "plaid",
      P_HEALING_SPELL,     27,  5, 3, 15, A_WIS, 1, IMMEDIATE, 0, CLR_GREEN, O1_NONE),
SPELL("restore ability", "light brown",
      P_HEALING_SPELL,     25,  5, 5, 30, A_WIS, 1, NODIR, 0, CLR_BROWN, O1_NONE),
SPELL("invisibility",    "dark brown",
      P_ESCAPE_SPELL,      25,  5, 2, 15, A_INT, 1, NODIR, 0, CLR_BROWN, O1_NONE),
SPELL("detect treasure", "gray",
      P_DIVINATION_SPELL,  20,  5, 0, 3, A_INT, 1, NODIR, 0, CLR_GRAY, O1_NONE),
SPELL("remove curse",    "wrinkled",
      P_CLERIC_SPELL,      25,  5, 4, 20, A_WIS, 1, NODIR, 0, HI_PAPER, O1_NONE),
SPELL("magic mapping",   "dusty",
      P_DIVINATION_SPELL,  18,  7, 8, 50, A_INT, 1, NODIR, 0, HI_PAPER, O1_NONE),
SPELL("identify",        "bronze-plated",
      P_DIVINATION_SPELL,  20,  6, 9, 50, A_INT, 1, NODIR, 0, HI_COPPER, O1_NONE),
SPELL("turn undead",     "copper-plated",
      P_CLERIC_SPELL,      16,  8, 9, 30, A_WIS, 1, IMMEDIATE, 0, HI_COPPER, O1_NONE),
SPELL("polymorph",       "silver-plated",
      P_MATTER_SPELL,      10,  8, 7, 40, A_INT, 1, IMMEDIATE, 0, HI_SILVER, O1_NONE),
SPELL("teleport away",   "gold-plated",
      P_ESCAPE_SPELL,      15,  6, 4, 25, A_INT, 1, IMMEDIATE, 0, HI_GOLD, O1_NONE),
SPELL("create familiar", "glittering",
      P_CLERIC_SPELL,      10,  7, 4, 30, A_WIS, 1, NODIR, 0, CLR_WHITE, O1_NONE),
SPELL("cancellation",    "shining",
      P_MATTER_SPELL,      15,  8, 6, 35, A_INT, 1, IMMEDIATE, 0, CLR_WHITE, O1_NONE),
SPELL("protection",      "dull",
      P_CLERIC_SPELL,      18,  3, 2, 10, A_WIS, 1, NODIR, 0, HI_PAPER, O1_NONE),
SPELL("jumping",         "thin",
      P_ESCAPE_SPELL,      18,  3, 0,  2, A_DEX,  1, IMMEDIATE, 0, HI_PAPER, O1_NONE),
SPELL("stone to flesh",  "thick",
      P_HEALING_SPELL,     15,  1, 3, 20, A_WIS, 1, IMMEDIATE, 0, HI_PAPER, O1_NONE),
SPELL("finger of death", "leather bound",
	P_ATTACK_SPELL,		    5, 10, 9,100, A_INT, 1, RAY, RAY_DEATH, HI_PAPER, O1_NONE),
SPELL("armageddon",      "pitch black",
      P_ATTACK_SPELL,       2, 10,10,200, A_INT, 1, NODIR, 0, CLR_BLACK, O1_NONE),
SPELL("wish",			 "platinum-plated",
      P_MATTER_SPELL,       0, 15,10,300, A_INT, 1, NODIR, 0, HI_SILVER, O1_NONE),
 ...
 */
SPELL("blank paper", "plain", P_NONE, 18, 0, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
