...
SPELL("detect monsters", "leathery",
      P_DIVINATION_SPELL,  18,  1, 0, 5, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_LEATHER, O1_NONE),
SPELL("healing",         "white",
...
SPELL("detect food",     "cyan",
      P_DIVINATION_SPELL,  30,  3, -1, 8, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_CYAN, O1_NONE),
...
SPELL("clairvoyance",    "dark blue",
      P_DIVINATION_SPELL,  15,  3, 2, 15, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_BLUE, O1_NONE),
...
SPELL("detect unseen",   "violet",
      P_DIVINATION_SPELL,  20,  4, 1, 10, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_MAGENTA, O1_NONE),
...
SPELL("detect treasure", "gray",
      P_DIVINATION_SPELL,  20,  5, 0, 15, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_GRAY, O1_NONE),
...
SPELL("magic mapping",   "dusty",
      P_DIVINATION_SPELL,  18,  7, 4, 60, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
...
SPELL("stone to flesh",  "thick",
      P_HEALING_SPELL,     15,  1, 3, 20, A_WIS, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
...
SPELL("wish",			 "platinum-plated",
      P_MATTER_SPELL,       0, 15,10,300, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_SILVER, O1_NONE),
