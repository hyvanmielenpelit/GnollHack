...
SPELL("create monster",  "turquoise",
      P_CLERIC_SPELL,      35,  3, 3, 15, A_CHA, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_BRIGHT_CYAN, O1_NONE),
...
SPELL("polymorph",       "silver-plated",
      P_MATTER_SPELL,      10,  8, 7, 40, A_INT, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, HI_SILVER, O1_NONE),
...
SPELL("protection",      "dull",
      P_CLERIC_SPELL,      18,  3, 2, 10, A_WIS, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
SPELL("jumping",         "thin",
      P_ESCAPE_SPELL,      18,  3, 0,  2, A_DEX,  1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
...
SPELL("finger of death", "leather bound",
	P_ATTACK_SPELL,		    5, 10, 9,100, A_INT, 1, RAY, RAY_DEATH, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
