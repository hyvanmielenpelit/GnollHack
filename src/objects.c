...
SPELL("dig",             "parchment",
      P_MATTER_SPELL,      20,  4, 4, 3, 10, A_INT, 1, RAY, RAY_DIGGING, 0, 0, 0, 0, 0, 0, HI_LEATHER, O1_NONE),
SPELL("magic missile",   "vellum",
      P_ATTACK_SPELL,      20,  2, 1, 0,  7, A_INT, 1, RAY, RAY_MAGIC_MISSILE, 3, 4, 0, 3, 4, 0, HI_LEATHER, O1_NONE),
#undef PAPER /* revert to normal material */
SPELL("fire bolt",        "light red",
      P_ATTACK_SPELL,      20,  4, 4, 3, 20, A_INT, 1, RAY, RAY_FIRE, 3, 6, 0, 3, 6, 0, CLR_RED, O1_FIRE_RESISTANT),
SPELL("fireball",        "ragged",
      P_ATTACK_SPELL,      20,  6, 6, 5, 50, A_INT, 1, TARGETED, RAY_FIRE, 5, 6, 0, 5, 6, 0, HI_PAPER, O1_FIRE_RESISTANT | O1_SPELL_EXPLOSION_EFFECT),
SPELL("fire storm",       "crimson",
      P_ATTACK_SPELL,      10,  8, 8, 7,100, A_INT, 1, TARGETED, RAY_FIRE, 12, 6, 0, 12, 6, 0, CLR_RED, O1_FIRE_RESISTANT | O1_SPELL_EXPLOSION_EFFECT),
SPELL("cone of cold",    "dog eared",
      P_ATTACK_SPELL,      10,  6, 6, 5, 50, A_INT, 1, RAY, RAY_COLD, 15, 6, 0, 15, 6, 0, HI_PAPER, O1_COLD_RESISTANT),
SPELL("ice storm",		  "mithril-plated",
      P_ATTACK_SPELL,      10,  7, 7, 6, 75, A_INT, 1, TARGETED, RAY_COLD, 4, 10, 8, 4, 10, 8, HI_SILVER, O1_COLD_RESISTANT | O1_SPELL_EXPLOSION_EFFECT),
SPELL("sleep",           "mottled",
      P_ENCHANTMENT_SPELL, 30,  1, 4, 3,  5, A_CHA, 1, RAY, RAY_SLEEP, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
SPELL("disintegrate",	 "stained",
      P_ATTACK_SPELL,       5, 12, 14, 10,300, A_INT, 1, RAY, RAY_DISINTEGRATION, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_DISINTEGRATION_RESISTANT),
SPELL("lightning bolt",  "shimmering",
      P_ATTACK_SPELL,      15,  3, 	3, 2, 15, A_INT, 1, RAY, RAY_LIGHTNING, 6, 6, 0, 6, 6, 0, HI_PAPER, O1_LIGHTNING_RESISTANT),
SPELL("thunderstorm",	 "strange",
      P_ATTACK_SPELL,      10,  10, 10, 8,150, A_INT, 1, TARGETED, RAY_LIGHTNING, 10, 12, 0, 10, 12, 0, HI_PAPER, O1_LIGHTNING_RESISTANT | O1_SPELL_EXPLOSION_EFFECT),
SPELL("light",           "cloth",
      P_DIVINATION_SPELL,  20,  1, 1, 0,  2, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_CLOTH, O1_NONE),
SPELL("black blade of disaster", "ebony",
	  P_MATTER_SPELL,		5,  10, 12, 9,200, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_BLACK, O1_DISINTEGRATION_RESISTANT),
SPELL("summon ogre",	  "old",
	P_CLERIC_SPELL,		   15,  3, 4, 3, 30, A_CHA, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
SPELL("summon demon", "worn",
	P_CLERIC_SPELL,			5,  5, 8, 7,100, A_CHA, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
SPELL("detect monsters", "leathery",
      P_DIVINATION_SPELL,  18,  1, 1, 0, 5, A_WIS, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_LEATHER, O1_NONE),
SPELL("healing",         "white",
      P_HEALING_SPELL,     30,  2, 2, 1,10, A_WIS, 1, IMMEDIATE, 0, 4, 4, 0, 4, 4, 0, CLR_WHITE, O1_NONE),
SPELL("knock",           "pink",
      P_MATTER_SPELL,      25,  1, 0, -1, 1, A_INT, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_BRIGHT_MAGENTA, O1_NONE),
SPELL("force bolt",      "red",
      P_ATTACK_SPELL,      35,  2, 2, 1,10, A_INT, 1, IMMEDIATE, 0, 3, 6, 1, 3, 6, 1, CLR_RED, O1_NONE),
SPELL("magic arrow",      "hardcover",
      P_ATTACK_SPELL,      30,  1, 0, -1, 4, A_INT, 1, IMMEDIATE, 0, 1, 3, 1, 1, 4, 1, CLR_BROWN, O1_NONE),
SPELL("confuse monster", "orange",
      P_ENCHANTMENT_SPELL, 30,  2, 1, 0,  7, A_CHA, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_ORANGE, O1_NONE),
SPELL("cure blindness",  "yellow",
      P_HEALING_SPELL,     25,  2, 1, 0,  7, A_WIS, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_YELLOW, O1_NONE),
SPELL("drain life",      "velvet",
      P_ATTACK_SPELL,      10,  2, 6, 5, 50, A_INT, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_MAGENTA, O1_NONE),
SPELL("slow monster",    "light green",
      P_ENCHANTMENT_SPELL, 30,  2, 2, 1, 10, A_INT, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_BRIGHT_GREEN, O1_NONE),
SPELL("wizard lock",     "dark green",
      P_MATTER_SPELL,      30,  3, 0, -1, 3, A_INT, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_GREEN, O1_NONE),
SPELL("create monster",  "turquoise",
      P_CLERIC_SPELL,      25,  3, 4, 3, 30, A_CHA, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_BRIGHT_CYAN, O1_NONE),
SPELL("detect food",     "cyan",
      P_DIVINATION_SPELL,  30,  3, 0, -1, 8, A_WIS, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_CYAN, O1_NONE),
SPELL("cause fear",      "light blue",
      P_ENCHANTMENT_SPELL, 25,  3, 3, 2, 15, A_CHA, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_BRIGHT_BLUE, O1_NONE),
...
SPELL("cure sickness",   "indigo",
      P_HEALING_SPELL,     32,  3, 3, 2, 15, A_WIS, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_BLUE, O1_NONE),
SPELL("charm monster",   "magenta",
      P_ENCHANTMENT_SPELL, 20,  3, 7, 6, 75, A_CHA, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_MAGENTA, O1_NONE),
SPELL("haste self",      "purple",
      P_ESCAPE_SPELL,      23,  4, 4, 3, 30, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_MAGENTA, O1_NONE),
...
SPELL("levitation",      "tan",
      P_ESCAPE_SPELL,      20,  4, 3, 2, 15, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_BROWN, O1_NONE),
SPELL("extra healing",   "plaid",
      P_HEALING_SPELL,     27,  5, 4, 3, 20, A_WIS, 1, IMMEDIATE, 0, 8, 4, 0, 8, 4, 0, CLR_GREEN, O1_NONE),
SPELL("full healing",    "light gray",
      P_HEALING_SPELL,     10,  6, 6, 5, 50, A_WIS, 1, IMMEDIATE, 0, 0, 0, 255, 0, 0, 255, CLR_WHITE, O1_NONE),
SPELL("restore ability", "light brown",
      P_HEALING_SPELL,     25,  5, 6, 5, 50, A_WIS, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_BROWN, O1_NONE),
SPELL("invisibility",    "dark brown",
      P_ESCAPE_SPELL,      20,  5, 3, 2, 15, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_BROWN, O1_NONE),
SPELL("detect treasure", "gray",
      P_DIVINATION_SPELL,  20,  5, 1, 0, 15, A_WIS, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_GRAY, O1_NONE),
SPELL("remove curse",    "wrinkled",
      P_CLERIC_SPELL,      25,  5, 5, 4, 20, A_WIS, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
...
SPELL("polymorph",       "silver-plated",
      P_MATTER_SPELL,      10,  6, 6, 5, 50, A_INT, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, HI_SILVER, O1_NONE),
SPELL("teleport away",   "gold-plated",
      P_ESCAPE_SPELL,      15,  6, 5, 4, 30, A_INT, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, HI_GOLD, O1_NONE),
...
SPELL("cancellation",    "shining",
      P_MATTER_SPELL,      15,  8, 7, 6, 75, A_INT, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_WHITE, O1_NONE),
SPELL("protection",      "dull",
      P_CLERIC_SPELL,      16,  3, 3, 2, 15, A_WIS, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
SPELL("jumping",         "thin",
      P_ESCAPE_SPELL,      15,  3, 0,-1,  4, A_DEX, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
...
SPELL("touch of death", "leather bound",
	P_ATTACK_SPELL,		    5,  8, 8, 7,100, A_INT, 1, TOUCH, RAY_DEATH, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
SPELL("finger of death", "leather bound",
	P_ATTACK_SPELL,		    5, 10, 10, 8,150, A_INT, 1, RAY, RAY_DEATH, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
SPELL("deathspell",	     "morbid",
	P_ATTACK_SPELL,		    5, 10, 12, 9,200, A_INT, 1, TARGETED, RAY_DEATH, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE | O1_SPELL_EXPLOSION_EFFECT),
SPELL("armageddon",      "pitch black",
      P_ATTACK_SPELL,       2, 14, 20,10,300, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_BLACK, O1_NONE),
SPELL("wish",			 "platinum-plated",
      P_MATTER_SPELL,       2, 15, 20,10,300, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_SILVER, O1_NONE),
SPELL("time stop",		  "ancient",
	  P_ENCHANTMENT_SPELL,  2, 10, 12, 9,200, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
