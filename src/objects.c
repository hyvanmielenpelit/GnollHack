...
SPELL("fireball",        "ragged",
      P_ATTACK_SPELL,      20,  6, 5, 20, A_INT, 1, RAY, RAY_FIRE, 5, 6, 0, 5, 6, 0, HI_PAPER, O1_FIRE_RESISTANT | O1_SPELL_EXPLOSION_EFFECT),
SPELL("fire storm",       "crimson",
      P_ATTACK_SPELL,      10,  8, 7, 60, A_INT, 1, RAY, RAY_FIRE, 12, 6, 0, 12, 6, 0, CLR_RED, O1_FIRE_RESISTANT | O1_SPELL_EXPLOSION_EFFECT),
...
SPELL("ice storm",		  "mithril-plated",
      P_ATTACK_SPELL,      10,  7, 6, 40, A_INT, 1, RAY, RAY_COLD, 4, 10, 8, 4, 10, 8, HI_SILVER, O1_COLD_RESISTANT | O1_SPELL_EXPLOSION_EFFECT),
SPELL("sleep",           "mottled",
...
SPELL("thunderstorm",	 "strange",
      P_ATTACK_SPELL,      10,  10, 8, 90, A_INT, 1, RAY, RAY_LIGHTNING, 10, 12, 0, 10, 12, 0, HI_PAPER, O1_LIGHTNING_RESISTANT | O1_SPELL_EXPLOSION_EFFECT),
SPELL("light",           "cloth",
...
SPELL("full healing",    "light gray",
      P_HEALING_SPELL,     10,  7, 6, 40, A_WIS, 1, IMMEDIATE, 0, 0, 0, 255, 0, 0, 255, CLR_WHITE, O1_NONE),
...
SPELL("invisibility",    "dark brown",
      P_ESCAPE_SPELL,      25,  5, 2, 15, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_BROWN, O1_NONE),
...
SPELL("deathspell",	     "morbid",
	P_ATTACK_SPELL,		    5, 10, 9,150, A_INT, 1, RAY, RAY_DEATH, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE | O1_SPELL_EXPLOSION_EFFECT),
...
WAND("magic missile",   "steel", 50, 150, 1, RAY, RAY_WND_MAGIC_MISSILE, 4, 4, 0, 4, 4, 0, IRON, HI_METAL, O1_NONE),
WAND("fire",        "hexagonal", 40, 175, 1, RAY, RAY_WND_FIRE, 9, 6, 0, 9, 6, 0, IRON, HI_METAL, O1_FIRE_RESISTANT),
