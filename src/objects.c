...
SPELL("sleep",           "mottled",
      P_ENCHANTMENT_SPELL, 10,  1, 4, 3,  5, A_CHA, 1, RAY, RAY_SLEEP, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
...
SPELL("lightning bolt",  "shimmering",
      P_ARCANE_SPELL,      10,  3, 	3, 2, 15, A_INT, 1, RAY, RAY_LIGHTNING, 6, 6, 0, 6, 6, 0, HI_PAPER, O1_LIGHTNING_RESISTANT),
...
SPELL("light",           "cloth",
      P_DIVINATION_SPELL,  10,  1, 1, 0,  2, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_CLOTH, O1_NONE),
...
SPELL("healing",         "white",
      P_HEALING_SPELL,     15,  2, 2, 1,10, A_WIS, 1, IMMEDIATE, 0, 4, 4, 0, 4, 4, 0, CLR_WHITE, O1_NONE),
SPELL("knock",           "pink",
      P_TRANSMUTATION_SPELL,      25,  1, 0, -1, 1, A_INT, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_BRIGHT_MAGENTA, O1_NONE),
SPELL("force bolt",      "red",
      P_ARCANE_SPELL,      15,  2, 2, 1,10, A_INT, 1, IMMEDIATE, 0, 3, 6, 1, 3, 6, 1, CLR_RED, O1_NONE),
SPELL("magic arrow",      "hardcover",
      P_ARCANE_SPELL,      15,  1, 0, -1, 4, A_INT, 1, IMMEDIATE, 0, 1, 3, 1, 1, 4, 1, CLR_BROWN, O1_NONE),
SPELL("confuse monster", "orange",
      P_ENCHANTMENT_SPELL, 15,  2, 1, 0,  7, A_CHA, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_ORANGE, O1_NONE),
...
SPELL("create monster",  "turquoise",
      P_CLERIC_SPELL,      20,  3, 4, 3, 30, A_CHA, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_BRIGHT_CYAN, O1_NONE),
...
SPELL("cause fear",      "light blue",
      P_ENCHANTMENT_SPELL, 20,  3, 3, 2, 15, A_CHA, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_BRIGHT_BLUE, O1_NONE),
