...
SPELL("magic missile",   "vellum",
      P_ARCANE_SPELL,      20,  2, 1, 0,  7, A_INT, 1, RAY, RAY_MAGIC_MISSILE, 3, 4, 0, 3, 4, 0, HI_LEATHER, O1_NONE),
#undef PAPER /* revert to normal material */
SPELL("fire bolt",        "light red",
      P_ARCANE_SPELL,      20,  4, 4, 3, 20, A_INT, 1, RAY, RAY_FIRE, 3, 6, 0, 3, 6, 0, CLR_RED, O1_FIRE_RESISTANT),
SPELL("fireball",        "ragged",
      P_ARCANE_SPELL,      20,  6, 6, 5, 50, A_INT, 1, TARGETED, RAY_FIRE, 5, 6, 0, 5, 6, 0, HI_PAPER, O1_FIRE_RESISTANT | O1_SPELL_EXPLOSION_EFFECT),
SPELL("fire storm",       "crimson",
      P_ARCANE_SPELL,      10,  8, 8, 7,100, A_INT, 1, TARGETED, RAY_FIRE, 12, 6, 0, 12, 6, 0, CLR_RED, O1_FIRE_RESISTANT | O1_SPELL_EXPLOSION_EFFECT),
SPELL("cone of cold",    "dog eared",
      P_ARCANE_SPELL,      10,  6, 6, 5, 50, A_INT, 1, RAY, RAY_COLD, 15, 6, 0, 15, 6, 0, HI_PAPER, O1_COLD_RESISTANT),
SPELL("ice storm",		  "mithril-plated",
      P_ARCANE_SPELL,      10,  7, 7, 6, 75, A_INT, 1, TARGETED, RAY_COLD, 4, 10, 8, 4, 10, 8, HI_SILVER, O1_COLD_RESISTANT | O1_SPELL_EXPLOSION_EFFECT),
SPELL("sleep",           "mottled",
      P_ENCHANTMENT_SPELL, 30,  1, 4, 3,  5, A_CHA, 1, RAY, RAY_SLEEP, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
SPELL("disintegrate",	 "stained",
      P_ARCANE_SPELL,       5, 12, 14, 10,300, A_INT, 1, RAY, RAY_DISINTEGRATION, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_DISINTEGRATION_RESISTANT),
SPELL("lightning bolt",  "shimmering",
      P_ARCANE_SPELL,      15,  3, 	3, 2, 15, A_INT, 1, RAY, RAY_LIGHTNING, 6, 6, 0, 6, 6, 0, HI_PAPER, O1_LIGHTNING_RESISTANT),
SPELL("thunderstorm",	 "strange",
      P_ARCANE_SPELL,      10,  10, 10, 8,150, A_INT, 1, TARGETED, RAY_LIGHTNING, 10, 12, 0, 10, 12, 0, HI_PAPER, O1_LIGHTNING_RESISTANT | O1_SPELL_EXPLOSION_EFFECT),
SPELL("light",           "cloth",
      P_DIVINATION_SPELL,  20,  1, 1, 0,  2, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_CLOTH, O1_NONE),
SPELL("black blade of disaster", "ebony",
	P_CONJURATION_SPELL,		5,  10, 12, 9,200, A_INT, 1, NODIR, 0, 0, 0, 0, 3, 4, 8, CLR_BLACK, O1_DISINTEGRATION_RESISTANT),
SPELL("summon ogre",	  "old",
	P_CONJURATION_SPELL,		   15,  3, 4, 3, 30, A_CHA, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
SPELL("summon demon", "worn",
	P_CONJURATION_SPELL,			5,  5, 8, 7,100, A_CHA, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_PAPER, O1_NONE),
SPELL("detect monsters", "leathery",
      P_DIVINATION_SPELL,  18,  1, 1, 0, 5, A_WIS, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_LEATHER, O1_NONE),
SPELL("healing",         "white",
      P_HEALING_SPELL,     20,  2, 2, 1,10, A_WIS, 1, IMMEDIATE, 0, 4, 4, 0, 4, 4, 0, CLR_WHITE, O1_NONE),
SPELL("knock",           "pink",
      P_TRANSMUTATION_SPELL,      25,  1, 0, -1, 1, A_INT, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_BRIGHT_MAGENTA, O1_NONE),
SPELL("force bolt",      "red",
      P_ARCANE_SPELL,      25,  2, 2, 1,10, A_INT, 1, IMMEDIATE, 0, 3, 6, 1, 3, 6, 1, CLR_RED, O1_NONE),
SPELL("magic arrow",      "hardcover",
      P_ARCANE_SPELL,      20,  1, 0, -1, 4, A_INT, 1, IMMEDIATE, 0, 1, 3, 1, 1, 4, 1, CLR_BROWN, O1_NONE),
SPELL("confuse monster", "orange",
      P_ENCHANTMENT_SPELL, 20,  2, 1, 0,  7, A_CHA, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_ORANGE, O1_NONE),
...
SPELL("drain life",      "velvet",
      P_ARCANE_SPELL,      10,  2, 6, 5, 50, A_INT, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_MAGENTA, O1_NONE),
...
SPELL("detect food",     "cyan",
      P_DIVINATION_SPELL,  20,  3, 0, -1, 8, A_WIS, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_CYAN, O1_NONE),
...
SPELL("cure sickness",   "indigo",
      P_HEALING_SPELL,     22,  3, 3, 2, 15, A_WIS, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_BLUE, O1_NONE),
...
SPELL("haste self",      "purple",
      P_MOVEMENT_SPELL,      23,  4, 4, 3, 30, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_MAGENTA, O1_NONE),
...
SPELL("cancellation",    "shining",
      P_TRANSMUTATION_SPELL,      15,  8, 6, 5, 50, A_INT, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_WHITE, O1_NONE),
...
SPELL("wish",			 "platinum-plated",
      P_TRANSMUTATION_SPELL,       2, 15, 20,10,300, A_INT, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, HI_SILVER, O1_NONE),
