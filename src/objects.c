...
SPELL("slow monster",    "light green",
      P_ENCHANTMENT_SPELL, 20,  2, 2, 1, 10, A_INT, 1, IMMEDIATE, 0, 0, 0, 0, 0, 0, 0, CLR_BRIGHT_GREEN, O1_NONE),
...
SPELL("resurrection",		  "bright",
	P_CLERIC_SPELL,				10, 5,10, 5,50, A_WIS, 1, NODIR, 0, 0, 0, 0, 0, 0, 0, CLR_WHITE, O1_NONE),
