...
SPELL("dig",             "parchment",
      P_MATTER_SPELL,      20,  6, 9, 1, RAY, HI_LEATHER),
...
SPELL("finger of death", "stained",
      P_ATTACK_SPELL,       5, 10, 20, 1, RAY, HI_PAPER),
SPELL("light",           "cloth",
...
SPELL("magic mapping",   "dusty",
      P_DIVINATION_SPELL,  18,  7, 10, 1, NODIR, HI_PAPER),
SPELL("identify",        "bronze",
      P_DIVINATION_SPELL,  20,  6, 12, 1, NODIR, HI_COPPER),
...
SPELL("create familiar", "glittering",
      P_CLERIC_SPELL,      10,  7, 11, 1, NODIR, CLR_WHITE),
