...
SPELL("dig",             "parchment",
      P_MATTER_SPELL,      20,  6, 10, 1, RAY, HI_LEATHER),
SPELL("magic missile",   "vellum",
      P_ATTACK_SPELL,      40,  2, 3, 1, RAY, HI_LEATHER),
#undef PAPER /* revert to normal material */
SPELL("fireball",        "ragged",
      P_ATTACK_SPELL,      20,  4, 8, 1, RAY, HI_PAPER),
SPELL("cone of cold",    "dog eared",
      P_ATTACK_SPELL,      10,  7, 7, 1, RAY, HI_PAPER),
SPELL("sleep",           "mottled",
      P_ENCHANTMENT_SPELL, 50,  1, 4, 1, RAY, HI_PAPER),
SPELL("disintegrate", "stained",
      P_ATTACK_SPELL,       5, 10, 25, 1, RAY, HI_PAPER),
SPELL("light",           "cloth",
      P_DIVINATION_SPELL,  45,  1, 1, 1, NODIR, HI_CLOTH),
SPELL("detect monsters", "leathery",
      P_DIVINATION_SPELL,  43,  1, 2, 1, NODIR, HI_LEATHER),
SPELL("healing",         "white",
      P_HEALING_SPELL,     40,  2, 2, 1, IMMEDIATE, CLR_WHITE),
SPELL("knock",           "pink",
...
SPELL("haste self",      "purple",
      P_ESCAPE_SPELL,      33,  4, 5, 1, NODIR, CLR_MAGENTA),
SPELL("detect unseen",   "violet",
      P_DIVINATION_SPELL,  20,  4, 4, 1, NODIR, CLR_MAGENTA),
SPELL("levitation",      "tan",
      P_ESCAPE_SPELL,      20,  4, 7, 1, NODIR, CLR_BROWN),
SPELL("extra healing",   "plaid",
      P_HEALING_SPELL,     27,  5, 5, 1, IMMEDIATE, CLR_GREEN),
SPELL("restore ability", "light brown",
      P_HEALING_SPELL,     25,  5, 8, 1, NODIR, CLR_BROWN),
...
SPELL("stone to flesh",  "thick",
      P_HEALING_SPELL,     15,  1, 5, 1, IMMEDIATE, HI_PAPER),
