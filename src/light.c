...
void
new_light_source(xchar x, xchar y, int range, int type, anything *id, int sidedness)
{
    light_source *ls;
...
void
light_stats(const char *hdrfmt, char *hdrbuf, int64_t *count, size_t *size)
{
    light_source *ls;
...
/* light emitting artifact's range depends upon its curse/bless state */
int
current_arti_light_radius(struct obj *obj)
{
    /*
...
int64_t
obj_light_maximum_burn_time(struct obj *obj)
{
    if (!obj)
        return 0;
...
int
obj_light_radius(struct obj *obj)
{
    if (!obj)
        return 0;
...
int64_t
burn_time_left_from_timer(struct obj *obj)
{
    if (!obj)
        return 0L;
...
int64_t
obj_light_burn_time_left(struct obj *obj)
{
    if (!obj)
        return 0;
