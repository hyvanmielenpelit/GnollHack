...
NEARDATA const char getobj_pickaxe_objects[] = { ALL_CLASSES, WEAPON_CLASS, TOOL_CLASS, 0 };
...
NEARDATA char debug_buf_array[TOTALNUM_DEBUGBUFS][DEBUGBUFSIZ] = { 0 };
NEARDATA char* debug_bufs[TOTALNUM_DEBUGBUFS] = { 0 };
