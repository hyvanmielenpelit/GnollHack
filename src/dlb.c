...
static long lib_dlb_fread(char*, long, long, dlb*);
...
static long
lib_dlb_fread(char *buf, long size, long quan, dlb *dp)
{
...
long
dlb_fread(char *buf, long size, long quan, dlb *dp)
{
