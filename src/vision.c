...
static void right_side(int, int, int, int, int,
                                    int, int, char *);
 ...
 * Parameters:
 *   row: current row
 *   cb_row, cb_col: close block row and col
 *   fb_row, fb_col: far block row and col
 *   left: left mark of the previous row
 *   right_mark: right mark of previous row
 ...
 */
static void
right_side(int row, int cb_row, int cb_col, int fb_row, int fb_col, int left, int right_mark, char *limits)
{
    int i;
    char *rowp = NULL;
    int hit_stone = 0;
 ...
 *   cb_row, cb_col: close block row and col
 *   fb_row, fb_col: far block row and col
 *   left_mark: left mark of previous row
 *   right: right mark of the previous row
 */
/*
 * left_side()
 *
 ...
 */
static void
left_side(int row, int cb_row, int cb_col, int fb_row, int fb_col, int left_mark, int right, char *limits)
{
    int i;
    char *rowp = NULL;
    int hit_stone = 0;
...
/*
 * Parameters:
 *   srow, scol: source row and column
 *   loc_cs_rows: could_see array (row pointers)
 *   left_most, right_most: limits of what could be seen
 ...
 */
static void
right_side(int row, int left, int right_mark, char *limits)
{
...
howmonseen(struct monst *mon)
{
    ...
    if ((mon->wormno ? worm_known(mon) : (cansee(mon->mx, mon->my)
        ...
        && mon_visible(mon) && !is_invisible(mon))
