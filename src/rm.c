...
NEARDATA struct decoration_type_definition decoration_type_definitions[MAX_DECORATIONS] = {
    {
        ...
        0, 0, STRANGE_OBJECT, NO_COLOR, LOCATION_SOUNDSET_NONE, 
        DECORATION_TYPE_FLAGS_NONE 
    },
    {
        "cobweb", "cobweb", "cobweb", 
        DOODAD_COBWEB_NORMAL, 2, STRANGE_OBJECT, NO_COLOR, LOCATION_SOUNDSET_NONE, 
        DECORATION_TYPE_FLAGS_MIRRORABLE
    },
    {
        "cobweb", "cobweb", "cobweb", 
        DOODAD_COBWEB_CORNER_ELONGATED, 5, STRANGE_OBJECT, NO_COLOR, LOCATION_SOUNDSET_NONE, 
        DECORATION_TYPE_FLAGS_MIRRORABLE | DECORATION_TYPE_FLAGS_CORNERS
    },
    {
        "torch", "torch holder", "torch", 
        DOODAD_TORCH_HOLDER, 1, BRASS_LANTERN, NO_COLOR, LOCATION_SOUNDSET_BRAZIER,
        DECORATION_TYPE_FLAGS_LOOTABLE | DECORATION_TYPE_FLAGS_LIGHTABLE | DECORATION_TYPE_FLAGS_UNDERSCORE | DECORATION_TYPE_FLAGS_ALL_SIDES
    },
    {
        "lantern", "lantern holder", "brass lantern", 
        DOODAD_LANTERN_HOLDER, 1, BRASS_LANTERN, NO_COLOR, LOCATION_SOUNDSET_BRAZIER,
        DECORATION_TYPE_FLAGS_LOOTABLE | DECORATION_TYPE_FLAGS_LIGHTABLE | DECORATION_TYPE_FLAGS_UNDERSCORE | DECORATION_TYPE_FLAGS_ALL_SIDES
    },
};
