...
NEARDATA struct decoration_type_definition decoration_type_definitions[MAX_DECORATIONS] = {
    {
        ...
        {0, 0, 0, 0},
        0, STRANGE_OBJECT, NO_COLOR, LOCATION_SOUNDSET_NONE, 
    ...
    },
    {
        ...
        2, STRANGE_OBJECT, NO_COLOR, LOCATION_SOUNDSET_NONE, 
    ...
    },
    {
        ...
        5, STRANGE_OBJECT, NO_COLOR, LOCATION_SOUNDSET_NONE,
    ...
    },
    {
        ...
        1, BRASS_LANTERN, CLR_ORANGE, LOCATION_SOUNDSET_BRAZIER,
    ...
    },
    {
        ...
        {DOODAD_LANTERN_HOLDER, DOODAD_LANTERN_HOLDER, DOODAD_LANTERN_HOLDER, DOODAD_LANTERN_HOLDER},
        1, BRASS_LANTERN, CLR_YELLOW, LOCATION_SOUNDSET_BRAZIER,
        DECORATION_TYPE_FLAGS_LOOTABLE | DECORATION_TYPE_FLAGS_LIGHTABLE | DECORATION_TYPE_FLAGS_UNDERSCORE | DECORATION_TYPE_FLAGS_ALL_SIDES
    },
};
