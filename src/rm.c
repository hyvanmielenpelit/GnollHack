...
struct door_subtype_definition door_subtype_defintions[MAX_DOOR_SUBTYPES] =
{
    ...
    {"magic door",           "door", MAT_MINERAL, LOCATION_SOUNDSET_NONE, DSTFLAGS_MASTER_KEY_OPENS | DSTFLAGS_BLOCKS_VISION | DSTFLAGS_BLOCKS_SOUND | DSTFLAGS_BLOCKS_PROJECTILES},
    {"windowed magic door",  "door", MAT_MINERAL, LOCATION_SOUNDSET_NONE, DSTFLAGS_MASTER_KEY_OPENS},
    {"alien door",           "door", MAT_MODRONITE, LOCATION_SOUNDSET_NONE, DSTFLAGS_BLOCKS_VISION | DSTFLAGS_BLOCKS_SOUND | DSTFLAGS_BLOCKS_PROJECTILES},
    {"reinforced door",      "door", MAT_METAL, LOCATION_SOUNDSET_NONE, DSTFLAGS_BLOCKS_VISION | DSTFLAGS_BLOCKS_SOUND | DSTFLAGS_BLOCKS_PROJECTILES},
