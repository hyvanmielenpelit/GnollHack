...
struct tree_subtype_definition tree_subtype_definitions[MAX_TREE_SUBTYPES] =
{
    ...
    {"fig tree",      "tree",
        TREE_SUBTYPE_FIG_VARIATIONS, TREE_SUBTYPE_BANANA_VARIATIONS + TREE_SUBTYPE_APPLE_VARIATIONS + TREE_SUBTYPE_DATE_PALM_VARIATIONS + TREE_SUBTYPE_FIR_VARIATIONS + TREE_SUBTYPE_SPRUCE_VARIATIONS + TREE_SUBTYPE_NORMAL_VARIATIONS,
        TREE_CLASS_DECIDUOUS,
        {1, 2, 0, 2, 0, 5, 0, 0, 0, 0},
    ...
    {"orange tree",      "tree",
        TREE_SUBTYPE_ORANGE_VARIATIONS, TREE_SUBTYPE_FIG_VARIATIONS + TREE_SUBTYPE_BANANA_VARIATIONS + TREE_SUBTYPE_APPLE_VARIATIONS + TREE_SUBTYPE_DATE_PALM_VARIATIONS + TREE_SUBTYPE_FIR_VARIATIONS + TREE_SUBTYPE_SPRUCE_VARIATIONS + TREE_SUBTYPE_NORMAL_VARIATIONS,
        TREE_CLASS_DECIDUOUS,
        {0, 1, 0, 10, 0, 10, 0, 0, 0, 0},
        ORANGE, 2, 6, 0, 50, 1, 3, 0,  -1, -1,
        TREE_FLAGS_MAY_HAVE_KILLER_BEES,
    },
    {"pitaya plant",      "tree",
        TREE_SUBTYPE_PITAYA_VARIATIONS, TREE_SUBTYPE_ORANGE_VARIATIONS + TREE_SUBTYPE_BANANA_VARIATIONS + TREE_SUBTYPE_APPLE_VARIATIONS + TREE_SUBTYPE_DATE_PALM_VARIATIONS + TREE_SUBTYPE_FIR_VARIATIONS + TREE_SUBTYPE_SPRUCE_VARIATIONS + TREE_SUBTYPE_NORMAL_VARIATIONS,
        TREE_CLASS_DECIDUOUS,
        {1, 2, 0, 2, 0, 5, 0, 0, 0, 0},
