...
const struct doodad_definition simple_doodads[MAX_SIMPLE_DOODAD_TILES] =
{
    ...
    {"carpet-beige-tlcorn", 0, NO_REPLACEMENT, NO_ANIMATION, NO_ENLARGEMENT},
    {"carpet-beige-blcorn", 0, NO_REPLACEMENT, NO_ANIMATION, NO_ENLARGEMENT},
    {"carpet-beige-trcorn", 0, NO_REPLACEMENT, NO_ANIMATION, NO_ENLARGEMENT},
    {"carpet-beige-brcorn", 0, NO_REPLACEMENT, NO_ANIMATION, NO_ENLARGEMENT},
    {"carpet-beige-left", 0, NO_REPLACEMENT, NO_ANIMATION, NO_ENLARGEMENT},
    {"carpet-beige-right", 0, NO_REPLACEMENT, NO_ANIMATION, NO_ENLARGEMENT},
    {"carpet-beige-top", 0, NO_REPLACEMENT, NO_ANIMATION, NO_ENLARGEMENT},
    {"carpet-beige-bottom", 0, NO_REPLACEMENT, NO_ANIMATION, NO_ENLARGEMENT},
    {"carpet-beige-middle", 0, NO_REPLACEMENT, NO_ANIMATION, NO_ENLARGEMENT},
    {"carpet-blue-tlcorn", 0, NO_REPLACEMENT, NO_ANIMATION, NO_ENLARGEMENT},
    {"carpet-blue-blcorn", 0, NO_REPLACEMENT, NO_ANIMATION, NO_ENLARGEMENT},
    {"carpet-blue-trcorn", 0, NO_REPLACEMENT, NO_ANIMATION, NO_ENLARGEMENT},
    {"carpet-blue-brcorn", 0, NO_REPLACEMENT, NO_ANIMATION, NO_ENLARGEMENT},
    {"carpet-blue-left", 0, NO_REPLACEMENT, NO_ANIMATION, NO_ENLARGEMENT},
    {"carpet-blue-right", 0, NO_REPLACEMENT, NO_ANIMATION, NO_ENLARGEMENT},
    {"carpet-blue-top", 0, NO_REPLACEMENT, NO_ANIMATION, NO_ENLARGEMENT},
...
const struct decoration_type_definition decoration_type_definitions[MAX_DECORATIONS] = {
    {
...
get_initial_location_subtype(int ltype)
{
    ...
    case TREE:
        ...
        break;
    case GRASS:
        if (get_flag(level.flags.bitflags, LEVEL_BITFLAGS_SWAMPY))
            res = GRASS_SUBTYPE_SWAMPY;
        else
            res = GRASS_SUBTYPE_NORMAL;
        break;
    case GROUND:
        if (get_flag(level.flags.bitflags, LEVEL_BITFLAGS_DESERT))
            res = GROUND_SUBTYPE_DESERT_SAND;
        else if (get_flag(level.flags.bitflags, LEVEL_BITFLAGS_SWAMPY))
