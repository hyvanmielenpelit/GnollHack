...
NEARDATA struct decoration_type_definition decoration_type_definitions[MAX_DECORATIONS] = {
    ...
    },
    {
        ...
        DOODAD_COBWEB_NORMAL, 1, BRASS_LANTERN, NO_COLOR, LOCATION_SOUNDSET_BRAZIER, 
        NO_ANIMATION, NO_ENLARGEMENT, NO_REPLACEMENT, 
        DECORATION_TYPE_FLAGS_LOOTABLE | DECORATION_TYPE_FLAGS_LIGHTABLE | DECORATION_TYPE_FLAGS_MIRRORABLE | DECORATION_TYPE_FLAGS_UNDERSCORE | DECORATION_TYPE_FLAGS_ALL_SIDES
    },
    {
