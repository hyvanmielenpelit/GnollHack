...
{
    {"wooden door",          MAT_WOOD, LOCATION_SOUNDSET_NONE, DSTFLAGS_CREDIT_CARD_OPENS | DSTFLAGS_LOCK_PICK_OPENS | DSTFLAGS_MASTER_KEY_OPENS | DSTFLAGS_BLOCKS_VISION | DSTFLAGS_BLOCKS_SOUND | DSTFLAGS_BLOCKS_PROJECTILES | DSTFLAGS_BROKEN_BY_KICKING},
    {"windowed wooden door", MAT_WOOD, LOCATION_SOUNDSET_NONE, DSTFLAGS_CREDIT_CARD_OPENS | DSTFLAGS_LOCK_PICK_OPENS | DSTFLAGS_MASTER_KEY_OPENS | DSTFLAGS_BROKEN_BY_KICKING },
    {"iron door",            MAT_IRON, LOCATION_SOUNDSET_NONE, DSTFLAGS_CREDIT_CARD_OPENS | DSTFLAGS_LOCK_PICK_OPENS | DSTFLAGS_MASTER_KEY_OPENS | DSTFLAGS_BLOCKS_VISION | DSTFLAGS_BLOCKS_SOUND | DSTFLAGS_BLOCKS_PROJECTILES},
    {"windowed iron door",   MAT_IRON, LOCATION_SOUNDSET_NONE, DSTFLAGS_CREDIT_CARD_OPENS | DSTFLAGS_LOCK_PICK_OPENS | DSTFLAGS_MASTER_KEY_OPENS },
    {"iron bar door",        MAT_IRON, LOCATION_SOUNDSET_NONE, DSTFLAGS_CREDIT_CARD_OPENS | DSTFLAGS_LOCK_PICK_OPENS | DSTFLAGS_MASTER_KEY_OPENS },
    {"magic door",           MAT_MINERAL, LOCATION_SOUNDSET_NONE, DSTFLAGS_MASTER_KEY_OPENS | DSTFLAGS_BLOCKS_VISION | DSTFLAGS_BLOCKS_SOUND | DSTFLAGS_BLOCKS_PROJECTILES},
    {"windowed magic door",  MAT_MINERAL, LOCATION_SOUNDSET_NONE, DSTFLAGS_MASTER_KEY_OPENS},
    {"alien door",           MAT_MODRONITE, LOCATION_SOUNDSET_NONE, DSTFLAGS_BLOCKS_VISION | DSTFLAGS_BLOCKS_SOUND | DSTFLAGS_BLOCKS_PROJECTILES},
    {"reinforced door",      MAT_METAL, LOCATION_SOUNDSET_NONE, DSTFLAGS_BLOCKS_VISION | DSTFLAGS_BLOCKS_SOUND | DSTFLAGS_BLOCKS_PROJECTILES},
    {"stone door",           MAT_MINERAL, LOCATION_SOUNDSET_NONE, DSTFLAGS_BLOCKS_VISION | DSTFLAGS_BLOCKS_SOUND | DSTFLAGS_BLOCKS_PROJECTILES},
    {"massive gate",         MAT_MINERAL, LOCATION_SOUNDSET_NONE, DSTFLAGS_BLOCKS_VISION | DSTFLAGS_BLOCKS_SOUND | DSTFLAGS_BLOCKS_PROJECTILES},
    {"portcullis",           MAT_METAL, LOCATION_SOUNDSET_NONE, DSTFLAGS_NONE},
};
