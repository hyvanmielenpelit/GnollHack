...
struct door_subtype_definition door_subtype_definitions[MAX_DOOR_SUBTYPES] =
{
    ...
    {"obsidian door",        "door", MAT_MINERAL, LOCATION_SOUNDSET_NONE, DSTFLAGS_NO_LOCK_DESCRIPTION_IS_DEFAULT | DSTFLAGS_BLOCKS_VISION_AND_SOUND | DSTFLAGS_BLOCKS_PROJECTILES},
    {"black gate",           "gate", MAT_METAL, LOCATION_SOUNDSET_NONE, DSTFLAGS_BLOCKS_VISION_AND_SOUND},
};
