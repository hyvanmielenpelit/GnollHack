...
NEARDATA struct permonst mons[] = {
	...
	MON("gnoll", S_GNOLL, LVL(3, 9, 8, 0, -4), (G_GENO | G_LGROUP | 2),
		A(ATTK(AT_WEAP, AD_PHYS, 1, 8, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
			NO_ATTK),
		SIZ(900, 200, MS_BARK, MZ_HUMAN), 0, 0, M1_HUMANOID | M1_CARNIVORE,
	...
	MON("gnoll lord", S_GNOLL, LVL(4, 9, 7, 0, -5), (G_GENO | 2),
		A(ATTK(AT_WEAP, AD_PHYS, 1, 10, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
			NO_ATTK),
		SIZ(900, 250, MS_BARK, MZ_HUMAN), 0, 0, M1_HUMANOID | M1_CARNIVORE,
		M2_GNOLL | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_COLLECT,
	...
	MON("gnoll king", S_GNOLL, LVL(8, 9, 7, 0, -6), (G_GENO | 1),
		A(ATTK(AT_WEAP, AD_PHYS, 2, 8, 0), ATTK(AT_WEAP, AD_PHYS, 2, 8, 0), NO_ATTK,
			NO_ATTK, NO_ATTK, NO_ATTK),
		SIZ(900, 350, MS_BARK, MZ_HUMAN), 0, 0, M1_HUMANOID | M1_CARNIVORE,
		M2_GNOLL | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_COLLECT,
	...
	MON("flind lord", S_GNOLL, LVL(16, 10, -3, 40, -12), (G_GENO | 1),
		A(ATTK(AT_WEAP, AD_PHYS, 3, 8, 0), ATTK(AT_WEAP, AD_PHYS, 3, 8, 0), NO_ATTK,
			NO_ATTK, NO_ATTK, NO_ATTK),
		SIZ(900, 400, MS_BARK, MZ_HUMAN), MR_FIRE | MR_POISON, 0, M1_HUMANOID | M1_CARNIVORE | M1_SEE_INVIS,
    ...
    MON("imp", S_IMP, LVL(3, 12, 2, 20, -7), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(20, 10, MS_CUSS, MZ_TINY), 0, 0, M1_REGEN, M2_DEMON | M2_WANDER | M2_STALK,
        M3_INFRAVISIBLE | M3_INFRAVISION, 4, CLR_RED),
...
struct permonst _mons2[] = {
	...
	(G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 8, 0), NO_ATTK,
		NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
		SIZ(900, 75, MS_SILENT, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON, 0,
		M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("Yeenoghu", S_DEMON, LVL(56, 18, -5, 80, -15),
        ...
        A(ATTK(AT_WEAP, AD_PHYS, 3, 6, 0), ATTK(AT_WEAP, AD_CONF, 2, 8, 0),
          ...
          NO_ATTK),
        SIZ(900, 500, MS_BRIBE, MZ_LARGE), MR_FIRE | MR_POISON, 0,
        M1_FLY | M1_SEE_INVIS | M1_POIS,
        M2_NOPOLY | M2_DEMON | M2_STALK | M2_HOSTILE | M2_PNAME | M2_NASTY
            | M2_LORD | M2_MALE | M2_COLLECT,
