...
NEARDATA struct permonst mons[] = {
    ...
    MON("floating eye", S_EYE, LVL(2, 1, 9, 10, 0), (G_GENO | 5),
        A(ATTK(AT_NONE, AD_PLYS, 3, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK),
        SIZ(10, 10, MS_SILENT, MZ_SMALL), 0, 0,
	...
	MON("gnomish wizard", S_GNOLL, LVL(3, 10, 4, 10, 0), (G_GENO | 1),
		A(ATTK(AT_MAGC, AD_SPEL, 0, 0), ATTK(AT_WEAP, AD_PHYS, 1, 4), NO_ATTK, NO_ATTK, NO_ATTK,
			NO_ATTK),
		SIZ(700, 120, MS_ORC, MZ_SMALL), 0, 0, M1_HUMANOID | M1_OMNIVORE,
	...
	MON("gnoll warden", S_GNOLL, LVL(5, 10, 2, 0, -7), (G_GENO | 1),
		A(ATTK(AT_MAGC, AD_CLRC, 0, 0), ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK,
			NO_ATTK),
	...
	MON("gnoll king", S_GNOLL, LVL(8, 9, 7, 0, -6), (G_GENO | 1),
		A(ATTK(AT_WEAP, AD_PHYS, 2, 8), ATTK(AT_WEAP, AD_PHYS, 2, 8), NO_ATTK,
			NO_ATTK, NO_ATTK, NO_ATTK),
	...
	MON("flind", S_GNOLL, LVL(12, 10, -2, 30, -8), (G_GENO | 1),
		A(ATTK(AT_WEAP, AD_PHYS, 2, 10), ATTK(AT_WEAP, AD_PHYS, 2, 10), NO_ATTK,
			NO_ATTK, NO_ATTK, NO_ATTK),
...
struct permonst _mons2[] = {
	...
	(G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 8), NO_ATTK,
		NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
