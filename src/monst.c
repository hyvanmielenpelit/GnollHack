...
#define SEDUCTION_ATTACKS_NO                                      \
	...
	//GNOLLS
			  ...
			  MON("gnoll", S_GNOLL, LVL(2, 9, 10, 0, -4), (G_GENO | G_LGROUP | 2),
				  A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
					  NO_ATTK),
				  SIZ(1000, 200, MS_ORC, MZ_HUMAN), 0, 0, M1_HUMANOID | M1_CARNIVORE,
				  M2_GNOLL | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_COLLECT,
				  M3_INFRAVISIBLE | M3_INFRAVISION, 4, CLR_YELLOW),
			  MON("gnoll lord", S_GNOLL, LVL(3, 5, 10, 0, -5), (G_GENO | G_LGROUP | 1),
				  A(ATTK(AT_WEAP, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
					  NO_ATTK),
				  SIZ(1200, 200, MS_ORC, MZ_HUMAN), 0, 0, M1_HUMANOID | M1_CARNIVORE,
				  M2_GNOLL | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_COLLECT,
				  M3_INFRAVISIBLE | M3_INFRAVISION, 5, CLR_BRIGHT_BLUE),
			MON("gnoll king", S_GNOLL, LVL(5, 5, 10, 0, -5), (G_GENO | 1),
				A(ATTK(AT_WEAP, AD_PHYS, 2, 4), ATTK(AT_WEAP, AD_PHYS, 2, 4), NO_ATTK,
					NO_ATTK, NO_ATTK, NO_ATTK),
				SIZ(1350, 350, MS_ORC, MZ_HUMAN), 0, 0, M1_HUMANOID | M1_CARNIVORE,
				M2_GNOLL | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_COLLECT,
				M3_INFRAVISIBLE | M3_INFRAVISION, 7, HI_LORD),
		
			  MON("gnoll mummy", S_MUMMY, LVL(5, 10, 5, 20, -4),
			  (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 6), NO_ATTK,
				  NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
				  SIZ(850, 75, MS_SILENT, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON, 0,
				  M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
			...
			MON("gnoll zombie", S_ZOMBIE, LVL(2, 6, 9, 0, -3),
			(G_GENO | G_SGROUP | G_NOCORPSE | 1),
				A(ATTK(AT_CLAW, AD_PHYS, 1, 6), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
					NO_ATTK),
				SIZ(850, 75, MS_SILENT, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON, 0,
