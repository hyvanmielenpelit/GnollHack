...
NEARDATA struct permonst mons[] = {
    ...
    MON("lurker above", S_TRAPPER, LVL(10, 3, 3, 0, 0), (G_GENO | 2),
        A(ATTK(AT_ENGL, AD_DGST, 1, 8, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(800, 350, MS_SILENT, MZ_HUGE), STATS(18+100, 7, 18, 4, 4, 1), 0, 0,
    ...
    MON("long worm", S_WORM, LVL(9, 3, 5, 10, 0), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 4, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 500, MS_SILENT, MZ_GIGANTIC), STATS(100+20, 7, 20, 1, 1, 1), 0, 0,
...
struct permonst _mons2[] = {
    ...
    MON("green slime", S_PUDDING, LVL(6, 6, 6, 0, 0),
        ...
        A(ATTK(AT_TUCH, AD_SLIM, 1, 4, 0), ATTK(AT_NONE, AD_SLIM, 0, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 150, MS_SILENT, MZ_LARGE), STATS(15, 7, 18, 1, 1, 1),
    ...
    MON("black pudding", S_PUDDING, LVL(10, 6, 6, 0, 0),
        ...
        A(ATTK(AT_BITE, AD_CORR, 3, 8, 0), ATTK(AT_NONE, AD_CORR, 0, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(900, 250, MS_SILENT, MZ_LARGE), STATS(15, 7, 18, 1, 1, 1),
        MR_COLD | MR_ELEC | MR_POISON | MR_ACID | MR_STONE,
        MR_COLD | MR_ELEC | MR_POISON,
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS | M1_OMNIVORE | M1_ACID,
    ...
    MON("vampire mage", S_VAMPIRE, LVL(11, 13, 0, 55, -9),
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6, 0), ATTK(AT_BITE, AD_DRLI, 1, 6, 0), ATTK(AT_MAGC, AD_SPEL, 0, 0, 0),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_VAMPIRE, MZ_HUMAN), STATS(18 + 100, 14, 18, 18, 15, 16), MR_SLEEP | MR_POISON, 0,
        M1_FLY | M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
        M2_UNDEAD | M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY
            | M2_SHAPESHIFTER,
