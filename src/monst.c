...
NEARDATA struct permonst mons[] = {
	...
	MON("gnoll lord", S_GNOLL, LVL(4, 9, 7, 0, -5), (G_GENO | G_LGROUP | 1),
		A(ATTK(AT_WEAP, AD_PHYS, 1, 10), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
			NO_ATTK),
		SIZ(1200, 250, MS_BARK, MZ_HUMAN), 0, 0, M1_HUMANOID | M1_CARNIVORE,
	...
	MON("gnoll", S_GNOLL, LVL(3, 9, 8, 0, -4), (G_GENO | G_LGROUP | 2),
		A(ATTK(AT_WEAP, AD_PHYS, 1, 8), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
			NO_ATTK),
		SIZ(1000, 200, MS_BARK, MZ_HUMAN), 0, 0, M1_HUMANOID | M1_CARNIVORE,
		M2_GNOLL | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_COLLECT,
	...
	(G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 8), NO_ATTK,
		NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
		SIZ(1000, 75, MS_SILENT, MZ_HUMAN), MR_COLD | MR_SLEEP | MR_POISON, 0,
	...
	MON("gnoll king", S_GNOLL, LVL(8, 9, 7, 0, -6), (G_GENO | 1),
		A(ATTK(AT_WEAP, AD_PHYS, 2, 8), ATTK(AT_WEAP, AD_PHYS, 2, 8), NO_ATTK,
			NO_ATTK, NO_ATTK, NO_ATTK),
		SIZ(1350, 350, MS_BARK, MZ_HUMAN), 0, 0, M1_HUMANOID | M1_CARNIVORE,
		M2_GNOLL | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_COLLECT,
		M3_INFRAVISIBLE, 8, CLR_RED), //  | M3_INFRAVISION
