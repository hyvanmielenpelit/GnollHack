...
NEARDATA struct permonst mons[] = {
    ...
    MON("acid blob", S_BLOB, LVL(1, 3, 8, 0, 0), (G_GENO | 2),
        A(ATTK(AT_NONE, AD_ACID, 1, 8, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(30, 10, MS_SILENT, MZ_TINY), STATS(1, 1, 1, 1, 1, 1),
    ...
    MON("quivering blob", S_BLOB, LVL(5, 1, 8, 0, 0), (G_GENO | 2),
        A(ATTK(AT_TUCH, AD_PHYS, 1, 8, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(200, 100, MS_SILENT, MZ_SMALL), STATS(6, 1, 6, 1, 1, 1), MR_SLEEP | MR_POISON, MR_POISON,
    ...
    MON("gelatinous cube", S_BLOB, LVL(6, 6, 8, 0, 0), (G_GENO | 2),
        A(ATTK(AT_TUCH, AD_PLYS, 2, 4, 0), ATTK(AT_NONE, AD_PLYS, 1, 4, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 150, MS_SILENT, MZ_LARGE), STATS(12, 1, 20, 1, 1, 1),
    ...
    MON("gas spore", S_EYE, LVL(1, 3, 10, 0, 0), (G_NOCORPSE | G_GENO | 1),
        A(ATTK(AT_BOOM, AD_PHYS, 4, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(10, 10, MS_SILENT, MZ_SMALL), STATS(1, 1, 1, 1, 1, 1), 0, 0,
    ...
    MON("floating eye", S_EYE, LVL(2, 1, 9, 10, 0), (G_GENO | 5),
        A(ATTK(AT_NONE, AD_PLYS, 3, 8, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(10, 10, MS_SILENT, MZ_SMALL), STATS(1, 1, 1, 15, 1, 1), 0, 0,
    ...
    MON("freezing sphere", S_EYE, LVL(6, 13, 4, 0, 0),
        ...
        A(ATTK(AT_EXPL, AD_COLD, 4, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(10, 10, MS_SILENT, MZ_SMALL), STATS(1, 1, 1, 1, 1, 1), MR_COLD, MR_COLD,
        M1_FLY | M1_BREATHLESS | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
    ...
    MON("flaming sphere", S_EYE, LVL(6, 13, 4, 0, 0),
        ...
        SIZ(10, 10, MS_SILENT, MZ_SMALL), STATS(1, 1, 1, 1, 1, 1), MR_FIRE, MR_FIRE,
        M1_FLY | M1_BREATHLESS | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
    ...
    MON("shocking sphere", S_EYE, LVL(6, 13, 4, 0, 0),
        (G_NOCORPSE | G_GENO | 2), A(ATTK(AT_EXPL, AD_ELEC, 4, 6, 0), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(10, 10, MS_SILENT, MZ_SMALL), STATS(1, 1, 1, 1, 1, 1), MR_ELEC, MR_ELEC,
        M1_FLY | M1_BREATHLESS | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
	...
	MON("gnoll", S_GNOLL, LVL(3, 9, 8, 0, -4), (G_GENO | G_LGROUP | 2),
		...
		M2_GNOLL | M2_STRONG | M2_GREEDY | M2_JEWELS | M2_COLLECT,
	...
	MON("flind lord", S_GNOLL, LVL(16, 10, -3, 40, -12), (G_GENO | 1),
		...
		M2_GNOLL | M2_DEMON | M2_STALK | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_COLLECT,
    ...
    MON("blue jelly", S_JELLY, LVL(4, 0, 8, 10, 0), (G_GENO | 2),
        A(ATTK(AT_NONE, AD_COLD, 0, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(50, 20, MS_SILENT, MZ_MEDIUM), STATS(12, 1, 12, 1, 1, 1), MR_COLD | MR_POISON,
        MR_COLD | MR_POISON,
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
    ...
    MON("spotted jelly", S_JELLY, LVL(5, 0, 8, 10, 0), (G_GENO | 1),
        A(ATTK(AT_NONE, AD_ACID, 0, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(50, 20, MS_SILENT, MZ_MEDIUM), STATS(12, 1, 12, 1, 1, 1), MR_ACID | MR_STONE, 0,
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
    ...
    MON("ochre jelly", S_JELLY, LVL(6, 3, 8, 20, 0), (G_GENO | 2),
        A(ATTK(AT_ENGL, AD_ACID, 3, 6, 0), ATTK(AT_NONE, AD_ACID, 3, 6, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(50, 20, MS_SILENT, MZ_MEDIUM), STATS(15, 1, 15, 1, 1, 1), MR_ACID | MR_STONE, 0,
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS | M1_ACID | M1_NOTAKE,
    ...
    MON("rock piercer", S_PIERCER, LVL(3, 1, 3, 0, 0), (G_GENO | 4),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(200, 200, MS_SILENT, MZ_SMALL), STATS(6, 1, 9, 1, 1, 1), 0, 0,
    ...
    MON("iron piercer", S_PIERCER, LVL(5, 1, 0, 0, 0), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 3, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 300, MS_SILENT, MZ_MEDIUM), STATS(9, 1, 10, 1, 1, 1), 0, 0,
        M1_CLING | M1_HIDE | M1_ANIMAL | M1_NOEYES | M1_NOLIMBS | M1_CARNIVORE
            | M1_NOTAKE,
    ...
    MON("glass piercer", S_PIERCER, LVL(7, 1, 0, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 4, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 300, MS_SILENT, MZ_MEDIUM), STATS(12, 1, 12, 1, 1, 1), MR_ACID, 0,
        M1_CLING | M1_HIDE | M1_ANIMAL | M1_NOEYES | M1_NOLIMBS | M1_CARNIVORE
            | M1_NOTAKE,
    ...
    MON("mumak", S_QUADRUPED, LVL(5, 9, 0, 0, -2), (G_GENO | 1),
        A(ATTK(AT_BUTT, AD_PHYS, 4, 12, 0), ATTK(AT_BITE, AD_PHYS, 2, 6, 0),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2500, 500, MS_ROAR, MZ_LARGE), STATS(18, 9, 18, 2, 2, 1), 0, 0,
    ...
    MON("wumpus", S_QUADRUPED, LVL(8, 3, 2, 10, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 3, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2500, 500, MS_BURBLE, MZ_LARGE), STATS(100+19, 9, 18, 2, 2, 1), 0, 0,
    ...
    MON("titanothere", S_QUADRUPED, LVL(12, 12, 6, 0, 0), (G_GENO | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 8, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2650, 650, MS_SILENT, MZ_LARGE), STATS(100 + 20, 9, 18, 2, 2, 1), 0, 0,
        M1_ANIMAL | M1_THICK_HIDE | M1_NOHANDS | M1_HERBIVORE,
    ...
    MON("baluchitherium", S_QUADRUPED, LVL(14, 12, 5, 0, 0), (G_GENO | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 5, 4, 0), ATTK(AT_CLAW, AD_PHYS, 5, 4, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(3800, 800, MS_SILENT, MZ_LARGE), STATS(100 + 22, 9, 18, 2, 2, 1), 0, 0,
        M1_ANIMAL | M1_THICK_HIDE | M1_NOHANDS | M1_HERBIVORE,
    ...
    MON("mastodon", S_QUADRUPED, LVL(20, 12, 5, 0, 0), (G_GENO | 1),
        A(ATTK(AT_BUTT, AD_PHYS, 4, 8, 0), ATTK(AT_BUTT, AD_PHYS, 4, 8, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(3800, 800, MS_SILENT, MZ_LARGE), STATS(100 + 24, 9, 18, 2, 2, 1), 0, 0,
        M1_ANIMAL | M1_THICK_HIDE | M1_NOHANDS | M1_HERBIVORE,
    ...
    MON("lurker above", S_TRAPPER, LVL(10, 3, 3, 0, 0), (G_GENO | 2),
        A(ATTK(AT_ENGL, AD_DGST, 1, 8, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(800, 350, MS_SILENT, MZ_HUGE), STATS(18+100, 6, 18, 4, 4, 1), 0, 0,
    ...
    MON("pony", S_UNICORN, LVL(3, 16, 6, 0, 0), (G_GENO | 2),
        A(ATTK(AT_KICK, AD_PHYS, 1, 6, 0), ATTK(AT_BITE, AD_PHYS, 1, 2, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1300, 250, MS_NEIGH, MZ_MEDIUM), STATS(18 + 51, 9, 15, 2, 2, 2), 0, 0,
    ...
    MON("horse", S_UNICORN, LVL(5, 20, 5, 0, 0), (G_GENO | 2),
        A(ATTK(AT_KICK, AD_PHYS, 1, 8, 0), ATTK(AT_BITE, AD_PHYS, 1, 3, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 300, MS_NEIGH, MZ_LARGE), STATS(18 + 100, 14, 19, 2, 2, 2), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_HERBIVORE,
    ...
    MON("warhorse", S_UNICORN, LVL(7, 24, 4, 0, 0), (G_GENO | 2),
        A(ATTK(AT_KICK, AD_PHYS, 1, 10, 0), ATTK(AT_BITE, AD_PHYS, 1, 4, 0),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1800, 350, MS_NEIGH, MZ_LARGE), STATS(100+19, 11, 18, 2, 2, 2), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_HERBIVORE,
    ...
    MON("baby long worm", S_WORM, LVL(5, 3, 5, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 250, MS_SILENT, MZ_LARGE), STATS(18, 5, 15, 1, 1, 1), 0, 0,
    ...
    MON("baby purple worm", S_WORM, LVL(8, 3, 5, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(600, 250, MS_SILENT, MZ_LARGE), STATS(18, 5, 16, 1, 1, 1), 0, 0,
        M1_ANIMAL | M1_SLITHY | M1_NOLIMBS | M1_CARNIVORE, M2_HOSTILE, 0,
        9, CLR_MAGENTA),
    MON("long worm", S_WORM, LVL(9, 3, 5, 10, 0), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 4, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 500, MS_SILENT, MZ_GIGANTIC), STATS(100+20, 6, 20, 1, 1, 1), 0, 0,
    ...
    MON("purple worm", S_WORM, LVL(15, 9, 6, 20, 0), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 2, 8, 0), ATTK(AT_ENGL, AD_DGST, 1, 10, 0),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2700, 700, MS_SILENT, MZ_GIGANTIC), STATS(100+25, 7, 23, 1, 1, 1), 0, 0,
        M1_ANIMAL | M1_SLITHY | M1_NOLIMBS | M1_OVIPAROUS | M1_CARNIVORE,
    ...
    MON("grid bug", S_XAN, LVL(0, 12, 9, 0, 0),
        ...
        A(ATTK(AT_BITE, AD_ELEC, 1, 1, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(15, 10, MS_BUZZ, MZ_TINY), STATS(1, 6, 1, 1, 1, 1), MR_ELEC | MR_POISON, 0, M1_ANIMAL,
    ...
    MON("zruty", S_ZRUTY, LVL(9, 8, 3, 0, 0), (G_GENO | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 3, 4, 0), ATTK(AT_CLAW, AD_PHYS, 3, 4, 0),
          ATTK(AT_BITE, AD_PHYS, 3, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1200, 600, MS_SILENT, MZ_LARGE), STATS(19+100, 11, 18, 2, 2, 1), 0, 0,
    ...
    MON("couatl", S_ANGEL, LVL(8, 10, 5, 30, 7),
        ...
        SIZ(900, 400, MS_HISS, MZ_LARGE), STATS(18 + 100, 19, 18, 18, 19, 20), MR_POISON, 0,
    ...
    MON("Aleax", S_ANGEL, LVL(10, 8, 0, 30, 7), (G_NOHELL | G_NOCORPSE | 1),
        ...
        SIZ(WT_HUMAN, 400, MS_IMITATE, MZ_HUMAN), STATS(19 + 100, 17, 18, 18, 20, 21),
    ...
    MON("Angel", S_ANGEL, LVL(14, 10, -4, 55, 12),
        ...
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6, 0), ATTK(AT_WEAP, AD_PHYS, 1, 6, 0),
          ...
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_CUSS, MZ_HUMAN), STATS(20 + 100, 18, 19, 18, 21, 22),
        MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON, 0,
    ...
    MON("ki-rin", S_ANGEL, LVL(16, 18, -5, 90, 15),
        ...
        A(ATTK(AT_KICK, AD_PHYS, 2, 4, 0), ATTK(AT_KICK, AD_PHYS, 2, 4, 0),
          ...
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_NEIGH, MZ_LARGE), STATS(19 + 100, 16, 19, 24, 21, 23), 0, 0,
    ...
    MON("Archon", S_ANGEL, LVL(19, 16, -6, 80, 15),
        ...
        SIZ(WT_HUMAN, 400, MS_CUSS, MZ_LARGE), STATS(24 + 100, 20, 23, 20, 22, 24),
    ...
    MON("baby gray dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), STATS(19 + 100, 15, 17, 14, 14, 9), 0, 0,
    ...
    MON("baby red dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), STATS(19 + 100, 15, 17, 14, 14, 9), MR_FIRE, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_CARNIVORE,
    ...
    MON("baby yellow dragon", S_DRAGON, LVL(12, 9, 2, 10, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 2, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 500, MS_ROAR, MZ_HUGE), STATS(19 + 100, 15, 17, 14, 14, 9), MR_ACID | MR_STONE, 0,
    ...
    MON("gray dragon", S_DRAGON, LVL(15, 9, -1, 20, 4), (G_GENO | 1),
        A(ATTK(AT_BREA, AD_MAGM, 4, 6, 0), ATTK(AT_BITE, AD_PHYS, 3, 8, 0),
          ...
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_DRAGON, 1500, MS_ROAR, MZ_GIGANTIC), STATS(25 + 100, 18, 20, 19, 16, 18), 0, 0,
    ...
    MON("silver dragon", S_DRAGON, LVL(15, 9, -1, 20, 4), (G_GENO | 1),
        A(ATTK(AT_BREA, AD_COLD, 4, 6, 0), ATTK(AT_BITE, AD_PHYS, 3, 8, 0),
          ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_DRAGON, 1500, MS_ROAR, MZ_GIGANTIC), STATS(25 + 100, 18, 20, 19, 16, 18), MR_COLD, 0,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 20, DRAGON_SILVER),
    ...
    MON("shimmering dragon", S_DRAGON,
        ...
        A(ATTK(AT_BREA, AD_MAGM, 4, 6, 0), ATTK(AT_BITE, AD_PHYS, 3, 8),
          ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), ATTK(AT_CLAW, AD_PHYS, 1, 4),
    ...
    MON("red dragon", S_DRAGON, LVL(15, 9, -1, 20, -4), (G_GENO | 1),
        A(ATTK(AT_BREA, AD_FIRE, 6, 6, 0), ATTK(AT_BITE, AD_PHYS, 3, 8, 0),
          ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_DRAGON, 1500, MS_ROAR, MZ_GIGANTIC), STATS(25 + 100, 18, 20, 19, 16, 18), MR_FIRE, MR_FIRE,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
    ...
    MON("white dragon", S_DRAGON, LVL(15, 9, -1, 20, -5), (G_GENO | 1),
        A(ATTK(AT_BREA, AD_COLD, 4, 6, 0), ATTK(AT_BITE, AD_PHYS, 3, 8, 0),
          ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_DRAGON, 1500, MS_ROAR, MZ_GIGANTIC), STATS(25 + 100, 18, 20, 19, 16, 18), MR_COLD, MR_COLD,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 20, CLR_WHITE),
    MON("orange dragon", S_DRAGON, LVL(15, 9, -1, 20, 5), (G_GENO | 1),
        A(ATTK(AT_BREA, AD_SLEE, 4, 25, 0), ATTK(AT_BITE, AD_PHYS, 3, 8, 0),
          ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_DRAGON, 1500, MS_ROAR, MZ_GIGANTIC), STATS(25 + 100, 18, 20, 19, 16, 18), MR_SLEEP, MR_SLEEP,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 20, CLR_ORANGE),
    ...
    MON("black dragon", S_DRAGON, LVL(15, 9, -1, 20, -6), (G_GENO | 1),
        A(ATTK(AT_BREA, AD_DISN, 1, 255, 0), ATTK(AT_BITE, AD_PHYS, 3, 8, 0),
          ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_DRAGON, 1500, MS_ROAR, MZ_GIGANTIC), STATS(25 + 100, 18, 20, 19, 16, 18), MR_DISINT, MR_DISINT,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 20, CLR_BLACK),
    MON("blue dragon", S_DRAGON, LVL(15, 9, -1, 20, -7), (G_GENO | 1),
        A(ATTK(AT_BREA, AD_ELEC, 4, 6, 0), ATTK(AT_BITE, AD_PHYS, 3, 8, 0),
          ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_DRAGON, 1500, MS_ROAR, MZ_GIGANTIC), STATS(25 + 100, 18, 20, 19, 16, 18), MR_ELEC, MR_ELEC,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
            | M1_CARNIVORE,
        M2_HOSTILE | M2_STRONG | M2_NASTY | M2_GREEDY | M2_JEWELS | M2_MAGIC,
        0, 20, CLR_BLUE),
    MON("green dragon", S_DRAGON, LVL(15, 9, -1, 20, 6), (G_GENO | 1),
        A(ATTK(AT_BREA, AD_DRST, 4, 6, 0), ATTK(AT_BITE, AD_PHYS, 3, 8, 0),
          ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_DRAGON, 1500, MS_ROAR, MZ_GIGANTIC), STATS(25 + 100, 18, 20, 19, 16, 18), MR_POISON, MR_POISON,
        M1_FLY | M1_THICK_HIDE | M1_NOHANDS | M1_SEE_INVIS | M1_OVIPAROUS
    ...
    MON("yellow dragon", S_DRAGON, LVL(15, 9, -1, 20, 7), (G_GENO | 1),
        A(ATTK(AT_BREA, AD_ACID, 4, 6, 0), ATTK(AT_BITE, AD_PHYS, 3, 8, 0),
          ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_DRAGON, 1500, MS_ROAR, MZ_GIGANTIC), STATS(25 + 100, 18, 20, 19, 16, 18), MR_ACID | MR_STONE,
    ...
    MON("air elemental", S_ELEMENTAL, LVL(8, 36, 2, 30, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_ENGL, AD_PHYS, 1, 10, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(0, 0, MS_SILENT, MZ_HUGE), STATS(19 + 100, 14, 19, 6, 2, 1), MR_POISON | MR_STONE, 0,
    ...
    MON("fire elemental", S_ELEMENTAL, LVL(8, 12, 2, 30, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_FIRE, 3, 6, 0), ATTK(AT_NONE, AD_FIRE, 0, 4, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(0, 0, MS_SILENT, MZ_HUGE), STATS(20 + 100, 14, 19, 6, 2, 1), MR_FIRE | MR_POISON | MR_STONE, 0,
        M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS | M1_BREATHLESS
    ...
    MON("earth elemental", S_ELEMENTAL, LVL(8, 6, 2, 30, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 4, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2500, 0, MS_SILENT, MZ_HUGE), STATS(22 + 100, 12, 20, 6, 2, 1),
    ...
    MON("water elemental", S_ELEMENTAL, LVL(8, 6, 2, 30, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 5, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2500, 0, MS_SILENT, MZ_HUGE), STATS(21 + 100, 13, 19, 6, 2, 1), MR_POISON | MR_STONE, 0,
        M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS | M1_BREATHLESS
    ...
    MON("lichen", S_FUNGUS, LVL(0, 1, 9, 0, 0), (G_GENO | 4),
        A(ATTK(AT_TUCH, AD_STCK, 0, 0, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(20, 200, MS_SILENT, MZ_SMALL), STATS(1, 1, 3, 1, 1, 1), 0, 0,
    ...
    MON("brown mold", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_GENO | 1),
        A(ATTK(AT_NONE, AD_COLD, 0, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(50, 30, MS_SILENT, MZ_SMALL), STATS(1, 1, 6, 1, 1, 1), MR_COLD | MR_POISON,
    ...
    MON("yellow mold", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_GENO | 2),
        A(ATTK(AT_NONE, AD_STUN, 0, 4, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(50, 30, MS_SILENT, MZ_SMALL), STATS(1, 1, 9, 1, 1, 1), MR_POISON, MR_POISON,
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_POIS | M1_NOTAKE,
    ...
    MON("green mold", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_GENO | 1),
        A(ATTK(AT_NONE, AD_ACID, 0, 4, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(50, 30, MS_SILENT, MZ_SMALL), STATS(1, 1, 12, 1, 1, 1), MR_ACID | MR_STONE, MR_STONE,
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_ACID | M1_NOTAKE,
    ...
    MON("red mold", S_FUNGUS, LVL(1, 0, 9, 0, 0), (G_GENO | 1),
        A(ATTK(AT_NONE, AD_FIRE, 0, 4, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(50, 30, MS_SILENT, MZ_SMALL), STATS(1, 1, 15, 1, 1, 1), MR_FIRE | MR_POISON,
    ...
    MON("shrieker", S_FUNGUS, LVL(3, 1, 7, 0, 0), (G_GENO | 1),
        ...
        SIZ(100, 100, MS_SHRIEK, MZ_SMALL), STATS(1, 1, 17, 1, 1, 1), MR_POISON, MR_POISON,
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
    ...
    MON("violet fungus", S_FUNGUS, LVL(3, 1, 7, 0, 0), (G_GENO | 2),
        A(ATTK(AT_TUCH, AD_PHYS, 1, 4, 0), ATTK(AT_TUCH, AD_STCK, 0, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(100, 100, MS_SILENT, MZ_SMALL), STATS(1, 1, 18, 1, 1, 1), MR_POISON, MR_POISON,
        M1_BREATHLESS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD | M1_MINDLESS
            | M1_NOTAKE,
...
struct permonst _mons2[] = {
    ...
    MON("hill giant", S_GIANT, LVL(8, 10, 6, 0, -2), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 8, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2200, 700, MS_BOAST, MZ_HUGE), STATS(19 + 100, 14, 17, 8, 8, 9), 0, 0, M1_HUMANOID | M1_CARNIVORE,
        M2_GIANT | M2_STRONG | M2_ROCKTHROW | M2_NASTY | M2_COLLECT
            | M2_JEWELS,
    ...
    MON("fire giant", S_GIANT, LVL(9, 12, 4, 5, 2), (G_GENO | G_SGROUP | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 10, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2250, 750, MS_BOAST, MZ_HUGE), STATS(22 + 100, 14, 18, 7, 7, 8), MR_FIRE, MR_FIRE,
    ...
    MON("frost giant", S_GIANT, LVL(10, 12, 3, 10, -3),
        ...
        A(ATTK(AT_WEAP, AD_PHYS, 2, 12, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2250, 750, MS_BOAST, MZ_HUGE), STATS(21 + 100, 14, 18, 7, 7, 8), MR_COLD, MR_COLD,
        M1_HUMANOID | M1_CARNIVORE, M2_GIANT | M2_STRONG | M2_ROCKTHROW
                                        | M2_NASTY | M2_COLLECT | M2_JEWELS,
    ...
    MON("storm giant", S_GIANT, LVL(16, 12, 3, 10, -3),
        (G_GENO | G_SGROUP | 1), A(ATTK(AT_WEAP, AD_PHYS, 2, 12, 0), NO_ATTK,
                                   NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2250, 750, MS_BOAST, MZ_HUGE), STATS(24 + 100, 16, 20, 15, 15, 16), MR_ELEC, MR_ELEC,
        M1_HUMANOID | M1_CARNIVORE, M2_GIANT | M2_STRONG | M2_ROCKTHROW
                                        | M2_NASTY | M2_COLLECT | M2_JEWELS,
    ...
    MON("titan", S_GIANT, LVL(16, 18, -3, 70, 9), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 8, 0), ATTK(AT_MAGC, AD_SPEL, 0, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2300, 900, MS_SPELL, MZ_HUGE), STATS(25 + 100, 18, 25, 19, 19, 24), 0, 0,
    ...
    MON("minotaur", S_GIANT, LVL(15, 15, 6, 0, 0), (G_GENO | G_NOGEN),
        ...
        SIZ(1500, 700, MS_SILENT, MZ_LARGE), STATS(25 + 100, 12, 25, 12, 12, 5), 0, 0,
        M1_ANIMAL | M1_HUMANOID | M1_CARNIVORE,
    ...
    MON("jabberwock", S_JABBERWOCK, LVL(15, 12, -2, 50, 0), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 10, 0), ATTK(AT_BITE, AD_PHYS, 2, 10, 0),
          ...
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1300, 600, MS_BURBLE, MZ_LARGE), STATS(24 + 100, 15, 19, 6, 9, 3), 0, 0,
    ...
    MON("lich", S_LICH, LVL(11, 6, 0, 30, -9), (G_GENO | G_NOCORPSE | 1),
        A(ATTK(AT_TUCH, AD_COLD, 1, 10, 0), ATTK(AT_MAGC, AD_SPEL, 0, 0, 0),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1200, 100, MS_MUMBLE, MZ_HUMAN), STATS(15, 9, 18, 19, 15, 9), MR_COLD | MR_SLEEP | MR_POISON,
    ...
    MON("demilich", S_LICH, LVL(14, 9, -2, 60, -12),
        ...
        A(ATTK(AT_TUCH, AD_COLD, 3, 4, 0), ATTK(AT_MAGC, AD_SPEL, 0, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1200, 100, MS_MUMBLE, MZ_HUMAN), STATS(16, 7, 19, 20, 16, 12), MR_COLD | MR_SLEEP | MR_POISON,
        MR_COLD, M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
    ...
    MON("master lich", S_LICH, LVL(17, 9, -4, 90, -15),
        ...
        A(ATTK(AT_TUCH, AD_COLD, 3, 6, 0), ATTK(AT_MAGC, AD_SPEL, 0, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1200, 100, MS_MUMBLE, MZ_HUMAN), STATS(17, 11, 20, 24, 18, 15),
    ...
    MON("arch-lich", S_LICH, LVL(25, 9, -6, 90, -15),
        ...
        A(ATTK(AT_TUCH, AD_COLD, 5, 6, 0), ATTK(AT_MAGC, AD_SPEL, 0, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1200, 100, MS_MUMBLE, MZ_HUMAN), STATS(18, 13, 21, 25, 20, 18),
    ...
    MON("kobold mummy", S_MUMMY, LVL(3, 8, 6, 20, -2),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 50, MS_SILENT, MZ_SMALL), STATS(12, 7, 16, 1, 1, 1), MR_COLD | MR_SLEEP | MR_POISON, 0,
    ...
    MON("gnome mummy", S_MUMMY, LVL(4, 10, 6, 20, -3),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 6, 0), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(650, 50, MS_SILENT, MZ_SMALL), STATS(14, 7, 17, 1, 1, 1), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
	...
	(G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 8, 0), NO_ATTK,
		NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
		SIZ(900, 75, MS_SILENT, MZ_HUMAN), STATS(18 + 100, 8, 18, 1, 1, 1), MR_COLD | MR_SLEEP | MR_POISON, 0,
		M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
    ...
    MON("orc mummy", S_MUMMY, LVL(5, 10, 5, 20, -4),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 6, 0), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(850, 75, MS_SILENT, MZ_HUMAN), STATS(18 + 100, 8, 18, 1, 1, 1), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
    ...
    MON("dwarf mummy", S_MUMMY, LVL(5, 10, 5, 20, -4),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 6, 0), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(900, 150, MS_SILENT, MZ_HUMAN), STATS(18 + 91, 8, 18, 1, 1, 1), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
    ...
    MON("elf mummy", S_MUMMY, LVL(6, 12, 4, 30, -5),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 2, 4, 0), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 175, MS_SILENT, MZ_HUMAN), STATS(18 + 76, 8, 18, 1, 1, 1), MR_COLD | MR_SLEEP | MR_POISON,
    ...
    MON("human mummy", S_MUMMY, LVL(6, 12, 4, 30, -5),
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4, 0), ATTK(AT_CLAW, AD_PHYS, 2, 4, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_SILENT, MZ_HUMAN), STATS(18 + 51, 8, 18, 1, 1, 1),
    ...
    MON("ettin mummy", S_MUMMY, LVL(7, 12, 4, 30, -6),
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 2, 6, 0), ATTK(AT_CLAW, AD_PHYS, 2, 6, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1700, 250, MS_SILENT, MZ_HUGE), STATS(23 + 100, 8, 21, 1, 1, 1), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
    ...
    MON("giant mummy", S_MUMMY, LVL(8, 14, 3, 30, -7),
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 3, 4, 0), ATTK(AT_CLAW, AD_PHYS, 3, 4, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2050, 375, MS_SILENT, MZ_HUGE), STATS(24 + 100, 10, 22, 1, 1, 1), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
    ...
    MON("red naga hatchling", S_NAGA, LVL(3, 10, 6, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(500, 100, MS_MUMBLE, MZ_LARGE), STATS(18 + 31, 15, 18, 11, 12, 9), MR_FIRE | MR_POISON,
        MR_FIRE | MR_POISON,
    ...
    MON("black naga hatchling", S_NAGA, LVL(3, 10, 6, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(500, 100, MS_MUMBLE, MZ_LARGE), STATS(18 + 31, 15, 18, 11, 12, 9), MR_POISON | MR_ACID | MR_STONE,
    ...
    MON("golden naga hatchling", S_NAGA, LVL(3, 10, 6, 0, 0), G_GENO,
        A(ATTK(AT_BITE, AD_PHYS, 1, 4, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(500, 100, MS_MUMBLE, MZ_LARGE), STATS(18 + 31, 15, 18, 11, 12, 9), MR_POISON, MR_POISON,
        M1_NOLIMBS | M1_SLITHY | M1_THICK_HIDE | M1_NOTAKE | M1_OMNIVORE,
    ...
    MON("red naga", S_NAGA, LVL(6, 12, 4, 0, -4), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 4, 0), ATTK(AT_BREA, AD_FIRE, 2, 6, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2600, 400, MS_MUMBLE, MZ_HUGE), STATS(18 + 100, 16, 18, 15, 17, 14), MR_FIRE | MR_POISON,
    ...
    MON("black naga", S_NAGA, LVL(8, 14, 2, 10, 4), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6, 0), ATTK(AT_SPIT, AD_ACID, 0, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2600, 400, MS_MUMBLE, MZ_HUGE), STATS(18 + 100, 16, 18, 15, 17, 14), MR_POISON | MR_ACID | MR_STONE,
        MR_POISON | MR_STONE,
    ...
    MON("golden naga", S_NAGA, LVL(10, 14, 2, 70, 5), (G_GENO | 1),
        A(ATTK(AT_BITE, AD_PHYS, 2, 6, 0), ATTK(AT_MAGC, AD_SPEL, 4, 6, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2600, 400, MS_MUMBLE, MZ_HUGE), STATS(19 + 100, 16, 19, 15, 18, 15), MR_POISON, MR_POISON,
    ...
    MON("guardian naga", S_NAGA, LVL(12, 16, 0, 50, 7), (G_GENO | 1),
        ...
        SIZ(2600, 400, MS_MUMBLE, MZ_HUGE), STATS(20 + 100, 18, 20, 16, 20, 16), MR_POISON, MR_POISON,
    ...
    MON("ogre", S_OGRE, LVL(5, 10, 5, 0, -3), (G_SGROUP | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 5, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1600, 500, MS_GRUNT, MZ_LARGE), STATS(18 + 76, 9, 16, 8, 7, 5), 0, 0, M1_HUMANOID | M1_CARNIVORE,
    ...
    MON("ogre lord", S_OGRE, LVL(7, 12, 3, 30, -5), (G_GENO | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1700, 700, MS_GRUNT, MZ_LARGE), STATS(18 + 95, 10, 17, 9, 8, 9), 0, 0, M1_HUMANOID | M1_CARNIVORE,
    ...
    MON("ogre king", S_OGRE, LVL(9, 14, 4, 60, -7), (G_GENO | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 5, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1700, 750, MS_GRUNT, MZ_LARGE), STATS(18 + 100, 11, 18, 9, 8, 13), 0, 0, M1_HUMANOID | M1_CARNIVORE,
    ...
    MON("gray ooze", S_PUDDING, LVL(3, 1, 8, 0, 0), (G_GENO | G_NOCORPSE | 2),
        A(ATTK(AT_BITE, AD_RUST, 2, 8, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(500, 250, MS_SILENT, MZ_MEDIUM), STATS(6, 1, 15, 1, 1, 1),
    ...
    MON("brown pudding", S_PUDDING, LVL(5, 3, 8, 0, 0),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_BITE, AD_DCAY, 0, 0, 0), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(500, 250, MS_SILENT, MZ_MEDIUM), STATS(9, 1, 16, 1, 1, 1),
    ...
    MON("green slime", S_PUDDING, LVL(6, 6, 6, 0, 0),
        ...
        A(ATTK(AT_TUCH, AD_SLIM, 1, 4, 0), ATTK(AT_NONE, AD_SLIM, 0, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 150, MS_SILENT, MZ_LARGE), STATS(15, 1, 18, 1, 1, 1),
    ...
    MON("black pudding", S_PUDDING, LVL(10, 6, 6, 0, 0),
        ...
        A(ATTK(AT_BITE, AD_CORR, 3, 8, 0), ATTK(AT_NONE, AD_CORR, 0, 0, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(900, 250, MS_SILENT, MZ_LARGE), STATS(15, 1, 18, 1, 1, 1),
        MR_COLD | MR_ELEC | MR_POISON | MR_ACID | MR_STONE,
        MR_COLD | MR_ELEC | MR_POISON,
        M1_BREATHLESS | M1_AMORPHOUS | M1_NOEYES | M1_NOLIMBS | M1_NOHEAD
            | M1_MINDLESS | M1_OMNIVORE | M1_ACID,
    ...
    MON("troll", S_TROLL, LVL(7, 12, 4, 0, -3), (G_GENO | 2),
        ...
        SIZ(800, 350, MS_GRUNT, MZ_LARGE), STATS(18, 12, 19, 6, 4, 4), 0, 0,
    ...
    MON("ice troll", S_TROLL, LVL(9, 10, 2, 20, -3), (G_NOHELL | G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6, 0), ATTK(AT_CLAW, AD_COLD, 2, 6, 0),
          ATTK(AT_BITE, AD_PHYS, 2, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1000, 300, MS_GRUNT, MZ_LARGE), STATS(18+51, 12, 20, 6, 4, 4), MR_COLD, MR_COLD,
        M1_HUMANOID | M1_REGEN | M1_CARNIVORE,
        M2_STRONG | M2_STALK | M2_HOSTILE, M3_INFRAVISIBLE | M3_INFRAVISION,
        12, CLR_WHITE),
    MON("rock troll", S_TROLL, LVL(9, 12, 0, 0, -3), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 6, 0), ATTK(AT_CLAW, AD_PHYS, 2, 8, 0),
          ATTK(AT_BITE, AD_PHYS, 2, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1200, 300, MS_GRUNT, MZ_LARGE), STATS(18 + 51, 12, 20, 6, 4, 4), 0, 0,
        M1_HUMANOID | M1_REGEN | M1_CARNIVORE,
    ...
    MON("water troll", S_TROLL, LVL(11, 14, 4, 40, -3), (G_NOGEN | G_GENO),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 8, 0), ATTK(AT_CLAW, AD_PHYS, 2, 8, 0),
          ATTK(AT_BITE, AD_PHYS, 2, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1200, 350, MS_GRUNT, MZ_LARGE), STATS(18 + 76, 12, 21, 6, 4, 4), 0, 0,
    ...
    MON("Olog-hai", S_TROLL, LVL(13, 12, -4, 0, -7), (G_GENO | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 6, 0), ATTK(AT_CLAW, AD_PHYS, 2, 8, 0),
          ATTK(AT_BITE, AD_PHYS, 2, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 400, MS_GRUNT, MZ_LARGE), STATS(18 + 100, 12, 22, 7, 5, 4), 0, 0,
        M1_HUMANOID | M1_REGEN | M1_CARNIVORE,
        M2_STRONG | M2_STALK | M2_HOSTILE | M2_COLLECT,
    ...
    MON("vampire", S_VAMPIRE, LVL(10, 12, 1, 25, -8),
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6, 0), ATTK(AT_BITE, AD_DRLI, 1, 6, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_VAMPIRE, MZ_HUMAN), STATS(18 + 100, 14, 18, 15, 13, 16), MR_SLEEP | MR_POISON, 0,
    ...
    MON("vampire lord", S_VAMPIRE, LVL(12, 14, 0, 50, -9),
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 1, 8, 0), ATTK(AT_BITE, AD_DRLI, 1, 8, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_VAMPIRE, MZ_HUMAN), STATS(19 + 100, 14, 19, 16, 14, 17), MR_SLEEP | MR_POISON, 0,
        M1_FLY | M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
    ...
    MON("Vlad the Impaler", S_VAMPIRE, LVL(28, 26, -6, 80, -10),
        ...
        A(ATTK(AT_WEAP, AD_PHYS, 2, 10, 0), ATTK(AT_BITE, AD_DRLI, 1, 12, 0),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_VAMPIRE, MZ_HUMAN), STATS(20 + 100, 15, 20, 17, 15, 18), MR_SLEEP | MR_POISON, 0,
        M1_FLY | M1_BREATHLESS | M1_HUMANOID | M1_POIS | M1_REGEN,
    ...
    MON("barrow wight", S_WRAITH, LVL(3, 12, 5, 5, -3),
        ...
        SIZ(1200, 0, MS_SPELL, MZ_HUMAN), STATS(17, 11, 17, 8, 8, 3), MR_COLD | MR_SLEEP | MR_POISON, 0,
    ...
    MON("Nazgul", S_WRAITH, LVL(13, 12, 0, 25, -17),
        ...
        A(ATTK(AT_WEAP, AD_DRLI, 1, 4, 0), ATTK(AT_BREA, AD_SLEE, 2, 25, 0),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 0, MS_SPELL, MZ_HUMAN), STATS(18+100, 17, 20, 15, 11, 6), MR_COLD | MR_SLEEP | MR_POISON,
    ...
    MON("xorn", S_XORN, LVL(8, 9, -2, 20, 0), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 3, 0), ATTK(AT_CLAW, AD_PHYS, 1, 3, 0),
          ...
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1200, 700, MS_ROAR, MZ_MEDIUM), STATS(18 + 100, 9, 18, 6, 6, 3), MR_FIRE | MR_COLD | MR_STONE,
        MR_STONE,
    ...
    MON("monkey", S_YETI, LVL(2, 12, 6, 0, 0), (G_GENO | 1),
        A(ATTK(AT_CLAW, AD_SITM, 0, 0, 0), ATTK(AT_BITE, AD_PHYS, 1, 3, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(100, 50, MS_GROWL, MZ_SMALL), STATS(6, 12, 6, 5, 5, 3), 0, 0,
    ...
    MON("kobold zombie", S_ZOMBIE, LVL(0, 6, 10, 0, -2),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(400, 50, MS_SILENT, MZ_SMALL), STATS(12, 3, 14, 1, 1, 1), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
    ...
    MON("gnome zombie", S_ZOMBIE, LVL(1, 6, 10, 0, -2),
        (G_GENO | G_NOCORPSE | 1), A(ATTK(AT_CLAW, AD_PHYS, 1, 5, 0), NO_ATTK,
                                     NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(650, 50, MS_SILENT, MZ_SMALL), STATS(13, 3, 15, 1, 1, 1), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
    ...
    MON("orc zombie", S_ZOMBIE, LVL(2, 6, 9, 0, -3),
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(850, 75, MS_SILENT, MZ_HUMAN), STATS(18, 3, 16, 1, 1, 1), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
    ...
    MON("dwarf zombie", S_ZOMBIE, LVL(2, 6, 9, 0, -3),
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(900, 150, MS_SILENT, MZ_HUMAN), STATS(18, 3, 17, 1, 1, 1), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
	...
	MON("gnoll zombie", S_ZOMBIE, LVL(4, 6, 7, 0, -3),
		(G_GENO | G_SGROUP | G_NOCORPSE | 1),
			A(ATTK(AT_CLAW, AD_PHYS, 1, 8, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
				NO_ATTK, NO_ATTK, NO_ATTK),
			SIZ(900, 75, MS_SILENT, MZ_HUMAN), STATS(18, 3, 16, 1, 1, 1), MR_COLD | MR_SLEEP | MR_POISON, 0,
			M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_POIS,
	...
	MON("elf zombie", S_ZOMBIE, LVL(3, 6, 9, 0, -3),
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 1, 7, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 175, MS_SILENT, MZ_HUMAN), STATS(17, 3, 15, 1, 1, 1), MR_COLD | MR_SLEEP | MR_POISON,
    ...
    MON("human zombie", S_ZOMBIE, LVL(4, 6, 8, 0, -3),
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 1, 8, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 200, MS_SILENT, MZ_HUMAN), STATS(18, 3, 15, 1, 1, 1),
        MR_COLD | MR_SLEEP | MR_POISON, 0,
    ...
    MON("ettin zombie", S_ZOMBIE, LVL(6, 8, 6, 0, -4),
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 1, 10, 0), ATTK(AT_CLAW, AD_PHYS, 1, 10, 0),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1700, 250, MS_SILENT, MZ_HUGE), STATS(22+100, 3, 20, 1, 1, 1), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID,
    ...
    MON("giant zombie", S_ZOMBIE, LVL(8, 8, 6, 0, -4),
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 2, 8, 0), ATTK(AT_CLAW, AD_PHYS, 2, 8, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2050, 375, MS_SILENT, MZ_HUGE), STATS(22+100, 3, 20, 1, 1, 1), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID,
    ...
    MON("skeleton", S_ZOMBIE, LVL(12, 8, 4, 0, 0), (G_NOCORPSE | G_NOGEN),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 6, 0), ATTK(AT_TUCH, AD_SLOW, 1, 6, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(300, 5, MS_BONES, MZ_HUMAN), STATS(18+100, 9, 18, 1, 1, 1),
        MR_COLD | MR_SLEEP | MR_POISON | MR_STONE, 0,
    ...
    MON("gold golem", S_GOLEM, LVL(5, 9, 6, 0, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 3, 0), ATTK(AT_CLAW, AD_PHYS, 2, 3, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(450, 0, MS_SILENT, MZ_LARGE), STATS(18, 7, 14, 1, 1, 1), MR_SLEEP | MR_POISON | MR_ACID, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE,
    ...
    MON("leather golem", S_GOLEM, LVL(6, 6, 6, 0, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 6, 0), ATTK(AT_CLAW, AD_PHYS, 1, 6, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(800, 0, MS_SILENT, MZ_LARGE), STATS(12, 7, 13, 1, 1, 1), MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID, M2_HOSTILE | M2_NEUTER, 0,
        7, HI_LEATHER),
    MON("wood golem", S_GOLEM, LVL(7, 3, 4, 0, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 3, 4, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(900, 0, MS_SILENT, MZ_LARGE), STATS(16, 7, 14, 1, 1, 1), MR_COLD | MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE,
        M2_HOSTILE | M2_NEUTER, 0, 8, HI_WOOD),
    MON("flesh golem", S_GOLEM, LVL(9, 8, 9, 30, 0), (1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 8, 0), ATTK(AT_CLAW, AD_PHYS, 2, 8, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1400, 600, MS_SILENT, MZ_LARGE), STATS(18+51, 7, 17, 1, 1, 1),
    ...
    MON("clay golem", S_GOLEM, LVL(11, 7, 7, 40, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 3, 10, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1550, 0, MS_SILENT, MZ_LARGE), STATS(18+100, 7, 18, 1, 1, 1), MR_SLEEP | MR_POISON, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE,
    ...
    MON("stone golem", S_GOLEM, LVL(14, 6, 5, 50, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 3, 8, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1900, 0, MS_SILENT, MZ_LARGE), STATS(19+100, 7, 21, 1, 1, 1), MR_SLEEP | MR_POISON | MR_STONE, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE,
        M2_HOSTILE | M2_STRONG, 0, 15, CLR_GRAY),
    MON("glass golem", S_GOLEM, LVL(16, 6, 1, 50, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 8, 0), ATTK(AT_CLAW, AD_PHYS, 2, 8, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1800, 0, MS_SILENT, MZ_LARGE), STATS(20 + 100, 7, 20, 1, 1, 1), MR_SLEEP | MR_POISON | MR_ACID, 0,
        M1_BREATHLESS | M1_MINDLESS | M1_HUMANOID | M1_THICK_HIDE,
    ...
    MON("iron golem", S_GOLEM, LVL(18, 6, 3, 60, 0), (G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10, 0), ATTK(AT_BREA, AD_DRST, 4, 6, 0),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2000, 0, MS_SILENT, MZ_LARGE), STATS(23 + 100, 7, 23, 1, 1, 1),
        MR_FIRE | MR_COLD | MR_ELEC | MR_SLEEP | MR_POISON, 0,
    ...
    MON("werewolf", S_HUMAN, LVL(5, 12, 10, 20, -7), (1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_WERE, MZ_HUMAN), STATS(18+100, 14, 18, 10, 10, 9), MR_POISON, 0,
        M1_HUMANOID | M1_POIS | M1_REGEN | M1_OMNIVORE,
        M2_NOPOLY | M2_WERE | M2_HOSTILE | M2_HUMAN | M2_COLLECT,
    ...
    MON("Grey-elf", S_HUMAN, LVL(6, 12, 10, 10, -7), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), STATS(15, 17, 14, 16, 12, 15), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS, M2_ELF | M2_COLLECT,
        M3_INFRAVISIBLE | M3_INFRAVISION, 8, CLR_GRAY),
    MON("elf-lord", S_HUMAN, LVL(8, 12, 10, 20, -9), (G_GENO | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4, 0), ATTK(AT_WEAP, AD_PHYS, 2, 4, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_ELF, 350, MS_HUMANOID, MZ_HUMAN), STATS(12, 15, 10, 17, 14, 18), MR_SLEEP, MR_SLEEP,
        M1_HUMANOID | M1_OMNIVORE | M1_SEE_INVIS,
    ...
    MON("guard", S_HUMAN, LVL(12, 12, 10, 40, 10), G_NOGEN,
        A(ATTK(AT_WEAP, AD_PHYS, 4, 10, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GUARD, MZ_HUMAN), STATS(18+51, 12, 15, 9, 10, 9), 0, 0,
        M1_HUMANOID | M1_OMNIVORE,
...
#define SEDUCTION_ATTACKS_NO                                      \
    ...
    MON("succubus", S_DEMON, LVL(6, 12, 0, 70, -9), (G_NOCORPSE | 1),
        SEDUCTION_ATTACKS_YES, SIZ(WT_HUMAN, 400, MS_SEDUCE, MZ_HUMAN), STATS(15, 15, 17, 15, 13, 18),
    ...
    MON("erinys", S_DEMON, LVL(7, 12, 2, 30, 10),
        ...
        A(ATTK(AT_WEAP, AD_DRST, 2, 4, 0), ATTK(AT_DMNS, AD_SMMN, 0, 0, 10), NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_HUMAN), STATS(18+76, 15, 17, 10, 8, 14), MR_FIRE | MR_POISON, 0,
        M1_HUMANOID | M1_POIS,
    ...
    MON("barbed devil", S_DEMON, LVL(8, 12, 0, 35, 8),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4, 0), ATTK(AT_CLAW, AD_PHYS, 2, 4, 0),
          ATTK(AT_STNG, AD_PHYS, 3, 4, 0), ATTK(AT_DMNS, AD_SMMN, 0, 0, 10), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
	...
	MON("marilith", S_DEMON, LVL(7, 12, -6, 80, -12),
        ...
        A(ATTK(AT_WEAP, AD_PHYS, 2, 4, 0), ATTK(AT_WEAP, AD_PHYS, 2, 4, 0),
          ...
          ATTK(AT_CLAW, AD_PHYS, 2, 4, 0), ATTK(AT_CLAW, AD_PHYS, 2, 4, 0), ATTK(AT_DMNS, AD_SMMN, 0, 0, 15), NO_ATTK),
    ...
    MON("vrock", S_DEMON, LVL(8, 12, 0, 50, -9),
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), ATTK(AT_CLAW, AD_PHYS, 1, 4, 0),
          ...
          ATTK(AT_BITE, AD_PHYS, 1, 6, 0), ATTK(AT_DMNS, AD_SMMN, 0, 0, 10/2), NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_LARGE), STATS(17, 14, 15, 7, 6, 4), MR_FIRE | MR_POISON, 0,
        M1_POIS, M2_DEMON | M2_STALK | M2_HOSTILE | M2_NASTY,
        M3_INFRAVISIBLE | M3_INFRAVISION, 11, CLR_RED),
    MON("hezrou", S_DEMON, LVL(9, 6, -2, 55, -10),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 3, 0), ATTK(AT_CLAW, AD_PHYS, 1, 3, 0),
          ATTK(AT_BITE, AD_PHYS, 4, 4, 0), ATTK(AT_DMNS, AD_SMMN, 0, 0, 20/2), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("bone devil", S_DEMON, LVL(9, 15, -1, 40, -9),
        (G_HELL | G_NOCORPSE | G_SGROUP | 2),
        A(ATTK(AT_WEAP, AD_PHYS, 3, 4, 0), ATTK(AT_STNG, AD_DRST, 2, 4, 0), ATTK(AT_DMNS, AD_SMMN, 0, 0, 10),
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_LARGE), STATS(18, 14, 18, 13, 10, 7), MR_FIRE | MR_POISON, 0,
    ...
    MON("glabrezu", S_DEMON, LVL(10, 9, -4, 60, -10),
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 2, 6, 0), ATTK(AT_CLAW, AD_PHYS, 2, 6, 0),
          ATTK(AT_CLAW, AD_PHYS, 1, 3, 0), ATTK(AT_CLAW, AD_PHYS, 1, 3, 0), ATTK(AT_BITE, AD_PHYS, 1, 4, 1),
			ATTK(AT_DMNS, AD_SMMN, 0, 0, 30/2), NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SPELL, MZ_LARGE), STATS(18 + 76, 16, 18, 10, 7, 6), MR_FIRE | MR_POISON, 0,
        M1_HUMANOID | M1_POIS, M2_DEMON | M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY,
        M3_INFRAVISIBLE | M3_INFRAVISION, 14, CLR_RED),
    MON("ice devil", S_DEMON, LVL(11, 6, -4, 55, -12),
        (G_HELL | G_NOCORPSE | 2),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), ATTK(AT_CLAW, AD_PHYS, 1, 4, 0),
          ATTK(AT_BITE, AD_PHYS, 2, 4, 0), ATTK(AT_STNG, AD_COLD, 3, 4, 0), ATTK(AT_DMNS, AD_SMMN, 0, 0, 15),
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_LARGE), STATS(18+51, 15, 18, 14, 11, 8),
        MR_FIRE | MR_COLD | MR_POISON, 0, M1_SEE_INVIS | M1_POIS,
        M2_DEMON | M2_STALK | M2_HOSTILE | M2_STRONG | M2_NASTY,
        M3_INFRAVISIBLE | M3_INFRAVISION, 14, CLR_WHITE),
    MON("nalfeshnee", S_DEMON, LVL(11, 9, -1, 65, -11),
        (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_CLAW, AD_PHYS, 1, 4, 0), ATTK(AT_CLAW, AD_PHYS, 1, 4, 0),
          ATTK(AT_BITE, AD_PHYS, 2, 4, 0), ATTK(AT_MAGC, AD_SPEL, 0, 0, 0), ATTK(AT_DMNS, AD_SMMN, 0, 0, 40/2),
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("pit fiend", S_DEMON, LVL(13, 6, -3, 65, -13),
        ...
        A(ATTK(AT_WEAP, AD_PHYS, 4, 2, 0), ATTK(AT_WEAP, AD_PHYS, 4, 2, 0),
          ATTK(AT_HUGS, AD_PHYS, 2, 4, 0), ATTK(AT_DMNS, AD_SMMN, 0, 0, 20), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_GROWL, MZ_LARGE), STATS(18 + 100, 13, 18, 14, 11, 13), MR_FIRE | MR_POISON, 0,
    ...
    MON("balrog", S_DEMON, LVL(16, 5, -2, 75, -14), (G_HELL | G_NOCORPSE | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 8, 4, 0), ATTK(AT_WEAP, AD_PHYS, 4, 6, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_SILENT, MZ_LARGE), STATS(19 + 100, 16, 19, 13, 10, 9), MR_FIRE | MR_POISON, 0,
    ...
    MON("Juiblex", S_DEMON, LVL(50, 3, -7, 65, -15),
		...
		ATTK(AT_DMNS, AD_SMMN, 0, 0, 70/2), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 0, MS_GURGLE, MZ_LARGE), STATS(19 + 100, 13, 25, 15, 14, 4),
    ...
    MON("Yeenoghu", S_DEMON, LVL(56, 18, -5, 80, -15),
        ...
        A(ATTK(AT_WEAP, AD_PHYS, 3, 6, 0), ATTK(AT_WEAP, AD_CONF, 2, 8, 0),
          ATTK(AT_CLAW, AD_PLYS, 1, 6, 0), ATTK(AT_MAGC, AD_MAGM, 2, 6, 0), ATTK(AT_DMNS, AD_SMMN, 0, 0, 10),
          NO_ATTK, NO_ATTK, NO_ATTK),
    ...
    MON("Orcus", S_DEMON, LVL(66, 9, -6, 85, -20),
        ...
        A(ATTK(AT_WEAP, AD_PHYS, 3, 6, 0), ATTK(AT_CLAW, AD_PHYS, 3, 4, 0),
          ...
          ATTK(AT_STNG, AD_DRST, 2, 4, 0), ATTK(AT_DMNS, AD_SMMN, 0, 0, 80/2), NO_ATTK, NO_ATTK),
    ...
    MON("Geryon", S_DEMON, LVL(72, 3, -3, 75, 15),
        ...
        SIZ(1500, 500, MS_BRIBE, MZ_HUGE), STATS(24 + 100, 18, 20, 18, 18, 18), MR_FIRE | MR_POISON, 0,
    ...
    MON("Dispater", S_DEMON, LVL(78, 15, -2, 80, 15),
        ...
        A(ATTK(AT_WEAP, AD_PHYS, 4, 6, 0), ATTK(AT_MAGC, AD_SPEL, 6, 6, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 500, MS_BRIBE, MZ_HUMAN), STATS(24 + 100, 20, 24, 24, 23, 23), MR_FIRE | MR_POISON, 0,
    ...
    MON("Baalzebub", S_DEMON, LVL(89, 9, -5, 85, 20),
        ...
        A(ATTK(AT_BITE, AD_DRST, 2, 6, 0), ATTK(AT_GAZE, AD_STUN, 2, 6, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 500, MS_BRIBE, MZ_LARGE), STATS(24 + 100, 18, 24, 23, 22, 24), MR_FIRE | MR_POISON, 0,
        M1_FLY | M1_SEE_INVIS | M1_POIS,
        M2_NOPOLY | M2_DEMON | M2_STALK | M2_HOSTILE | M2_PNAME | M2_NASTY
            | M2_PRINCE | M2_MALE,
    ...
    MON("Asmodeus", S_DEMON, LVL(105, 12, -7, 90, 20),
        ...
        A(ATTK(AT_CLAW, AD_PHYS, 4, 4, 0), ATTK(AT_MAGC, AD_COLD, 6, 6, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 500, MS_BRIBE, MZ_HUGE), STATS(24 + 100, 21, 25, 25, 24, 25), MR_FIRE | MR_COLD | MR_POISON, 0,
    ...
    MON("Demogorgon", S_DEMON, LVL(106, 15, -8, 95, -20),
        ...
        A(ATTK(AT_MAGC, AD_SPEL, 8, 6, 0), ATTK(AT_STNG, AD_DRLI, 1, 4, 0),
          ...
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 500, MS_GROWL, MZ_HUGE), STATS(24 + 100, 23, 25, 25, 23, 19), MR_FIRE | MR_POISON, 0,
    ...
    MON("Death", S_DEMON, LVL(30, 12, -5, 100, 0), (G_UNIQ | G_NOGEN),
        A(ATTK(AT_TUCH, AD_DETH, 8, 8, 0), ATTK(AT_TUCH, AD_DETH, 8, 8, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 1, MS_RIDER, MZ_HUMAN), STATS(18 + 100, 19, 25, 19, 19, 19),
    ...
    MON("djinni", S_DEMON, LVL(7, 12, 4, 30, 0), (G_NOGEN | G_NOCORPSE),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 8, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 400, MS_DJINNI, MZ_HUMAN), STATS(18, 15, 19, 15, 15, 15), MR_POISON | MR_STONE, 0,
    ...
    MON("kraken", S_EEL, LVL(20, 3, 6, 0, -3), (G_GENO | G_NOGEN),
        A(ATTK(AT_CLAW, AD_PHYS, 2, 4, 0), ATTK(AT_CLAW, AD_PHYS, 2, 4, 0),
          ...
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1800, 1000, MS_SILENT, MZ_HUGE), STATS(25 + 100, 18, 23, 4, 4, 1), 0, 0,
    ...
    MON("lizard", S_LIZARD, LVL(5, 6, 6, 10, 0), (G_GENO | 5),
        A(ATTK(AT_BITE, AD_PHYS, 1, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(10, 40, MS_SILENT, MZ_TINY), STATS(1, 10, 1, 2, 2, 1), MR_STONE, MR_STONE,
    ...
    MON("chameleon", S_LIZARD, LVL(6, 5, 6, 10, 0), (G_GENO | 2),
        A(ATTK(AT_BITE, AD_PHYS, 4, 2, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(100, 100, MS_SILENT, MZ_TINY), STATS(1, 15, 1, 2, 2, 1), 0, 0,
        M1_ANIMAL | M1_NOHANDS | M1_CARNIVORE,
    ...
    MON("salamander", S_LIZARD, LVL(8, 12, -1, 0, -9), (G_HELL | 1),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 8, 0), ATTK(AT_TUCH, AD_FIRE, 1, 6, 0),
          ...
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(1500, 400, MS_MUMBLE, MZ_HUMAN), STATS(15, 14, 15, 2, 2, 1), MR_SLEEP | MR_FIRE, MR_FIRE,
    ...
    MON("long worm tail", S_WORM_TAIL, LVL(0, 0, 0, 0, 0),
        (G_NOGEN | G_NOCORPSE | G_UNIQ),
        A(NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(0, 0, 0, 0), STATS(1, 1, 18, 1, 1, 1), 0, 0, 0L, M2_NOPOLY, 0, 1, CLR_BROWN),
    /* Note:
    ...
    MON("Minion of Huhetotl", S_DEMON, LVL(16, 12, -2, 75, -14),
        ...
        A(ATTK(AT_WEAP, AD_PHYS, 8, 4, 0), ATTK(AT_WEAP, AD_PHYS, 4, 6, 0),
          ...
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_NEMESIS, MZ_LARGE), STATS(20 + 100, 18, 18, 18, 18, 13),
    ...
    MON("Thoth Amon", S_HUMAN, LVL(16, 12, 0, 10, -14),
        ...
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6, 0), ATTK(AT_MAGC, AD_SPEL, 0, 0, 0),
          ...
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_NEMESIS, MZ_HUMAN), STATS(15, 18, 18, 23, 18, 17), MR_POISON | MR_STONE, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("Chromatic Dragon", S_DRAGON, LVL(16, 12, 0, 30, -14),
        ...
        SIZ(WT_DRAGON, 1700, MS_NEMESIS, MZ_GIGANTIC), STATS(25 + 100, 18, 25, 20, 18, 20),
    ...
    MON("Cyclops", S_GIANT, LVL(18, 12, 0, 0, -15), (G_NOGEN | G_UNIQ),
        ...
        SIZ(1900, 700, MS_NEMESIS, MZ_HUGE), STATS(25 + 100, 15, 25, 10, 8, 7), MR_STONE, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("Ixoth", S_DRAGON, LVL(15, 12, -1, 20, -14), (G_NOGEN | G_UNIQ),
        ...
        SIZ(WT_DRAGON, 1600, MS_NEMESIS, MZ_GIGANTIC), STATS(25 + 100, 18, 24, 18, 16, 18), MR_FIRE | MR_STONE,
        MR_FIRE,
    ...
    MON("Master Kaen", S_HUMAN, LVL(25, 12, -10, 10, -20), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_CLAW, AD_PHYS, 16, 2, 0), ATTK(AT_CLAW, AD_PHYS, 16, 2, 0),
          ...
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_NEMESIS, MZ_HUMAN), STATS(18 + 100, 20, 20, 19, 19, 19), MR_POISON | MR_STONE,
    ...
    MON("Nalzok", S_DEMON, LVL(16, 12, -2, 85, -127),
        ...
        A(ATTK(AT_WEAP, AD_PHYS, 8, 4, 0), ATTK(AT_WEAP, AD_PHYS, 4, 6, 0),
          ATTK(AT_MAGC, AD_SPEL, 0, 0, 0), ATTK(AT_CLAW, AD_SAMU, 2, 6, 0), NO_ATTK,
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_NEMESIS, MZ_LARGE), STATS(20 + 100, 19, 22, 18, 16, 16),
        MR_FIRE | MR_POISON | MR_STONE, 0, M1_FLY | M1_SEE_INVIS | M1_POIS,
    ...
    MON("Scorpius", S_SPIDER, LVL(15, 12, 10, 0, -15), (G_NOGEN | G_UNIQ),
        ...
        SIZ(750, 350, MS_NEMESIS, MZ_HUMAN), STATS(18 + 100, 23, 19, 18, 18, 15), MR_POISON | MR_STONE, MR_POISON,
        M1_ANIMAL | M1_NOHANDS | M1_OVIPAROUS | M1_POIS | M1_CARNIVORE,
    ...
    MON("Master Assassin", S_HUMAN, LVL(15, 12, 0, 30, 18),
        ...
        A(ATTK(AT_WEAP, AD_DRST, 2, 6, 0), ATTK(AT_WEAP, AD_PHYS, 2, 8, 0),
          ATTK(AT_CLAW, AD_SAMU, 2, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_NEMESIS, MZ_HUMAN), STATS(18 + 100, 22, 19, 18, 18, 18), MR_STONE, 0,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("Lord Surtur", S_GIANT, LVL(15, 12, 2, 50, 12), (G_NOGEN | G_UNIQ),
        A(ATTK(AT_WEAP, AD_PHYS, 2, 10, 0), ATTK(AT_WEAP, AD_PHYS, 2, 10, 0),
          ATTK(AT_CLAW, AD_SAMU, 2, 6, 0), NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(2250, 850, MS_NEMESIS, MZ_HUGE), STATS(23 + 100, 17, 23, 12, 10, 14), MR_FIRE | MR_STONE, MR_FIRE,
        M1_HUMANOID | M1_OMNIVORE,
    ...
    MON("Dark One", S_HUMAN, LVL(15, 12, 0, 80, -10),
        ...
        A(ATTK(AT_WEAP, AD_PHYS, 1, 6, 0), ATTK(AT_WEAP, AD_PHYS, 1, 6, 0),
          ...
          NO_ATTK, NO_ATTK, NO_ATTK),
        SIZ(WT_HUMAN, 400, MS_NEMESIS, MZ_HUMAN), STATS(17, 18, 18, 20, 16, 15), MR_STONE, 0,
        M1_HUMANOID | M1_OMNIVORE,
