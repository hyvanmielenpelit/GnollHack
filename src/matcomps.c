...
struct materialcomponentlist matlists[] =
{
	...
	"Topaz",
	5,
	{{TOPAZ, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS}, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP} },

	{ SPE_CALL_DEMOGORGON,
	"Cursed ape corpse, black pearl, mandrake",
	1,
	...
	1,
		{
			{ROCK, NOT_APPLICABLE, 25, MATCOMP_BLESSED_REQUIRED}, 
	...
	"25 rocks, spider silk",
	1,
		{
			{ROCK, NOT_APPLICABLE, 25, MATCOMP_NO_FLAGS},
			{THREAD_OF_SPIDER_SILK, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS},
			NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP
		}
	},
	...
	"5 iron chains, spider silk",
	1,
		{
			{IRON_CHAIN, NOT_APPLICABLE, 5, MATCOMP_NO_FLAGS}, 
			{THREAD_OF_SPIDER_SILK, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS}, 
			NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP
		} 
	},
