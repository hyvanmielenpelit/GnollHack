...
struct materialcomponentlist matlists[] =
{
	...
	1,
	{
		...
		{RUBY, NOT_APPLICABLE, 1, MATCOMP_NOT_CURSED},
 		{UNICORN_HORN, NOT_APPLICABLE, 1, MATCOMP_NOT_CURSED},
	...
	{SPE_TIME_STOP,
		...
		2,
		{
			{SAPPHIRE, NOT_APPLICABLE, 1, MATCOMP_NOT_CURSED},
	...
	{SPE_ARMAGEDDON,
		...
		1,
		{
			...
			{HUMAN_SKULL, NOT_APPLICABLE, 1, MATCOMP_NOT_CURSED},
			{DEATH_CAP, NOT_APPLICABLE, 1, MATCOMP_NOT_CURSED},
			{HEAP_OF_SPORAL_POWDER, NOT_APPLICABLE, 1, MATCOMP_NOT_CURSED},
	...
	{SPE_CIRCLE_OF_MAGIC,
		...
		20,
		{
			{NUGGET_OF_PLATINUM_ORE, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS},
			NO_MATCOMP,
			NO_MATCOMP,
			NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP
		}
	...
	15,
		{
			{NUGGET_OF_PLATINUM_ORE, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS},
			{DILITHIUM_CRYSTAL, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS},
			NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP
		}
	},
	...
	20,
		{
			...
			{PINCH_OF_SULFUROUS_ASH, NOT_APPLICABLE, 4, MATCOMP_NO_FLAGS},
			NO_MATCOMP,
			NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP
		}
	},
	...
	1,
		{
			{CITRINE, NOT_APPLICABLE, 1, MATCOMP_NOT_CURSED},
			NO_MATCOMP,
			NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP
		}
	},
	...
	2,
		{
			{TURQUOISE, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS},
			NO_MATCOMP,
			NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP
		}
	},
