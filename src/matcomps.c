...
struct materialcomponentlist matlists[] =
{
	...
	{SPE_ARMAGEDDON,
	"Black opal and death bone dagger",
	1,
	...
	{SPE_CURSE,
	"Unicorn horn and holy symbol",
	1,
	{{UNICORN_HORN, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS}, {HOLY_SYMBOL, NOT_APPLICABLE, 1, MATCOMP_NOT_SPENT}, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP}},
