...
struct materialcomponentlist matlists[] =
{
	...
	{SPE_DEATHSPELL,
	"Human skull, fungal spores",
	STRANGE_OBJECT,
	1,
	{{HUMAN_SKULL, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS}, {HEAP_OF_FUNGAL_SPORES, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS}, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP}},
	...
	{SPE_FULL_HEALING,
	"Blessed ginseng root",
	STRANGE_OBJECT,
	1,
	{{GINSENG_ROOT, NOT_APPLICABLE, 1, MATCOMP_BLESSED_REQUIRED}, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP}},
	...
	{ SPE_MASS_SLEEP,
	"Ginseng root, bone, fungal spores",
	STRANGE_OBJECT,
	5,
	{{GINSENG_ROOT, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS}, {BONE, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS}, {HEAP_OF_FUNGAL_SPORES, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS}, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP} },
	...
	{ SPE_MASS_FEAR,
	"Mandrake root, fungal spores",
	STRANGE_OBJECT,
	5,
	{{MANDRAKE_ROOT, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS},  {HEAP_OF_FUNGAL_SPORES, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS}, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP} },
	...
	"Ginseng, wolfsbane, fungal spores",
	STRANGE_OBJECT,
	5,
	{{GINSENG_ROOT, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS}, {SPRIG_OF_WOLFSBANE, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS}, {HEAP_OF_FUNGAL_SPORES, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS}, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP} },

	{ SPE_MASS_CHARM,
	"Ginseng, wolfsbane, blessed spores",
	STRANGE_OBJECT,
	5,
	{{GINSENG_ROOT, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS}, {SPRIG_OF_WOLFSBANE, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS}, {HEAP_OF_FUNGAL_SPORES, NOT_APPLICABLE, 1, MATCOMP_BLESSED_REQUIRED}, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP} },
	...
	"Bsd ginseng, wolfsbane, spores",
	STRANGE_OBJECT,
	1,
		{
			{GINSENG_ROOT, NOT_APPLICABLE, 1, MATCOMP_BLESSED_REQUIRED},
			{SPRIG_OF_WOLFSBANE, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS},
			{HEAP_OF_FUNGAL_SPORES, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS}, 
			NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP
		}
	},

	{ SPE_MASS_DOMINATION,
	"Blessed ginseng and spores, wolfsbane",
	STRANGE_OBJECT,
	1,
		{
			{GINSENG_ROOT, NOT_APPLICABLE, 1, MATCOMP_BLESSED_REQUIRED},
			{HEAP_OF_FUNGAL_SPORES, NOT_APPLICABLE, 1, MATCOMP_BLESSED_REQUIRED},
			{SPRIG_OF_WOLFSBANE, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS},
			NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP, NO_MATCOMP
		}
	},
	...
	{ SPE_MASS_CONFLICT,
	"Wolfsbane, mandrake, fungal spores",
	STRANGE_OBJECT,
	1,
		{
			{SPRIG_OF_WOLFSBANE, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS},
	...
	{ SPE_THUNDERSTORM,
	"Nugget of copper ore, fungal spores",
	STRANGE_OBJECT,
	5,
		{
			{NUGGET_OF_COPPER_ORE, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS},
	...
	{ SPE_ICE_STORM,
	"Nugget of iron ore, potion of water",
	STRANGE_OBJECT,
	5,
		{
			{NUGGET_OF_IRON_ORE, NOT_APPLICABLE, 1, MATCOMP_NO_FLAGS},
