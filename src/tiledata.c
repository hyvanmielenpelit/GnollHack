...
NEARDATA struct ui_component_definition ui_tile_component_array[MAX_UI_TILES] = {
    ...
    {"status2",                 NO_REPLACEMENT, NO_ANIMATION, NO_ENLARGEMENT, min(min(MAX_UI_TILE_16_x_16_COMPONENTS, MAX_UI_TILE_COMPONENTS), max(0, MAX_STATUS_MARKS - MAX_UI_TILE_16_x_16_COMPONENTS)), 16, 16, {"eating", "frozen", "", "",  "", "", "", "",  "", "", "", "",  "", "", "", "",  "", "", "", "",  "", "", "", "",  "", "", "", "",  "", "", "", ""} },
