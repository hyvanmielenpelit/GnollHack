...
const struct propname {
	...
	{ STRANGLED, "strangling", "strangulation" },
	...
	{ FIRE_RES, "fire resistance", "fire resistance" },
	{ COLD_RES, "cold resistance", "cold resistance" },
	{ SLEEP_RES, "sleep resistance", "sleep resistance" },
	{ DISINT_RES, "disintegration resistance", "disintegration resistance" },
	{ SHOCK_RES, "shock resistance", "shock resistance" },
	{ POISON_RES, "poison resistance", "poison resistance" },
	{ ACID_RES, "acid resistance", "acid resistance" },
	{ STONE_RES, "stoning resistance", "stoning resistance" },
	{ DRAIN_RES, "drain resistance", "drain resistance" },
	{ SICK_RES, "sickness resistance", "sickness resistance" },
	{ ANTIMAGIC, "magic resistance", "magic resistance" },
	{ HALLUC_RES, "hallucination resistance", "hallucination resistance" },
	{ FUMBLING, "fumbling", "fumbling" },
	{ HUNGER, "voracious hunger", "voracious hunger" },
	{ TELEPAT, "telepathic", "telepathy" },
	{ WARNING, "warning", "warning" },
	{ WARN_OF_MON, "warning of monster type or class", "warning of monster type or class" },
	{ WARN_UNDEAD, "warning of undead", "warning of undead" },
	{ SEARCHING, "searching", "searching" },
	{ INFRAVISION, "infravision", "infravision" },
	...
	{ POLYMORPH_CONTROL, "polymorph control", "polymorph control" },
	{ UNCHANGING, "unchanging", "unchange" },
	{ REFLECTING, "reflecting", "reflection" },
	{ FREE_ACTION, "free action", "free action" },
	{ FIXED_ABIL, "fixed abilites", "fixed abilites" },
	{ LIFESAVED, "life will be saved", "life saving" },
	{ DEATH_RES, "death resistance", "death resistance" },
	{ LYCANTHROPY_RES, "lycanthropy resistance", "lycanthropy resistance" },
	{ CURSE_RES, "curse resistance", "curse resistance" },
	{ BLIND_TELEPAT, "telepathic when blind", "blind telepathy" },
	{ ENHANCED_VISION, "enhanced vision", "enhanced vision" },
	{ FLASH_RES, "flash resistance", "flash resistance" },
	{ EYE_PROTECTION, "protection from eye damage", "protection from eye damage" },
	{ BRAIN_PROTECTION, "protection from brain damage", "protection from brain damage" },
	{ WARN_DEMON, "warning of demons", "warning of demons" },
	{ WARN_ORC, "warning of orcs", "warning of orcs" },
	{ WARN_TROLL, "warning of trolls", "warning of trolls" },
	{ WARN_GIANT, "warning of giants", "warning of giants" },
	{ WARN_DRAGON, "warning of dragons", "warning of dragons" },
	{ WARN_ELF, "warning of elves", "warning of elves" },
	{ WARN_DWARF, "warning of dwarves", "warning of dwarves" },
	{ WARN_GNOLL, "warning of gnolls", "warning of gnolls" },
	{ WARN_HUMAN, "warning of human beings", "warning of human beings" },
