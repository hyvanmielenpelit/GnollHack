...
void FDECL(enter_topl_mode, (int, int, char *));
...
E char FDECL(mac_yn_function_ex, (int, int, int, const char *, const char *, const char *, CHAR_P, const char*));
E void FDECL(mac_getlin_ex, (int, int, const char *, char *));
