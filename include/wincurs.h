...
extern void curses_putstr_ex2(winid wid, const char* text, const char* attrs, const char* colors, int app);
...
extern void curses_print_text_ex(WINDOW* win, int* mx, int* my, const char* text, const char* attrs, const char* colors, int attr, int color, char extra_attrs);
