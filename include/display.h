...
#define GLYPH_ROTATABLE_DOODAD_OFF  (MAX_SIMPLE_DOODAD_TILES + GLYPH_SIMPLE_DOODAD_OFF)
#define GLYPH_CURSOR_OFF  (NUM_DOODAD_ROTATIONS * MAX_ROTATABLE_DOODAD_TILES + GLYPH_ROTATABLE_DOODAD_OFF)
