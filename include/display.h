...
#define GLYPH_FEMALE_MON_OFF  (NUM_MONSTERS + GLYPH_RIDDEN_OFF)
...
#define GLYPH_CURSOR_OFF  (NUM_PLAYER_CHARACTERS + GLYPH_PLAYER_OFF)
#define GLYPH_UI_TILE_OFF  (MAX_CURSORS + GLYPH_CURSOR_OFF)
#define GLYPH_ANIMATION_OFF         (MAX_UI_TILES + GLYPH_UI_TILE_OFF)
#define MAX_GLYPH         (MAX_ANIMATION_FRAMES + GLYPH_ANIMATION_OFF)
