...
#define NEWSYM_FLAGS_KEEP_OLD_BACKGROUND_EFFECT_GLYPH   0x00000008UL
...
#define NEWSYM_FLAGS_KEEP_OLD_FLAGS                     0x00000010UL
...
#define GLYPH_UI_TILE_OFF  (MAX_HIT_TILES + GLYPH_HIT_TILE_OFF)
...
#define cmap_to_glyph(cmap_idx) ((int) (cmap_idx) + get_current_cmap_type_index() * NUM_CMAP_TYPE_CHARS + GLYPH_CMAP_OFF)
#define broken_cmap_to_glyph(bcmap_idx) ((int) (bcmap_idx) + get_current_cmap_type_index() * NUM_CMAP_TYPE_CHARS + GLYPH_BROKEN_CMAP_OFF)
...
#define display_self() display_self_with_extra_info_choose_ascii(0UL, 0, FALSE)
