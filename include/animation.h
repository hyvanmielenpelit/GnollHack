...
#define DUST_VORTEX_SWALLOW_ANIMATION_OFF (ELF_PRIEST_MALE_CHAOTIC_KICK_ANIMATION_FRAMES + ELF_PRIEST_MALE_CHAOTIC_KICK_ANIMATION_OFF)
...
#define PONY_ENLARGEMENT_OFF (ELF_PRIEST_MALE_CHAOTIC_KICK_ENLARGEMENT_TILES * ELF_PRIEST_MALE_CHAOTIC_KICK_ANIMATION_FRAMES + ELF_PRIEST_MALE_CHAOTIC_KICK_ENLARGEMENT_OFF)
