...
#define DRACOLICH_ATTACK_ENLARGEMENT_OFF (HUMAN_KNIGHT_FEMALE_KICK_ENLARGEMENT_TILES * HUMAN_KNIGHT_FEMALE_KICK_ANIMATION_FRAMES + HUMAN_KNIGHT_FEMALE_KICK_ENLARGEMENT_OFF)
