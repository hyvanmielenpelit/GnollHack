...
#define DUST_VORTEX_SWALLOW_ANIMATION_OFF (DWARF_KNIGHT_FEMALE_KICK_ANIMATION_FRAMES + DWARF_KNIGHT_FEMALE_KICK_ANIMATION_OFF)
...
#define PONY_ENLARGEMENT_OFF (DWARF_KNIGHT_FEMALE_KICK_ENLARGEMENT_TILES * DWARF_KNIGHT_FEMALE_KICK_ANIMATION_FRAMES + DWARF_KNIGHT_FEMALE_KICK_ENLARGEMENT_OFF)
