...
#define MAGIC_MISSILE_RAY_ANIMATION_FRAMES 8
#define MAGIC_MISSILE_RAY_ANIMATION_TILES 8
...
#define FROST_BREATH_ANIMATION_OFF (FROST_RAY_ANIMATION_FRAMES * NUM_ZAP_CHARS + FROST_RAY_ANIMATION_OFF)
