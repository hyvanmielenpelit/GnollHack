...
#define DUST_VORTEX_SWALLOW_ANIMATION_OFF (ELF_PRIEST_MALE_CHAOTIC_CAST_ANIMATION_FRAMES + ELF_PRIEST_MALE_CHAOTIC_CAST_ANIMATION_OFF)
#define DUST_VORTEX_SWALLOW_ANIMATION_FRAMES 3
#define DUST_VORTEX_SWALLOW_ANIMATION_TILES 3 
#define TWISTED_CANDLE_ANIMATION_OFF (DUST_VORTEX_SWALLOW_ANIMATION_FRAMES * MAX_SWALLOW_CHARS + DUST_VORTEX_SWALLOW_ANIMATION_OFF)
...
#define DRACOLICH_ATTACK_ENLARGEMENT_OFF (ELF_PRIEST_MALE_CHAOTIC_CAST_ENLARGEMENT_TILES * ELF_PRIEST_MALE_CHAOTIC_CAST_ANIMATION_FRAMES + ELF_PRIEST_MALE_CHAOTIC_CAST_ENLARGEMENT_OFF)
