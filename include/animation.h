...
#define DUNGEON_NORMAL_WATER_REPLACEMENT_TILES (MAX_FLOOR_CATEGORIES + MAX_GRASS_CATEGORIES + MAX_GROUND_CATEGORIES + MAX_CORRIDOR_CATEGORIES + 3)
#define DUNGEON_NORMAL_ICE_REPLACEMENT_OFF (DUNGEON_NORMAL_WATER_REPLACEMENT_TILES + DUNGEON_NORMAL_WATER_REPLACEMENT_OFF)
#define DUNGEON_NORMAL_ICE_REPLACEMENT_TILES (MAX_FLOOR_CATEGORIES + MAX_GRASS_CATEGORIES + MAX_GROUND_CATEGORIES + MAX_CORRIDOR_CATEGORIES + 3)
#define DUNGEON_NORMAL_LAVA_REPLACEMENT_OFF (DUNGEON_NORMAL_ICE_REPLACEMENT_TILES + DUNGEON_NORMAL_ICE_REPLACEMENT_OFF)
#define DUNGEON_NORMAL_LAVA_REPLACEMENT_TILES (MAX_FLOOR_CATEGORIES + MAX_GRASS_CATEGORIES + MAX_GROUND_CATEGORIES + MAX_CORRIDOR_CATEGORIES + 3)
