...
enum enlargement_types
{
    ...
    DUNGEON_NORMAL_UPSTAIRS_ENLARGEMENT /* Keep this last */
};

#define NUM_ENLARGEMENTS DUNGEON_NORMAL_UPSTAIRS_ENLARGEMENT
...
#define UPSTAIRS_ENLARGEMENT_OFF (DRACOLICH_STATUE_ENLARGEMENT_FRAMES + DRACOLICH_STATUE_ENLARGEMENT_OFF)
#define UPSTAIRS_ENLARGEMENT_FRAMES 1

#define MAX_ENLARGEMENT_FRAMES (UPSTAIRS_ENLARGEMENT_FRAMES + UPSTAIRS_ENLARGEMENT_OFF)
...
#define LOOK_CURSOR_ANIMATION_OFF (BRASS_LANTERN_LIT_ANIMATION_FRAMES + BRASS_LANTERN_LIT_ANIMATION_OFF)
#define LOOK_CURSOR_ANIMATION_FRAMES 3
#define TWISTED_CANDLE_ANIMATION_OFF (LOOK_CURSOR_ANIMATION_FRAMES + LOOK_CURSOR_ANIMATION_OFF)
...
#define HANDCRAFTED_CANDLE_LIT_OFF (COIN_REPLACEMENT_TILES + COIN_REPLACEMENT_OFF)
#define HANDCRAFTED_CANDLE_LIT_TILES 1
#define BRASS_LANTERN_LIT_OFF (HANDCRAFTED_CANDLE_LIT_TILES + HANDCRAFTED_CANDLE_LIT_OFF)
