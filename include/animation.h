...
#define DRACOLICH_ATTACK_ENLARGEMENT_OFF (ELF_PRIEST_MALE_CHAOTIC_ATTACK_ENLARGEMENT_TILES * ELF_PRIEST_MALE_CHAOTIC_ATTACK_ANIMATION_FRAMES + ELF_PRIEST_MALE_CHAOTIC_ATTACK_ENLARGEMENT_OFF)
