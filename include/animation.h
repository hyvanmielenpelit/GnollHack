...
#define TWISTED_CANDLE_ANIMATION_OFF (HUMAN_KNIGHT_FEMALE_KICK_ANIMATION_FRAMES + HUMAN_KNIGHT_FEMALE_KICK_ANIMATION_OFF)
...
#define DRACOLICH_ENLARGEMENT_POSITIONS 5

#define DRACOLICH_STATUE_ENLARGEMENT_OFF (DRACOLICH_ENLARGEMENT_POSITIONS + DRACOLICH_ENLARGEMENT_OFF)
#define DRACOLICH_STATUE_ENLARGEMENT_POSITIONS 5

#define TREE_ENLARGEMENT_OFF (DRACOLICH_STATUE_ENLARGEMENT_POSITIONS + DRACOLICH_STATUE_ENLARGEMENT_OFF)
#define TREE_ENLARGEMENT_POSITIONS 5

#define UPSTAIRS_ENLARGEMENT_OFF (TREE_ENLARGEMENT_POSITIONS + TREE_ENLARGEMENT_OFF)
#define UPSTAIRS_ENLARGEMENT_POSITIONS 1

#define BRANCH_UPSTAIRS_ENLARGEMENT_OFF (UPSTAIRS_ENLARGEMENT_POSITIONS + UPSTAIRS_ENLARGEMENT_OFF)
#define BRANCH_UPSTAIRS_ENLARGEMENT_POSITIONS 1

#define SPECIAL_BRANCH_UPSTAIRS_ENLARGEMENT_OFF (BRANCH_UPSTAIRS_ENLARGEMENT_POSITIONS + BRANCH_UPSTAIRS_ENLARGEMENT_OFF)
#define SPECIAL_BRANCH_UPSTAIRS_ENLARGEMENT_POSITIONS 1

#define HUMAN_KNIGHT_FEMALE_ATTACK_ENLARGEMENT_OFF (SPECIAL_BRANCH_UPSTAIRS_ENLARGEMENT_POSITIONS + SPECIAL_BRANCH_UPSTAIRS_ENLARGEMENT_OFF)
#define HUMAN_KNIGHT_FEMALE_ATTACK_ENLARGEMENT_POSITIONS 2

#define HUMAN_KNIGHT_FEMALE_KICK_ENLARGEMENT_OFF (HUMAN_KNIGHT_FEMALE_ATTACK_ENLARGEMENT_POSITIONS * HUMAN_KNIGHT_FEMALE_ATTACK_ANIMATION_FRAMES + HUMAN_KNIGHT_FEMALE_ATTACK_ENLARGEMENT_OFF)
#define HUMAN_KNIGHT_FEMALE_KICK_ENLARGEMENT_POSITIONS 2

#define DRACOLICH_ATTACK_ENLARGEMENT_OFF (HUMAN_KNIGHT_FEMALE_KICK_ENLARGEMENT_POSITIONS * HUMAN_KNIGHT_FEMALE_KICK_ANIMATION_FRAMES + HUMAN_KNIGHT_FEMALE_KICK_ENLARGEMENT_OFF)
#define DRACOLICH_ATTACK_ENLARGEMENT_POSITIONS 5

#define TOTAL_ENLARGEMENT_POSITIONS (DRACOLICH_ATTACK_ENLARGEMENT_POSITIONS * DRACOLICH_ATTACK_ANIMATION_FRAMES + DRACOLICH_ATTACK_ENLARGEMENT_OFF)
...
#define DUNGEON_NORMAL_WATER_REPLACEMENT_OFF (IRON_BAR_REPLACEMENT_TILES + IRON_BAR_REPLACEMENT_OFF)
#define DUNGEON_NORMAL_WATER_REPLACEMENT_TILES (MAX_FLOOR_CATEGORIES + MAX_GRASS_CATEGORIES + MAX_GROUND_CATEGORIES + MAX_CORRIDOR_CATEGORIES)
#define DUNGEON_NORMAL_ICE_REPLACEMENT_OFF (DUNGEON_NORMAL_WATER_REPLACEMENT_TILES + DUNGEON_NORMAL_WATER_REPLACEMENT_OFF)
#define DUNGEON_NORMAL_ICE_REPLACEMENT_TILES (MAX_FLOOR_CATEGORIES + MAX_GRASS_CATEGORIES + MAX_GROUND_CATEGORIES + MAX_CORRIDOR_CATEGORIES)
#define DUNGEON_NORMAL_LAVA_REPLACEMENT_OFF (DUNGEON_NORMAL_ICE_REPLACEMENT_TILES + DUNGEON_NORMAL_ICE_REPLACEMENT_OFF)
#define DUNGEON_NORMAL_LAVA_REPLACEMENT_TILES (MAX_FLOOR_CATEGORIES + MAX_GRASS_CATEGORIES + MAX_GROUND_CATEGORIES + MAX_CORRIDOR_CATEGORIES)
#define BRASS_LANTERN_LIT_OFF (DUNGEON_NORMAL_LAVA_REPLACEMENT_TILES + DUNGEON_NORMAL_LAVA_REPLACEMENT_OFF)
