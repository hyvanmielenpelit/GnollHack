...
#define NUM_SHORE_TILES (MAX_FLOOR_CATEGORIES + MAX_GRASS_CATEGORIES + MAX_GROUND_CATEGORIES + MAX_CORRIDOR_CATEGORIES + 5)
...
#define DUNGEON_NORMAL_STAIRS_UP_REPLACEMENT_OFF (DUNGEON_NORMAL_AIR_REPLACEMENT_TILES + DUNGEON_NORMAL_AIR_REPLACEMENT_OFF)
