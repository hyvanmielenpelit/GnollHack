...
#define TWISTED_CANDLE_ANIMATION_OFF (DRACOLICH_ATTACK_ANIMATION_FRAMES + DRACOLICH_ATTACK_ANIMATION_OFF)
...
#define DRACOLICH_ATTACK_ENLARGEMENT_OFF (SPECIAL_BRANCH_UPSTAIRS_ENLARGEMENT_FRAMES + SPECIAL_BRANCH_UPSTAIRS_ENLARGEMENT_OFF)
