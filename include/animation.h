...
#define OCHRE_JELLY_SWALLOW_ANIMATION_OFF (HUMAN_MONK_MALE_KICK_ANIMATION_FRAMES + HUMAN_MONK_MALE_KICK_ANIMATION_OFF)
...
#define PONY_ENLARGEMENT_OFF (HUMAN_MONK_MALE_KICK_ENLARGEMENT_TILES * HUMAN_MONK_MALE_KICK_ANIMATION_FRAMES + HUMAN_MONK_MALE_KICK_ENLARGEMENT_OFF)
