...
#define DUST_VORTEX_SWALLOW_ANIMATION_OFF (ELF_PRIEST_MALE_CHAOTIC_ATTACK_ANIMATION_FRAMES + ELF_PRIEST_MALE_CHAOTIC_ATTACK_ANIMATION_OFF)
...
#define TWISTED_CANDLE_ANIMATION_OFF (FIERY_EXPLOSION_ANIMATION_FRAMES * MAX_EXPLOSION_CHARS + FIERY_EXPLOSION_ANIMATION_OFF)
...
#define TREE_ENLARGEMENT_OFF (DRACOLICH_STATUE_ENLARGEMENT_TILES + DRACOLICH_STATUE_ENLARGEMENT_OFF)
...
#define PONY_ENLARGEMENT_OFF (ELF_PRIEST_MALE_CHAOTIC_ATTACK_ENLARGEMENT_TILES * ELF_PRIEST_MALE_CHAOTIC_ATTACK_ANIMATION_FRAMES + ELF_PRIEST_MALE_CHAOTIC_ATTACK_ENLARGEMENT_OFF)
#define PONY_ENLARGEMENT_TILES 1

#define PONY_STATUE_ENLARGEMENT_OFF (PONY_ENLARGEMENT_OFF + PONY_ENLARGEMENT_OFF)
#define PONY_STATUE_ENLARGEMENT_TILES 1

#define DRACOLICH_ATTACK_ENLARGEMENT_OFF (PONY_STATUE_ENLARGEMENT_OFF + PONY_STATUE_ENLARGEMENT_OFF)
...
#define GNOMISH_MINES_STONE_REPLACEMENT_OFF (DUNGEON_NORMAL_LAVA_REPLACEMENT_TILES + DUNGEON_NORMAL_LAVA_REPLACEMENT_OFF)
...
#define BRASS_LANTERN_LIT_OFF (GNOMISH_MINES_IRON_BAR_REPLACEMENT_TILES + GNOMISH_MINES_IRON_BAR_REPLACEMENT_OFF)
