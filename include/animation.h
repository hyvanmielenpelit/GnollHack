...
#define DRACOLICH_ATTACK_ANIMATION_OFF (KOBOLD_LORD_ANIMATION_FRAMES + KOBOLD_LORD_ANIMATION_OFF)
...
#define HUMAN_KNIGHT_FEMALE_ATTACK_ANIMATION_OFF (MAGIC_FOUNTAIN_ANIMATION_FRAMES + MAGIC_FOUNTAIN_ANIMATION_OFF)
...
#define HUMAN_KNIGHT_FEMALE_ATTACK_ENLARGEMENT_OFF (SPECIAL_BRANCH_UPSTAIRS_ENLARGEMENT_FRAMES + SPECIAL_BRANCH_UPSTAIRS_ENLARGEMENT_OFF)
#define HUMAN_KNIGHT_FEMALE_ATTACK_ENLARGEMENT_FRAMES 2

#define HUMAN_KNIGHT_FEMALE_KICK_ENLARGEMENT_OFF (HUMAN_KNIGHT_FEMALE_ATTACK_ENLARGEMENT_FRAMES * HUMAN_KNIGHT_FEMALE_ATTACK_ANIMATION_FRAMES + HUMAN_KNIGHT_FEMALE_ATTACK_ENLARGEMENT_OFF)
#define HUMAN_KNIGHT_FEMALE_KICK_ENLARGEMENT_FRAMES 2

#define DRACOLICH_ATTACK_ENLARGEMENT_OFF (HUMAN_KNIGHT_FEMALE_KICK_ENLARGEMENT_FRAMES * HUMAN_KNIGHT_FEMALE_KICK_ANIMATION_FRAMES + HUMAN_KNIGHT_FEMALE_KICK_ENLARGEMENT_OFF)
#define DRACOLICH_ATTACK_ENLARGEMENT_FRAMES 5

#define MAX_ENLARGEMENT_FRAMES (DRACOLICH_ATTACK_ENLARGEMENT_FRAMES * DRACOLICH_ATTACK_ANIMATION_FRAMES + DRACOLICH_ATTACK_ENLARGEMENT_OFF)
