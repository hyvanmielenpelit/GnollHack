...
#define FIRE_RAY_ANIMATION_OFF (MAGIC_EXPLOSION_ANIMATION_FRAMES * MAX_EXPLOSION_CHARS + MAGIC_EXPLOSION_ANIMATION_OFF)
...
#define TREE_ENLARGEMENT_OFF (TARRASQUE_STATUE_ENLARGEMENT_TILES + TARRASQUE_STATUE_ENLARGEMENT_OFF)
