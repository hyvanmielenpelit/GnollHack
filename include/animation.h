...
#define MAGIC_MISSILE_RAY_ANIMATION_OFF (FIRE_RAY_ANIMATION_FRAMES * MAX_ZAP_CHARS + FIRE_RAY_ANIMATION_OFF)
#define MAGIC_MISSILE_RAY_ANIMATION_FRAMES 8
#define MAGIC_MISSILE_RAY_ANIMATION_TILES 8
#define FROST_BREATH_ANIMATION_OFF (MAGIC_MISSILE_RAY_ANIMATION_FRAMES * MAX_ZAP_CHARS + MAGIC_MISSILE_RAY_ANIMATION_OFF)
#define FROST_BREATH_ANIMATION_FRAMES 10
#define FROST_BREATH_ANIMATION_TILES 10
#define GENERIC_SPELL_EFFECT_ANIMATION_OFF (FROST_BREATH_ANIMATION_FRAMES * MAX_ZAP_CHARS + FROST_BREATH_ANIMATION_OFF)
