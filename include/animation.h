...
#define DUST_VORTEX_SWALLOW_ANIMATION_OFF (HUMAN_KNIGHT_FEMALE_CAST_ANIMATION_FRAMES + HUMAN_KNIGHT_FEMALE_CAST_ANIMATION_OFF)
...
#define DRACOLICH_ATTACK_ENLARGEMENT_OFF (HUMAN_KNIGHT_FEMALE_CAST_ENLARGEMENT_TILES * HUMAN_KNIGHT_FEMALE_CAST_ANIMATION_FRAMES + HUMAN_KNIGHT_FEMALE_CAST_ENLARGEMENT_OFF)
