...
enum enlargement_types
{
    ...
    TREE_ENLARGEMENT,
    DUNGEON_NORMAL_BOULDER_ENLARGEMENT,
...
#define BOULDER_ENLARGEMENT_OFF (TREE_ENLARGEMENT_FRAMES + TREE_ENLARGEMENT_OFF)
#define BOULDER_ENLARGEMENT_FRAMES 2

#define UPSTAIRS_ENLARGEMENT_OFF (BOULDER_ENLARGEMENT_FRAMES + BOULDER_ENLARGEMENT_OFF)
...
#define CHEST_REPLACEMENT_OFF (HANDCRAFTED_CANDLE_LIT_TILES + HANDCRAFTED_CANDLE_LIT_OFF)
