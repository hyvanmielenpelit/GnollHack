...
#define DUST_VORTEX_SWALLOW_ANIMATION_OFF (ORC_ROGUE_FEMALE_ATTACK_ANIMATION_FRAMES + ORC_ROGUE_FEMALE_ATTACK_ANIMATION_OFF)
...
#define PONY_ENLARGEMENT_OFF (ORC_ROGUE_FEMALE_ATTACK_ENLARGEMENT_TILES * ORC_ROGUE_FEMALE_ATTACK_ANIMATION_FRAMES + ORC_ROGUE_FEMALE_ATTACK_ENLARGEMENT_OFF)
