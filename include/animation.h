...
#define DUST_VORTEX_SWALLOW_ANIMATION_OFF (HUMAN_TOURIST_MALE_KICK_ANIMATION_FRAMES + HUMAN_TOURIST_MALE_KICK_ANIMATION_OFF)
...
#define PONY_ENLARGEMENT_OFF (HUMAN_TOURIST_MALE_KICK_ENLARGEMENT_TILES * HUMAN_TOURIST_MALE_KICK_ANIMATION_FRAMES + HUMAN_TOURIST_MALE_KICK_ENLARGEMENT_OFF)
...
#define DRACOLICH_ATTACK_ENLARGEMENT_OFF (WARHORSE_STATUE_ENLARGEMENT_TILES + WARHORSE_STATUE_ENLARGEMENT_OFF)
...
#define DUNGEON_NORMAL_GROUND_REPLACEMENT_OFF (DUNGEON_NORMAL_GRASS_REPLACEMENT_TILES + DUNGEON_NORMAL_GRASS_REPLACEMENT_OFF)
...
#define DUNGEON_NORMAL_STAIRS_UP_REPLACEMENT_TILES (MAX_FLOOR_CATEGORIES + MAX_GRASS_CATEGORIES + MAX_GROUND_CATEGORIES + MAX_CORRIDOR_CATEGORIES + 4)
...
#define DUNGEON_NORMAL_STAIRS_DOWN_REPLACEMENT_TILES (MAX_FLOOR_CATEGORIES + MAX_GRASS_CATEGORIES + MAX_GROUND_CATEGORIES + MAX_CORRIDOR_CATEGORIES + 4)
...
#define DUNGEON_NORMAL_TRAPDOOR_REPLACEMENT_TILES (MAX_FLOOR_CATEGORIES + MAX_GRASS_CATEGORIES + MAX_GROUND_CATEGORIES + MAX_CORRIDOR_CATEGORIES + 4)
...
#define DUNGEON_NORMAL_HOLE_REPLACEMENT_TILES (MAX_FLOOR_CATEGORIES + MAX_GRASS_CATEGORIES + MAX_GROUND_CATEGORIES + MAX_CORRIDOR_CATEGORIES + 4)
#define DUNGEON_NORMAL_PIT_REPLACEMENT_OFF (DUNGEON_NORMAL_HOLE_REPLACEMENT_TILES + DUNGEON_NORMAL_HOLE_REPLACEMENT_OFF)
#define DUNGEON_NORMAL_PIT_REPLACEMENT_TILES (MAX_FLOOR_CATEGORIES + MAX_GRASS_CATEGORIES + MAX_GROUND_CATEGORIES + MAX_CORRIDOR_CATEGORIES + 4)
#define DUNGEON_NORMAL_SPIKED_PIT_REPLACEMENT_OFF (DUNGEON_NORMAL_PIT_REPLACEMENT_TILES + DUNGEON_NORMAL_PIT_REPLACEMENT_OFF)
#define DUNGEON_NORMAL_SPIKED_PIT_REPLACEMENT_TILES (MAX_FLOOR_CATEGORIES + MAX_GRASS_CATEGORIES + MAX_GROUND_CATEGORIES + MAX_CORRIDOR_CATEGORIES + 4)
