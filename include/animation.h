...
#define DUNGEON_NORMAL_GROUND_REPLACEMENT_OFF (DUNGEON_NORMAL_LAVA_REPLACEMENT_TILES + DUNGEON_NORMAL_LAVA_REPLACEMENT_OFF)
...
#define GNOMISH_MINES_STONE_REPLACEMENT_OFF (DUNGEON_NORMAL_GROUND_REPLACEMENT_TILES + DUNGEON_NORMAL_GROUND_REPLACEMENT_OFF)
