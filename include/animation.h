...
#define TWISTED_CANDLE_ANIMATION_OFF (SUMMON_DEMON_ANIMATION_FRAMES + SUMMON_DEMON_ANIMATION_OFF)
...
#define TOTAL_ENLARGEMENT_TILES (SUMMON_DEMON_ENLARGEMENT_TILES * SUMMON_DEMON_ANIMATION_FRAMES + SUMMON_DEMON_ENLARGEMENT_OFF)
