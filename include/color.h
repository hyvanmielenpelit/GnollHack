...
#define HI_ELEMENTAL_PLANES CLR_GRAY
#define HI_ASTRAL CLR_BRIGHT_CYAN
#define HI_GARDEN CLR_BRIGHT_GREEN
#define HI_MODRON CLR_GRAY
#define HI_SHOP CLR_MAGENTA
#define HI_REINFORCED CLR_CYAN
#define HI_NEST CLR_YELLOW
#define HI_TOWER CLR_BRIGHT_BLUE
#define HI_OPULENT CLR_BRIGHT_MAGENTA
