...
#define HI_ASTRAL CLR_BRIGHT_CYAN /* HI_GLASS */
#define HI_GARDEN CLR_BRIGHT_GREEN
#define HI_MODRON CLR_MAGENTA /* to make it look special */
...
#define HI_OPULENT CLR_BRIGHT_MAGENTA /* could be also CLR_MAGENTA but best choice seems to depend on the color scheme */
