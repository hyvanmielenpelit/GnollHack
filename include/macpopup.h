...
extern char topl_yn_function_ex(int style, int attr, int color, int glyph, const char* title, const char *query, const char *resp, int def, const char* resp_desc, const char* introline, uint64_t ynflags);
