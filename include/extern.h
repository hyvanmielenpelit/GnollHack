...
E short FDECL(maybe_get_animated_tile, (short, enum animation_play_types, unsigned long, boolean*, enum autodraw_types*));
...
E void FDECL(set_occupation, (int (*)(void), const char *, enum object_soundset_types, int /*enum object_occupation_types*/, enum occupation_sound_types, int));
