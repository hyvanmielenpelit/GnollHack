...
E const char* FDECL(get_game_mode_text, (boolean));
E const char* FDECL(get_game_mode_text_core, (boolean, boolean, boolean, boolean, boolean, boolean, boolean));
E const char* NDECL(get_game_mode_description);
E const char* FDECL(get_game_mode_description_core, (boolean, boolean, boolean, boolean));
...
E void NDECL(reset_all_object_origin_coordinates);
...
E struct replacement_info FDECL(data_to_replacement_info, (int, int, struct obj*, struct monst*, uint64_t, uint64_t, uint64_t, uchar, short));
E int FDECL(get_animation_frame_with_tile, (int, int));
E void FDECL(play_special_effect_with_details_at, (int, int, int, int, enum layer_types, short, int, int, int, boolean));
...
E int FDECL(use_unicorn_horn, (struct obj *, boolean));
...
E boolean FDECL(turn_undead_success_effect, (struct monst*, int, int, int));
...
E const char *FDECL(artiname, (short));
E struct obj *FDECL(mk_artifact, (struct obj *, aligntyp, uchar));
...
E boolean FDECL(artifact_has_flag, (struct obj *, uint64_t));
E boolean FDECL(artifact_confers_monster_power, (struct monst*, struct obj*, int));
E boolean FDECL(mythic_confers_monster_power, (struct monst*, struct obj*, int));
E boolean FDECL(material_confers_monster_power, (struct monst*, struct obj*, int));
...
E void FDECL(set_artifact_intrinsic, (struct obj *, int64_t));
E int FDECL(touch_artifact, (struct obj *, struct monst *));
E int FDECL(spec_abon, (struct obj *, struct monst *));
E double FDECL(spec_dbon, (struct obj *, struct monst *, struct monst*, double));
E void FDECL(discover_artifact, (short));
E boolean FDECL(undiscovered_artifact, (short));
...
E uint64 FDECL(spec_m2, (struct obj *));
E boolean FDECL(artifact_has_invprop, (struct obj *, uchar));
E int64_t FDECL(arti_cost, (struct obj *));
E struct obj *FDECL(what_gives, (int, boolean));
E const char *FDECL(glow_color, (int));
E const char *FDECL(glow_verb, (int, boolean));
...
E boolean FDECL(carried_base_item_is_giving_monster_power, (struct monst*, struct obj*, int, boolean));
E boolean FDECL(worn_base_item_is_giving_monster_power, (struct monst*, struct obj*, int, boolean));
E boolean FDECL(item_is_giving_monster_power, (struct monst*, struct obj*, int, boolean));
E boolean FDECL(item_is_giving_power, (struct obj*, int));
E boolean FDECL(item_is_giving_known_power, (struct obj*, int));
E boolean FDECL(carried_artifact_is_giving_monster_power, (struct monst*, struct obj*, int));
E uint64_t FDECL(prop_to_spfx, (int));
E int FDECL(spfx_to_prop, (uint64_t));
...
E uchar FDECL(m_adjattrib, (struct monst*, int, int, boolean));
E void FDECL(gainstr, (struct obj *, int, boolean));
E void FDECL(losestr, (int));
E void FDECL(poisontell, (int, boolean));
E void FDECL(poisoned, (const char *, int, const char *, int, boolean, int, struct monst*));
E void FDECL(extra_enchantment_damage, (const char*, uchar, const char*, boolean, struct monst*));
E void FDECL(change_luck, (int, boolean));
...
E int FDECL(m_hpmaxadjustment, (struct monst*, boolean));
...
E boolean FDECL(parse_status_hl1, (char *op, boolean));
...
#endif
E const char* FDECL(get_condition_name, (uint64_t));
E uint64_t NDECL(get_u_condition_bits);
E uint64_t FDECL(get_m_status_bits, (struct monst*, boolean, boolean, boolean, boolean));
E uint64_t FDECL(get_m_condition_bits, (struct monst*));
E void FDECL(get_m_buff_bits, (struct monst*, uint64_t*, boolean));
...
E const char *FDECL(key2extcmddesc, (uchar));
E boolean FDECL(bind_specialkey, (char, const char *));
...
E boolean FDECL(bind_key, (uchar, const char *));
...
E int FDECL(getdir_ex, (const char*, boolean));
...
E char FDECL(get_count, (char *, char, int64_t, int64_t *, boolean));
...
E char* FDECL(key2txt, (uchar, char *));
E char FDECL(yn_function, (const char*, const char*, char, const char*));
E char FDECL(yn_function_core, (int, int, int, int, const char*, const char *, const char *, char, const char*, const char*, uint64_t));
E char FDECL(yn_function_mon, (struct monst*, const char*, const char*, char, const char*));
E char FDECL(yn_function_end, (const char*, const char*, char, const char*));
...
E boolean FDECL(paranoid_query_ex, (int, int, boolean, const char*, const char*));
...
E void FDECL(open_drawbridge, (int, int, boolean));
E void FDECL(maybe_close_drawbridge, (int, int, boolean));
E void FDECL(close_drawbridge, (int, int, boolean));
...
E int FDECL(reveal_terrain_getglyph, (int, int, int, boolean, int, int));
...
E int FDECL(unearth_objs, (struct monst*, int, int, boolean, boolean));
E int FDECL(rot_organic, (ANY_P *, int64_t));
E int FDECL(rot_corpse, (ANY_P *, int64_t));
...
E void FDECL(map_object_no_chain_check_choose_ascii, (struct obj*, int, boolean));
E void FDECL(map_object_core, (struct obj*, int, boolean, boolean, boolean));
...
E void FDECL(newsym_with_flags, (int, int, uint64_t));
E void FDECL(newsym_with_extra_info_and_flags, (int, int, uint64_t, uint64_t, int, int, uint64_t));
E void FDECL(newsym_force, (int, int));
E void FDECL(force_redraw_at, (int, int));
E void FDECL(shieldeff, (xchar, xchar));
E void FDECL(talkeff, (xchar, xchar));
E void FDECL(tmp_at, (int, int));
E void FDECL(tmp_at_with_missile_flags, (int, int, uint64_t, uchar, short));
E void FDECL(tmp_at_with_obj, (int, int, struct obj*, uint64_t, uchar, short));
...
E void FDECL(maybe_clear_and_show_glyph, (int, int, int, boolean));
...
E void FDECL(show_monster_glyph_with_extra_info, (int, int, int, struct monst*, uint64_t, uint64_t, int, int));
E void FDECL(show_monster_glyph_with_extra_info_choose_ascii, (int, int, int, struct monst*, int, int, uint64_t, uint64_t, int, int, boolean));
...
E void FDECL(show_extra_info, (int, int, uint64_t, uint64_t, int, int));
E void FDECL(show_missile_info, (int, int, uchar, uchar, short, uchar, uchar, uchar, uchar, uchar, uchar, uint64_t, short, xchar, xchar));
E uint64_t FDECL(get_missile_flags, (struct obj*, boolean));
...
E void FDECL(add_glyph_buffer_layer_flags, (int, int, uint64_t, uint64_t));
E void FDECL(remove_glyph_buffer_layer_flags, (int, int, uint64_t, uint64_t));
E void FDECL(set_glyph_buffer_object_height, (int, int, short));
E void FDECL(set_glyph_buffer_feature_doodad_height, (int, int, schar));
...
E int FDECL(back_to_broken_glyph, (xchar, xchar));
E int FDECL(zapdir_to_glyph, (int, int, int));
E int FDECL(zapbounce_to_glyph, (int, int, int, int, int));
E int FDECL(zap_glyph_to_corner_glyph, (int, uint64_t, int));
E int FDECL(dir_to_beam_index, (int, int));
E int FDECL(glyph_at, (xchar, xchar));
E struct layer_info FDECL(layers_at, (xchar, xchar));
...
E void FDECL(display_self_with_extra_info_choose_ascii, (uint64_t, uint64_t, int, int, boolean));
E int FDECL(get_location_light_range, (xchar, xchar));
E int FDECL(get_location_light_sidedness, (xchar, xchar));
...
E void FDECL(update_tile_gui_info, (boolean, struct monst*, int, int, uint64_t, uint64_t));
E void FDECL(refresh_u_tile_gui_info, (boolean));
E void FDECL(refresh_m_tile_gui_info, (struct monst*, boolean));
...
E const char* FDECL(get_damage_type_text, (short));
...
E boolean FDECL(dropxf, (struct obj*));
E boolean FDECL(dropy, (struct obj *));
E boolean FDECL(dropyf, (struct obj*));
E boolean FDECL(dropz, (struct obj *, boolean));
...
E void FDECL(goto_level, (d_level *, uchar, boolean, boolean, xchar));
E void FDECL(schedule_goto, (d_level *, uchar, boolean, boolean, boolean, int64_t,
...
E int FDECL(revive_mon, (ANY_P *, int64_t));
E int NDECL(donull);
E int NDECL(dowipe);
E void FDECL(set_wounded_legs, (int64_t, int));
...
E void FDECL(printweight, (char*, int, boolean, boolean, boolean));
E void FDECL(printdice, (char*, int, int, int));
...
E void FDECL(delete_decoration, (xchar, xchar));
E void FDECL(full_location_transform, (xchar, xchar, int, int, int, unsigned short, schar, schar, uchar, schar, schar, schar, uchar, int, int, int, int, boolean, boolean, short, short, boolean));
E void FDECL(full_initial_location_transform, (xchar, xchar, int, unsigned short, schar, schar, uchar, schar, schar, schar, uchar, int, int, boolean, boolean, short, short, boolean));
...
E void FDECL(create_simple_location_with_carpet, (xchar, xchar, int, int, int, unsigned short, schar, schar, uchar, int, int, int, int, boolean));
...
E struct extended_create_window_info FDECL(extended_create_window_info_from_mon_with_flags, (struct monst*, uint64_t));
...
E void FDECL(item_destruction_hint, (int, boolean));
...
E void FDECL(getpos_sethilite, (void (*f)(int), int (*d)(int,int)));
...
E const char* FDECL(hcolor_multi, (const char*, int*, int));
E const char* FDECL(hcolor_multi_buf0, (const char*));
E const char* FDECL(hcolor_multi_buf1, (const char*));
E const char* FDECL(hcolor_multi_buf2, (const char*));
E const char* FDECL(hcolor_multi_buf3, (const char*));
E const char* FDECL(hcolor_multi_buf4, (const char*));
E int FDECL(color_name_to_nhcolor, (const char*));
...
E const char *FDECL(noveltitle, (short *, uint64_t, uint64_t));
E const char* FDECL(manualtitle, (short*, uint64_t, uint64_t));
...
E int FDECL(select_on, (struct obj*));
...
E void FDECL(cancel_doff, (struct obj *, int64_t));
...
E int FDECL(cursed, (struct obj *, boolean));
E int FDECL(armoroff, (struct obj *));
E int FDECL(canwearobj, (struct obj *, int64_t *, boolean, boolean, int*));
E int NDECL(dowear);
E int NDECL(doputon);
E int NDECL(ddowear);
...
E boolean FDECL(inaccessible_equipment, (struct obj *, const char *, boolean, boolean));
...
E boolean FDECL(could_reach_item, (struct monst*, xchar, xchar));
E void FDECL(m_gainstr, (struct monst*, struct obj*, int, boolean));
...
E void FDECL(impact_drop, (struct obj *, xchar, xchar, xchar, boolean));
E int FDECL(kick_object, (xchar, xchar, char *, boolean));
...
E boolean FDECL(hitfloor, (struct obj *, boolean));
E void FDECL(hurtle, (int, int, int, boolean));
E void FDECL(mhurtle, (struct monst *, int, int, int));
E void FDECL(throwit, (struct obj *, int64_t));
E int FDECL(omon_adj, (struct monst *, struct obj *, boolean));
E int FDECL(thitmonst, (struct monst *, struct obj *, boolean, uchar *));
E boolean FDECL(hero_breaks, (struct obj *, xchar, xchar, boolean));
E boolean FDECL(breaks, (struct obj *, xchar, xchar));
E void FDECL(release_camera_demon, (struct obj *, xchar, xchar));
E boolean FDECL(breakobj, (struct obj *, xchar, xchar, boolean, boolean));
...
E struct multishot_result FDECL(get_multishot_stats, (struct monst*, struct obj*, struct obj*, uchar));
E void FDECL(check_shop_obj, (struct obj*, xchar, xchar, boolean, boolean));
E void NDECL(reset_throw);

/* ### do_wear.c ### */
E void FDECL(learnring, (struct obj*, boolean));
...
E void FDECL(overview_stats, (winid, const char *, int64_t *, size_t *));
...
E void FDECL(update_hunger_status, (boolean));
...
E int FDECL(eat_brains, (struct monst *, struct monst *, boolean, double *));
...
E unsigned FDECL(mon_obj_nutrition_value, (struct obj*, struct monst*));
E unsigned FDECL(mon_obj_oeaten_value, (struct obj*, struct monst*));
E unsigned FDECL(mon_nutrition_factor, (struct obj*, struct monst*, boolean));
E int FDECL(adjust_nutrition_base_value, (int, struct obj*, struct monst*));
...
#endif /* !MAKEDEFS_C && !LEV_LEX_C */
E void FDECL(set_panic_handling, (int, boolean));
E void VDECL(panic, (const char *, ...)) PRINTF_F(1, 2) NORETURN;
#if !defined(MAKEDEFS_C) && !defined(LEV_LEX_C)
E void FDECL(done, (int));
E void FDECL(container_contents, (struct obj *, boolean, boolean, boolean, int, boolean));
E void FDECL(magic_chest_contents, (boolean, boolean, boolean, int, boolean));
#ifdef VMS
E void FDECL(nh_terminate, (int));
E void FDECL(nh_bail, (int, const char*, boolean));
#else
E void FDECL(nh_terminate, (int)) NORETURN;
E void FDECL(nh_bail, (int, const char*, boolean)) NORETURN;
#endif
...
E struct item_score_count_result FDECL(count_sarcophaguses, (struct obj*));
E struct item_score_count_result FDECL(count_mummy_wrappings, (struct obj*));
E struct item_score_count_result FDECL(count_valuable_art_objects, (struct obj*));
E int64_t FDECL(count_archaeologist_item_score, (struct obj*));
...
E void FDECL(make_engr_at, (int, int, const char *, int64_t, xchar, unsigned short));
...
E void FDECL(engr_stats, (const char *, char *, int64_t *, size_t *));
...
E int64_t FDECL(game_score_difficulty_adjustment, (int64_t));

E void FDECL(losexp, (const char *));
E void NDECL(newexplevel);
E void FDECL(pluslvl, (boolean));
E int64_t FDECL(rndexp, (boolean));

/* ### explode.c ### */

E void FDECL(explode, (int, int, int, struct monst*, int, int, int, int, char, int));
E int64_t FDECL(scatter, (int, int, int, unsigned int, struct obj *));
E void FDECL(splatter_burning_oil, (int, int, boolean));
...
E int FDECL(open_savefilepath, (const char*));
E int NDECL(delete_savefile);
E int FDECL(ask_delete_invalid_savefile, (const char*, boolean));
E int NDECL(query_about_corrupted_savefile);
E int FDECL(open_and_validate_saved_game, (boolean, boolean*));
...
#endif
E void FDECL(config_error_init, (boolean, const char *, boolean));
...
E struct save_game_data FDECL(newsavegamedata, (char*, char*, struct save_game_stats, boolean, boolean, boolean));
#endif
...
E int FDECL(restore_backup_savefile, (boolean));
...
E void FDECL(reset_save_file_name, (boolean));
...
E int FDECL(get_file_descriptor_limit, (boolean));
#endif
...
E int FDECL(inv_cnt_ex, (boolean, boolean));
E int64_t FDECL(money_cnt, (struct obj *));
...
E struct extended_menu_info FDECL(menu_group_heading_info, (char));
...
#endif
E void FDECL(print_realtime, (char*, int64_t));
E int64_t FDECL(yyyymmdd, (time_t));
E int64_t FDECL(hhmmss, (time_t));
...
E void FDECL(write_nhsym_utf8, (char**, nhsym, boolean, boolean));
...
E Loot *FDECL(sortloot, (struct obj **, unsigned, boolean,
                         boolean (*)(OBJ_P)));
...
E void FDECL(update_all_character_properties, (struct obj*, boolean));
E struct obj *FDECL(addinv, (struct obj *));
E struct obj *FDECL(hold_another_object,
                    (struct obj *, const char *, const char *, const char *, boolean));
...
E void FDECL(delobj_with_flags, (struct obj*, uint64_t));
...
E struct obj* FDECL(carrying_class, (char));
...
E struct obj* FDECL(o_on_open_inventory, (unsigned int));
...
E boolean FDECL(is_wearable, (struct obj*));
E struct obj *FDECL(g_at, (int, int));
E boolean FDECL(splittable, (struct obj *));
E struct obj *FDECL(getobj, (const char *, const char *, int, const char*));
E struct obj* FDECL(getobj_ex, (const char*, const char*, int, boolean, const char*, boolean (*)(struct obj*), int64_t, unsigned int));
...
E int FDECL(count_unidentified, (struct obj *, boolean(*)(OBJ_P), boolean));
E int FDECL(count_unknown, (struct obj*, boolean(*)(OBJ_P), boolean));
E int FDECL(count_objects_in_class, (struct obj*, char, boolean(*)(OBJ_P), boolean));
E int FDECL(identify_pack, (int, boolean));
...
E void FDECL(prinv_ex, (const char*, struct obj*, int64_t, int, int, int, int, boolean, boolean));
E char *FDECL(xprname,
              (struct obj *, const char *, char, boolean, int64_t, int64_t));
E int NDECL(ddoinv);
E int NDECL(doseeworn);
E int NDECL(dolastpickeditem);
E int FDECL(display_item_command_menu_by_invlet, (char, int64_t, boolean*));
E int FDECL(display_item_command_menu, (struct obj*, int64_t, boolean*));
E char FDECL(display_inventory, (const char *, boolean, int, boolean));
E char FDECL(display_inventory_with_header, (const char*, boolean, int64_t*, int, boolean, boolean, boolean));
...
E int FDECL(look_here, (int, boolean, boolean));
E int NDECL(dolook);
...
E void FDECL(useupf, (struct obj *, int64_t));
E void FDECL(useupf_with_flags, (struct obj*, int64_t, uint64_t));
E char *FDECL(let_to_name, (char, uchar, boolean));
E const char* FDECL(get_class_name, (char));
E void NDECL(free_invbuf);
E void NDECL(reassign);
E int NDECL(doorganize);
E void NDECL(free_pickinv_cache);
E int FDECL(count_unpaid, (struct obj *, boolean(*)(OBJ_P), boolean));
E int FDECL(count_objects, (struct obj*, boolean(*)(OBJ_P), boolean));
E int FDECL(count_buc, (struct obj *, int, boolean (*)(OBJ_P), boolean));
E void FDECL(tally_BUCX, (struct obj *, boolean,
                          int *, int *, int *, int *, int *, int *));
E int64_t FDECL(count_contents, (struct obj *, boolean, boolean, boolean));
E int64_t FDECL(count_contained_contents, (struct obj*, boolean, boolean, boolean));
...
E void FDECL(invocation_ritual_quest_update, (boolean));
E void FDECL(play_hint_sound_with_delay, (boolean));
...
E void FDECL(new_light_source, (xchar, xchar, int, int, ANY_P *, int));
...
E int64_t FDECL(obj_light_maximum_burn_time, (struct obj*));
E int64_t FDECL(obj_light_burn_time_left, (struct obj*));
...
E int FDECL(pick_lock_core, (struct obj*, int, int, boolean));
#ifdef ANDROID
...
E int FDECL(maccreat, (const char *, int64_t));
E int FDECL(macopen, (const char *, int, int64_t));
E int FDECL(macclose, (int));
E int FDECL(macread, (int, void *, unsigned));
E int FDECL(macwrite, (int, void *, unsigned));
E int64_t FDECL(macseek, (int, int64_t, short));
...
E struct monst* FDECL(clone_mon, (struct monst*, xchar, xchar, boolean));
...
E void FDECL(newmonhp, (struct monst *, int, int, uint64_t));
...
E struct monst *FDECL(makemon, (struct permonst *, int, int, uint64_t));
E struct monst* FDECL(makemon2, (struct permonst*, int, int, uint64_t, uint64_t));
E struct monst* FDECL(makemon_ex, (struct permonst*, int, int, uint64_t, uint64_t, unsigned short, int, int));
E struct monst* FDECL(makemon_limited, (struct permonst*, int, int, uint64_t, uint64_t, unsigned short, unsigned short, int, int, int, aligntyp));
E boolean FDECL(create_critters, (int, struct permonst *, boolean));
E struct permonst *NDECL(rndmonst);
E struct permonst* FDECL(rndmonst_core, (int, int));
E struct permonst* FDECL(rndmonst_for_polymon, (struct monst*));
E void FDECL(reset_rndmonst, (int));
E void FDECL(get_generated_monster_minmax_levels, (int, int*, int*, int, int));
E struct permonst *FDECL(mkclass, (char, int));
E struct permonst *FDECL(mkclass_aligned, (char, int, aligntyp, uint64_t));
E struct permonst* FDECL(mkclass_core, (char, int, aligntyp, int, uint64_t));
...
E struct obj* FDECL(mongets_with_material, (struct monst*, int, uchar));
...
E int64_t FDECL(mongetsgold, (struct monst*, int64_t));
...
E void FDECL(mkmonmoney, (struct monst *, int64_t));
...
E void FDECL(m_initthrow, (struct monst*, int, int, int, boolean, int, int, int));
E boolean FDECL(randomize_monster_gender, (struct permonst*));
E void NDECL(makemon_animation_wait_until_end);
E struct monst* FDECL(make_level_monster, (int, int, uint64_t, uint64_t));
...
E struct monst* FDECL(get_mmonst, (struct monst*, boolean));
E void FDECL(save_mmonst, (struct monst*, struct monst*));
E struct obj* FDECL(get_mobj, (struct monst*, boolean));
...
E int FDECL(mapglyph, (struct layer_info, nhsym *, int *, uint64_t*, int, int));
...
E int FDECL(fightm, (struct monst *, boolean));
...
E void FDECL(paralyze_monst, (struct monst *, int, boolean));
...
E int64_t FDECL(attk_protection, (int));
...
E void FDECL(mdamageu, (struct monst *, double, boolean));
E void FDECL(mdamageu_with_hit_tile, (struct monst*, double, boolean, enum hit_tile_types));
E int FDECL(could_seduce, (struct monst *, struct monst *, struct attack *));
E int FDECL(doseduce, (struct monst *));
E void FDECL(update_m_facing, (struct monst*, int, boolean));
...
E int64_t FDECL(bribe, (struct monst *));
E int FDECL(dprince, (aligntyp, boolean, boolean));
E int FDECL(dlord, (aligntyp, boolean, boolean));
E int FDECL(llord, (boolean, boolean));
E int FDECL(ndemon, (aligntyp, boolean, boolean));
E int FDECL(lminion, (boolean, boolean));
E void FDECL(lose_guardian_angel, (struct monst *));
E void FDECL(gain_guardian_angel, (boolean));
...
E void FDECL(add_room, (int, int, int, int, boolean, schar, boolean, int, int, int, int, short));
...
E void FDECL(mkmodronportal, (int, coord*, coord*, uint64_t));
E void FDECL(mkstairs, (xchar, xchar, char, struct mkroom *, int));
...
E void FDECL(define_level_location_floor_types, (boolean, boolean, boolean, boolean));
...
E void FDECL(mkportal, (xchar, xchar, xchar, xchar, uchar, uint64_t, boolean));
...
E struct obj* FDECL(mkobj_at_with_flags, (char, int, int, boolean, boolean, uchar, int64_t, int64_t, uint64_t));
E struct obj *FDECL(mksobj_at, (int, int, int, boolean, boolean));
E struct obj* FDECL(mksobj_found_at, (int, int, int, boolean, boolean));
E struct obj* FDECL(mksobj_at_with_flags, (int, int, int, boolean, boolean, int, struct monst*, uchar, int64_t, int64_t, uint64_t));
E struct obj *FDECL(mksobj_migr_to_species, (int, unsigned, boolean, boolean));
E struct obj *FDECL(mkobj, (char, boolean, int));
E struct obj* FDECL(mkobj_with_flags, (char, boolean, boolean, int, struct monst*, uchar, int64_t, int64_t, uint64_t));
E int FDECL(random_objectid_from_class, (char, struct monst*, uint64_t));
E int FDECL(random_spellbook_objectid, (struct monst*, uint64_t));
E int NDECL(rndmonnum);
E boolean FDECL(bogon_is_pname, (char));
E struct obj *FDECL(splitobj, (struct obj *, int64_t));
...
E struct obj *FDECL(mksobj, (int, boolean, boolean, int));
E struct obj* FDECL(mksobj_ex, (int, boolean, boolean, int, struct monst*, uchar));
E struct obj* FDECL(mksobj_with_flags, (int, boolean, boolean, int, struct monst*, uchar, int64_t, int64_t, uint64_t));
E int FDECL(bcsign, (struct obj *));
E int FDECL(weight, (struct obj *));
E int64_t NDECL(get_random_gold_amount);
E void FDECL(set_random_gold_amount, (struct obj*));
E struct obj *FDECL(mkgold, (int64_t, int, int));
...
E int64_t FDECL(get_multigen_quan, (uchar));
E short FDECL(get_init_charge, (uchar));
E short FDECL(get_obj_init_charge, (struct obj*));
E short FDECL(get_max_charge, (uchar));
...
E int64_t FDECL(peek_at_iced_corpse_age, (struct obj *));
...
E struct mkroom* FDECL(which_room, (xchar, xchar));
E struct mkroom* FDECL(which_room_by_list, (struct mkroom**, int, xchar, xchar));
...
E int FDECL(can_carry_core, (struct monst*, struct obj*, boolean));
E int FDECL(mfndpos, (struct monst *, coord *, int64_t *, int64_t));
E int FDECL(mfndpos_xy, (struct monst*, xchar, xchar, coord*, int64_t*, int64_t));
E boolean FDECL(monnear, (struct monst *, int, int));
E boolean FDECL(mon_somewhat_near, (struct monst*, int, int));
E void NDECL(dmonsfree);
E int FDECL(mcalcmove, (struct monst *, boolean));
...
E void FDECL(mondead_with_flags, (struct monst*, uint64_t));
E void FDECL(mondied, (struct monst *));
E void FDECL(mongone, (struct monst *));
E void FDECL(monstone, (struct monst *));
E void FDECL(monkilled, (struct monst *, const char *, int, int));
E void FDECL(unstuck, (struct monst *));
E void FDECL(killed, (struct monst *));
E void FDECL(killed_by_stoning, (struct monst*));
E void FDECL(killed_by_disintegration, (struct monst*));
E void FDECL(xkilled, (struct monst *, int));
E void FDECL(mon_to_stone, (struct monst *));
E void FDECL(m_into_limbo, (struct monst *, boolean));
E void FDECL(mnexto, (struct monst *));
E void FDECL(mnexto2, (struct monst*, boolean));
E void FDECL(maybe_mnexto, (struct monst *));
E int FDECL(mnearto, (struct monst *, xchar, xchar, boolean, boolean));
...
E int FDECL(newcham,
            (struct monst *, struct permonst *, unsigned short, boolean, boolean));
...
E int FDECL(random_reagent_otyp, (boolean, boolean, int));
E int FDECL(randomore, (boolean));
E const char* FDECL(pm_monster_name, (struct permonst*, uchar));
...
E const char* FDECL(pm_plural_name, (struct permonst*, uchar));
E const char* FDECL(pm_general_name, (struct permonst*, uchar));
...
E int FDECL(revert_mon_polymorph, (struct monst*, boolean, boolean, boolean));
E void NDECL(reset_mon);

/* ### mondata.c ### */

E void FDECL(set_mon_data, (struct monst *, struct permonst *, unsigned short));
...
E int FDECL(pronoun_gender, (struct monst *, boolean));
...
E uint64_t FDECL(prop_to_innate, (int));
E uint64_t FDECL(prop_to_innate2, (int));
E uint64_t FDECL(prop_to_conveyed, (int));
E int FDECL(innate_to_prop, (uint64_t));
E int FDECL(innate2_to_prop, (uint64_t));
E int FDECL(conveyed_to_prop, (uint64_t));
E const char* FDECL(get_mflag_description, (uint64_t, boolean, uchar));
...
E void FDECL(monster_regeneration_and_timeout, (struct monst *, boolean));
...
E void FDECL(mon_yells, (struct monst *, const char *, const char *, const char*, boolean, boolean));
E void FDECL(check_mon_talk, (struct monst*));
E int FDECL(dochug, (struct monst *));
E boolean FDECL(m_digweapon_check, (struct monst *, xchar, xchar));
...
E boolean FDECL(should_displace,
                (struct monst *, coord *, int64_t *, int, xchar, xchar));
E boolean FDECL(undesirable_disp, (struct monst *, xchar, xchar));
E boolean FDECL(m_findtravelpath, (struct monst*, int, xchar*, xchar*, int64_t));
E boolean FDECL(m_test_move, (struct monst*, xchar, xchar, xchar, xchar, int, int64_t));
E void FDECL(check_boss_fight, (struct monst*));
E void NDECL(check_seen_bosses);
...
E boolean FDECL(linedup, (xchar, xchar, xchar, xchar, int, boolean, boolean, boolean, int, boolean, int));
E boolean FDECL(lined_up, (struct monst *, boolean, int, boolean, int));
...
E void FDECL(mcureblindness, (struct monst *, boolean));
E void FDECL(mcuresickness, (struct monst*, boolean));
E void FDECL(mcurehallucination, (struct monst*, boolean));
E void FDECL(mcurestun, (struct monst*, boolean));
E void FDECL(mcureconfusion, (struct monst*, boolean));
...
E void FDECL(awaken_monsters, (int, boolean));
E void FDECL(awaken_soldiers, (struct monst *, boolean));
...
E struct monst* FDECL(findnpc, (char));
E boolean FDECL(in_his_npc_room, (struct monst*));
E void FDECL(in_npc_room, (int, boolean));
E void FDECL(npcini, (d_level*, struct mkroom*, int, int, uchar, int));
E void FDECL(newenpc, (struct monst*));
E void FDECL(free_enpc, (struct monst*));
E void NDECL(clearnpcs);
E void FDECL(restnpc, (struct monst*, boolean));
...
E uint64_t FDECL(get_obj_oc_flags, (struct obj*));
E uint64_t FDECL(get_obj_oc_flags2, (struct obj*));
E uint64_t FDECL(get_obj_oc_flags3, (struct obj*));
E uint64_t FDECL(get_obj_oc_flags4, (struct obj*));
E uint64_t FDECL(get_obj_oc_flags5, (struct obj*));
E uint64_t FDECL(get_obj_oc_flags6, (struct obj*));
...
E struct fruit *FDECL(fruit_from_name, (const char *, boolean, int *));
E void FDECL(reorder_fruit, (boolean));
...
E char* FDECL(doname_payobj, (struct obj*));
...
E char* FDECL(doname_with_weight_first, (struct obj*, boolean, boolean, unsigned));
E char* FDECL(doname_with_weight_last, (struct obj*, boolean, boolean, unsigned));
E char* FDECL(doname_with_price, (struct obj*));
E char* FDECL(doname_with_price_quick, (struct obj*));
E char* FDECL(doname_with_price_and_weight_first, (struct obj*, boolean, boolean));
E char* FDECL(doname_with_price_and_weight_last, (struct obj*, boolean, boolean));
E char* FDECL(doname_with_price_and_comparison, (struct obj*, boolean, char**, char**));
E char* FDECL(doname_with_price_and_weight_first_and_comparison, (struct obj*, boolean, boolean, char**, char**));
E char* FDECL(doname_with_price_and_weight_last_and_comparison, (struct obj*, boolean, boolean, char**, char**));
...
E char* FDECL(aqcxname, (struct obj*));
...
E char *FDECL(An, (const char *));
E char* FDECL(an_prefix, (const char*));
E char* FDECL(An_prefix, (const char*));
...
E char* FDECL(Doname_payobj2, (struct obj*));
...
E char* FDECL(simpleonames_payobj, (struct obj*));
E char *FDECL(ansimpleoname, (struct obj *));
E char* FDECL(ansimpleoname_payobj, (struct obj*));
E char *FDECL(thesimpleoname, (struct obj *));
E char* FDECL(thesimpleoname_payobj, (struct obj*));
...
E struct obj *FDECL(readobjnam, (char *, struct obj *, boolean, boolean*));
...
E void FDECL(print_lock_with_buf, (char*, int, int, boolean));
E char* NDECL(nextobuf);
E char* NDECL(next_offset_init_obuf);
E char* FDECL(str_upper_start, (const char*));
E void FDECL(print_comparison_stats, (struct obj*, char*, winid, int, int, uchar, boolean, char*, char*, char*));
...
E boolean FDECL(match_optname, (const char *, const char *, size_t, boolean));
E void NDECL(process_options_file);
E void NDECL(init_options);
E void NDECL(finish_options);
E boolean FDECL(parseoptions, (char *, boolean, boolean));
E int NDECL(doset);
...
E char FDECL(get_menu_cmd_key, (char));
...
E void FDECL(set_wc_option_mod_status, (uint64_t, int));
E void FDECL(set_wc2_option_mod_status, (uint64_t, int));
...
E int FDECL(clrnameptr2color, (const char*));
E int FDECL(match_str2clr, (char *));
E int FDECL(match_str2attr, (const char *, boolean));
...
E int FDECL(do_screen_description, (coord, boolean, nhsym, char *,
...
E boolean FDECL(rider_corpse_revival, (struct obj *, boolean, boolean*));
...
E boolean FDECL(is_wearable_by_type, (struct obj*));
...
#endif
E int FDECL(auto_bag_in, (struct obj*, struct obj*, boolean));
E int FDECL(count_bags_for_stashing, (struct obj*, struct obj*, boolean, boolean));
E int FDECL(pickup, (int, boolean));
E int FDECL(pickup_object, (struct obj *, int64_t, boolean, boolean, uchar*));
...
E int FDECL(container_at, (int, int, boolean));
E int NDECL(doloot);
E int NDECL(dolootin);
E int NDECL(dolootout);
E void FDECL(observe_quantum_cat, (struct obj *, boolean, boolean));
E boolean FDECL(container_gone, (int (*)(OBJ_P)));
E boolean NDECL(u_handsy);
E int FDECL(use_container, (struct obj **, int, boolean, int));
E int FDECL(loot_mon, (struct monst *, int *, boolean *, boolean));
E int NDECL(dotip);
E boolean FDECL(is_autopickup_exception, (struct obj *, boolean));
E boolean FDECL(autopick_testobj, (struct obj *, boolean));
...
E boolean NDECL(can_floor_stash_objs);
...
E void VDECL(You_multi_ex, (int, int, const int*, const int*, const char*, ...)) PRINTF_F(5, 6);
E void VDECL(Your_ex, (int, int, const char*, ...)) PRINTF_F(3, 4);
E void VDECL(Your_multi_ex, (int, int, const int*, const int*, const char*, ...)) PRINTF_F(5, 6);
...
E void VDECL(pline_The_multi_ex, (int, int, const int*, const int*, const char*, ...)) PRINTF_F(5, 6);
E void VDECL(There_ex, (int, int, const char*, ...)) PRINTF_F(3, 4);
E void VDECL(There_multi_ex, (int, int, const int*, const int*, const char*, ...)) PRINTF_F(5, 6);
...
E void VDECL(silent_impossible, (const char*, ...)) PRINTF_F(1, 2);
...
E int FDECL(get_ray_adtyp_choose, (uchar, const char*, struct monst*));
E void NDECL(reset_polyself);

/* ### potion.c ### */

E void FDECL(set_itimeout, (int64_t *, int64_t));
E void FDECL(incr_itimeout, (int64_t *, int));
E int64_t FDECL(itimeout_incr, (int64_t, int));
E void FDECL(make_confused, (int64_t, boolean));
E void FDECL(make_stunned, (int64_t, boolean));
E void FDECL(make_sick, (int64_t, const char *, boolean, int));
E void FDECL(make_food_poisoned, (int64_t, const char*, boolean, int));
E void FDECL(make_mummy_rotted, (int64_t, const char*, boolean, int));
E void FDECL(make_slimed, (int64_t, const char*, int, const char*, int));
E void FDECL(make_stoned, (int64_t, const char *, int, const char *, int));
E void FDECL(make_vomiting, (int64_t, boolean));
E void FDECL(make_blinded, (int64_t, boolean));
E void NDECL(toggle_blindness);
E boolean FDECL(make_hallucinated, (int64_t, boolean, int64_t));
E void FDECL(make_deaf, (int64_t, boolean));
E void NDECL(self_invis_message);
E int NDECL(dodrink);
E int FDECL(dopotion, (struct obj *));
E int FDECL(peffects, (struct obj *));
E void FDECL(healup, (int, int, boolean, boolean, boolean, boolean, boolean));
E void FDECL(strange_feeling, (struct obj *, const char *, boolean));
...
E boolean FDECL(H2Opotion_dip, (struct obj*, struct obj*, boolean, const char*));
...
E const char* FDECL(align_gdesc, (aligntyp));
E const char* FDECL(align_ghisher, (aligntyp));
E const char* NDECL(u_ghisher);
E const char *FDECL(halu_gname, (aligntyp));
E const char *FDECL(align_gtitle, (aligntyp));
E boolean FDECL(align_gfemale, (aligntyp));
...
E void FDECL(priestini, (d_level *, struct mkroom *, int, int, boolean, int));
...
E struct monst *FDECL(mk_roamer, (struct permonst *, aligntyp, xchar,
                                  xchar, boolean));
...
E struct monst* FDECL(findsmith, (char));
E boolean FDECL(inhissmithy, (struct monst*));
E void FDECL(insmithy, (int));
E void FDECL(smithini, (d_level*, struct mkroom*, int, int, uchar, int));
...
E void FDECL(restsmith, (struct monst*, boolean));
...
E boolean FDECL(quest_chat, (struct monst *, boolean));
...
E void FDECL(com_pager_ex, (struct monst*, int, int, int, boolean));
E void FDECL(qt_pager, (struct monst*, int));
E void FDECL(qt_pager_ex, (struct monst*, int, int, int, boolean));
...
E void FDECL(recharge, (struct obj *, int, boolean, const char*, boolean));
...
E void FDECL(strip_charges, (struct obj*, boolean, boolean));
E void FDECL(p_glow1, (struct obj*, int, int, const char*, boolean));
E void FDECL(p_glow2, (struct obj*, const char*, int, int, const char*, boolean));
E void FDECL(dragon_scales_to_scale_mail, (struct obj*, boolean, boolean));
E boolean FDECL(get_valid_targeted_position, (int, int, int));
E int FDECL(get_invalid_stinking_cloud_pos, (int, int));
E boolean FDECL(is_valid_stinking_cloud_pos, (int, int, boolean));
...
E void FDECL(enchant_ring, (struct obj*, int, int, boolean));
E void FDECL(enchant_armor, (struct obj*, int, int, boolean));
...
E void FDECL(remove_expired_regions, (boolean));
E void FDECL(region_stats, (const char *, char *, int64_t *, size_t *));
E NhRegion *FDECL(create_gas_cloud, (xchar, xchar, enum region_types, int, int, int, int));
E NhRegion* FDECL(create_simple_permanent_region, (xchar, xchar, xchar, xchar, enum region_types));
...
E int FDECL(dorestore, (int, boolean));
...
E void FDECL(print_character_description, (char*, short, short, short, boolean, aligntyp, const char*));
E void FDECL(print_location_description, (char*, const char*, const char*, int, schar, const char*));
E void FDECL(print_mode_duration_description, (char*, schar, int64_t, boolean, boolean, boolean, boolean, boolean, boolean, const char*));
E void FDECL(print_timestamp_description, (char*, const char*, time_t, const char*));
E void NDECL(reset_restore);
...
E int FDECL(get_initial_tree_subtype, (schar));
...
E boolean FDECL(has_door_normal_lock_at, (xchar, xchar));
...
E void FDECL(set_initial_location_type_at, (xchar, xchar, int));
E void FDECL(set_initial_location_type_ptr, (struct rm*, int));

/* ### rnd.c ### */

#ifdef USE_ISAAC64
E void FDECL(init_isaac64, (uint64_t, int FDECL((*fn), (int))));
E int64_t NDECL(nhrand);
#endif
E int FDECL(rn2, (int));
...
E char *FDECL(build_plselection_prompt, (char *, size_t, int, int, int, int, boolean));
...
E uint64_t FDECL(get_player_action_flags, (enum action_tile_types, int, int, int, int, int));
E uint64_t FDECL(u_action_flags,(enum action_tile_types));
E uint64_t NDECL(u_item_use_flags);
#if 0
...
E const char* FDECL(get_advancement_description, (int, int, int, boolean));
...
E void FDECL(outoracle, (struct monst*, struct obj*, boolean, int));
...
E int64_t FDECL(money2mon, (struct monst *, int64_t));
E void FDECL(money2u, (struct monst *, int64_t));
...
E int NDECL(dopay);
E boolean FDECL(paybill, (int, boolean));
E void NDECL(finish_paybill);
E struct obj *FDECL(find_oid, (unsigned));
E int64_t FDECL(contained_cost,
             (struct obj *, struct monst *, int64_t, boolean, boolean));
E int64_t FDECL(contained_gold, (struct obj *));
E void FDECL(picked_container, (struct obj *));
E void FDECL(gem_learned, (int));
E void FDECL(alter_cost, (struct obj *, int64_t));
E int64_t FDECL(unpaid_cost, (struct obj *, boolean));
...
E void FDECL(add_damage, (xchar, xchar, int64_t));
...
E void FDECL(costly_gold, (xchar, xchar, int64_t));
E int64_t FDECL(get_cost_of_shop_item, (struct obj *, int *));
...
E int FDECL(shk_chastise_pet, (struct monst* mtmp, struct obj*, boolean, boolean));
E int64_t FDECL(set_cost, (struct obj*, struct monst*));
E boolean FDECL(is_obj_on_shk_bill, (struct obj*, struct monst*));
E void FDECL(add_one_tobill, (struct obj*, boolean, struct monst*));
E void NDECL(reset_shk);
E int64_t FDECL(getprice, (struct obj*, boolean));
...
E void FDECL(stock_room, (int, struct mkroom *, boolean));
...
E int64_t FDECL(get_object_base_value, (struct obj*));
...
E int64_t FDECL(get_cost_of_monster_item, (struct obj*, struct monst*));
E int64_t FDECL(m_contained_cost, (struct obj*, struct monst*));
...
E void FDECL(popup_talk_line_ex, (struct monst*, const char*, int, int, boolean, boolean));
E void FDECL(popup_talk_line_with_know_mname, (struct monst*, const char*, boolean));
E int FDECL(service_identify, (struct monst*, int64_t));
E void FDECL(You_ex1_popup, (const char*, const char*, int, int, int, uint64_t));
...
E enum floor_surface_types FDECL(get_floor_surface_type, (int, int, boolean));
E void FDECL(play_movement_sound, (struct monst*, enum climbing_types));
E void FDECL(play_object_floor_sound, (struct obj*, enum object_sound_types, boolean));
E void FDECL(play_object_floor_sound_at_location, (struct obj*, enum object_sound_types, int, int, boolean));
...
E void FDECL(play_monster_attack_sound, (struct monst*, int, enum object_sound_types));
...
E void FDECL(new_sound_source, (xchar, xchar, enum ghsound_types, double, enum soundsource_types, enum soundsource_ambient_subtypes, ANY_P*));
...
E void FDECL(sound_stats, (const char*, char*, int64_t*, size_t*));
E void FDECL(relink_sound_sources, (boolean));
...
E void FDECL(begin_sound, (struct obj*, boolean));
E void FDECL(end_sound, (struct obj*, boolean));
...
E void FDECL(play_voice_shopkeeper_for_you, (struct monst*, int, int, int64_t));
E void FDECL(play_voice_shopkeeper_pay_before_buying, (struct monst*, int64_t, int64_t));
...
E void FDECL(play_voice_god_simple_line_at, (xchar, xchar, enum god_simple_lines));
E void FDECL(play_voice_god_simple_line_by_align, (aligntyp, enum god_simple_lines));
E void FDECL(play_voice_oracle_major_consultation, (struct monst*, int));
E void FDECL(play_hermit_dialogue_line, (struct monst*, enum ghsound_types, uchar, int));
...
E void FDECL(selection_floodfill, (struct opvar *, int, int, boolean));
E void FDECL(create_carpet, (xchar, xchar, xchar, xchar, int));
...
E int NDECL(docast);
E int NDECL(docastquick);
E int FDECL(docastquick_core, (boolean*));
E int NDECL(dospellmanage);
E int NDECL(dospellview);
E int NDECL(dosetquickspell);
E int FDECL(spell_skilltype, (int));
E int FDECL(spelleffects, (int, boolean, struct monst*, boolean*));
...
E void FDECL(print_spell_level_text, (char*, int, boolean, uchar, boolean));
E void NDECL(reset_spells);
E int64_t FDECL(get_object_spell_casting_penalty, (struct obj*));
...
E int FDECL(add_to_obj_tracking, (struct obj*));
E boolean FDECL(finish_obj_tracking, (int));
E boolean FDECL(remove_worn_item, (struct obj*, boolean));
E boolean FDECL(remove_worn_item_ex, (struct obj *, boolean, boolean));
...
E void FDECL(mdrop_obj, (struct monst *, struct obj *, boolean, boolean));
E void FDECL(mdrop_special_objs, (struct monst *));
E void FDECL(release_monster_objects, (struct monst *, int, boolean, boolean));
...
E boolean FDECL(goodpos, (int, int, struct monst *, uint64_t));
E boolean FDECL(enexto, (coord *, xchar, xchar, struct permonst *));
E boolean FDECL(enexto_core, (coord *, xchar, xchar,
                              struct permonst *, uint64_t));
E void FDECL(teleds, (int, int, boolean, boolean));
E boolean FDECL(safe_teleds, (boolean, boolean));
E void FDECL(teleds_with_effects, (int, int, boolean, boolean));
E boolean FDECL(safe_teleds_with_effects, (boolean, boolean));
E boolean FDECL(teleport_pet, (struct monst *, boolean));
E void NDECL(tele);
E void NDECL(controlled_teleportation);
E void NDECL(wiztele);
E boolean FDECL(scrolltele, (struct obj *, boolean, boolean));
E boolean FDECL(modronportaltele, (struct trap*, struct monst*));
E int NDECL(dotelecmd);
E int FDECL(dotele, (boolean));
E void FDECL(level_tele, (int, int, d_level, uchar));
...
E boolean FDECL(rloc_with_effects, (struct monst*, boolean));
E boolean FDECL(rloc2, (struct monst*, boolean, boolean));
...
E void FDECL(attach_egg_hatch_timeout, (struct obj *, int64_t));
E void FDECL(attach_fig_transform_timeout, (struct obj *));
E void FDECL(kill_egg, (struct obj *));
E int FDECL(hatch_egg, (ANY_P *, int64_t));
E void FDECL(learn_egg_type, (int));
E void FDECL(learn_corpse_type, (int));
E int FDECL(burn_object, (ANY_P *, int64_t));
E void FDECL(begin_burn, (struct obj *, boolean));
E void FDECL(end_burn, (struct obj *, boolean));
E int FDECL(unsummon_item, (ANY_P*, int64_t));
E void FDECL(begin_existence, (struct obj*));
E int FDECL(unsummon_monster, (ANY_P*, int64_t));
E void FDECL(begin_summontimer, (struct monst*));
E void FDECL(begin_timestoptimer, (int64_t));
E int FDECL(restart_time, (ANY_P*, int64_t));
E void NDECL(do_storms);
E boolean FDECL(start_timer, (int64_t, short, short, ANY_P *));
E int64_t FDECL(stop_timer, (short, ANY_P *));
E int64_t FDECL(peek_timer, (short, ANY_P *));
...
E void FDECL(obj_remove_timers, (struct obj*));
...
E void FDECL(mon_remove_timers, (struct monst*));
E boolean FDECL(mon_has_timer, (struct monst*, short));

E void FDECL(spot_stop_timers, (xchar, xchar, short));
E int64_t FDECL(spot_time_expires, (xchar, xchar, short));
E int64_t FDECL(spot_time_left, (xchar, xchar, short));
E boolean FDECL(obj_is_local, (struct obj *));
E void FDECL(save_timers, (int, int, int));
E void FDECL(restore_timers, (int, int, boolean, int64_t));
E void NDECL(reset_timers);
E void FDECL(timer_stats, (const char *, char *, int64_t *, size_t *));
E void FDECL(relink_timers, (boolean));
E int NDECL(wiz_timeout_queue);
E void NDECL(timer_sanity_check);
E int FDECL(make_sound_object, (ANY_P*, int64_t));
E void FDECL(property_expiry_message, (int, boolean));

/* ### topten.c ### */

E void FDECL(formatkiller, (char *, size_t, int, boolean));
...
E int64_t NDECL(encodeconduct);
E int64_t NDECL(encodeachieve);
...
E int FDECL(succeed_untrap, (int, boolean));
...
E struct trap *FDECL(maketrap, (int, int, int, int, uint64_t));
...
E void FDECL(set_utrap, (uint64_t, uchar));
E void FDECL(reset_utrap, (boolean));
...
E void FDECL(start_delayed_petrification, (struct monst*, boolean));
E void FDECL(start_delayed_sliming, (struct monst*, boolean));
...
E int FDECL(float_down, (int64_t, int64_t));
...
E boolean FDECL(lava_damage, (struct obj *, xchar, xchar));
...
E void FDECL(cnv_trap_obj, (int, int, struct trap *, boolean, boolean));
E int FDECL(untrap, (boolean));
E int FDECL(check_all_box_traps, (boolean));
E int FDECL(check_box_trap, (struct obj*, boolean));
...
E int FDECL(trap_difficulty, (int, boolean, struct monst*));
...
E char* FDECL(get_role_achievement_description, (uchar));
...
E int FDECL(find_roll_to_hit, (struct monst *, uchar, struct obj *,
                               int *, int *));
...
E int FDECL(passive, (struct monst *, struct obj *, boolean, int,
                      uchar, boolean));
...
E double FDECL(adjust_damage, (int, struct monst*, struct monst*, short, uint64_t));
...
E void FDECL(update_u_action_core, (enum action_tile_types, uint64_t, uint64_t));
E void FDECL(update_m_action_core, (struct monst*, enum action_tile_types, uint64_t, uint64_t));
...
E void FDECL(display_being_hit, (struct monst*, int, int, enum hit_tile_types, int, uint64_t));
E void FDECL(display_u_being_hit, (enum hit_tile_types, int, uint64_t));
E void FDECL(display_m_being_hit, (struct monst*, enum hit_tile_types, int, uint64_t, boolean));
...
#ifdef MICRO
E boolean FDECL(comp_times, (int64_t));
#endif
E boolean FDECL(check_version, (struct version_info *, const char *, boolean));
E boolean FDECL(uptodate, (int, const char *));
E void FDECL(store_version, (int));
E uint64_t FDECL(get_feature_notice_ver, (char *));
E uint64_t NDECL(get_current_feature_ver);
E const char *FDECL(copyright_banner_line, (int));
E void FDECL(early_version_info, (boolean));
...
E uint64_t NDECL(init_broadcast_trapping);
E uint64_t NDECL(enable_broadcast_trapping);
E uint64_t NDECL(disable_broadcast_trapping);
#if 0
...
E int FDECL(special_dmgval, (struct monst *, struct monst *, int64_t, int64_t *));
E void FDECL(silver_sears, (struct monst *, struct monst *, int64_t));
E struct obj *FDECL(select_rwep, (struct monst *));
E boolean FDECL(monmightthrowwep, (struct obj *));
E struct obj *FDECL(select_hwep, (struct monst *, boolean, xchar, xchar));
...
E int FDECL(mon_wield_item, (struct monst *, boolean, xchar, xchar));
...
E double FDECL(strength_damage_bonus_core, (int, boolean));
E int FDECL(strength_tohit_bonus, (int));
E double FDECL(strength_tohit_bonus_core, (int, boolean));
...
E char *FDECL(skill_level_name, (int, char *, uchar));
E const char *FDECL(skill_name, (int, boolean));
E boolean FDECL(can_advance, (int, boolean));
...
E int FDECL(weapon_skill_hit_bonus, (struct obj *, int, boolean, boolean, uchar, int, boolean, boolean));
E int FDECL(weapon_skill_dmg_bonus, (struct obj *, int, boolean, boolean, uchar, int, boolean, boolean));
...
E int FDECL(get_skill_critical_strike_chance, (enum p_skills, boolean, boolean, int, boolean, boolean));
E double FDECL(get_wand_skill_damage_multiplier, (int));
E double FDECL(get_wand_exceptionality_damage_multiplier, (uchar));
E int FDECL(get_exceptionality_multiplier, (uchar));
E void FDECL(print_weapon_style_string, (char*, boolean));
E void FDECL(print_quivered_weapon_style_string, (char*));
E int FDECL(limited_skill_level, (enum p_skills, boolean, boolean));
E int FDECL(adjusted_limited_skill_level, (enum p_skills, boolean, boolean));
...
E void FDECL(setuwep, (struct obj *, int64_t));
E void FDECL(setuwepcore, (struct obj*, int64_t, boolean));
E void FDECL(setuwepquietly, (struct obj*, int64_t));
E void FDECL(setuqwep, (struct obj *));
E void FDECL(setuswapwep, (struct obj *, int64_t));
E void FDECL(setuqwepquietly, (struct obj*));
E void FDECL(setuswapwepquietly, (struct obj*, int64_t));
E int NDECL(dowield);
E int NDECL(dounwield);
E int NDECL(dowieldprevwep);
E int NDECL(doswaphandedness);
E int NDECL(doswapweapon_right_or_both);
E int NDECL(doswapweapon);
E int FDECL(dosingleswapweapon, (int64_t, int64_t));
...
E int FDECL(enchant_weapon, (struct obj *, struct obj*, int, boolean));
...
E int FDECL(wield_weapon, (struct obj*));
...
E char *FDECL(genl_getmsghistory_ex, (char**, char**, boolean));
E void FDECL(genl_putmsghistory_ex, (const char *, const char*, const char*, boolean));
#ifdef HANGUPHANDLING
...
E void FDECL(genl_status_update, (int, genericptr_t, int, int, int, uint64_t *));
...
E void FDECL(genl_update_status_button, (int, int, int, uint64_t));
E void FDECL(genl_toggle_animation_timer, (int, int, int, int, int, int, uint64_t));
E void FDECL(genl_display_floating_text, (int, int, const char*, int, int, int, uint64_t));
E void FDECL(genl_display_screen_text, (const char*, const char*, const char*, int, int, int, uint64_t));
E void FDECL(genl_display_popup_text, (const char*, const char*, int, int, int, int, uint64_t));
E void FDECL(genl_display_gui_effect, (int, int, int, int, int, int, uint64_t));
...
E void FDECL(dump_open_log, (time_t, boolean));
...
E void FDECL(html_dump_glyph, (int, int, int, nhsym, int, uint64_t));
#endif
#endif
...
E int FDECL(pick_nasty, (int, int));
...
E void FDECL(cutworm, (struct monst *, xchar, xchar, boolean));
...
E void FDECL(setworncore, (struct obj*, int64_t, boolean));
E void FDECL(setwornquietly, (struct obj*, int64_t));
E boolean FDECL(setnotworncore, (struct obj*, boolean));
...
E void FDECL(update_mon_extrinsics, (struct monst*, boolean));
E void FDECL(update_all_mon_statistics, (struct monst *, boolean));
E void FDECL(update_all_mon_statistics_core, (struct monst*, boolean));
E int FDECL(find_mac, (struct monst *));
E void FDECL(m_dowear, (struct monst *, boolean, boolean));
E struct obj *FDECL(which_armor, (struct monst *, int64_t));
...
E boolean FDECL(verbose_wrapper, (enum verbose_function_types, struct monst*, int, int, boolean));
E boolean FDECL(increase_mon_property_verbosely, (struct monst*, int, int));
E boolean FDECL(increase_mon_property_b, (struct monst*, int, int, boolean));
E boolean FDECL(nonadditive_increase_mon_property_b, (struct monst*, int, int, boolean));
E boolean FDECL(set_mon_property_b, (struct monst*, int, int, boolean));
...
E struct monst *FDECL(montraits, (struct obj *, coord *, boolean, int, int, uint64_t));
E struct monst *FDECL(revive, (struct obj *, boolean, int, boolean));
E int FDECL(revive_from_inventory, (struct monst *));
E void FDECL(cancel_item, (struct obj *, boolean));
E boolean FDECL(drain_item, (struct obj *, boolean));
...
E int FDECL(bhitpile, (struct obj *, struct monst*, int (*)(OBJ_P, OBJ_P, MONST_P), int, int, schar, uchar, boolean));
E int FDECL(bhitt, (struct trap*, struct obj*, struct monst*));
E int FDECL(zappable, (struct obj *));
E void FDECL(zapnodir, (struct obj *));
E int NDECL(dozap);
E int NDECL(dozapquick);
E int FDECL(dozapquick_core, (boolean*));
E int NDECL(dosetquickwand);
E int NDECL(dounsetquickwand);
E double FDECL(zapyourself, (struct obj *, boolean));
E void FDECL(ubreatheu, (struct attack *));
E double FDECL(lightdamage, (struct obj *, boolean, int));
E boolean FDECL(flashburn, (int64_t));
E boolean FDECL(cancel_monst, (struct monst *, struct obj *, boolean,
                               boolean, boolean, int));
E boolean FDECL(add_temporary_property, (struct monst*, struct obj*, boolean,
    boolean, boolean, int));
...
E void FDECL(buzz, (int, struct obj*, struct monst*, int, int, int, xchar, xchar, int, int));
E void FDECL(dobuzz, (int, struct obj*, struct monst*, int, int, int, xchar, xchar, int, int, boolean));
E void FDECL(melt_ice, (xchar, xchar, const char *));
E void FDECL(start_melt_ice_timeout, (xchar, xchar, int64_t));
E int FDECL(melt_ice_away, (ANY_P *, int64_t));
E int FDECL(zap_over_floor, (xchar, xchar, int, boolean *, short));
E boolean FDECL(fracture_rock, (struct obj *, boolean));
...
E boolean FDECL(check_magic_resistance_and_inflict_damage, (struct monst *, struct obj *, struct monst*, boolean, int, int, int));
E boolean FDECL(inflict_spell_damage, (struct monst*, struct obj*, struct monst*, int, int, int));
E void FDECL(makewish, (boolean, boolean));
E void FDECL(summonitem, (struct obj*, int));
E void FDECL(summonblackblade, (struct obj*));
E void FDECL(summonmagearmor, (struct obj*));
E struct monst* FDECL(summoncreature, (int, int, const char*, uint64_t, uint64_t)); // int, boolean, boolean, boolean, boolean, boolean, boolean, boolean));
...
E int FDECL(get_spell_damage, (int, uchar, struct monst*, struct monst*));
...
E boolean FDECL(get_wand_explosion_damage, (struct obj*, int*, int*, int*, short*, boolean));
