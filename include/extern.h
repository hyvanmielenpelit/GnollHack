...
E struct replacement_info FDECL(data_to_replacement_info, (int, int, struct obj*, struct monst*, unsigned long, unsigned long, UCHAR_P));
...
E void FDECL(tmp_at_with_missile_flags, (int, int, unsigned long, UCHAR_P));
E void FDECL(tmp_at_with_obj, (int, int, struct obj*, unsigned long, UCHAR_P));
...
E void FDECL(show_missile_info, (int, int, UCHAR_P, UCHAR_P, UCHAR_P, UCHAR_P, UCHAR_P, UCHAR_P, UCHAR_P, UCHAR_P, unsigned long, SHORT_P, XCHAR_P, XCHAR_P));
