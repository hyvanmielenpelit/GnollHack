...
E void FDECL(memory_dummy_object, (struct obj*));
...
E enum obj_material_types FDECL(get_hit_surface_type, (enum hit_surface_sources, ANY_P*));
E void FDECL(get_hit_location, (enum hit_surface_sources, ANY_P*, xchar*, xchar*));
E void FDECL(play_simple_object_sound, (struct obj*, enum object_sound_types));
E void FDECL(play_object_hit_sound, (struct obj*, enum hit_surface_sources, ANY_P*, double, enum hmon_atkmode_types));
...
E void FDECL(play_monster_weapon_hit_sound, (struct monst*, enum hit_surface_sources, ANY_P*, int, struct obj*, double, enum hmon_atkmode_types));
