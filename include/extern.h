...
E const char *FDECL(noveltitle, (short *, unsigned long));
E const char* FDECL(manualtitle, (short*, unsigned long));
...
E struct monst* FDECL(makemon_limited, (struct permonst*, int, int, unsigned long, int, int, int));
...
E struct obj* FDECL(mksobj_at_with_flags, (int, int, int, BOOLEAN_P, BOOLEAN_P, int, long, unsigned long));
...
E struct obj* FDECL(mksobj_with_flags, (int, BOOLEAN_P, BOOLEAN_P, int, long, unsigned long));
...
E int FDECL(weapon_skill_hit_bonus, (struct obj *, int, BOOLEAN_P, BOOLEAN_P, BOOLEAN_P, int));
E int FDECL(weapon_skill_dmg_bonus, (struct obj *, int, BOOLEAN_P, BOOLEAN_P, BOOLEAN_P, int));
