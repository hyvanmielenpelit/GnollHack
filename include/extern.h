...
E void FDECL(play_object_hit_sound, (struct obj*, struct monst*, double, enum hmon_atkmode_types));
...
E void FDECL(play_monster_weapon_hit_sound, (struct monst*, struct monst*, int, struct obj*, double, enum hmon_atkmode_types));
