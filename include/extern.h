...
E boolean FDECL(In_modron_level_1, (d_level*));
E boolean FDECL(In_modron_level_2, (d_level*));
E boolean FDECL(In_modron_level_3, (d_level*));
...
E boolean FDECL(is_magic_resistant, (struct monst *));
...
E int FDECL(extradmgval, (struct obj*, struct monst*, struct monst*, int));
E int FDECL(totaldmgval, (struct obj*, struct monst*, struct monst*));
...
E int FDECL(monster_current_dex, (struct monst*));
E int FDECL(monster_current_con, (struct monst*));
...
E int FDECL(weapon_hit_bonus, (struct obj *, BOOLEAN_P));
E int FDECL(weapon_dam_bonus, (struct obj *, BOOLEAN_P));
...
E int FDECL(resist, (struct monst *, struct obj *, int, int, int));
