...
E short FDECL(maybe_get_animated_tile, (short, int, enum animation_play_types, unsigned long, int*, int*, boolean*, enum autodraw_types*));
...
E int NDECL(dotogglebigmonstertargeting);
...
E void FDECL(add_room, (int, int, int, int, BOOLEAN_P, SCHAR_P, BOOLEAN_P, int, int));
E void FDECL(add_subroom, (struct mkroom *, int, int, int, int, BOOLEAN_P,
                           SCHAR_P, BOOLEAN_P, int, int));
...
E void FDECL(play_immediate_ray_sound_at_location, (enum object_ray_soundset_types, enum ray_sound_types, int, int));
...
E boolean FDECL(create_room, (XCHAR_P, XCHAR_P, XCHAR_P, XCHAR_P, XCHAR_P,
                              XCHAR_P, XCHAR_P, XCHAR_P, int, int));
