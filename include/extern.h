...
E void FDECL(replmon, (struct monst *, struct monst *, BOOLEAN_P));
...
E void FDECL(restore_cham, (struct monst *, BOOLEAN_P));
...
E struct monst *FDECL(montraits, (struct obj *, coord *, BOOLEAN_P, int, int, uint64_t, uint64_t));
