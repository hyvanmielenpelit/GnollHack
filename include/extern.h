...
E void FDECL(recharge, (struct obj *, int, BOOLEAN_P, BOOLEAN_P));
...
E void FDECL(p_glow1, (struct obj*, int, int, BOOLEAN_P));
E void FDECL(p_glow2, (struct obj*, const char*, int, int, BOOLEAN_P));
