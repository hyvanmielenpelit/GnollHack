...
E short FDECL(maybe_get_animated_tile, (short, enum animation_play_types, int, unsigned long, int*, int*, boolean*, enum autodraw_types*));
...
E void FDECL(map_object_core, (struct obj*, int, boolean, boolean));
...
E void FDECL(set_simple_monster_sound_id_and_volume, (enum player_soundset_types, enum monster_sound_types, enum ghsound_types*, float*));
