...
E int FDECL(weapon_skill_hit_bonus, (struct obj *, int, BOOLEAN_P, BOOLEAN_P, BOOLEAN_P, int, BOOLEAN_P, UCHAR_P));
E int FDECL(weapon_skill_dmg_bonus, (struct obj *, int, BOOLEAN_P, BOOLEAN_P, BOOLEAN_P, int, BOOLEAN_P, UCHAR_P));
