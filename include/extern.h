...
E void ai_invoke_state_text(struct obj *, char *);
...
E void get_known_props(boolean *);
...
E struct obj* o_on_ex(unsigned int, struct obj*, boolean*);
...
E void ai_corpse_age_text(struct obj *, char *);
...
E void polyself(int);
E void polyself_ex(int, int);
E int polymon(int);
E int polymon_ex(int, boolean, int);
...
E struct obj* find_oid_ex(unsigned, int*, int*);
...
E void start_delayed_sliming(struct monst*, struct monst*, boolean);
...
E int weapon_skill_hit_bonus(struct obj *, int, boolean, boolean, uchar, int, boolean, boolean, boolean, boolean);
E int weapon_skill_dmg_bonus(struct obj *, int, boolean, boolean, uchar, int, boolean, boolean, boolean, boolean);
...
E int get_skill_critical_strike_chance(enum p_skills, boolean, boolean, int, boolean, boolean, boolean);
...
E void dump_weapon_style_key_ai(void);
E int limited_skill_level(enum p_skills, boolean, boolean, boolean);
E int adjusted_limited_skill_level(enum p_skills, boolean, boolean, boolean);
