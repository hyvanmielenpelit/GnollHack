...
E boolean tamedog(struct monst *, struct obj *, uchar, int, unsigned short, boolean, boolean);
...
E int maybe_tame(struct monst*, struct obj*, struct monst*);
E int maybe_controlled(struct monst*, struct obj*, struct monst*);
...
E int weapon_skill_hit_bonus(struct obj *, int, boolean, boolean, uchar, int, boolean, boolean);
E int weapon_skill_dmg_bonus(struct obj *, int, boolean, boolean, uchar, int, boolean, boolean);
...
E boolean cancel_monst(struct monst *, struct obj *, boolean,
                               boolean, boolean, int);
E boolean add_temporary_property(struct monst*, struct obj*, boolean,
    boolean, boolean, int);
