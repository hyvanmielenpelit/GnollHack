...
void FDECL(construct_getobj_letters, (const char*, const char*, char*, char*, int*, xchar*, char**, boolean*, boolean*, boolean*, boolean*, struct obj*));
...
E boolean FDECL(check_magic_resistance_and_inflict_damage, (struct monst *, struct obj *, boolean, int, int, int));
E boolean FDECL(inflict_spell_damage, (struct monst*, struct obj*, int, int, int));
