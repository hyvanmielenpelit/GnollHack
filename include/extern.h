...
E int FDECL(pseudo_artifact_hit, (struct monst*, struct monst*, struct obj*, int, int, int, int*));
...
E boolean FDECL(tamedog, (struct monst *, struct obj *, BOOLEAN_P, int, unsigned short, BOOLEAN_P, BOOLEAN_P));
...
E void FDECL(play_sfx_sound_at_location_with_minimum_volume, (enum sfx_sound_types, int, int, float));
...
E double FDECL(adjust_damage, (int, struct monst*, struct monst*, int, unsigned long));
