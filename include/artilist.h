...
STATIC_OVL NEARDATA struct artifact artilist[] = {
	...
	A("Howling Flail", "gold-hilted runed flail", None, RUNED_FLAIL, FLAIL, (AF_RESTR | AF_NAME_KNOWN_WHEN_INVOKED | AF_INVOKE_MAY_DRAIN_LIFE), AF2_NONE, SPFX_LUCK | SPFX_CHA_25, SPFX_NONE, 0,
	...
	A("Luck Blade", "bright runed broadsword", None, SWORD_OF_LUCKINESS, LONG_SWORD, (AF_RESTR | AF_NAME_KNOWN_WHEN_INVOKED | AF_NO_WISH | AF_INVOKE_EXPENDS_CHARGE), AF2_NONE, SPFX_NONE, SPFX_NONE, 0,
