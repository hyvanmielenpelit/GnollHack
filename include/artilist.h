...
STATIC_OVL NEARDATA struct artifact artilist[] = {
    ...
    A("Excalibur", "gold-hilted runed long sword", LONG_SWORD, LONG_SWORD, 
  	  AF_NOGEN | AF_RESTR | AF_DEFN | AF_INTEL | AF_FAMOUS | AF_DEFN | AF_INTEL, (SPFX_SEEK | SPFX_SEARCH), SPFX_NONE, 0, 
	  1, 5, 0, PHYS(1, 20), DRAIN_RES, NO_POWER, 0, A_LAWFUL, PM_KNIGHT, NON_PM,
      4000L, NO_COLOR, NO_COLOR),
    /*
     *      Stormbringer only has a 5 because it can drain a level,
     *      providing 8 + CON bonus more.
     */
    A("Stormbringer", "black runesword", RUNESWORD, ELVEN_BROADSWORD, (AF_RESTR | AF_ATTK | AF_DEFN | AF_INTEL | AF_DRLI | AF_NAME_KNOWN_WHEN_PICKED_UP), SPFX_NONE, SPFX_NONE, 0, 
	  1, 5, 0, DRLI(1, 5), DRAIN_RES, NO_POWER, 0, A_CHAOTIC, NON_PM, NON_PM, 8000L,
      NO_COLOR, CLR_BLACK),
    /*
    ...
    A("Mjollnir", "shining runed war hammer", HEAVY_WAR_HAMMER, WAR_HAMMER, /* Mjo:llnir */
	   ...
	   1, 5, 0, ELEC(1, 30), NO_POWER, NO_POWER, 0,
    ...
    A("Cleaver", "runed double-headed axe", BATTLE_AXE, BATTLE_AXE,  AF_RESTR, SPFX_NONE, SPFX_NONE, 0, 
	  1, 3, 0, PHYS(1, 6), NO_POWER, NO_POWER,
    ...
    A("Grimtooth", "runed crude dagger", ORNAMENTAL_ORCISH_DAGGER, ORCISH_DAGGER, 
	  ...
	  1, 5, 0, PHYS(1, 20), NO_POWER,
      NO_POWER, 0, A_CHAOTIC, NON_PM, PM_ORC, 500L, CLR_RED, NO_COLOR),
    /*
    ...
    A("Orcrist", "ornate runed broadsword", ELVEN_BROADSWORD, ELVEN_BROADSWORD, AF_DFLAG2, SPFX_WARN_OF_MON, SPFX_NONE, M2_ORC,
	  1, 5, 0, PHYS(ARTDMG_TRIPLE_DAMAGE, 0), NO_POWER, NO_POWER, 0,
    ...
    A("Sting", "ornate runed dagger", ELVEN_RUNEDAGGER, ELVEN_DAGGER, (AF_DFLAG2), SPFX_WARN_OF_MON, SPFX_NONE, M2_ORC,
		 1, 5, 0, PHYS(ARTDMG_DOUBLE_DAMAGE, 0), NO_POWER, NO_POWER, 0, A_CHAOTIC, NON_PM, PM_ELF, 1000L, CLR_BRIGHT_BLUE, NO_COLOR),
    /*
    ...
    A("Magicbane", "runed athame", ATHAME, ATHAME, (AF_RESTR | AF_ATTK | AF_DEFN | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), SPFX_NONE, SPFX_NONE, 0,
	  1, 3, 0, STUN(1, 10), ANTIMAGIC, NO_POWER, 0, A_NEUTRAL, PM_WIZARD, NON_PM,
    ...
    A("Frost Brand", "iron-hilted runed long sword", LONG_SWORD, LONG_SWORD, (AF_RESTR | AF_ATTK | AF_DEFN | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), SPFX_NONE, SPFX_NONE, 0,
	  1, 5, 0, COLD(ARTDMG_DOUBLE_DAMAGE, 0), COLD_RES, NO_POWER, 0, A_NONE, NON_PM, NON_PM, 3000L,
      NO_COLOR, CLR_WHITE),
    ...
    A("Fire Brand", "copper-hilted runed long sword", LONG_SWORD, LONG_SWORD, (AF_RESTR | AF_ATTK | AF_DEFN | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), SPFX_NONE, SPFX_NONE, 0,
	  1, 5, 0, FIRE(ARTDMG_DOUBLE_DAMAGE, 0), FIRE_RES, NO_POWER, 0, A_NONE, NON_PM, NON_PM, 3000L,
      NO_COLOR, CLR_RED),
    ...
    A("Dragonbane", "mithril-hilted runed broadsword", SWORD_OF_DRAGON_SLAYING, BROADSWORD,
	  ...
	  1, 5, 0, PHYS(1, 20), NO_POWER, NO_POWER, 0, A_NONE, NON_PM, NON_PM, 500L,
      NO_COLOR, NO_COLOR),
    ...
    A("Demonbane", "runed silver long sword", SWORD_OF_DEMON_SLAYING, SILVER_LONG_SWORD, (AF_RESTR | AF_DFLAG2 | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), SPFX_NONE, SPFX_NONE, M2_DEMON,
	  1, 5, 0, PHYS(1, 20), NO_POWER, NO_POWER, 0, A_LAWFUL, NON_PM, NON_PM, 2500L,
      NO_COLOR, NO_COLOR),
    ...
    A("Werebane", "runed silver saber", SABER_OF_LYCANTHROPE_SLAYING, SILVER_SABER, (AF_RESTR | AF_DFLAG2 | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), SPFX_NONE, SPFX_NONE, M2_WERE,
	  1, 5, 0, PHYS(1, 20), LYCANTHROPY_RES, NO_POWER, 0, A_NONE, NON_PM, NON_PM, 1500L,
      NO_COLOR, NO_COLOR),
    ...
    A("Grayswandir", "diamond-encrusted silver saber", SILVER_SABER, SILVER_SABER, (AF_RESTR | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), SPFX_HALRES, SPFX_NONE, 0,
	  1, 5, 0, PHYS(1, ARTDMG_DOUBLE_DAMAGE), NO_POWER, NO_POWER, 0, A_LAWFUL, NON_PM, NON_PM, 8000L,
      NO_COLOR, CLR_GRAY),
    ...
    A("Giantslayer", "ruby-encrusted long sword", SWORD_OF_GIANT_SLAYING, LONG_SWORD, (AF_RESTR | AF_DFLAG2 | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), SPFX_NONE, SPFX_NONE, M2_GIANT,
	  1, 5, 0, PHYS(1, 20), NO_POWER, NO_POWER, 0, A_NEUTRAL, NON_PM, NON_PM, 500L,
      NO_COLOR, NO_COLOR),
	...
	A("Gnollbane", "ruby-hilted war hammer", WAR_HAMMER_OF_GNOLL_SLAYING, WAR_HAMMER, (AF_RESTR | AF_DFLAG2 | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), SPFX_NONE, SPFX_NONE, M2_GNOLL,
		1, 5, 0, PHYS(1, 20), SHOCK_RES, NO_POWER, 0, A_LAWFUL, NON_PM, NON_PM, 500L,
      NO_COLOR, NO_COLOR),
	...
	A("Crossbow of the Gnoll Lords", "runed repeating heavy crossbow", REPEATING_HEAVY_CROSSBOW, REPEATING_HEAVY_CROSSBOW, (AF_RESTR | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), SPFX_STLTH , SPFX_NONE, 0,
		1, 5, 0, PHYS(1, 5), NO_POWER, NO_POWER, 0, A_NONE, NON_PM, PM_GNOLL, 2000L,
      NO_COLOR, NO_COLOR),
    ...
    A("Vorpal Blade", "immaculate runed long sword", LONG_SWORD, LONG_SWORD, (AF_RESTR | AF_BEHEAD | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), SPFX_NONE, SPFX_NONE, 0,
		1, 5, 0, PHYSI(0, 0, 1), NO_POWER, NO_POWER, 0, A_NEUTRAL, NON_PM, NON_PM, 4000L,
      NO_COLOR, NO_COLOR),
    /*
    ...
    A("Snickersnee", "gold-hilted runed katana", KATANA, KATANA, AF_RESTR, SPFX_NONE, SPFX_NONE, 0,
		0, 0, 0, PHYS(ARTDMG_DOUBLE_DAMAGE, 0), NO_POWER, NO_POWER,
    ...
    A("The Orb of Detection", "runed crystal ball", CRYSTAL_BALL, CRYSTAL_BALL, //STARTMARKER FOR QUEST ARTIFACTS
		...
		0, 0, 0, NO_ATTK, NO_POWER, ANTIMAGIC, INVISIBILITY, A_LAWFUL, PM_ARCHEOLOGIST,
    ...
    A("The Heart of Ahriman", "glowing red jewel", LUCKSTONE, LUCKSTONE,
      ...
      /* this stone does double damage if used as a projectile weapon */
		1, 5, 0, PHYS(ARTDMG_DOUBLE_DAMAGE, 0), NO_POWER, NO_POWER, LEVITATION, A_NEUTRAL, PM_BARBARIAN,
    ...
    A("The Sceptre of Might", "diamond-encrusted sceptre", MACE, MACE,
		...
		1, 5, 0, PHYS(ARTDMG_DOUBLE_DAMAGE, 0),
      ANTIMAGIC, NO_POWER, CONFLICT, A_LAWFUL, PM_CAVEMAN, NON_PM, 2500L,
      NO_COLOR, HI_GOLD),
...
A("The Palantir of Westernesse",        CRYSTAL_BALL, CRYSTAL_BALL,
    ...
    A("The Staff of Aesculapius", "serpent-entwined quarterstaff", STAFF_OF_LIFE, QUARTERSTAFF,
		(AF_NOGEN | AF_RESTR | AF_ATTK | AF_INTEL | AF_DRLI | AF_FAMOUS), SPFX_REGEN,
		SPFX_NONE, 0, 
		0, 0, 0, DRLI(0,0), DRAIN_RES, NO_POWER, HEALING, A_NEUTRAL, PM_HEALER,
    ...
    A("The Eyes of the Overworld", "runed eyeglasses", LENSES, LENSES,
		...
		0, 0, 0, NO_ATTK, ANTIMAGIC, NO_POWER, ENLIGHTENING, A_NEUTRAL, PM_MONK, NON_PM,
    ...
    A("The Mitre of Holiness", "diamond-encrusted helmet", HELM_OF_BRILLIANCE, HELMET,
	  (AF_NOGEN | AF_RESTR | AF_INTEL | AF_FAMOUS), SPFX_PROTECT | SPFX_HALF_PHYSICAL_DAMAGE_AGAINST_UNDEAD_AND_DEMONS, SPFX_NONE, 0, 
		0, 0, 0, NO_ATTK, NO_POWER, FIRE_RES, ENERGY_BOOST, A_LAWFUL,
    ...
    A("The Longbow of Diana", "ornamental long bow", LONG_BOW, LONG_BOW,
		...
		1, 10, 0, PHYS(ARTDMG_DOUBLE_DAMAGE, 0), NO_POWER, NO_POWER, CREATE_AMMO, A_CHAOTIC, PM_RANGER, NON_PM,
    ...
    A("The Master Key of Thievery", "ornamental key", SKELETON_KEY, SKELETON_KEY,
		...
		0, 0, 0, NO_ATTK, NO_POWER, NO_POWER,
    ...
    A("The Tsurugi of Muramasa", "runed tsurugi", TSURUGI, TSURUGI,
		...
		0, 0, 0, PHYS(1, 8), NO_POWER, NO_POWER, 0, A_LAWFUL, PM_SAMURAI, NON_PM,
    ...
    A("The Platinum Yendorian Express Card", "black credit card", CREDIT_CARD, CREDIT_CARD,
		...
		0, 0, 0, NO_ATTK, NO_POWER, ANTIMAGIC, CHARGE_OBJ, A_NEUTRAL, PM_TOURIST, NON_PM, 7000L, NO_COLOR, CLR_BLACK),
    ...
    A("The Eye of the Aethiopica", "eye-shaped amulet", AMULET_OF_ESP, AMULET,
		...
		0, 0, 0, NO_ATTK, ANTIMAGIC, NO_POWER, CREATE_PORTAL, A_NEUTRAL, PM_WIZARD,
	...
	A("The Ark of the Covenant", "gold-covered wooden chest", GOLDEN_CHEST, GOLDEN_CHEST,
		...
		0, 0, 0, NO_ATTK, NO_POWER, ANTIMAGIC, BLESS_CONTENTS, A_LAWFUL, NON_PM, // PM_ARCHEOLOGIST,
     ...
     */
    A(0, 0, 0, 0, AF_NONE, SPFX_NONE, SPFX_NONE, 0, 0, 0, 0, NO_ATTK, NO_POWER, NO_POWER, 0, A_NONE, NON_PM, NON_PM, 0L,
