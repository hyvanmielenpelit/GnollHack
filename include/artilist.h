...
NEARDATA struct artifact artilist[] = {
    ...
    A("Grimtooth", "runed crude dagger", None, ORNAMENTAL_ORCISH_DAGGER, ORCISH_DAGGER,
      ...
      (AF_RESTR | AF_DFLAG2 | AF_FLICKERS | AF_FAMOUS), AF2_NAME_IS_PROPER_NAME | AF2_FLOOR_TILE, SPFX_ELF_WARNING, SPFX_NONE, M2_ELF,
      1, 5, 0, PHYS(1, 10), NO_POWER, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_CHAOTIC, NON_PM, PM_ORC, 500L,
      CLR_RED, NO_COLOR, 18, OBJECT_SOUNDSET_NONE),
    /*
    ...
    A("Sting", "runed dagger", None, ELVEN_RUNEDAGGER, ELVEN_DAGGER, 
         MAT_NONE, EXCEPTIONALITY_ELITE, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
         (AF_DFLAG2 | AF_FLICKERS | AF_FAMOUS), AF2_MISSILE_TILE | AF2_NAME_IS_PROPER_NAME | AF2_FLOOR_TILE, SPFX_ORC_WARNING, SPFX_NONE, M2_ORC,
         1, 5, 0, PHYS(1, 10), NO_POWER, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_NEUTRAL, NON_PM, PM_ELF, 1000L, CLR_BRIGHT_BLUE, NO_COLOR, 18, OBJECT_SOUNDSET_NONE),
    /*
    ...
    A("Magicbane", "runed athame", None, ATHAME, ATHAME, 
        ...
        AF2_NAME_IS_PROPER_NAME | AF2_FLOOR_TILE, SPFX_NONE, SPFX_NONE, 0,
        1, 3, 0, STUN(1, 10), ANTIMAGIC, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_NEUTRAL, PM_WIZARD, NON_PM, 3500L,
        NO_COLOR, NO_COLOR, 10, OBJECT_SOUNDSET_NONE),
    ...
    A("Frost Brand", "ice-cold long sword", "ice-cold blade", LONG_SWORD, LONG_SWORD, 
        ...
        1, 5, 0, COLD(ARTDMG_175PCT_DAMAGE, 0), COLD_IMMUNITY, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_NONE, NON_PM, NON_PM, 3000L,
        NO_COLOR, HI_ICE, 0, OBJECT_SOUNDSET_NONE),

    A("Fire Brand", "red-hot long sword", "fiery blade", LONG_SWORD, LONG_SWORD, 
        MAT_NONE, EXCEPTIONALITY_EXCEPTIONAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        (AF_RESTR | AF_FAMOUS), AF2_NAME_IS_PROPER_NAME, SPFX_NONE, SPFX_NONE, 0,
        1, 5, 0, FIRE(ARTDMG_175PCT_DAMAGE, 0), FIRE_IMMUNITY, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_NONE, NON_PM, NON_PM, 3000L,
        NO_COLOR, HI_FIRE, 0, OBJECT_SOUNDSET_NONE),
    ...
    A("Luck Blade", "ornate broadsword", None, SWORD_OF_LUCKINESS, LONG_SWORD, 
        MAT_NONE, EXCEPTIONALITY_EXCEPTIONAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        (AF_RESTR | AF_NAME_KNOWN_WHEN_INVOKED | AF_NO_WISH | AF_INVOKE_EXPENDS_CHARGE), AF2_RARE, SPFX_NONE, SPFX_NONE, 0,
    ...
    A("Wand of Orcus", "skull-headed obsidian mace", None, MACE_OF_THE_UNDERWORLD, MACE, 
        ...
        1, 5, 0, DRLI(1, 10), NO_POWER, NO_POWER, ARTINVOKE_WAND_OF_DEATH, 0, 0, 0, 0, 150, A_NONE, NON_PM, NON_PM, 6000L,
        NO_COLOR, CLR_BLACK, 0, OBJECT_SOUNDSET_NONE),

    A("Ruby Rod of Asmodeus", "ruby-encrusted sceptre", None, DIABOLICAL_SCEPTRE, MACE,
        ...
        1, 5, 0, COLD(2, 8), ANTIMAGIC, NO_POWER, ARTINVOKE_RUBY_ROD, 0, 0, 0, 10, 10, A_NONE, NON_PM, NON_PM, 6000L,
    ...
    A("Rhongomyniad", "runed lance", None, LANCE, LANCE,
        ...
        1, 5, 0, PHYS(ARTDMG_250PCT_DAMAGE, 0), MAGIC_MISSILE_IMMUNITY, CURSE_RESISTANCE, NO_POWER, 0, 0, 0, 0, 0, A_LAWFUL, PM_KNIGHT, NON_PM, 2500L,
        NO_COLOR, CLR_MAGENTA, 0, OBJECT_SOUNDSET_NONE),
    ...
    A("Snickersnee", None, None, KATANA, KATANA,
        MAT_NONE, EXCEPTIONALITY_EXCEPTIONAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        AF_RESTR | AF_FAMOUS, AF2_NAME_IS_PROPER_NAME, SPFX_NONE, SPFX_NONE, 0,
        0, 0, 0, PHYS(ARTDMG_150PCT_DAMAGE, 0), NO_POWER, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_LAWFUL, PM_SAMURAI, NON_PM, 1200L,
        NO_COLOR, HI_GOLD, 0, OBJECT_SOUNDSET_NONE),
    ...
    A("Sunsword", None, None, LONG_SWORD, LONG_SWORD,
        ...
        1, 5, 0, PHYS(ARTDMG_150PCT_DAMAGE, 0), FLASH_RESISTANCE, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_LAWFUL, NON_PM, NON_PM, 1500L,
        NO_COLOR, HI_GOLD, 0, OBJECT_SOUNDSET_NONE),
    ...
    A("The Emerald Sword", None, None, TWO_HANDED_SWORD, TWO_HANDED_SWORD,
        ...
        AF2_NONE,
        SPFX_REFLECT, SPFX_HALRES, 0,
        1, 5, 0, PHYS(ARTDMG_150PCT_DAMAGE, 0), NO_POWER, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_NEUTRAL, NON_PM, NON_PM, 5000L,
    ...
    A("The Katana of Masamune", "engraved katana", "razor-sharp blade", KATANA, KATANA,
        MAT_NONE, EXCEPTIONALITY_ELITE, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        (AF_RESTR | AF_BISECT), AF2_JAPANESE, SPFX_LUCK, SPFX_NONE, 0,
    ...
    A("The Kusanagi", "engraved tsurugi", None, TSURUGI, TSURUGI,
        MAT_NONE, EXCEPTIONALITY_ELITE, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        (AF_RESTR | AF_NAME_KNOWN_WHEN_INVOKED), AF2_APPLICABLE_AS_AXE | AF2_JAPANESE, SPFX_NONE, SPFX_NONE, 0,
    ...
    /* Artifact rings */
    A("The Ruling Ring of Yendor", "plain golden", None, RIN_SUPREME_POWER, RIN_INVISIBILITY, 
    ...
    A("The Ring of Three Wishes", "three-ruby-studded", None, RIN_THREE_CHARGES, RIN_ADORNMENT, 
        MAT_NONE, EXCEPTIONALITY_NORMAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        (AF_RESTR | AF_NO_WISH | AF_NAME_KNOWN_WHEN_INVOKED | AF_INVOKE_EXPENDS_CHARGE | AF_INVOKE_REQUIRES_WORN),
        AF2_FLOOR_TILE | AF2_RARE, SPFX_NONE, SPFX_NONE, 0,
    ...
    A("The Ring of Conflict", "ruby", None, RIN_SEVEN_CHARGES, RIN_ADORNMENT,
        MAT_NONE, EXCEPTIONALITY_NORMAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
    ...
    A("The Rod of Disjunction", "black metal", None, WAN_DISJUNCTION, WAN_CANCELLATION, 
    ...
    A("The Gauntlets of Yin and Yang", "black and white gauntlets", None, GAUNTLETS_OF_BALANCE, GAUNTLETS,
        MAT_NONE, EXCEPTIONALITY_ELITE, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
    ...
    A("The Sceptre of Might", "diamond-encrusted sceptre", None, RUNED_SCEPTRE, MACE,
        ...
        1, 5, 0, PHYS(ARTDMG_125PCT_DAMAGE, 0), ANTIMAGIC, NO_POWER, CONFLICT, 2, 10, 140, 0, 300, A_LAWFUL, PM_CAVEMAN, NON_PM, 2500L,
        NO_COLOR, HI_GOLD, 0, OBJECT_SOUNDSET_NONE),
...
A("The Palantir of Westernesse",        CRYSTAL_BALL, CRYSTAL_BALL,
    ...
    A("The Staff of Aesculapius", "serpent-entwined quarterstaff", None, STAFF_OF_LIFE, QUARTERSTAFF,
        MAT_NONE, EXCEPTIONALITY_ELITE, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        (AF_NOGEN | AF_RESTR | AF_INTEL | AF_DRLI | AF_FAMOUS), AF2_INDESTRUCTIBLE, SPFX_NONE, SPFX_NONE, 0,
        0, 0, 0, DRLI(0,0), POISON_RESISTANCE, SICK_RESISTANCE, ARTINVOKE_HEALING, 0, 0, 0, 0, 150, A_NEUTRAL, PM_HEALER, NON_PM, 5000L,
        NO_COLOR, CLR_MAGENTA, 0, OBJECT_SOUNDSET_NONE),
    ...
    A("The Eyes of the Overworld", "runed eyeglasses", None, LENSES, LENSES,
        MAT_NONE, EXCEPTIONALITY_NORMAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        (AF_NOGEN | AF_RESTR | AF_INTEL | AF_FAMOUS), AF2_INDESTRUCTIBLE | AF2_FLOOR_TILE, (SPFX_ASTRAL | SPFX_BLIND_SEEING),  SPFX_NONE, 0,
    ...
    A("The Longbow of Diana", "shining long bow", None, DIVINE_LONG_BOW, LONG_BOW,
        MAT_NONE, EXCEPTIONALITY_ELITE, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        (AF_NOGEN | AF_RESTR | AF_INTEL | AF_FAMOUS), AF2_INDESTRUCTIBLE, SPFX_NONE, SPFX_ESP, 0,
    ...
    A("The Tsurugi of Muramasa", "engraved tsurugi", "razor-sharp blade", TSURUGI, TSURUGI,
        MAT_NONE, EXCEPTIONALITY_ELITE, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        (AF_NOGEN | AF_RESTR | AF_INTEL | AF_BISECT | AF_FAMOUS), AF2_INDESTRUCTIBLE | AF2_JAPANESE, (SPFX_LUCK | SPFX_PROTECT), SPFX_NONE, 0,
    ...
    A("The Mattock of the Titans", "large mattock", None, DWARVISH_MATTOCK, DWARVISH_MATTOCK,
        MAT_ADAMANTIUM, EXCEPTIONALITY_EXCEPTIONAL, MYTHIC_PREFIX_CYCLOPEAN, MYTHIC_SUFFIX_NONE,
        AF_RESTR, AF2_NONE, SPFX_STR_25, SPFX_NONE, 0,
        1, 5, 0, PHYS(1, 5), NO_POWER, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_NONE, NON_PM, NON_PM, 8000L,
        NO_COLOR, NO_COLOR, 0, OBJECT_SOUNDSET_NONE),

    A("The Maul of the Titans", "large maul", None, TWO_HANDED_CLUB, TWO_HANDED_CLUB,
        MAT_WOOD, EXCEPTIONALITY_EXCEPTIONAL, MYTHIC_PREFIX_CYCLOPEAN, MYTHIC_SUFFIX_NONE,
        AF_RESTR, AF2_FLOOR_TILE, SPFX_STR_25, SPFX_NONE, 0,
        1, 5, 0, PHYS(1, 5), NO_POWER, NO_POWER, ARTINVOKE_EARTHQUAKE, 0, 0, 0, 0, 250, A_NONE, NON_PM, NON_PM, 8000L,
        NO_COLOR, NO_COLOR, 16, OBJECT_SOUNDSET_NONE),

    /* Reserved artifacts slots for making new artifacts */
    A("Reserved Artifact A", None, None, STRANGE_OBJECT, STRANGE_OBJECT,
        MAT_NONE, EXCEPTIONALITY_NORMAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        (AF_NOGEN | AF_NO_WISH | AF_RESTR), AF2_NONE | AF2_NO_CATALOGUE, SPFX_NONE, SPFX_NONE, 0,
        0, 0, 0, NO_ATTK, NO_POWER, 0, 0, 0, 0, 0, 0, 0, A_NONE, NON_PM, NON_PM, 0L,
        NO_COLOR, NO_COLOR, 0, OBJECT_SOUNDSET_NONE),

    A("Reserved Artifact B", None, None, STRANGE_OBJECT, STRANGE_OBJECT,
        MAT_NONE, EXCEPTIONALITY_NORMAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        (AF_NOGEN | AF_NO_WISH | AF_RESTR), AF2_NONE | AF2_NO_CATALOGUE, SPFX_NONE, SPFX_NONE, 0,
        0, 0, 0, NO_ATTK, NO_POWER, 0, 0, 0, 0, 0, 0, 0, A_NONE, NON_PM, NON_PM, 0L,
        NO_COLOR, NO_COLOR, 0, OBJECT_SOUNDSET_NONE),

    A("Reserved Artifact C", None, None, STRANGE_OBJECT, STRANGE_OBJECT,
        MAT_NONE, EXCEPTIONALITY_NORMAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        (AF_NOGEN | AF_NO_WISH | AF_RESTR), AF2_NONE | AF2_NO_CATALOGUE, SPFX_NONE, SPFX_NONE, 0,
        0, 0, 0, NO_ATTK, NO_POWER, 0, 0, 0, 0, 0, 0, 0, A_NONE, NON_PM, NON_PM, 0L,
        NO_COLOR, NO_COLOR, 0, OBJECT_SOUNDSET_NONE),

    A("Reserved Artifact D", None, None, STRANGE_OBJECT, STRANGE_OBJECT,
        MAT_NONE, EXCEPTIONALITY_NORMAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        (AF_NOGEN | AF_NO_WISH | AF_RESTR), AF2_NONE | AF2_NO_CATALOGUE, SPFX_NONE, SPFX_NONE, 0,
        0, 0, 0, NO_ATTK, NO_POWER, 0, 0, 0, 0, 0, 0, 0, A_NONE, NON_PM, NON_PM, 0L,
        NO_COLOR, NO_COLOR, 0, OBJECT_SOUNDSET_NONE),

    A("Reserved Artifact E", None, None, STRANGE_OBJECT, STRANGE_OBJECT,
        MAT_NONE, EXCEPTIONALITY_NORMAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        (AF_NOGEN | AF_NO_WISH | AF_RESTR), AF2_NONE | AF2_NO_CATALOGUE, SPFX_NONE, SPFX_NONE, 0,
        0, 0, 0, NO_ATTK, NO_POWER, 0, 0, 0, 0, 0, 0, 0, A_NONE, NON_PM, NON_PM, 0L,
        NO_COLOR, NO_COLOR, 0, OBJECT_SOUNDSET_NONE),

    A("Reserved Artifact F", None, None, STRANGE_OBJECT, STRANGE_OBJECT,
        MAT_NONE, EXCEPTIONALITY_NORMAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        (AF_NOGEN | AF_NO_WISH | AF_RESTR), AF2_NONE | AF2_NO_CATALOGUE, SPFX_NONE, SPFX_NONE, 0,
        0, 0, 0, NO_ATTK, NO_POWER, 0, 0, 0, 0, 0, 0, 0, A_NONE, NON_PM, NON_PM, 0L,
        NO_COLOR, NO_COLOR, 0, OBJECT_SOUNDSET_NONE),

    A("Reserved Artifact G", None, None, STRANGE_OBJECT, STRANGE_OBJECT,
        MAT_NONE, EXCEPTIONALITY_NORMAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        (AF_NOGEN | AF_NO_WISH | AF_RESTR), AF2_NONE | AF2_NO_CATALOGUE, SPFX_NONE, SPFX_NONE, 0,
        0, 0, 0, NO_ATTK, NO_POWER, 0, 0, 0, 0, 0, 0, 0, A_NONE, NON_PM, NON_PM, 0L,
        NO_COLOR, NO_COLOR, 0, OBJECT_SOUNDSET_NONE),

    A("Reserved Artifact H", None, None, STRANGE_OBJECT, STRANGE_OBJECT,
        MAT_NONE, EXCEPTIONALITY_NORMAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        (AF_NOGEN | AF_NO_WISH | AF_RESTR), AF2_NONE | AF2_NO_CATALOGUE, SPFX_NONE, SPFX_NONE, 0,
        0, 0, 0, NO_ATTK, NO_POWER, 0, 0, 0, 0, 0, 0, 0, A_NONE, NON_PM, NON_PM, 0L,
        NO_COLOR, NO_COLOR, 0, OBJECT_SOUNDSET_NONE),
