...
STATIC_OVL NEARDATA struct artifact artilist[] = {
	...
	A("Magicbane", "runed athame", None, ATHAME, ATHAME, (AF_RESTR | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED | AF_MAGIC_ABSORBING),
		EXCEPTIONALITY_EXCEPTIONAL, AF2_NAME_IS_PROPER_NAME, SPFX_NONE, SPFX_NONE, 0,
    ...
    A("The Ring of Three Wishes", "three-ruby-studded", None, RIN_THREE_CHARGES, RIN_THREE_CHARGES, (AF_RESTR | AF_NO_WISH | AF_NAME_KNOWN_WHEN_INVOKED | AF_INVOKE_EXPENDS_CHARGE | AF_INVOKE_REQUIRES_WORN),
    ...
    A("The Serpent Ring of Set", "serpent-shaped", None, RIN_THE_SERPENT_GOD, RIN_THE_SERPENT_GOD, (AF_RESTR | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED | AF_INVOKE_REQUIRES_WORN),
    ...
    A("The Ring of Conflict", "ruby", None, RIN_SEVEN_CHARGES, RIN_SEVEN_CHARGES, (AF_RESTR | AF_NAME_KNOWN_WHEN_INVOKED | AF_INVOKE_EXPENDS_CHARGE | AF_INVOKE_REQUIRES_WORN),
		EXCEPTIONALITY_NORMAL, AF2_NONE, SPFX_NONE, SPFX_NONE, 0,
		0, 0, 0, NO_ATTK, NO_POWER, NO_POWER, CONFLICT, 2, 10, 140, 0, 200, A_NONE, NON_PM, NON_PM, 3500L,
		NO_COLOR, CLR_RED, 0, OBJECT_SOUNDSET_NONE),

	/* Other non-weapon artifacts */
    A("The Rod of Disjunction", "black metal", None, WAN_DISJUNCTION, WAN_DISJUNCTION, (AF_RESTR | AF_FAMOUS),
	...
	A("The Gauntlets of Yin and Yang", "black and white gauntlets", None, GAUNTLETS_OF_BALANCE, GAUNTLETS_OF_BALANCE,
		EXCEPTIONALITY_EXCEPTIONAL, (AF_NOGEN | AF_RESTR | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED | AF_NO_WISH | AF_INVOKE_REQUIRES_WORN | AF_INVOKE_MAY_DRAIN_ENERGY), AF2_FLOOR_TILE, SPFX_NONE, SPFX_NONE, 0,
