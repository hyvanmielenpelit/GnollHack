...
STATIC_OVL NEARDATA struct artifact artilist[] = {
	...
	A("Gauntlets of Yin and Yang", "black and white gauntlets", None, GAUNTLETS_OF_BALANCE, GAUNTLETS_OF_BALANCE, (AF_NOGEN | AF_RESTR | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED | AF_NAME_KNOWN_WHEN_INVOKED | AF_NO_WISH), SPFX_NONE, SPFX_NONE, 0,
