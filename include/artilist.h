...
STATIC_OVL NEARDATA struct artifact artilist[] = {
    ...
    A("Mjollnir", "runed war hammer", "massive hammer", HEAVY_WAR_HAMMER, WAR_HAMMER, /* Mjo:llnir */
	   EXCEPTIONALITY_ELITE, (AF_RESTR | AF_FAMOUS), AF2_MISSILE_TILE | AF2_NAME_IS_PROPER_NAME, SPFX_NONE, SPFX_NONE, 0,
    ...
    A("Cleaver", "runed double-headed axe", None, BATTLE_AXE, BATTLE_AXE,  
	  EXCEPTIONALITY_EXCEPTIONAL, AF_RESTR | AF_HITS_ADJACENT_SQUARES, AF2_NAME_IS_PROPER_NAME, SPFX_NONE, SPFX_NONE, 0,
    ...
    A("Grimtooth", "runed crude dagger", None, ORNAMENTAL_ORCISH_DAGGER, ORCISH_DAGGER,
	  EXCEPTIONALITY_EXCEPTIONAL, (AF_RESTR | AF_DFLAG2 | AF_FLICKERS), AF2_NAME_IS_PROPER_NAME, SPFX_ELF_WARNING, SPFX_NONE, M2_ELF,
    ...
    A("Orcrist", "runed broadsword", None, ELVEN_BROADSWORD, ELVEN_BROADSWORD, 
	  EXCEPTIONALITY_EXCEPTIONAL, (AF_DFLAG2 | AF_FLICKERS), AF2_NAME_IS_PROPER_NAME, SPFX_ORC_WARNING, SPFX_NONE, M2_ORC,
    ...
    A("Sting", "runed dagger", None, ELVEN_RUNEDAGGER, ELVEN_DAGGER, 
		 EXCEPTIONALITY_EXCEPTIONAL, (AF_DFLAG2 | AF_FLICKERS), AF2_MISSILE_TILE | AF2_NAME_IS_PROPER_NAME, SPFX_ORC_WARNING, SPFX_NONE, M2_ORC,
	...
	A("Magicbane", "runed athame", None, ATHAME, ATHAME, 
	    EXCEPTIONALITY_EXCEPTIONAL, (AF_RESTR | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED | AF_MAGIC_ABSORBING),
	...
	A("Frost Brand", "iron-hilted long sword", "ice-cold blade", LONG_SWORD, LONG_SWORD, 
		EXCEPTIONALITY_EXCEPTIONAL, (AF_RESTR | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), AF2_NAME_IS_PROPER_NAME, SPFX_NONE, SPFX_NONE, 0,
	...
	A("Dragonbane", "mithril-hilted broadsword", None, SWORD_OF_DRAGON_SLAYING, BROADSWORD,
		EXCEPTIONALITY_EXCEPTIONAL, (AF_RESTR | AF_DCLAS | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), AF2_NAME_IS_PROPER_NAME, SPFX_REFLECT, SPFX_NONE, S_DRAGON,
	...
	A("Werebane", "runed silver saber", None, SABER_OF_LYCANTHROPE_SLAYING, SILVER_SABER, 
		EXCEPTIONALITY_EXCEPTIONAL, (AF_RESTR | AF_DFLAG2 | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), AF2_NAME_IS_PROPER_NAME, SPFX_NONE, SPFX_NONE, M2_WERE,
	...
	A("Grayswandir", "diamond-encrusted silver saber", None, SILVER_SABER, SILVER_SABER, 
		EXCEPTIONALITY_EXCEPTIONAL, (AF_RESTR | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), AF2_NAME_IS_PROPER_NAME, SPFX_HALRES, SPFX_NONE, 0,
	...
	A("Giantslayer", "ruby-encrusted long sword", None, SWORD_OF_GIANT_SLAYING, LONG_SWORD, 
		EXCEPTIONALITY_EXCEPTIONAL, (AF_RESTR | AF_DFLAG2 | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), AF2_NAME_IS_PROPER_NAME, SPFX_NONE, SPFX_NONE, M2_GIANT,
	...
	A("Ogresmasher", "gold-hilted war hammer", None, WAR_HAMMER_OF_OGRE_SLAYING, WAR_HAMMER, 
		EXCEPTIONALITY_EXCEPTIONAL, (AF_RESTR | AF_DCLAS | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), AF2_NAME_IS_PROPER_NAME, SPFX_NONE, SPFX_NONE, S_OGRE,
		1, 5, 0, PHYS(1, 20), NO_POWER, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_NONE, NON_PM, NON_PM, 500L,
		NO_COLOR, NO_COLOR, 0, OBJECT_SOUNDSET_NONE),

	A("Trollsbane", "runed morning star", None, MORNING_STAR_OF_TROLL_SLAYING, MORNING_STAR, 
		EXCEPTIONALITY_EXCEPTIONAL, (AF_RESTR | AF_DCLAS | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), AF2_NAME_IS_PROPER_NAME, SPFX_REGEN, SPFX_NONE, S_TROLL,
		1, 5, 0, PHYS(1, 20), NO_POWER, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_NONE, NON_PM, NON_PM, 500L,
		NO_COLOR, NO_COLOR, 0, OBJECT_SOUNDSET_NONE),
	...
	A("Triple-Headed Flail of Yeenoghu", "runed triple-headed flail", None, TRIPLE_HEADED_FLAIL, TRIPLE_HEADED_FLAIL,
		EXCEPTIONALITY_INFERNAL, (AF_NOGEN | AF_RESTR | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED | AF_NO_WISH | AF_DRLI), AF2_NONE, SPFX_NONE, SPFX_NONE, 0,
	...
	A("Rhongomyniad", "runed lance", None, LANCE, LANCE,
		EXCEPTIONALITY_EXCEPTIONAL, (AF_RESTR | AF_FAMOUS), AF2_NAME_IS_PROPER_NAME, SPFX_NONE, SPFX_NONE, 0,
	...
	A("Snickersnee", "gold-hilted katana", None, KATANA, KATANA, 
		EXCEPTIONALITY_EXCEPTIONAL, AF_RESTR, AF2_NAME_IS_PROPER_NAME, SPFX_NONE, SPFX_NONE, 0,
	...
	A("The Mace of Saint Cuthbert", "wooden mace", None, MACE_OF_GREATER_DISRUPTION, MACE_OF_GREATER_DISRUPTION,
    ...
    A("The One Ring", "plain golden", None, RIN_SUPREME_POWER, RIN_SUPREME_POWER, 
		EXCEPTIONALITY_NORMAL, (AF_RESTR | AF_INTEL | AF_MONSTERS_CAN_TRACK_ARTIFACT),
    ...
    A("The Ring of Three Wishes", "three-ruby-studded", None, RIN_THREE_CHARGES, RIN_THREE_CHARGES, 
		EXCEPTIONALITY_NORMAL, (AF_RESTR | AF_NO_WISH | AF_NAME_KNOWN_WHEN_INVOKED | AF_INVOKE_EXPENDS_CHARGE | AF_INVOKE_REQUIRES_WORN),
    ...
    A("The Serpent Ring of Set", "serpent-shaped", None, RIN_THE_SERPENT_GOD, RIN_THE_SERPENT_GOD, 
		EXCEPTIONALITY_NORMAL, (AF_RESTR | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED | AF_INVOKE_REQUIRES_WORN),
    ...
    A("The Ring of Conflict", "ruby", None, RIN_SEVEN_CHARGES, RIN_SEVEN_CHARGES, 
		EXCEPTIONALITY_NORMAL, (AF_RESTR | AF_NAME_KNOWN_WHEN_INVOKED | AF_INVOKE_EXPENDS_CHARGE | AF_INVOKE_REQUIRES_WORN),
		AF2_NONE, SPFX_NONE, SPFX_NONE, 0,
    ...
    A("The Rod of Disjunction", "black metal", None, WAN_DISJUNCTION, WAN_DISJUNCTION, 
		EXCEPTIONALITY_NORMAL, (AF_RESTR | AF_FAMOUS),
	...
	A("The Gauntlets of Yin and Yang", "black and white gauntlets", None, GAUNTLETS_OF_BALANCE, GAUNTLETS_OF_BALANCE,
		EXCEPTIONALITY_EXCEPTIONAL, (AF_NOGEN | AF_RESTR | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED | AF_NO_WISH | AF_INVOKE_REQUIRES_WORN | AF_INVOKE_MAY_DRAIN_ENERGY), 
    ...
    A("The Holy Grail", "wooden grail", None, GRAIL_OF_HEALING, GRAIL_OF_HEALING, EXCEPTIONALITY_NORMAL, 
    ...
    A("The Prime Codex", "ornamental white", None, SPE_BOOK_OF_MODRON, SPE_BOOK_OF_MODRON,
		EXCEPTIONALITY_NORMAL, (AF_NOGEN | AF_RESTR | AF_FAMOUS | AF_READABLE | AF_NO_WISH), AF2_NONE, SPFX_NONE, 
    ...
    A("The Heart of Ahriman", "glowing red jewel", None, LUCKSTONE, LUCKSTONE,
		EXCEPTIONALITY_NORMAL, (AF_NOGEN | AF_RESTR | AF_INTEL | AF_FAMOUS), AF2_FLOOR_TILE, SPFX_NONE, SPFX_STLTH, 0,
...
A("The Palantir of Westernesse",        CRYSTAL_BALL, CRYSTAL_BALL,
    ...
    A("The Master Key of Thievery", "ornamental key", None, MASTER_KEY, SKELETON_KEY,
		EXCEPTIONALITY_NORMAL, (AF_NOGEN | AF_RESTR | AF_INTEL | AF_SPEAK | AF_FAMOUS), AF2_FLOOR_TILE, SPFX_NONE, (SPFX_WARNING | SPFX_TCTRL | SPFX_HPHDAM), 0,
    ...
    A("The Platinum Yendorian Express Card", "black credit card", None, CREDIT_CARD, CREDIT_CARD,
		EXCEPTIONALITY_NORMAL, (AF_NOGEN | AF_RESTR | AF_INTEL | AF_FAMOUS), AF2_FLOOR_TILE, SPFX_NONE, (SPFX_ESP | SPFX_CHA_25), 0,
    ...
    A("The Eye of the Aethiopica", "eye-shaped amulet", None, AMULET_OF_ESP, AMULET_OF_SEEING,
		EXCEPTIONALITY_NORMAL, (AF_NOGEN | AF_RESTR | AF_INTEL | AF_FAMOUS), AF2_FLOOR_TILE, SPFX_NONE, (SPFX_EREGEN | SPFX_HSPDAM), 0,
