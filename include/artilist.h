...
#define A(nam, desc, hit_desc, typ, masktyp, aflags, spfx, cspfx, mt, tohitdice, tohitsize, tohitplus, atk, dfn, cry, inv, inv_dur_dice, inv_dur_diesize, inv_dur_plus, manacost, repower, al, cl, rac, cost, glowclr, objclr) nam

static const char *artifact_names[] = {
#else
/* in artifact.c, set up the actual artifact list structure */

#define A(nam, desc, hit_desc, typ, masktyp, aflags, spfx, cspfx, mt, tohitdice, tohitsize, tohitplus, atk, dfn, cry, inv, inv_dur_dice, inv_dur_diesize, inv_dur_plus, manacost, repower, al, cl, rac, cost, glowclr, objclr) \
    {                                                                       \
        typ, masktyp, nam, desc, hit_desc, aflags, spfx, cspfx, mt, tohitdice, tohitsize, tohitplus, atk, dfn, cry, inv, inv_dur_dice, inv_dur_diesize, inv_dur_plus, manacost, repower, al, cl, rac, cost, glowclr, objclr    \
    }
...
STATIC_OVL NEARDATA struct artifact artilist[] = {
    ...
    A("", None, None, STRANGE_OBJECT, STRANGE_OBJECT, AF_NONE, SPFX_NONE, SPFX_NONE, 0, 0, 0, 0, NO_ATTK, NO_POWER, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_NONE,
	...
	A("Howling Flail", "gold-hilted runed flail", None, RUNED_FLAIL, FLAIL, (AF_RESTR | AF_NAME_KNOWN_WHEN_INVOKED | AF_INVOKE_MAY_DRAIN_LIFE), SPFX_LUCK, SPFX_NONE, 0,
	...
	A("Wand of Orcus", "skull-headed obsidian mace", None, MACE_OF_THE_UNDERWORLD, MACE_OF_THE_UNDERWORLD, (AF_NOGEN | AF_RESTR | AF_NAME_KNOWN_WHEN_INVOKED | AF_INVOKE_EXPENDS_CHARGE | AF_NO_WISH), SPFX_NONE, SPFX_NONE, 0,
    ...
    A("Serpent Ring of Set", "serpent-shaped", None, RIN_THE_SERPENT_GOD, RIN_THE_SERPENT_GOD, (AF_RESTR | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED | AF_INVOKE_REQUIRES_WORN),
		...
		0, 0, 0, NO_ATTK, NO_POWER, NO_POWER, ARTINVOKE_DEMON_SUMMON, 6, 6, 200, 50, 500, A_NONE, NON_PM, NON_PM, 3000L,
		NO_COLOR, CLR_RED),
	...
	A("Gauntlets of Yin and Yang", "black and white gauntlets", None, GAUNTLETS_OF_BALANCE, GAUNTLETS_OF_BALANCE, (AF_NOGEN | AF_RESTR | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED | AF_NO_WISH | AF_INVOKE_REQUIRES_WORN | AF_INVOKE_MAY_DRAIN_ENERGY), SPFX_NONE, SPFX_NONE, 0,
    ...
    A("The Holy Grail", "wooden grail", None, GRAIL_OF_HEALING, GRAIL_OF_HEALING, (AF_RESTR | AF_NAME_KNOWN_WHEN_INVOKED),
		...
		0, 0, 0, NO_ATTK, NO_POWER, SLOW_DIGESTION, ARTINVOKE_RECHARGE_ITSELF, 0, 0, 0, 0, 800, A_NONE, NON_PM, NON_PM, 3000L,
		NO_COLOR, CLR_RED),
    ...
    A("The Orb of Detection", "runed crystal ball", None, CRYSTAL_BALL, CRYSTAL_BALL, //STARTMARKER FOR QUEST ARTIFACTS
		...
		0, 0, 0, NO_ATTK, NO_POWER, ANTIMAGIC, INVISIBILITY, 0, 0, 0, 0, 60, A_LAWFUL, PM_ARCHEOLOGIST, NON_PM, 2500L,
		NO_COLOR, CLR_MAGENTA),
    ...
    A("The Heart of Ahriman", "glowing red jewel", None, LUCKSTONE, LUCKSTONE,
      ...
      /* this stone does double damage if used as a projectile weapon */
		1, 5, 0, PHYS(ARTDMG_DOUBLE_DAMAGE, 0), NO_POWER, NO_POWER, LEVITATION, 0, 0, 0, 50, 60, A_NEUTRAL, PM_BARBARIAN, NON_PM, 2500L,
		NO_COLOR, CLR_RED),

    A("The Sceptre of Might", "diamond-encrusted sceptre", None, RUNED_SCEPTRE, RUNED_SCEPTRE,
		(AF_NOGEN | AF_RESTR | AF_INTEL | AF_DALIGN | AF_FAMOUS | AF_INVOKE_EXPENDS_CHARGE), SPFX_NONE, SPFX_NONE, 0,
...
A("The Palantir of Westernesse",        CRYSTAL_BALL, CRYSTAL_BALL,
    ...
    A("The Magic Mirror of Merlin", "runed looking glass", None, MAGIC_MIRROR, MIRROR,
		...
		0, 0, 0, NO_ATTK, NO_POWER, ANTIMAGIC, NO_POWER, 0, 0, 0, 0, 0, A_LAWFUL, PM_KNIGHT, NON_PM, 1500L,
		NO_COLOR, CLR_MAGENTA),
    ...
    A("The Longbow of Diana", "ornamental long bow", None, LONG_BOW, LONG_BOW,
		...
		1, 10, 0, PHYS(ARTDMG_DOUBLE_DAMAGE, 0), NO_POWER, NO_POWER, ARTINVOKE_CREATE_AMMO, 0, 0, 0, 0, 75, A_CHAOTIC, PM_RANGER, NON_PM, 4000L,
		NO_COLOR, CLR_MAGENTA),
     ...
     */
    A(0, 0, 0, 0, 0, AF_NONE, SPFX_NONE, SPFX_NONE, 0, 0, 0, 0, NO_ATTK, NO_POWER, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_NONE, NON_PM, NON_PM, 0L,
