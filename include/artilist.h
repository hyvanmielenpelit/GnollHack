...
NEARDATA struct artifact artilist[] = {
    ...
    A("Ruby Rod of Asmodeus", "ruby-encrusted sceptre", None, RUNED_SCEPTRE, MACE, 
        MAT_GEMSTONE, EXCEPTIONALITY_ELITE, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE,
        (AF_NOGEN | AF_RESTR | AF_INVOKE_EXPENDS_CHARGE | AF_NO_WISH), AF2_INDESTRUCTIBLE | AF2_MATERIAL_NAME_2ND_WORD_DN, SPFX_ESP | SPFX_REGEN | SPFX_EREGEN, SPFX_NONE, 0,
        1, 5, 0, COLD(1, 10), ANTIMAGIC, NO_POWER, ARTINVOKE_WAND_OF_COLD, 0, 0, 0, 0, 0, A_LAWFUL, NON_PM, NON_PM, 6000L,
        NO_COLOR, CLR_RED, 0, OBJECT_SOUNDSET_NONE),
