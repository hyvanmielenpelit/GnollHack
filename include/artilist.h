...
NEARDATA struct artifact artilist[] = {
    ...
    A("Grimtooth", "runed crude dagger", None, ORNAMENTAL_ORCISH_DAGGER, ORCISH_DAGGER,
      EXCEPTIONALITY_ELITE, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_ELF_SLAYING,
    ...
    A("Orcrist", "runed broadsword", None, ELVEN_BROADSWORD, ELVEN_BROADSWORD, 
      EXCEPTIONALITY_ELITE, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_ORC_SLAYING,
    ...
    A("Dragonbane", "mithril-hilted broadsword", None, BROADSWORD, BROADSWORD,
        EXCEPTIONALITY_ELITE, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_DRAGON_SLAYING, 
    ...
    A("Demonbane", "runed silver long sword", None, SILVER_LONG_SWORD, SILVER_LONG_SWORD,
        EXCEPTIONALITY_ELITE, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_DEMON_SLAYING, 
    ...
    A("Werebane", "runed silver saber", None, SILVER_SABER, SILVER_SABER,
        EXCEPTIONALITY_ELITE, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_LYCANTHROPE_SLAYING, 
    ...
    A("Giantslayer", "ruby-encrusted long sword", None, LONG_SWORD, LONG_SWORD,
        EXCEPTIONALITY_ELITE, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_GIANT_SLAYING,
    ...
    A("Ogresmasher", "gold-hilted war hammer", None, WAR_HAMMER, WAR_HAMMER,
        EXCEPTIONALITY_ELITE, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_OGRE_SLAYING, 
    ...
    A("Trollsbane", "runed morning star", None, MORNING_STAR, MORNING_STAR,
        EXCEPTIONALITY_ELITE, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_TROLL_SLAYING, 
    ...
    A("Howling Flail", "runed flail", None, RUNED_FLAIL, FLAIL, 
        EXCEPTIONALITY_ELITE, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE, (AF_RESTR | AF_NAME_KNOWN_WHEN_INVOKED | AF_INVOKE_EXPENDS_CHARGE), AF2_NONE, SPFX_LUCK | SPFX_CHA_25, SPFX_NONE, 0,
    ...
    A("Sunsword", None, None, CRYSTAL_LONG_SWORD, CRYSTAL_LONG_SWORD,
        EXCEPTIONALITY_EXCEPTIONAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE, 
    ...
    A("The Mace of Saint Cuthbert", "wooden mace", None, HEAVENLY_OAK_MACE, MACE,
        EXCEPTIONALITY_CELESTIAL, MYTHIC_PREFIX_HALLOWED, MYTHIC_SUFFIX_BANISHMENT, 
        AF_RESTR | AF_ANGERS_DEMONS | AF_DFLAG2, AF2_NONE, SPFX_DEMON_WARNING | SPFX_UNDEAD_WARNING, SPFX_NONE, M2_DEMON | M2_UNDEAD,
        1, 5, 5, PHYSI(1, 20, 5), FREE_ACTION, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_LAWFUL, PM_PRIEST, NON_PM, 2000L,
    ...
    A("The Serpent Ring of Set", "serpent-shaped", None, RIN_THE_SERPENT_GOD, RIN_THE_SERPENT_GOD, 
        ...
        0, 0, 0, NO_ATTK, NO_POWER, NO_POWER, ARTINVOKE_DEMON_SUMMON, 6, 6, 200, 50, 500, A_CHAOTIC, PM_WIZARD, NON_PM, 3000L,
...
A("The Palantir of Westernesse",        CRYSTAL_BALL, CRYSTAL_BALL,
    ...
    A("The Eyes of the Overworld", "runed eyeglasses", None, LENSES, LENSES,
        EXCEPTIONALITY_NORMAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE, 
        (AF_NOGEN | AF_RESTR | AF_INTEL | AF_FAMOUS), AF2_INDESTRUCTIBLE, (SPFX_XRAY | SPFX_BLIND_SEEING),  SPFX_NONE, 0,
    ...
    A("The Mitre of Holiness", "diamond-encrusted helmet", None, HELM_OF_BRILLIANCE, HELMET,
        EXCEPTIONALITY_NORMAL, MYTHIC_PREFIX_HALLOWED, MYTHIC_SUFFIX_NONE, 
        (AF_NOGEN | AF_RESTR | AF_INTEL | AF_FAMOUS), AF2_INDESTRUCTIBLE, SPFX_PROTECT | SPFX_HALF_PHYSICAL_DAMAGE_AGAINST_UNDEAD_AND_DEMONS, SPFX_NONE, 0,
    ...
    A("The Ark of the Covenant", "gold-covered wooden chest", None, GOLDEN_CHEST, GOLDEN_CHEST,
        EXCEPTIONALITY_NORMAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE, 
        (AF_NOGEN | AF_RESTR | AF_INTEL | AF_FAMOUS | AF_NO_WISH), AF2_INDESTRUCTIBLE, SPFX_NONE, (SPFX_LUCK | SPFX_PROTECT), 0,
    ...
    A("Staff-Sling of the Ancients", "ornate staff-sling", None, STAFF_SLING, STAFF_SLING,
        EXCEPTIONALITY_ELITE, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE, 
