...
#define A(nam, desc, hit_desc, typ, masktyp, aflags, aflags2, spfx, cspfx, mt, tohitdice, tohitsize, tohitplus, atk, dfn, cry, inv, inv_dur_dice, inv_dur_diesize, inv_dur_plus, manacost, repower, al, cl, rac, cost, glowclr, objclr) nam
...
#define A(nam, desc, hit_desc, typ, masktyp, aflags, aflags2, spfx, cspfx, mt, tohitdice, tohitsize, tohitplus, atk, dfn, cry, inv, inv_dur_dice, inv_dur_diesize, inv_dur_plus, manacost, repower, al, cl, rac, cost, glowclr, objclr) \
    {                                                                       \
        typ, masktyp, nam, desc, hit_desc, aflags, aflags2, spfx, cspfx, mt, tohitdice, tohitsize, tohitplus, atk, dfn, cry, inv, inv_dur_dice, inv_dur_diesize, inv_dur_plus, manacost, repower, al, cl, rac, cost, glowclr, objclr    \
    }
...
STATIC_OVL NEARDATA struct artifact artilist[] = {
    ...
    A("Frost Brand", "iron-hilted runed long sword", "ice-cold blade", LONG_SWORD, LONG_SWORD, (AF_RESTR | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), AF2_NONE, SPFX_NONE, SPFX_NONE, 0,
	  1, 5, 0, COLD(ARTDMG_DOUBLE_DAMAGE, 0), COLD_RES, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_NONE, NON_PM, NON_PM, 3000L,
      NO_COLOR, CLR_WHITE),
    ...
    A("Fire Brand", "copper-hilted runed long sword", "fiery blade", LONG_SWORD, LONG_SWORD, (AF_RESTR | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), AF2_NONE, SPFX_NONE, SPFX_NONE, 0,
	  1, 5, 0, FIRE(ARTDMG_DOUBLE_DAMAGE, 0), FIRE_RES, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_NONE, NON_PM, NON_PM, 3000L,
      NO_COLOR, CLR_RED),
	...
	A("Gnollbane", "ruby-hilted war hammer", None, WAR_HAMMER_OF_GNOLL_SLAYING, WAR_HAMMER, (AF_RESTR | AF_DFLAG2 | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), AF2_NONE, SPFX_NONE, SPFX_NONE, M2_GNOLL,
		1, 5, 0, PHYS(1, 20), SHOCK_RES, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_LAWFUL, NON_PM, NON_PM, 500L,
		NO_COLOR, NO_COLOR),
...
A("The Palantir of Westernesse",        CRYSTAL_BALL, CRYSTAL_BALL,
    ...
    A("The Mitre of Holiness", "diamond-encrusted helmet", None, HELM_OF_BRILLIANCE, HELMET,
	  (AF_NOGEN | AF_RESTR | AF_INTEL | AF_FAMOUS), AF2_NONE, SPFX_PROTECT | SPFX_HALF_PHYSICAL_DAMAGE_AGAINST_UNDEAD_AND_DEMONS, SPFX_NONE, 0,
		0, 0, 0, NO_ATTK, NO_POWER, FIRE_RES, ARTINVOKE_ENERGY_BOOST, 0, 0, 0, 0, 150, A_LAWFUL, PM_PRIEST, NON_PM, 2000L,
		NO_COLOR, CLR_MAGENTA),
