...
STATIC_OVL NEARDATA struct artifact artilist[] = {
	...
	A("Luck Blade", "bright runed broadsword", None, SWORD_OF_LUCKINESS, LONG_SWORD, (AF_RESTR | AF_NAME_KNOWN_WHEN_INVOKED | AF_NO_WISH), SPFX_LUCK, SPFX_NONE, 0,
		1, 5, 0, PHYS(1, 5), NO_POWER, NO_POWER, INVOKE_WISHING, A_NONE, NON_PM, NON_PM, 6000L,
		NO_COLOR, HI_METAL),
	...
	A("Wand of Orcus", "skull-headed obsidian mace", None, MACE_OF_DEATH, MACE_OF_DEATH, (AF_NOGEN | AF_RESTR | AF_NAME_KNOWN_WHEN_INVOKED | AF_NO_WISH), SPFX_NONE, SPFX_NONE, 0,
		1, 5, 0, DRLI(1, 10), NO_POWER, NO_POWER, WAND_OF_DEATH, A_CHAOTIC, NON_PM, NON_PM, 6000L, 
		NO_COLOR, CLR_BLACK),
