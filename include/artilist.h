...
NEARDATA struct artifact artilist[] = {
    ...
    A("Wand of Orcus", "skull-headed obsidian mace", None, MACE_OF_THE_UNDERWORLD, MACE_OF_THE_UNDERWORLD, 
        ...
        (AF_NOGEN | AF_RESTR | AF_INVOKE_EXPENDS_CHARGE | AF_NO_WISH), AF2_NONE, SPFX_NONE, SPFX_NONE, 0,
    ...
    A("Triple-Headed Flail of Yeenoghu", "runed triple-headed flail", None, TRIPLE_HEADED_FLAIL, TRIPLE_HEADED_FLAIL,
        EXCEPTIONALITY_INFERNAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE, 
        (AF_NOGEN | AF_RESTR | AF_NO_WISH | AF_DRLI), AF2_NONE, SPFX_NONE, SPFX_NONE, 0,
    ...
    A("The Ruling Ring of Yendor", "plain golden", None, RIN_SUPREME_POWER, RIN_SUPREME_POWER, 
        ...
        AF2_FLOOR_TILE, SPFX_NONE, SPFX_AGGRAVATE_MONSTER | SPFX_UNLUCK, 0,
...
A("The Palantir of Westernesse",        CRYSTAL_BALL, CRYSTAL_BALL,
    ...
    A("The Longbow of Diana", "shining long bow", None, DIVINE_LONG_BOW, LONG_BOW,
        EXCEPTIONALITY_EXCEPTIONAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE, 
        (AF_NOGEN | AF_RESTR | AF_INTEL | AF_FAMOUS), AF2_NONE, SPFX_STLTH | SPFX_REFLECT, SPFX_ESP, 0,
    ...
    A("The Gladstone", None, None, LUCKSTONE, LUCKSTONE,
        ...
        1, 5, 20, PHYS(1, 5), NO_POWER, POISON_RESISTANCE, ARTINVOKE_HEALING, 0, 0, 0, 0, 300, A_NEUTRAL, NON_PM, NON_PM, 2000L,
