...
A("The Palantir of Westernesse",        CRYSTAL_BALL, CRYSTAL_BALL,
    ...
    A("The Eye of the Aethiopica", "eye-shaped", None, AMULET_OF_ESP, AMULET_OF_ESP,
        EXCEPTIONALITY_NORMAL, MYTHIC_PREFIX_NONE, MYTHIC_SUFFIX_NONE, 
        (AF_NOGEN | AF_RESTR | AF_INTEL | AF_FAMOUS), AF2_FLOOR_TILE | AF2_INDESTRUCTIBLE, SPFX_NONE, (SPFX_EREGEN | SPFX_HSPDAM), 0,
