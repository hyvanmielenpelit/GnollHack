...
STATIC_OVL NEARDATA struct artifact artilist[] = {
	...
	A("Wand of Orcus", "skull-headed obsidian mace", MACE_OF_DEATH, MACE_OF_DEATH, (AF_NOGEN | AF_RESTR | AF_NAME_KNOWN_WHEN_INVOKED | AF_NO_WISH), SPFX_NONE, SPFX_NONE, 0,
    ...
    A("Sunsword", "glowing runed long sword", LONG_SWORD, LONG_SWORD, (AF_RESTR | AF_DFLAG2 | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED | AF_ANGERS_DEMONS | AF_SHINES_MAGICAL_LIGHT),
