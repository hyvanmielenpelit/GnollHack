...
STATIC_OVL NEARDATA struct artifact artilist[] = {
	...
	A("Dragonbane", "mithril-hilted runed broadsword", None, SWORD_OF_DRAGON_SLAYING, BROADSWORD,
		(AF_RESTR | AF_DCLAS | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), AF2_GENERATED_ELITE, SPFX_REFLECT, SPFX_NONE, S_DRAGON,
	...
	A("Werebane", "runed silver saber", None, SABER_OF_LYCANTHROPE_SLAYING, SILVER_SABER, (AF_RESTR | AF_DFLAG2 | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), AF2_GENERATED_ELITE, SPFX_NONE, SPFX_NONE, M2_WERE,
	...
	A("Giantslayer", "ruby-encrusted long sword", None, SWORD_OF_GIANT_SLAYING, LONG_SWORD, (AF_RESTR | AF_DFLAG2 | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), AF2_GENERATED_ELITE, SPFX_NONE, SPFX_NONE, M2_GIANT,
		1, 5, 0, PHYS(1, 20), NO_POWER, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_NEUTRAL, NON_PM, NON_PM, 500L,
		NO_COLOR, NO_COLOR, 0, OBJECT_SOUNDSET_NONE),

	A("Ogresmasher", "gold-hilted war hammer", None, WAR_HAMMER_OF_OGRE_SLAYING, WAR_HAMMER, (AF_RESTR | AF_DCLAS | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), AF2_GENERATED_ELITE, SPFX_NONE, SPFX_NONE, S_OGRE,
		1, 5, 0, PHYS(1, 20), NO_POWER, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_NONE, NON_PM, NON_PM, 500L,
		NO_COLOR, NO_COLOR, 0, OBJECT_SOUNDSET_NONE),

	A("Trollsbane", "runed morning star", None, MORNING_STAR_OF_TROLL_SLAYING, MORNING_STAR, (AF_RESTR | AF_DCLAS | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), AF2_GENERATED_ELITE, SPFX_REGEN, SPFX_NONE, S_TROLL,
		1, 5, 0, PHYS(1, 20), NO_POWER, NO_POWER, NO_POWER, 0, 0, 0, 0, 0, A_NONE, NON_PM, NON_PM, 500L,
		NO_COLOR, NO_COLOR, 0, OBJECT_SOUNDSET_NONE),

	A("Crossbow of the Gnoll Lords", "runed repeating heavy crossbow", None, REPEATING_HEAVY_CROSSBOW, REPEATING_HEAVY_CROSSBOW, (AF_RESTR | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED), AF2_GENERATED_ELITE, SPFX_STLTH, SPFX_NONE, 0,
	...
	A("Luck Blade", "bright runed broadsword", None, SWORD_OF_LUCKINESS, LONG_SWORD, (AF_RESTR | AF_NAME_KNOWN_WHEN_INVOKED | AF_NO_WISH | AF_INVOKE_EXPENDS_CHARGE), AF2_GENERATED_ELITE, SPFX_NONE, SPFX_NONE, 0,
	...
	A("Wand of Orcus", "skull-headed obsidian mace", None, MACE_OF_THE_UNDERWORLD, MACE_OF_THE_UNDERWORLD, (AF_NOGEN | AF_RESTR | AF_NAME_KNOWN_WHEN_INVOKED | AF_INVOKE_EXPENDS_CHARGE | AF_NO_WISH), AF2_GENERATED_ELITE, SPFX_NONE, SPFX_NONE, 0,
	...
	A("Mace of Saint Cuthbert", "rugged wooden mace", None, MACE_OF_GREATER_DISRUPTION, MACE_OF_GREATER_DISRUPTION,
		AF_RESTR | AF_ANGERS_DEMONS | AF_DFLAG2, AF2_GENERATED_ELITE, SPFX_DEMON_WARNING | SPFX_UNDEAD_WARNING, SPFX_NONE, M2_DEMON | M2_UNDEAD,
