...
#define A(nam, desc, hit_desc, typ, masktyp, aflags, spfx, cspfx, mt, tohitdice, tohitsize, tohitplus, atk, dfn, cry, inv, al, cl, rac, cost, glowclr, objclr) nam

static const char *artifact_names[] = {
#else
/* in artifact.c, set up the actual artifact list structure */

#define A(nam, desc, hit_desc, typ, masktyp, aflags, spfx, cspfx, mt, tohitdice, tohitsize, tohitplus, atk, dfn, cry, inv, al, cl, rac, cost, glowclr, objclr) \
    {                                                                       \
        typ, masktyp, nam, desc, hit_desc, aflags, spfx, cspfx, mt, tohitdice, tohitsize, tohitplus, atk, dfn, cry, inv, al, cl, rac, cost, glowclr, objclr    \
    }
...
STATIC_OVL NEARDATA struct artifact artilist[] = {
    ...
    A("", None, None, STRANGE_OBJECT, STRANGE_OBJECT, AF_NONE, SPFX_NONE, SPFX_NONE, 0, 0, 0, 0, NO_ATTK, NO_POWER, NO_POWER, NO_POWER, A_NONE,
	...
	A("Howling Flail", "gold-hilted runed flail", None, RUNED_FLAIL, FLAIL, (AF_RESTR | AF_NAME_KNOWN_WHEN_INVOKED), SPFX_LUCK, SPFX_NONE, 0,
		1, 5, 0, PHYS(1, 10), NO_POWER, NO_POWER, ARTINVOKE_TAMING, A_CHAOTIC, NON_PM, PM_GNOLL, 6000L,
		NO_COLOR, HI_GOLD),
	...
	A("Luck Blade", "bright runed broadsword", None, SWORD_OF_LUCKINESS, LONG_SWORD, (AF_RESTR | AF_NAME_KNOWN_WHEN_INVOKED | AF_NO_WISH), SPFX_NONE, SPFX_NONE, 0,
		1, 5, 0, PHYS(1, 5), NO_POWER, NO_POWER, ARTINVOKE_WISHING, A_NONE, NON_PM, NON_PM, 6000L, /* Note: Base item gives luck already */
		NO_COLOR, HI_METAL),
	...
	A("Wand of Orcus", "skull-headed obsidian mace", None, MACE_OF_DEATH, MACE_OF_DEATH, (AF_NOGEN | AF_RESTR | AF_NAME_KNOWN_WHEN_INVOKED | AF_NO_WISH), SPFX_NONE, SPFX_NONE, 0,
		1, 5, 0, DRLI(1, 10), NO_POWER, NO_POWER, ARTINVOKE_WAND_OF_DEATH, A_CHAOTIC, NON_PM, NON_PM, 6000L, 
		NO_COLOR, CLR_BLACK),

    A("Rhongomyniad", "runed lance", None, LANCE, LANCE,
		(AF_RESTR | AF_FAMOUS), SPFX_NONE, SPFX_NONE, 0,
		1, 5, 0, PHYS(ARTDMG_TRIPLE_DAMAGE, 0), CURSE_RES, DEATH_RES, 0, A_LAWFUL, PM_KNIGHT, NON_PM, 2500L,
    ...
    A("The One Ring", "plain golden", None, RIN_SUPREME_POWER, RIN_SUPREME_POWER, (AF_RESTR | AF_INTEL | AF_MONSTERS_CAN_TRACK_ARTIFACT),
		...
		0, 0, 0, NO_ATTK, NO_POWER, NO_POWER, NO_POWER, A_NONE, NON_PM, NON_PM, 10000L,
		NO_COLOR, HI_GOLD),
    ...
    A("Ring of Three Wishes", "three-ruby-studded", None, RIN_THREE_CHARGES, RIN_THREE_CHARGES, (AF_RESTR | AF_NO_WISH | AF_NAME_KNOWN_WHEN_INVOKED),
		SPFX_NONE, SPFX_NONE, 0,
		0, 0, 0, NO_ATTK, NO_POWER, NO_POWER, ARTINVOKE_WISHING, A_NONE, NON_PM, NON_PM, 4500L,
		NO_COLOR, CLR_RED),
    ...
    A("Serpent Ring of Set", "serpent-shaped", None, RIN_THE_SERPENT_GOD, RIN_THE_SERPENT_GOD, (AF_RESTR | AF_NAME_KNOWN_WHEN_WORN_OR_WIELDED),
		...
		0, 0, 0, NO_ATTK, NO_POWER, NO_POWER, ARTINVOKE_DEMON_SUMMON, A_NONE, NON_PM, NON_PM, 3000L,
		NO_COLOR, CLR_RED),
...
A("The Palantir of Westernesse",        CRYSTAL_BALL, CRYSTAL_BALL,
    ...
    A("The Staff of Aesculapius", "serpent-entwined quarterstaff", None, STAFF_OF_LIFE, QUARTERSTAFF,
		...
		0, 0, 0, DRLI(0,0), DRAIN_RES, NO_POWER, ARTINVOKE_HEALING, A_NEUTRAL, PM_HEALER, NON_PM, 5000L, 
		NO_COLOR, CLR_MAGENTA),
    ...
    A("The Magic Mirror of Merlin", "runed looking glass", None, MAGIC_MIRROR, MIRROR,
		...
		0, 0, 0, NO_ATTK, NO_POWER, ANTIMAGIC, NO_POWER, A_LAWFUL, PM_KNIGHT, NON_PM, 1500L,
		NO_COLOR, CLR_MAGENTA),
    ...
    A("The Eyes of the Overworld", "runed eyeglasses", None, LENSES, LENSES,
		...
		0, 0, 0, NO_ATTK, ANTIMAGIC, NO_POWER, ARTINVOKE_ENLIGHTENING, A_NEUTRAL, PM_MONK, NON_PM, 2500L, 
		NO_COLOR, CLR_MAGENTA),
    ...
    A("The Mitre of Holiness", "diamond-encrusted helmet", None, HELM_OF_BRILLIANCE, HELMET,
	  (AF_NOGEN | AF_RESTR | AF_INTEL | AF_FAMOUS), SPFX_PROTECT | SPFX_HALF_PHYSICAL_DAMAGE_AGAINST_UNDEAD_AND_DEMONS, SPFX_NONE, 0, 
		0, 0, 0, NO_ATTK, NO_POWER, FIRE_RES, ARTINVOKE_ENERGY_BOOST, A_LAWFUL, PM_PRIEST, NON_PM, 2000L, 
		NO_COLOR, CLR_MAGENTA),
    ...
    A("The Longbow of Diana", "ornamental long bow", None, LONG_BOW, LONG_BOW,
		...
		1, 10, 0, PHYS(ARTDMG_DOUBLE_DAMAGE, 0), NO_POWER, NO_POWER, ARTINVOKE_CREATE_AMMO, A_CHAOTIC, PM_RANGER, NON_PM, 4000L, 
		NO_COLOR, CLR_MAGENTA),
    ...
    A("The Master Key of Thievery", "ornamental key", None, MASTER_KEY, SKELETON_KEY,
		...
		0, 0, 0, NO_ATTK, NO_POWER, NO_POWER, ARTINVOKE_UNTRAP, A_CHAOTIC, PM_ROGUE, NON_PM, 3500L, 
		NO_COLOR, CLR_MAGENTA),
    ...
    A("The Platinum Yendorian Express Card", "black credit card", None, CREDIT_CARD, CREDIT_CARD,
		(AF_NOGEN | AF_RESTR | AF_INTEL | AF_FAMOUS), SPFX_NONE, (SPFX_ESP | SPFX_HSPDAM), 0, 
		0, 0, 0, NO_ATTK, NO_POWER, ANTIMAGIC, ARTINVOKE_CHARGE_OBJ, A_NEUTRAL, PM_TOURIST, NON_PM, 7000L, 
		NO_COLOR, CLR_BLACK),
    ...
    A("The Orb of Fate", "ornamental crystal ball", None, CRYSTAL_BALL, CRYSTAL_BALL,
		...
		0, 0, 0, NO_ATTK, NO_POWER, NO_POWER, ARTINVOKE_LEVEL_TELEPORT, A_NEUTRAL, PM_VALKYRIE, NON_PM, 3500L, 
		NO_COLOR, CLR_MAGENTA),
    ...
    A("The Eye of the Aethiopica", "eye-shaped amulet", None, AMULET_OF_ESP, AMULET,
		...
		0, 0, 0, NO_ATTK, ANTIMAGIC, NO_POWER, ARTINVOKE_CREATE_PORTAL, A_NEUTRAL, PM_WIZARD, NON_PM, 4000L, 
		NO_COLOR, CLR_MAGENTA),
	...
	A("The Ark of the Covenant", "gold-covered wooden chest", None, GOLDEN_CHEST, GOLDEN_CHEST,
		...
		0, 0, 0, NO_ATTK, NO_POWER, ANTIMAGIC, ARTINVOKE_BLESS_CONTENTS, A_LAWFUL, NON_PM, /* PM_ARCHEOLOGIST */ NON_PM, 5000L, 
		NO_COLOR, HI_GOLD),
     ...
     */
    A(0, 0, 0, 0, 0, AF_NONE, SPFX_NONE, SPFX_NONE, 0, 0, 0, 0, NO_ATTK, NO_POWER, NO_POWER, NO_POWER, A_NONE, NON_PM, NON_PM, 0L,
