...
STATIC_OVL NEARDATA struct artifact artilist[] = {
    ...
    A("Sting", ELVEN_DAGGER, ELVEN_DAGGER, (SPFX_WARN | SPFX_DFLAG2), 0, M2_ORC, PHYS(5, 0),
    ...
    A("Dragonbane", BROADSWORD, BROADSWORD,
    ...
    A("Giantslayer", LONG_SWORD, LONG_SWORD, (SPFX_RESTR | SPFX_DFLAG2), 0, M2_GIANT,
	...
	A("Trollsbane", MORNING_STAR, MORNING_STAR, (SPFX_RESTR | SPFX_DCLAS), 0, S_TROLL,
      PHYS(5, 0), NO_DFNS, NO_CARY, 0, A_NONE, NON_PM, NON_PM, 200L,
      NO_COLOR),
    ...
    A("Sunsword", LONG_SWORD, LONG_SWORD, (SPFX_RESTR | SPFX_DFLAG2), 0, M2_UNDEAD,
