...
STATIC_OVL NEARDATA struct artifact artilist[] = {
	...
	AF_NOGEN | AF_RESTR | AF_DEFN | AF_INTEL | AF_FAMOUS | AF_DEFN | AF_INTEL,
...
A("The Palantir of Westernesse",        CRYSTAL_BALL, CRYSTAL_BALL,
    ...
    A("The Eyes of the Overworld", "runed eyeglasses", LENSES, LENSES,
		(AF_NOGEN | AF_RESTR | AF_INTEL | AF_FAMOUS), (SPFX_XRAY | SPFX_BLIND_SEEING), SPFX_NONE, 0, NO_ATTK,
    ...
    A("The Mitre of Holiness", "diamond-encrusted helmet", HELM_OF_BRILLIANCE, HELMET,
		(AF_NOGEN | AF_RESTR | AF_INTEL | AF_FAMOUS), SPFX_PROTECT | SPFX_HALF_PHYSICAL_DAMAGE_AGAINST_UNDEAD_AND_DEMONS, SPFX_NONE,
      0, NO_ATTK, NO_DFNS, CARY(AD_FIRE), ENERGY_BOOST, A_LAWFUL,
    ...
    A("The Tsurugi of Muramasa", "runed tsurugi", TSURUGI, TSURUGI,
			(AF_NOGEN | AF_RESTR | AF_INTEL | AF_BISECT | AF_FAMOUS),
    ...
    A("The Platinum Yendorian Express Card", "black credit card", CREDIT_CARD, CREDIT_CARD,
		(AF_NOGEN | AF_RESTR | AF_INTEL | AF_DEFN | AF_FAMOUS), SPFX_NONE,
