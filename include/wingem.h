...
E void mar_print_glyph(int, int, int, struct layer_info);
E void mar_issue_gui_command(int, int, int, const char*);
...
E winid Gem_create_nhwindow_ex(int, int, int, struct extended_create_window_info);
...
#ifdef CLIPPING
E void Gem_cliparound(int, int, boolean force);
#endif
#ifdef POSITIONBAR
E void Gem_update_positionbar(char *);
#endif
E void Gem_print_glyph(winid, xchar, xchar, struct layer_info);
E void Gem_issue_gui_command(int, int, int, const char*);
...
E char Gem_yn_function_ex(int, int, int, int, const char *, const char *, const char *, char, const char*, const char*, uint64_t);
E void Gem_getlin_ex(int, int, int, const char *, char *, const char*, const char*, const char*);
E int Gem_get_ext_cmd(void);
E void Gem_number_pad(int);
E void Gem_delay_output(void);
E void Gem_delay_output_milliseconds(int);
E void Gem_delay_output_intervals(int);
#ifdef CHANGE_COLOR
E void Gem_change_color(int color, int64_t rgb, int reverse);
