...
enum floating_text_types {
    ...
    FLOATING_TEXT_CRITICAL_DAMAGE,
    FLOATING_TEXT_LETHAL_DAMAGE,
    FLOATING_TEXT_MANA_GAIN,
    FLOATING_TEXT_MANA_LOSS,
    FLOATING_TEXT_NUTRITION_GAIN,
    FLOATING_TEXT_NUTRITION_LOSS,
    FLOATING_TEXT_ALIGNMENT_GAIN,
    FLOATING_TEXT_ALIGNMENT_LOSS,
    FLOATING_TEXT_LUCK_GAIN,
    FLOATING_TEXT_LUCK_LOSS,
    FLOATING_TEXT_LEVEL_GAIN,
    FLOATING_TEXT_LEVEL_LOSS,
    FLOATING_TEXT_ATTRIBUTE_GAIN,
    FLOATING_TEXT_ATTRIBUTE_LOSS,
    FLOATING_TEXT_INTRINSIC_GAIN,
    FLOATING_TEXT_INTRINSIC_LOSS,
    FLOATING_TEXT_DIVINE_PROTECTION_GAIN,
    FLOATING_TEXT_DIVINE_PROTECTION_LOSS,
    FLOATING_TEXT_NEGATIVE_CONDITION_OBTAINED,
    FLOATING_TEXT_NEGATIVE_CONDITION_CURED,
    FLOATING_TEXT_ITEM_PICKED,
    FLOATING_TEXT_ITEM_DAMAGED,
    FLOATING_TEXT_LOCK_BROKEN,
    FLOATING_TEXT_MUFFLED_SHATTER,
    FLOATING_TEXT_LID_ALREADY_OPEN,
