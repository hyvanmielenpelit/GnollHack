...
#define TER_DETECT 0x10    /* detect_foo magic rather than #terrain */
    ...
    boolean dumping_ai_snapshot; /* doing the AI snapshot dump right now? */
    ...
    boolean clickpole;       /* allow left-click to use polearm */
...
struct startup_flags {
    ...
    boolean damage_formula_set;
    boolean damage_formula_value;
