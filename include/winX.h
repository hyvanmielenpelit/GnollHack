...
E void FDECL(highlight_yn, (boolean));
...
E char *FDECL(X11_getmsghistory, (char**, char**, boolean));
E void FDECL(X11_putmsghistory, (const char *, const char *, const char *, boolean));
...
E winid FDECL(X11_create_nhwindow_ex, (int, int, int, struct extended_create_window_info));
...
E void FDECL(X11_add_menu, (winid, int, const ANY_P *, char, char, int,
                            const char *, boolean));
E void FDECL(X11_add_extended_menu, (winid, int, const ANY_P*, char, char, int, int,
...
#ifdef CLIPPING
E void FDECL(X11_cliparound, (int, int, boolean));
#endif
E void FDECL(X11_print_glyph, (winid, xchar, xchar, struct layer_info));
...
E char FDECL(X11_yn_function_ex, (int, int, int, int, const char *, const char *, const char *, char, const char*, const char*, uint64_t));
...
E void FDECL(X11_status_enablefield, (int, const char *, const char *, boolean));
