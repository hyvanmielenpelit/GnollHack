...
E void FDECL(X11_add_extended_menu, (winid, int, const ANY_P*, CHAR_P, CHAR_P, int, int,
...
E char FDECL(X11_yn_function_ex, (int, int, int, int, const char *, const char *, const char *, int, const char*, const char*, uint64_t));
