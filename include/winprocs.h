...
struct window_procs {
    ...
    void FDECL((*win_getlin_ex), (int, int, int, const char *, char *));
...
#define getlin(x, y) (*windowprocs.win_getlin_ex)(GETLINE_GENERAL, ATR_NONE, NO_COLOR, x, y)
...
struct chain_procs {
    ...
    void FDECL((*win_getlin_ex), (CARGS, int, int, int, const char *, char *));
...
extern void FDECL(safe_getlin_ex, (int, int, int, const char *, char *));
