...
struct window_procs {
    ...
    char FDECL((*win_yn_function_ex), (int, int, int, int, const char*, const char *, const char *, int, const char*, const char*, uint64_t));
...
struct chain_procs {
    ...
    char FDECL((*win_yn_function_ex),
               (CARGS, int, int, int, int, const char *, const char *, int, const char*, const char*, uint64_t));
...
extern char FDECL(safe_yn_function_ex, (int, int, int, int, const char *, const char *, const char *, int, const char*, const char*, uint64_t));
