...
#define TOTAL_TREE_SUBTYPE_VARIATIONS (TREE_SUBTYPE_NORMAL_VARIATIONS + TREE_SUBTYPE_SPRUCE_VARIATIONS + TREE_SUBTYPE_FIR_VARIATIONS + TREE_SUBTYPE_DATE_PALM_VARIATIONS + TREE_SUBTYPE_APPLE_VARIATIONS + TREE_SUBTYPE_BANANA_VARIATIONS + TREE_SUBTYPE_FIG_VARIATIONS)
