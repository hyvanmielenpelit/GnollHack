...
enum monster_sound_types {
    ...
    MONSTER_SOUND_TYPE_ITEM_TRADING,
    MONSTER_SOUND_TYPE_STANDARD_DIALOGUE_LINE,
    MONSTER_SOUND_TYPE_SPECIAL_DIALOGUE_LINE,
    MONSTER_SOUND_TYPE_STANDARD_SOUND,
    MONSTER_SOUND_TYPE_SPECIAL_SOUND,
    MONSTER_SOUND_TYPE_CREATION,
    MONSTER_SOUND_TYPE_GET_ANGRY,
    MONSTER_SOUND_TYPE_MOLLIFIED,
    MONSTER_SOUND_TYPE_ADVICE,
