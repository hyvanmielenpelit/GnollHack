...
#define tty_delay_output_intervals() tty_delay_output_intervals_()
...
#define tty_create_nhwindow_ex(x, y, z, info) tty_create_nhwindow_ex_(x, y, z, info)
...
#define tty_add_extended_menu(a, b, c, d, e, f, g, h, i, j) \
    tty_add_extended_menu_(a, b, c, d, e, f, g, h, i, j)
...
#define tty_issue_gui_command(a) tty_issue_gui_command_(a)
