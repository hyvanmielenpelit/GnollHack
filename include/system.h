...
/* GnollHack 4.0    system.h    $NHDT-Date: 1550268586 2019/02/15 22:09:46 $  $NHDT-Branch: NetHack-3.6.2-beta01 $:$NHDT-Revision: 1.17 $ */
...
#else
E int64_t FDECL(lseek, (int, off_t, int));
#endif
...
E int64_t FDECL(lseek, (int, int64_t, int));
...
E int64_t FDECL(atol, (const char *));
E int FDECL(chdir, (const char *));
...
E char *getlogin();
#if defined(HPUX) && !defined(_POSIX_SOURCE)
E int64_t NDECL(getuid);
E int64_t NDECL(getgid);
E int64_t NDECL(getpid);
#else
#ifdef POSIX_TYPES
...
E void FDECL(tputs, (const char *, int, void (*)(CHAR_P)));
