...
E int64_t lseek(int, int64_t, int);
...
E char *getlogin();
#if defined(HPUX) && !defined(_POSIX_SOURCE)
E int64_t getuid(void);
E int64_t getgid(void);
E int64_t getpid(void);
#else
#ifdef POSIX_TYPES
E pid_t getpid(void);
E uid_t getuid(void);
