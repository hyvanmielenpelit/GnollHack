...
#define MM_NO_MONSTER_INVENTORY 0x00000001  /* suppress minvent when creating mon */
#define MM_NOWAIT 0x00000002   /* don't set STRAT_WAITMASK flags */
#define MM_NOCOUNTBIRTH \
    0x00000004 /* don't increment born counter (for revival) */
#define MM_IGNOREWATER 0x00000008 /* ignore water when positioning */
#define MM_ADJACENTOK \
    0x00000010               /* it is acceptable to use adjacent coordinates */
#define MM_ANGRY  0x00000020  /* monster is created angry */
#define MM_NONAME 0x00000040 /* monster is not christened */
#define MM_EGD    0x00000100    /* add egd structure */
#define MM_EPRI   0x00000200   /* add epri structure */
#define MM_ESHK   0x00000400   /* add eshk structure */
#define MM_EMIN   0x00000800   /* add emin structure */
#define MM_EDOG   0x00001000   /* add edog structure */
#define MM_ASLEEP 0x00002000   /* monsters should be generated asleep */
#define MM_NOGRP  0x00004000   /* suppress creation of monster groups */
#define MM_MAX_HP  0x00008000  /* maximum hit points */
#define MM_MALE  0x00010000    /* always male */
#define MM_FEMALE  0x00020000  /* always female */
#define MM_NORMAL_HIT_DICE  0x00040000  /* use normal hit dice */
#define MM_EMIN_COALIGNED  0x00080000  /* minion is of the same alignment as player */
#define MM_NO_DIFFICULTY_HP_CHANGE  0x00100000  /* HP remains unadjusted due to difficulty */
#define MM_ADJUST_HP_FROM_EXISTING  0x00200000  /* Calculate only new maxhp and adjust HP proportionally */
...
#define ARM_AC_BONUS(obj, ptr) (((obj)->oclass == ARMOR_CLASS || (objects[(obj)->otyp].oc_flags & O1_IS_ARMOR_WHEN_WIELDED)) ?                    \
    (objects[(obj)->otyp].oc_armor_class + (objects[(obj)->otyp].oc_flags & O1_SPE_DOES_NOT_AFFECT_AC ? 0 : (!cursed_items_are_positive(ptr) ? (obj)->spe : abs((obj)->spe))) \
...
#define ARM_MC_BONUS(obj, ptr)                      \
    (objects[(obj)->otyp].oc_magic_cancellation + (objects[(obj)->otyp].oc_flags & O1_SPE_AFFECTS_MC ? (!cursed_items_are_positive(ptr) ? (obj)->spe : abs((obj)->spe)) : 0) \
