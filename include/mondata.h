...
#define mon_ambient_sound(ptr) ((ptr)->soundset <= MONSTER_SOUNDSET_NONE ? GHSOUND_NONE : monster_soundsets[(ptr)->soundset].ambient_sound.ghsound)
#define mon_ambient_volume(ptr) ((ptr)->soundset <= MONSTER_SOUNDSET_NONE ? 0 : monster_soundsets[(ptr)->soundset].ambient_sound.volume)
