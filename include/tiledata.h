...
enum game_command_tile_types
{
    ...
    SET_QUICK_SPELL_COMMAND_TILE,
    CAST_QUICK_SPELL_COMMAND_TILE,
    CAST_SPELL_COMMAND_TILE,
    MOVE_SPELL_TO_TOP_COMMAND_TILE,
    MOVE_SPELL_TO_BOTTOM_COMMAND_TILE,
    FORGET_SPELL_COMMAND_TILE,
    CANCEL_COMMAND_TILE,
    OK_COMMAND_TILE,
